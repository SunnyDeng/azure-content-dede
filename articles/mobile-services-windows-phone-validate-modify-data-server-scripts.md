<properties pageTitle="Verwenden von Serverskripts zum Überprüfen von Daten (Windows Phone) | Mobile Dev Center" description="Erfahren Sie, wie Sie Daten überprüfen und ändern, die mithilfe von Serverskripts von Ihrer Windows Phone-App gesendet wurden." services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
...
<div class="dev-onpage-video-wrapper"><a href="http://go.microsoft.com/fwlink/?LinkId=298629" target="_blank" class="label">Lernprogramm anzeigen</a> <a style="background-image: url('/media/devcenter/mobile/videos/mobile-wp8-validate-modify-data-180x120.png') !important;" href="http://go.microsoft.com/fwlink/?LinkId=298629" target="_blank" class="dev-onpage-video"><span class="icon">Video wiedergeben</span></a> <span class="time">11:36</span></div>
</div>
...
Dieses Lernprogramm baut auf den Schritten und der Beispiel-App aus dem vorherigen Lernprogramm, [Hinzufügen von Mobile Services zu einer vorhandenen App](/de-de/documentation/articles/mobile-services-windows-phone-get-started-data/), auf. Bevor Sie mit diesem Lernprogramm beginnen, müssen Sie zunächst dieses Lernprogramm abschließen.  
...
1. Öffnen Sie in Visual Studio 2012 Express für Windows Phone das Projekt, das Sie im Lernprogramm [Erste Schritte mit Daten] geändert haben.
...
6. 	Öffnen Sie die Datei "MainPage.xaml.cs", und ersetzen Sie die vorhandene **InsertTodoItem**-Methode durch den folgenden Code:
   	...
   	Diese Version der Methode enthält die Fehlerbehandlung für **MobileServiceInvalidOperationException**, die die Fehlermeldung in einer MessageBox anzeigt.
