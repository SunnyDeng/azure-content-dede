...
3. Wählen Sie rechts auf der Seite die Option **Zahlungsmethode ändern** aus.</br> ![changesub](./media/billing-how-to-change-credit-card/changesub.png)
4. Wählen Sie auf der Seite **Zahlungsmethode wählen** neben der Kreditkartennummer die Option **Bearbeiten** aus.</br> ![changesub](./media/billing-how-to-change-credit-card/editcard.png)
...
3. Wählen Sie rechts auf der Seite die Option **Zahlungsmethode ändern** aus.
...
1. Melden Sie sich beim [Azure-Kontocenter](https://account.windowsazure.com/Subscriptions) als Kontoadministrator an.
2. Wählen Sie unter **Klicken Sie auf ein Abonnement, um Details und Nutzung anzuzeigen** das Abonnement aus, für das Sie die Zahlungsmethode ändern möchten.
3. Wählen Sie rechts auf der Seite die Option **Zahlungsmethode ändern** aus.
