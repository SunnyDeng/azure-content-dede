<properties pageTitle="Erstellen Sie einen virtuellen Computer unter Windows im Azure-Vorschauportal" description="Erfahren Sie, wie Sie mithilfe von Azure Marketplace im Azure-Vorschauportal einen virtuellen Azure-Computer unter Windows erstellen." services="virtual-machines" documentationCenter="" authors="dlepow" manager="timlt"/>
...
[How to Connect Virtual Machines in a Cloud Service](http://www.windowsazure.com/de-de/documentation/articles/cloud-services-connect-virtual-machine/)
