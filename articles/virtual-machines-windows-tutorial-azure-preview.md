...
<!---Workflow kann verwirrend sein... haben, wählen Sie die richtige Größe mit **alle Preisstufen Durchsuchen** klicken Sie auf diesen Bereich auswählen und die **empfohlene Preisstufen** Bereich anwenden. Als'standard GRS' ist jedoch sogar nach, dass es das Speicherkonto Premium auswählen... erscheinen nicht aufgetreten, wenn ich untersucht welche Art von Speicher-Konto für den virtuellen Computer verwendet werden würde. 
-->
...
1. Melden Sie sich beim [Azure-Vorschauportal](https://portal.azure.com) an. Sehen Sie sich das Angebot [kostenlose Testversion](http://azure.microsoft.com/pricing/free-trial/) an, wenn Sie noch kein Abonnent sind.
...
3. Wählen Sie Ihren virtuellen Computer aus der Liste aus. 
