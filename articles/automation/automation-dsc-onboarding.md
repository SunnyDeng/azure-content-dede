...
Informationen zum Suchen von Registrierungs-URL und Registrierungsschlüssel für das Automation-Konto, um den Computer zu integrieren, finden Sie im Abschnitt [Sichere Registrierung](#Secure-registration) weiter unten.
...
Das Cmdlet [Register-AzureAutomationDscNode](https://msdn.microsoft.com/library/mt244097.aspx?f=255&MSPPError=-2147217396) kann verwendet werden, um virtuelle Computer im Azure-Vorschauportal über PowerShell zu integrieren.
...
Lokale Linux-Computer und Linux-Computer in anderen Clouds als Azure können auch in Azure Automation DSC integriert werden, sofern sie über ausgehenden Zugriff auf das Internet verfügen. Es sind nur wenige einfache Schritte erforderlich:
