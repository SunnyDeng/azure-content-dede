...
Das Verfahren zum Testen der verschiedenen [Runbooktypen](automation-runbook-types.md) ist identisch, und es besteht kein Unterschied zwischen Tests mit dem Text-Editor und dem grafischen Editor im Azure-Vorschauportal.


## So starten Sie ein Runbook im Azure-Vorschauportal

Sie können mit jedem [Runbooktyp](automation-runbook-types.md) im Azure-Vorschauportal arbeiten.
