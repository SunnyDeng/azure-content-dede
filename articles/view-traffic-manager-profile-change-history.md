<properties
   pageTitle="Anzeigen des Änderungsverlaufs für das Traffic Manager-Profil"
   description="In diesem Artikel wird erläutert, wie Sie den Änderungsverlauf für Ihr Traffic Manager-Profil anzeigen."
