...
4. Wenn Ihre App Storage verwendet, wird automatisch die Georeplikation eingerichtet, wenn Sie eine Preisstufe auswählen, die die Georeplikation unterstützt. Für SLQ hingegen müssen Sie die Georeplikation manuell konfigurieren, um eine hohe Verfügbarkeit und eine Notfallwiederherstellung für Ihre SQL-Datenbank zu gewährleisten. Klicken Sie hierzu auf den Bereich **Georeplikation**.
	...
	![Einrichten der Georeplikation für SQL-Datenbanken](./media/app-service-scale/GeoReplication.png)
...
- Debugger-Support steht für die Modi **Free**, **Shared** und **Basic** mit 1 gleichzeitigen Verbindung pro App Service-Plan zur Verfügung.
- Für die Modi **Standard** und **Premium** steht Debugger-Support mit 5 gleichzeitigen Verbindungen pro App Service-Plan zur Verfügung.
...
- Informationen zu Preisen, Support und SLAs erhalten Sie unter den folgenden Links.
	...
	[Datenübertragung – Preisdetails](/pricing/details/data-transfers/)
	...
	[App Service – Preisdetails für SSL-Verbindungen](/pricing/details/web-sites/#ssl-connections)

- Informationen zu den Best Practices für Azure App Service, einschließlich Aufbau einer skalierbaren, robusten Architektur, finden Sie unter [Best Practices: Azure App Service-Web-Apps](http://blogs.msdn.com/b/windowsazure/archive/2014/02/10/best-practices-windows-azure-websites-waws.aspx).
