<properties 
   ...
   description="Übersicht über den Abschnitt "Einstellungen" der Benutzeroberfläche von Azure Mobile Engagement" 
...
Die verfügbaren Optionen im Menü "Einstellungen" für eine Anwendung variieren abhängig von der Plattform der Anwendung und den Berechtigungen, die Sie der Anwendung erteilt haben. Es gibt u. a. die folgenden Einstellungen: Details, Projekte, Systemeigener Push, Pushgeschwindigkeit, SDK, Nachverfolgung, App-Info, Kommerzieller Druck und Berechtigungen. Nur die Menüoption "App-Info" im Abschnitt "Einstellungen" der Benutzeroberfläche enthält Elemente, die mit dem Feature "Tag" der Device-API verwaltet werden können. Das "Glossar" in "Konzepte" enthält die Definitionen der folgenden Begriffe und Abkürzungen: APNS, GCM, IDFA, API, SDK, API-Schlüssel, SDK-Schlüssel, Anwendungs-ID (App-ID), AppStore-ID, Tagplan, Benutzer-ID, Geräte-ID, App-Delegat, Stapelüberwachung und Deep Linking.

**Siehe auch:**

- [API-Dokumentation - Device-API][Link 4], [Konzepte - Glossar][Link 6], [Handbuch zur Problembehandlung - Dienst][Link 2]
 
  ![settings1][46]

## Details:
Ermöglicht Ihnen, den Namen und die Beschreibung Ihrer Anwendung zu ändern 
und den Besitzer Ihrer Anwendung und Ihre Rollenberechtigungen anzuzeigen. 
...
"Systemeigener Push" ermöglicht Azure Mobile Engagement Pushübertragungen an Ihre Anwendung zu jeder Zeit, selbst wenn sie nicht ausgeführt wird. 
...
- [API-Dokumentation - Reach-API] [Link 4], [API-Dokumentation - Push-API] [Link 4], [Dokumentation zur Benutzeroberfläche - Reach - Neue Pushkampagne][Link 17]
...
Um systemeigenen Push mit dem Windows-Pushbenachrichtigungsdienst zu aktivieren, müssen Sie die Anmeldeinformationen Ihrer Anwendung bereitstellen. 
Sie benötigen die Paketsicherheits-ID (SID) und den geheimen Schlüssel.
 
![settings5][50]
 
**Android Native Push mit GCM oder ADM**

**Google Cloud Messaging (GCM) für Android**

Um systemeigenen Push über GCM zu aktivieren, müssen Sie die Anweisungen unter "http://developer.android.com/guide/google/gcm/gs.html" befolgen. 
Dann müssen einen "Server::Simple"-API-Schlüssel einfügen, der ohne IP-Einschränkungen konfiguriert ist. 
Erfordert Integration mit dem SDK für Android ab Version 1.12.0.
...
Zum Aktivieren von systemeigenem Push mit ADM müssen Sie "OAuth-Anmeldeinformationen" angeben, die aus einer Client-ID und einem Clientschlüssel bestehen (erfordert die Integration mit dem SDK für Android ab Version 2.1.0).
...
- [SDK-Dokumentation - Android - Integration][Link 5], [SDK-Dokumentation - iOS - Integration][Link 5]
...
-    Verwenden eines Zuweisungsdiensts eines Drittanbieters (Azure Mobile Engagement unterstützt derzeit [Mobile App Tracking]( http://www.mobileapptracking.com/). [Trademob](http://www.trademob.com/) wird ggf. in naher Zukunft unterstützt.)
...
- [Dokumentation zur Benutzeroberfläche - Reach - Neue Pushkampagne][Link 17] 
...
- [Dokumentation zur Benutzeroberfläche - Reach - Pushübertragung von Inhalten][Link 17]
...
- [Dokumentation zur Benutzeroberfläche - Reach - Neue Pushkampagne][Link 17], [Dokumentation zur Benutzeroberfläche - Segmente][Link 18]
