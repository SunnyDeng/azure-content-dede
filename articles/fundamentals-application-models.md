...
<h2><a id="VMachine"></a>Virtuelle Computer</h2>
...
-	**Mittel**, mit zwei CPU-Kernen und 3,5 GB Arbeitsspeicher.
-	**Groß**, mit vier CPU-Kernen und 7 GB Arbeitsspeicher.
-	**Sehr groß**, mit acht CPU-Kernen und 14 GB Arbeitsspeicher.
-	**A6**, mit vier CPU-Kernen und 28 GB Arbeitsspeicher.
-	**A7**, mit acht CPU-Kernen und 56 GB Arbeitsspeicher.
...
Wir werden nun einige Szenarien im Detail betrachten, um Ihnen ein besseres Gefühl für die Funktionsweise von virtuellen Azure-Computern zu vermitteln. Nehmen wir z. B. an, Sie möchten eine zuverlässige und skalierbare Webanwendung unter Azure erstellen. Dazu kann z. B. die Anwendungslogik in einer oder mehreren virtuellen Azure-Computern ausgeführt und ein SQL Server für die Datenverwaltung verwendet werden. [Abbildung 3](#Fig3) zeigt, wie dies aussieht.
...
Wie in [Abbildung 5](#Fig5) gezeigt, können Sie Code und andere Webinhalte auf verschiedene Arten in Websites veröffentlichen. Sie können FTP, FTPS oder die WebDeploy-Technologie von Microsoft verwenden. Websites unterstützt außerdem die Veröffentlichung von Code aus Quellcodeverwaltungssystemen, darunter Git, GitHub, CodePlex, BitBucket, Dropbox, Mercurial, Team Foundation Server und dem cloudbasierten Team Foundation Service.


<h2><a id="CloudServices"></a>Cloud Services</h2>

Azure Virtual Machines bietet IaaS, während Azure-Websites Webhosting anbietet. Die dritte Option heißt Cloud-Dienste und bietet *Platform as a Service (PaaS)*. Diese Technologie unterstützt skalierbare und zuverlässige Anwendungen mit niedrigen Betriebskosten. Außerdem müssen sich Entwickler keine Gedanken mehr über die Verwaltung ihrer Plattform machen und können sich ausschließlich auf ihre Anwendungen konzentrieren. [Abbildung 6](#Fig6) veranschaulicht das Konzept.
...
<h2><a id="WhatShouldIUse"></a>Welches Modell sollte ich verwenden? Die Auswahl</h2>
