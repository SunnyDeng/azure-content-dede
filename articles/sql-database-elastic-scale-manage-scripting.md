<properties title="Scripting Elastic Scale with Scripts" pageTitle="Skripterstellung für die elastische Skalierung mit Skripts" description="Erstellen Sie Skripts für Elastic Scale-Aufgaben mit PowerShell und Azure Automation Service Runbooks." metaKeywords="Azure SQL Database, elastic scale, powershell scripts" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
