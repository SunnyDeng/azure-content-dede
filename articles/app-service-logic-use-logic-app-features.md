...
2. Führen Sie einen Bildlauf zur `twitterconnector`-Aktion durch, suchen Sie den Abfragewert, und ersetzen Sie ihn durch `@concat('#', parameters('topic'))`. Die **Concat**-Funktion verknüpft zwei oder mehr Zeichenfolgen.
