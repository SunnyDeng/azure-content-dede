...
Vorgehensweise: Hochladen von Inhalten
--------------------------------------
...
4.  Navigieren Sie im Dialogfeld **Inhalte hochladen** zur gewünschten Ressourcendatei. Klicken Sie auf die Datei, und klicken Sie dann auf **Öffnen**, oder drücken Sie **Eingabe**.
    ...
    ![Dialogfeld ](./media/media-services-manage-content/UploadContent.png)
...
Vorgehensweise: Codieren von Inhalten
-------------------------------------
...
4.  Wählen Sie im Dialogfeld "Azure Media Encoder" eine der häufig verwendeten oder erweiterten Voreinstellungen für das Codieren.
    ...
    **Erweiterte Voreinstellungen**
    ...
    -   Im Thema [Systemvoreinstellungen von Media Services Encoder](http://go.microsoft.com/fwlink/?LinkId=270865) wird die Bedeutung der einzelnen Voreinstellungen in der Liste der erweiterten Voreinstellungen erläutert.

    ![Dialogfeld ](./media/media-services-manage-content/EncoderDialog2.png)

    Das Portal unterstützt derzeit nicht alle Codierungsformate, die vom Media Encoder unterstützt werden. Außerdem wird die Medienressourcenverschlüsselung/-entschlüsselung nicht unterstützt. Sie können diese Aufgaben programmgesteuert ausführen. Weitere Informationen finden Sie unter [Erstellen von Anwendungen mit dem Media Services SDK für .NET](http://go.microsoft.com/fwlink/?LinkId=270866) und [Systemvoreinstellungen von Media Services Encoder](http://go.microsoft.com/fwlink/?LinkId=270865).
...
Vorgehensweise: Veröffentlichen von Inhalten
--------------------------------------------
