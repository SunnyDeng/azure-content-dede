<properties title="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with Directnic" pageTitle="Konfigurieren eines Directnic-Domänennamens für eine Azure-Website mit Traffic Manager" metaKeywords="Microsoft Azure, Microsoft Azure-Websites, Directnic, Traffic Manager" description="Erfahren Sie mehr über die Konfiguration einer Azure-Website, die Traffic Manager verwendet, um einen bei Directnic registrierten Domänennamen zu benutzen." services="web-sites" documentationCenter="" authors="larryfr,jroth" manager="wpickett" />
