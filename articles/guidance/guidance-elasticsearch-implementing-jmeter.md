<properties
   pageTitle="Aspekte bei der Implementierung eines JMeter-Testplans für Elasticsearch | Microsoft Azure"
...
# Aspekte bei der Implementierung eines JMeter-Testplans für Elasticsearch

Dieser Artikel ist [Teil einer Serie](guidance-elasticsearch-introduction.md).

Die anhand von Elasticsearch durchgeführten Leistungstests wurden mithilfe von JMeter-Testplänen zusammen mit integriertem Java-Code als JUnit-Test implementiert, um Aufgaben wie das Hochladen von Daten in den Cluster durchzuführen. Die Testpläne und der JUnit-Code werden in den Dokumenten „Maximieren der Datenaggregations- und Abfrageleistung mit Elasticsearch in Azure“ und „Maximieren der Leistung der Datenerfassung mit Elasticsearch in Azure“ beschrieben.
...
Sie können komplexen Code in einen JMeter-Testplan integrieren, indem Sie einen oder mehrere JUnit-Tests erstellen. Sie können einen JUnit-Test mit einer Java-IDE wie Eclipse schreiben. Das Dokument „Gewusst wie: Erstellen und Bereitstellen eines JMeter-JUnit-Samplers zum Testen der Elasticsearch-Leistung“ enthält Informationen zum Einrichten einer geeigneten Entwicklungsumgebung.
