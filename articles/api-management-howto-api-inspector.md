<properties 
	pageTitle="Verwenden des API-Inspektors zur Verfolgung von Aufrufen in der Azure API-Verwaltung" 
	description="Erfahren Sie, wie Sie den Ablauf von Aufrufen mit dem API Inspector in Azure API Management verfolgen können."
