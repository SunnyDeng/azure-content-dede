<properties urlDisplayName="How to manage" pageTitle="Verwalten von Websites - Microsoft Azure-Dienstverwaltung" metaKeywords="Azure-Portal Websiteverwaltung" description="Eine Referenz für die Websiteverwaltungs-Portalseiten in Microsoft Azure. Es werden Details für jede Websiteverwaltungsseite bereitgestellt." metaCanonical="" services="web-sites" documentationCenter="" title="How to Manage Websites" authors="cephalin"  solutions="" writer="mwasson" manager="wpickett" editor=""  />
...
##Überwachen
Die Verwaltungswebsite **Überwachen** enthält ein Diagramm mit den Nutzungsinformationen der Website. Standardmäßig zeigt dieses Diagramm dieselben Metriken wie das Diagramm auf der Seite **Dashboard** an, die oben im Abschnitt "Dashboard" beschrieben ist. Das Diagramm kann auch zur Anzeige der Metriken für HTTP-Erfolge, HTTP-Umleitungen, HTTP 401-Fehler, HTTP 403-Fehler, HTTP 404-Fehler und HTTP 406-Fehler konfiguriert werden. Weitere Informationen zu diesen Metriken finden Sie unter [Überwachen von Websites][Überwachen].
...
Der vollständige FTP-Benutzername ist "website\username".  Dies wird im Portal unter **Auf einen Blick** unter **Bereitstellung/FTP-Benutzer** aufgeführt.
...
Suchen Sie das Profil mit <code>publishMethod="FTP"</code>.  Der Benutzername wird unter <code>userName</code> aufgeführt, das Kennwort unter <code>userPWD</code>.
...
[Konfigurieren]: http://www.windowsazure.com/en-us/manage/services/web-sites/how-to-configure-websites

[Überwachen]: http://www.windowsazure.com/en-us/manage/services/web-sites/how-to-monitor-websites/

[Skalieren]: http://www.windowsazure.com/en-us/manage/services/web-sites/how-to-scale-websites
