<properties title="Managing Elastic Scale Credentials" pageTitle="Verwalten von Anmeldeinformationen für Elastic Scale" description="So richten Sie Anmeldeinformationen auf der passenden Stufe, von Administrator bis schreibgeschützt, für Elastic Scale-Apps ein" metaKeywords="Azure SQL Database, elastic scale, about user credentials in elastic scale" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
