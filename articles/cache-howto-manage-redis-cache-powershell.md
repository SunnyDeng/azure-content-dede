...
- Azure PowerShell, Version 0.8.0 oder höher. Um die neueste Version zu installieren und sie Ihrem Azure-Abonnement zuzuordnen, lesen Sie [Installieren und Konfigurieren von Azure PowerShell](powershell-install-configure.md).
...
Um detaillierte Hilfe zu einem Cmdlet im Lernprogramm zu erhalten, verwenden Sie das "Get-Help"-Cmdlet. 
...
- [Azure Resource Manager-Cmdlets](http://go.microsoft.com/fwlink/?LinkID=394765&clcid=0x409): Informationen zur Verwendung der Cmdlets im "AzureResourceManager"-Modul
