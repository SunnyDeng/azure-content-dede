<properties 
	pageTitle="Testen eines Hadoop-Ökosystems mit dem HDInsight-Emulator | Microsoft Azure" 
	description="Verwenden Sie einen Emulator auf einem Desktopcomputer und ein MapReduce-Lernprogramm, um das Hadoop-Ökosystem in HDInsight kennenzulernen. Der HDInsight-Emulator verhält sich wie ein Hadoop-Sandkasten." 
	editor="cgronlun" 
	manager="paulettm" 
	services="hdinsight" 
	authors="nitinme" 
...
- Installieren und konfigurieren Sie Azure PowerShell. Anweisungen hierzu finden Sie unter [Installieren und Konfigurieren von Azure PowerShell](install-configure-powershell.md).
...
Anleitungen zum Installieren der HDInsight Visual Studio-Tools finden Sie [hier](hdinsight-hadoop-visual-studio-tools-get-started.md#installation).
...
Sobald die Verbindung erfolgreich hergestellt wurde, können Sie die HDInsight Visual Studio-Tools mit dem Emulator wie mit einem Azure HDInsight-Cluster verwenden. Anleitungen zur Verwendung von Visual Studio-Tools mit Azure HDInsight-Clustern finden Sie unter [Verwenden der HDInsight Hadoop-Tools für Visual Studio](hdinsight-hadoop-visual-studio-tools-get-started.md).
...
In diesem Lernprogramm haben Sie den HDInsight-Emulator installiert und einige Hadoop-Aufträge ausgeführt. Weitere Informationen finden Sie in den folgenden Artikeln:
