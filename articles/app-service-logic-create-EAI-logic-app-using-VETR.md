...
*HTTP-Trigger* – Quelle zum Auslösen von Nachrichtenereignis 
*Überprüfen* – Überprüft die Richtigkeit der eingehenden Daten 
*Transformieren* – Transformiert Daten vom eingehenden Format in das vom nachfolgenden System benötigte Format 
*Service Bus-Connector* – Zielentität, an die die Daten gesendet werden.
