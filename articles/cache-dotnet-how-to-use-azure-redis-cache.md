...
zum Verwenden von Azure Redis Cache finden Sie im Abschnitt [Nächste Schritte][Nächste Schritte].

## Inhaltsverzeichnis

-   [Was ist Azure Redis Cache?][Was ist Azure Redis Cache?]
-   [Erste Schritte mit Azure Redis Cache][Erste Schritte mit Azure Redis Cache]
...
-   [Arbeiten mit Caches][Arbeiten mit Caches]
    ...
    -   [Verbindungsaufbau zum Cache][Verbindungsaufbau zum Cache]
    -   [Hinzufügen zu und Abrufen von Objekten aus dem Cache][Hinzufügen zu und Abrufen von Objekten aus dem Cache]
    -   [Angeben der Ablaufzeit eines Objekts im Cache][Angeben der Ablaufzeit eines Objekts im Cache]
    -   [Speichern des ASP.NET-Sitzungsstatus im Cache][Speichern des ASP.NET-Sitzungsstatus im Cache]
...
Dieser Leitfaden bietet einen Überblick über die ersten Schritte mit Azure Redis Cache. Detaillierte Informationen zu diesen Features, die über den Rahmen dieses Leitfadens hinausgehen, finden Sie unter [Azure Redis Cache: Übersicht][Azure Redis Cache: Übersicht].
...
> Weitere Informationen finden Sie auf der [StackExchange.Redis][StackExchange.Redis]-Webseite auf Github und in der [Dokumentation für StackExchange.Redis-Cacheclients][Dokumentation für StackExchange.Redis-Cacheclients].
...
![StackExchange.Redis-NuGet-Paket][StackExchange.Redis-NuGet-Paket]
...
> Warnung: Speichern Sie niemals Anmeldeinformationen im Quellcode. Ich zeige diese Daten hier im Code, um dieses Beispiel zu vereinfachen. Unter [Azure-Webseiten: Funktionsweise von Anwendungs- und Verbindungszeichenfolgen][Azure-Webseiten: Funktionsweise von Anwendungs- und Verbindungszeichenfolgen] finden Sie Informationen zum Speichern von Anmeldeinformationen.
...
> Weitere Informationen zu erweiterten Optionen für den Verbindungsaufbau finden Sie unter [StackExchange.Redis-Konfigurationsmodell][StackExchange.Redis-Konfigurationsmodell].

Cache-Endgerät und Schlüssel finden Sie im Azure-Vorschauportal im Fenster für Ihre Cache-Instanz.

![Cacheeigenschaften][Cacheeigenschaften]
...
![Redis Cache Sitzungszustands-NuGet-Paket][Redis Cache Sitzungszustands-NuGet-Paket]
...
Weitere Informationen zum Konfigurieren und Verwenden des Azure Redis Sitzungszustandsanbieters finden Sie unter [Azure Redis Sitzungszustandsanbieter][Azure Redis Sitzungszustandsanbieter].
