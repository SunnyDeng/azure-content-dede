...
### Was ist der Unterschied zwischen dem Löschen einer Ressourcengruppe im Azure-Vorschauportal und dem Klicken auf „Löschen“ für eine vorkonfigurierte Lösung in „azureiotsuite.com“?
...
- Wenn Sie die Ressourcengruppe im [Azure-Vorschauportal][lnk-azure-portal] löschen, werden nur die Ressourcen in dieser Ressourcengruppe gelöscht. Sie müssen im [Azure-Verwaltungsportal][lnk-classic-portal] außerdem die Azure Active Directory-Anwendung löschen, die der vorkonfigurierten Lösung zugeordnet ist.
