<properties title="Securing an Azure Website" pageTitle="Sichern einer Azure-Website" description="Erfahren Sie mehr über das Sichern einer Azure-Website." metaKeywords="Azure web site security, azure web site https, azure web site ftps, azure web site ssl, azure web site ssl rewrite" services="web-sites" solutions="" documentationCenter="web" authors="larryfr" videoId="" scriptId="" manager="wpickett" />
