...
Mit VM-Erweiterungen, die von Microsoft und vertrauenswürdigen Drittanbietern entwickelt werden, wird die Funktionalität der VM erweitert. Eine detaillierte Übersicht über die VM-Erweiterungen finden Sie in der
<a href="https://msdn.microsoft.com/library/azure/dn606311.aspx" target="_blank">MSDN-Dokumentation</a>.
...
2. Wenn die Skripts auf einer vorhandenen VM ausgeführt werden, müssen Sie sicherstellen, dass der VM-Agent auf der VM aktiviert ist. Andernfalls folgen Sie den Anweisungen in diesem <a href="https://msdn.microsoft.com/library/azure/dn832621.aspx" target="_blank">Artikel</a>, um einen Agent zu installieren.
...
Dieser Anwendungsfall zeigt, wie ein Nicht-Standardspeicher verwendet wird, entweder innerhalb desselben Abonnements oder in einem anderen Abonnement, um Skripts/Dateien hochzuladen. Es wird hier eine vorhandene VM verwendet, aber dieselben Operationen können auch beim Erstellen einer neuen VM verwendet werden.
  ...
  Wenn die Skriptdateien in mehreren Containern gespeichert sind, müssen Sie aktuelle zur Ausführung dieser Skripts die vollständige SAS-URL dieser Dateien bereitstellen.

      Get-AzureVM -Name $name -ServiceName $servicename | Set-AzureVMCustomScriptExtension -StorageAccountName $storageaccount -StorageAccountKey $storagekey -ContainerName $container -FileUri $fileUrl1, $fileUrl2 -Run 'file.ps1' | Update-AzureVM


### Hinzufügen der CustomScript-Erweiterung aus dem Portal
Wechseln Sie im <a href="https://portal.azure.com/ " target="_blank">Azure-Vorschauportal</a> zum virtuellen Computer, und fügen Sie die Erweiterung hinzu, indem Sie die auszuführende Skriptdatei angeben.
  ![][5]
