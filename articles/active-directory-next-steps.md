...
[Was ist Azure AD?](active-directory-whatis.md)<br> [Wie funktioniert Azure AD?](active-directory-works.md)<br> [Erste Schritte](active-directory-get-started.md)<br> [Weitere Informationen](active-directory-learn-map.md)
...
Synchronisieren Sie Benutzerkennwörter, damit Ihre Benutzer sich bei Microsoft Cloud Services (z. B. Office 365, Dynamics CRM und Windows InTune) mit dem gleichen Kennwort anmelden können, mit dem sie sich bei Ihrem lokalen Netzwerk anmelden. [Erfahren Sie mehr über das Verwalten von Kennwörtern](active-directory-manage-passwords.md).
