<properties urlDisplayName="MapReduce with Hadoop in HDInsight" pageTitle="Verwenden von Hadoop MapReduce in HDInsight | Azure" metaKeywords="" description="Learn how to use HDInsight to execute a simple Hadoop MapReduce job." metaCanonical="" services="hdinsight" documentationCenter="" title="Use Hadoop MapReduce in HDInsight" authors="jgao" solutions="" manager="paulettm" editor="cgronlun" />
...
4. Führen Sie den folgenden Befehl aus, und geben Sie Ihre Azure-Kontoinformationen an:
...
* [Entwickeln von Java MapReduce-Programmen für HDInsight][hdinsight-develop-MapReduce-jobs]
