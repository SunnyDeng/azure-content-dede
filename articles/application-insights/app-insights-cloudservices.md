...
Sehen Sie sich diese [Beispielcode](https://github.com/Microsoft/ApplicationInsights-Home/tree/master/Samples/AzureEmailService) in der Application Insights an einen Webdienst mit zwei Workerrollen in Azure gehosteten hinzugefügt wird.

Im folgenden wird erläutert, wie Ihre eigenen Cloud-Dienst-Projekt auf die gleiche Weise anpassen.
...
![Zu mehr Daten durchklicken](./media/app-insights-cloudservices/12-first-perf.png)
...
Gibt es [Beispiel](https://github.com/Microsoft/ApplicationInsights-Home/tree/master/Samples/AzureEmailService) einen Dienst mit einer Webrolle und zwei Workerrollen zu überwachen.
