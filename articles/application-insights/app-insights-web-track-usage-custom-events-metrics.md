...
![Navigieren Sie zu Ihrer Anwendungsressource in portal.azure.com.](./media/app-insights-web-track-usage-custom-events-metrics/01-custom.png)
...
![Wählen Sie das Diagramm aus, und legen Sie die Gruppierung fest.](./media/app-insights-web-track-usage-custom-events-metrics/02-segment.png)
...
![Führen Sie ein Drillthrough für die Ereignisse aus.](./media/app-insights-web-track-usage-custom-events-metrics/03-instances.png)
...
![Öffnen Sie den Metrik-Explorer, wählen Sie das Diagramm aus, und wählen Sie die Metrik aus.](./media/app-insights-web-track-usage-custom-events-metrics/03-track-custom.png)
...
![Legen Sie die Gruppierung fest, und wählen Sie dann unter "Gruppieren nach" die Eigenschaft aus.](./media/app-insights-web-track-usage-custom-events-metrics/04-segment-metric-event.png)
...
![Wählen Sie eine Instanz und anschließend "...".](./media/app-insights-web-track-usage-custom-events-metrics/appinsights-23-customevents-4.png)


Verwenden Sie das Suchfeld, um Ereignisvorkommen mit einem bestimmten Eigenschaftswert anzuzeigen.


![Geben Sie einen Begriff in das Suchfeld ein.](./media/app-insights-web-track-usage-custom-events-metrics/appinsights-23-customevents-5.png)
...
![Fügen Sie ein neues Diagramm hinzu, oder wählen Sie ein Diagramm aus, und wählen Sie Ihre Metrik unter "Benutzerdefiniert" aus.](./media/app-insights-web-track-usage-custom-events-metrics/03-track-custom.png)
