...
- **Pushbenachrichtigungen an Millionen Benutzer innerhalb von Sekunden** - Beteiligen Sie Ihre Kunden mit Pushbenachrichtigungen an beliebigen Geräten - personalisiert, auf ihre Anforderungen zugeschnitten und zum richtigen Zeitpunkt gesendet.
...
<!-- URLs. -->
[Migration von Mobile Service zu App Service]: app-service-mobile-dotnet-backend-migrating-from-mobile-services-preview.md
