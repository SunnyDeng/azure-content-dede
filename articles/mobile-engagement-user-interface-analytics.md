...
## Analyseüberschrift:
- Name des Elements: Bezeichnet das zu zählende Element
...
## Analyse:
- Dashboard: Zeigt allgemeine Informationen zu neuen und aktiven Benutzer sowie deren Trends.
...
3.    Dieser visuelle Indikator bietet dieselben Informationen wie oben grafisch dargestellt. (Die 3 im Kreis gehört zum Wert 33 %.) Die Farbe bietet zusätzliche Informationen: Grün gibt an, dass diese Zahl im Vergleich zur vorherigen Berechnung wächst. Gelb bedeutet stabil, Rot verringern.
