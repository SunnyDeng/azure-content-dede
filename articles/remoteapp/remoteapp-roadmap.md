<properties 
    pageTitle="Das ist neu bei RemoteApp" 
    description="Erfahren Sie mehr über neue Funktionen von RemoteApp" 
    services="remoteapp" 
    solutions="" 
	documentationCenter="" 
    authors="lizap" 
...
# Das ist neu bei RemoteApp

Wir arbeiten immer daran, RemoteApp mithilfe Ihres Feedbacks zu verbessern. Das ist der grobe Zeitrahmen für die Verfügbarkeit neuer Funktionen.

|Funktion|Juli - September 2014|Oktober - Dezember 2014|Januar - März 2015|April - Juni 2015|
|-----------|-------|-------|-------|-------|
|Hochladen von Branchenanwendungen in eine Cloud-Sammlung sowie in eine Hybrid-Sammlung|X| | | |
|Support für Windows Phone| |X| | |
|Dashboard für Nutzungsmetriken| |X| | | 	
|Mithilfe einer CSV-Datei eine große Anzahl an Benutzern bereitstellen | |X| | |
