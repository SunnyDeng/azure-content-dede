...
2. Legen Sie ein Microsoft-Konto (früher als Live ID bezeichnet) als Dienstadministrator fest. (Wissen Sie noch nicht, ob Sie bereits der Dienstadministrator sind? Sie können dies herausfinden, indem Sie auf **Einstellungen -> Administratoren** klicken.) Hier sehen, wie Sie dies ändern können:
	1. Klicken Sie in der rechten oberen Ecke auf den Benutzer und anschließend auf **Meine Rechnung anzeigen**.
