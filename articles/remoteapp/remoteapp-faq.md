...
## Netzwerkoptionen
- **Für die Hybrid-Sammlung ist ein virtuelles Netzwerk (VNET) erforderlich. Können wir unser vorhandenes VNET verwenden?** Das ist möglich, wenn das vorhandene VNET ein Azure VNET ist. Weitere Informationen finden Sie in den [Anweisungen zu Hybridsammlungen](remoteapp-create-hybrid-deployment.md) unter „Schritt 1: Einrichten des virtuellen Netzwerks“.
- **Kann ich ein VNET mit einer Cloudsammlung verwenden?** Dies ist möglich. Unter [Erstellen einer Cloudsammlung](remoteapp-create-cloud-deployment.md), und dort unter Schritt 1, finden Sie weitere Informationen.
