<properties urlDisplayName="Browse and Edit Your Source Code" pageTitle="Durchsuchen und Bearbeiten von Quellcode | Azure" metaKeywords="Visual Studio Online, VSO, git, tfvc, bearbeiten, Code, commit" description="Learn how to edit your source code." metaCanonical="" services="visual-studio-online" documentationCenter="" title="Browse and Edit Your Source Code" authors="ehollow" solutions="" manager="kamrani" editor="" />
...
1. Öffnen Sie zuerst Ihr Teamprojekt-Fenster und finden Sie dann den Bereich "Code".  Klicken Sie dann im Quellcode-Teil auf den Namen des Repositorys, das Sie durchsuchen möchten (hier ‚BrowseCode').  Hinweis: Wenn Sie mehr als zwei Repositorys haben, können Sie auf die Repositorynummer klicken (hier 1), um die vollständige Liste zu sehen.
