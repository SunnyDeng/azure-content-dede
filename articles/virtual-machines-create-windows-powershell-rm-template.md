...
Beim Ausführen des **New-AzureResourceGroupDeployment**-Befehls werden Sie aufgefordert, die Werte der Parameter im Abschnitt "Parameter" der JSON-Datei anzugeben. Wenn Sie alle Parameterwerte angegeben haben, erstellt der Befehl die Ressourcengruppe und den virtuellen Computer.
...
[Erstellen Sie einen virtuellen Windows-Computer mit einer Resource Manager-Vorlage von Azure und PowerShell](virtual-machines-create-windows-powershell-rm.md)

[Erstellen Sie einen virtuellen Windows-Computer mit PowerShell und Azure Service Manager](virtual-machines-create-windows-powershell-sm.md)
