<properties
 pageTitle="Verwenden von Logik-App-Vorlagen"
...
Diese Vorlagen zeigen, wie einige der vielen Connector im Marketplace verwendet werden. Außerdem eignen sich die Vorlagen gut, um verschiedene Muster kennenzulernen, die mit Logik-Apps erstellt werden können.  Sie können diese unverändert nutzen oder für Ihr Szenario anpassen.
Um mit der Verwendung von Logik-App-Vorlagen zu beginnen, wechseln Sie zum Marketplace und wählen "Logik-Apps".  Wählen Sie eine der Logik-App-Vorlagen aus der Liste der geordneten Vorlagen.
