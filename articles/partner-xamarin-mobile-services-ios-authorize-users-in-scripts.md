<properties 
	pageTitle="Autorisieren von Benutzern in Skripts - Azure Mobile Services" 
	description="Erfahren Sie, wie Sie Benutzer mithilfe von Skripts in Ihrer Azure Mobile Services-App für Xamarin.iOS autorisieren." 
...
5. Wiederholen Sie die Schritte 3 und 4, um den vorhandenen **Read** durch die folgende Funktion zu ersetzen:
...
5. Klicken Sie in der Tabelle **todoitem** im [Verwaltungsportal][Azure-Verwaltungsportal] auf **Durchsuchen**, und überprüfen Sie, ob jedes neu hinzugefügte Element jetzt einen zugehörigen userId-Wert aufweist.
