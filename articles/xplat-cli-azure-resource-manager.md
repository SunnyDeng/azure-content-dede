...
>[WACOM.NOTE]Wenn xplat-cli noch nicht installiert und konfiguriert wurde, finden Sie unter [Installieren und Konfigurieren der plattformübergreifenden Azure-Befehlszeilenschnittstelle][xplatsetup]weitere Anweisungen zum Installieren, Konfigurieren und Verwenden von xplat-cli.
...
Für die Arbeit mit dem Ressourcen-Manager über die xplat-cli ist es derzeit erforderlich, dass Sie sich mit einem Organisationskonto-Konto bei Microsoft Azure authentifizieren. Die Authentifizierung mit einem Microsoft-Konto oder einem Zertifikat über eine .publishsettings-Datei funktioniert nicht.
...
1. Verwenden Sie nach dem Speichern der Datei **params.json** den folgenden Befehl, um eine neue Ressourcengruppe basierend auf der Vorlage zu erstellen. Der Parameter "-e" bestimmt die **params.json**-Datei, die Sie im vorherigen Schritt erstellt haben.
