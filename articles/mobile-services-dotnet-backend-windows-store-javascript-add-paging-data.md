<properties pageTitle="Hinzufügen von Paging für Daten (JavaScript) - Azure Mobile Services" description="Erfahren Sie, wie Sie mit Paging die Menge derata returned to your Windows Store JavaScript app from Mobile Services." services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
