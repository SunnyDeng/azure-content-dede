...
4.  Führen Sie das Experiment aus und sehen Sie sich die Ausgabe des Moduls **Modell evaluieren** an (doppelklicken Sie auf den Ausgabeport und wählen Sie **Visualisieren** aus). Die folgenden Statistiken werden für unser Modell angezeigt.
