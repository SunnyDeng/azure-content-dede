...
1. Fügen Sie im Web-API-Controller das `EnableCors`-Attribut der Controllerklasse oder einzelnen Aktionsmethoden hinzu. Im folgenden Beispiel gilt die CORS-Unterstützung für den gesamten Controller.
