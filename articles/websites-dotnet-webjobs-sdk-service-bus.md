...
Sie müssen außerdem zusätzlich zu den Speicherverbindungszeichenfolgen die Verbindungszeichenfolge "AzureWebJobsServiceBus" festlegen.  Sie führen dies im Abschnitt `connectionStrings` der Datei "Web.config" aus, wie im folgenden Beispiel gezeigt:
...
Ein Beispielprojekt finden Sie unter [Service Bus-Beispiel](https://github.com/Azure/azure-webjobs-sdk-samples/tree/master/BasicSamples/ServiceBus). Weitere Informationen finden Sie unter [Erste Schritte mit dem Webaufträge-SDK](websites-dotnet-webjobs-sdk-get-started.md).
...
**Hinweis:** Wenn Sie die Warteschlangennachrichten in einer Anwendung erstellen, die das Webaufträge-SDK nicht verwendet, legen Sie [BrokeredMessage.ContentType](http://msdn.microsoft.com/library/microsoft.servicebus.messaging.brokeredmessage.contenttype.aspx) auf "text/plain" fest.
...
Codebeispiele, die zeigen, wie POCO-Eigenschaften zum Arbeiten mit Blobs und Tabellen in derselben Funktion verwendet werden, finden Sie in der [Speicher-Warteschlangen-Version dieses Artikels](websites-dotnet-webjobs-sdk-storage-queues-how-to.md#pocoblobs).
...
Informationen zu Webaufträge-SDK-Szenarios, die nicht spezifisch für Service Bus sind, finden Sie unter [Arbeiten mit Azure-Warteschlangenspeicher mithilfe des Webaufträge-SDKs](websites-dotnet-webjobs-sdk-storage-queues-how-to.md). 
