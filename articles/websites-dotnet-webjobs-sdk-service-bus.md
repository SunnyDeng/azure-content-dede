...
**Hinweis:** Wenn Sie die Warteschlangennachricht in einer Anwendung ohne Verwendung des Webaufträge-SDK schreiben, müssen Sie [BrokeredMessage.ContentType](http://msdn.microsoft.com/library/microsoft.servicebus.messaging.brokeredmessage.contenttype.aspx) auf "text/plain" festlegen.
