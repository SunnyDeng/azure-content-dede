<properties pageTitle="Bestätigte Verteilungen von Linux in Azure" description="Erfahren Sie mehr über bestätigte Linux-Verteilungen auf Azure, einschließlich Leitfäden für Ubuntu, OpenLogic und SUSE." services="virtual-machines" documentationCenter="" authors="szarkos" manager="timlt" editor="tysonn"/>
...
Die folgende Tabelle enthält die verschiedenen Distributionsversionen, LIS-Treiber (Linux Integration Services) sowie Azure Linux Agent-Versionen, die für den Einsatz unter Azure getestet wurden. LIS-Treiber sind entweder standardmäßig im Kernel der Distribution integriert oder [hier](http://go.microsoft.com/fwlink/?LinkID=403033&clcid=0x409) verfügbar. Linux-Agent-Versionen sind im Paketrepository der Distribution oder auf [Github](https://github.com/azure/walinuxagent) verfügbar.

Die Tabelle enthält zudem einen Link zum [Linux-Kernel-Kompatibilitätspatch](http://go.microsoft.com/fwlink/?LinkID=403027&clcid=0x409), das von einigen Distributions-/Kernelversionen für die optimale Funktion in Azure benötigt wird.
