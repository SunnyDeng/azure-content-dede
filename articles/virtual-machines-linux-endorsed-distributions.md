...
Die Verteilungsimages im Azure-Katalog werden von den folgenden Partnern zur Verfügung gestellt. Außerdem arbeiten wir mit verschiedenen Linux-Communitys daran, noch mehr unterstützte Verteilungen bereitzustellen. In der Zwischenzeit können Sie für Verteilungen, die im Katalog nicht verfügbar sind, stets Ihre eigene Linux-Verteilung bereitstellen ("Bring Your Own"), indem Sie die Richtlinien auf [dieser Seite](../virtual-machines-linux-create-upload-vhd/) befolgen

## Canonical ##
 
[http://www.ubuntu.com/cloud/azure](http://www.ubuntu.com/cloud/azure)

Engineering und Open Community Governance von Canonical steigern den Erfolg von Ubuntu bei Clients, Servern und Cloud Computing, einschließlich persönlicher Clouddienste für Endkunden. Canonicals Vision einer einheitlichen kostenlosen Plattform in Ubuntu, vom Telefon bis hin zur Cloud, mit einer Reihe kohärenter Schnittstellen für Telefon, Tablet, TV und Desktop macht Ubuntu zur ersten Wahl für verschiedene Institutionen - von öffentlichen Cloudanbietern bis hin zu Herstellern von Unterhaltungselektronik - sowie zu einem Favoriten für Fachleute.
...
Die folgende Tabelle enthält die verschiedenen Verteilungsversionen, LIS-Treiber (Linux Integration Services) sowie Azure Linux Agent-Versionen, die für den Einsatz unter Azure getestet wurden. LIS-Treiber sind entweder standardmäßig im Kernel der Verteilung integriert oder [hier](http://go.microsoft.com/fwlink/?LinkID=403033&clcid=0x409) verfügbar. Linux-Agent-Versionen sind im Paketrepository der Verteilung oder auf [Github](https://github.com/azure/walinuxagent) verfügbar.

Die Tabelle enthält zudem einen Link zum [Linux-Kernel-Kompatibilitätspatch](http://go.microsoft.com/fwlink/?LinkID=403027&clcid=0x409), das von einigen Verteilungs-/Kernelversionen für die optimale Funktion in Azure benötigt wird.
...
<table border="1" width="600">
  <tr bgcolor="#E9E7E7">
	...
	<tr>
		...
		<td> Ubuntu 12.04.1+, 14.04 und 14.10 </td>
		<td>Im Kernel</td>
	...
	<tr>
        ...
        <td>Im Kernel</td>
		<td>N/V</td>
		<td>Paket: In <a href="https://build.opensuse.org/project/show/Cloud:Tools" >Cloud:Tools-</a> Repository, Name: WALinuxAgent<br />
