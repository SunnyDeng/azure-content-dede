<properties urlDisplayName="Endorsed distributions" pageTitle="Bestätigte Distributionen von Linux in Azure" metaKeywords="" description="Erfahren Sie mehr über bestätigte Linux-Distributionen auf Azure, einschließlich Leitfäden für Ubuntu, OpenLogic und SUSE." metaCanonical="" services="virtual-machines" documentationCenter="" title="Linux on Azure-Endorsed Distributions" authors="szark" solutions="" manager="timlt" editor="tysonn" />
