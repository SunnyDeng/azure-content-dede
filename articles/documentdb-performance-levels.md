...
> [AZURE.WICHTIG] Leistungsebenen werden entsprechend der allgemeinen Verfügbarkeit von Azure DocumentDB verfügbar sein. Die Veröffentlichung dieser Version ist für April 2015 geplant.
...
> [AZURE.WICHTIG] DocumentDB-Standardsammlungen werden auf Stundenbasis abgerechnet. Hierbei wird für jede erstellte Sammlung eine Verwendung von mindestens einer Stunde berechnet.
...
> [AZURE.WICHTIG] Es ist wichtig, zu verstehen, dass die Abrechnung zu vollständigen Standardsätzen basierend auf der Anzahl der innerhalb Ihrer Anwendung erstellten Sammlungen erfolgt.
...
- [Verwalten der DocumentDB-Kapazität](http://azure.microsoft.com/documentation/articles/documentdb-manage/)
- [Datenmodellierung in DocumentDB](http://azure.microsoft.com/documentation/articles/documentdb-modeling-data/)
- [Datenpartitionierung in DocumentDB](http://azure.microsoft.com/documentation/articles/documentdb-partition-data/)
