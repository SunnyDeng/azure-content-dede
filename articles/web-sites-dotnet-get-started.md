...
5. Lassen Sie im Dialogfeld **Neues ASP.NET-Projekt** die Einstellungen für **Microsoft Azure** unverändert, und klicken Sie dann auf **OK**.
	...
	![Dialogfeld "New ASP.NET Project"](./media/web-sites-dotnet-get-started-vs2013/GS13newaspnetprojdb.png)
...
6. Klicken Sie auf **OK**.
	...
	![Bei Azure angemeldet](./media/web-sites-dotnet-get-started-vs2013/configuresitesettings2.png)
	...
	![Web-App erstellt](./media/web-sites-dotnet-get-started-vs2013/GS13sitecreated1.png)

	Und Sie können die Web-App im Server-Explorer sehen.

	![Web-App erstellt](./media/web-sites-dotnet-get-started-vs2013/siteinse.png)

## Bereitstellen der Anwendung in Azure

7. Klicken Sie im Fenster **Web Publish Activity** auf **Publish MyExample to this Web App now**.

	![Web-App erstellt](./media/web-sites-dotnet-get-started-vs2013/GS13sitecreated.png)
...
12. Klicken Sie auf **Veröffentlichen**.
	...
	![In Azure ausgeführte Web-App](./media/web-sites-dotnet-get-started-vs2013/GS13deployedsite.png)
...
1. Drücken Sie STRG+F5, um die geänderte Überschrift anzuzeigen, indem Sie die Web-App auf dem lokalen Computer ausführen.
	...
	![Lokal ausgeführte Web-App](./media/web-sites-dotnet-get-started-vs2013/localandazure.png)
...
4. Klicken Sie auf **Anwendungseinstellungen**, um ein Beispiel für die verschiedenen Einstellungen anzuzeigen, die Sie im Portal konfigurieren können.
	...
	![Registerkarte "Konfigurieren" der Web-App im Portal](./media/web-sites-dotnet-get-started-vs2013/portalconfigure2.png)
