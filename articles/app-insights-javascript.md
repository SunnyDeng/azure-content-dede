<properties 
	pageTitle="Application Insights für JavaScript-Apps und Webseiten" 
	description="Erhalten Sie die Anzahl der Seitenaufrufe und Sitzungen, rufen Sie Webclientdaten ab, und verfolgen Sie Verwendungsmuster. Erkennen Sie Ausnahmen und Leistungsprobleme in JavaScript-Apps und Webseiten." 
...
# Application Insights für JavaScript-Apps und Webseiten
...
![Wählen Sie "Neu", "Entwicklerdienste", Application Insights.](./media/app-insights-web-track-usage/16-page-views.png)
...
![Wählen Sie "Neu", "Entwicklerdienste", Application Insights.](./media/app-insights-web-track-usage/01-create.png)
...
![Wählen Sie in Ihrer App auf dem Blatt "Übersicht"  im Schnellstart die Option "Code abrufen", um Ihre Webseiten zu überwachen. Kopieren Sie das Skript.](./media/app-insights-web-track-usage/02-monitor-web-page.png)
...
#### Wenn Ihre App keine Webseite ist...

Wenn die JavaScript-App eine [Cordova](http://cordova.apache.org/)-App ist, fügen Sie nach dem Instrumentationsschlüssel eine zusätzliche Zeile ein:
...
Handelt es sich um eine [Windows-Runtime-App mit JavaScript](https://msdn.microsoft.com/library/windows/apps/br211385.aspx), fügen Sie Ihrem Projekt das NuGet-Paket *Application Insights für Javascript-Apps* hinzu. (Klicken Sie im Projektmappen-Explorer mit der rechten Maustaste auf das Projekt, und wählen Sie dann "NuGet-Pakete verwalten" aus. Aktivieren Sie "Vorabversion einschließen", und suchen Sie nach "Application Insights".)
...
* **Benutzer:** Die Anzahl der unterschiedlichen Benutzer über den Zeitbereich des Diagramms. (Cookies werden verwendet, um wiederkehrende Benutzer zu identifizieren.)
* **Sitzungen:** Eine Sitzung wird gezählt, wenn ein Benutzer für 30 Minuten keine Anforderungen gestellt hat.
