<properties pageTitle="Tutorial: Azure Active Directory-Integration mit IdeaScale | Microsoft Azure" description="Hier erfahren Sie, wie Sie IdeaScale mit Azure Active Directory verwenden können, um einmaliges Anmelden, automatisierte Bereitstellung und vieles mehr zu ermöglichen." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Tutorial: Azure Active Directory-Integration mit IdeaScale
>[AZURE.TIP]Klicken Sie [hier](http://go.microsoft.com/fwlink/?LinkId=529830), um Feedback abzugeben.
...
Nach Abschluss dieses Tutorials können sich die Azure AD-Benutzer, die Sie IdeaScale zugewiesen haben, wie unter [Einführung in den Zugriffsbereich](https://msdn.microsoft.com/library/dn308586) beschrieben mittels einmaliger Anmeldung bei der Anwendung anmelden.
...
3.  Geben Sie auf der Seite **App-URL konfigurieren** im Textfeld für die **IdeaScale-Anmelde-URL** die URL ein, die die Benutzer zur Anmeldung bei IdeaScale verwenden (z. B. „**https://company.IdeaScale.com*"), und klicken Sie dann auf **Weiter**.
