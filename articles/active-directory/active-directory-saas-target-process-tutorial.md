<properties
	pageTitle="Lernprogramm: Azure Active Directory-Integration mit TargetProcess | Microsoft Azure"
...
6. Geben Sie im Suchfeld als Suchbegriff **TargetProcess** ein.<br><br> ![Erstellen einen Azure AD-Testbenutzers](./media/active-directory-saas-flatter-files-tutorial/tutorial_flatter_files_01.png)<br>
...
3. Führen Sie auf der Dialogfeldseite **App-Einstellungen** konfigurieren die folgenden Schritte aus: <br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-target-process-tutorial/tutorial_target_process_03.png) <br>
...
1. Klicken Sie im Menü oben auf **Einrichtung**. <br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-target-process-tutorial/tutorial_target_process_05.png) <br>
...
3. Klicken Sie zum Anzeigen der Liste der Benutzer im Menü oben auf **Benutzer**. <br><br> ![Erstellen einen Azure AD-Testbenutzers](./media/active-directory-saas-flatter-files-tutorial/create_aaduser_03.png) <br>
