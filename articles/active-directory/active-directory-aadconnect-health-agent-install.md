...
Wenn Sie zur Authentifizierung aufgefordert werden, geben Sie das globale Administratorkonto (wie etwaadmin@domain.onmicrosoft.com) ein, das zum Konfigurieren von Azure AD Connect verwendet wurde.
