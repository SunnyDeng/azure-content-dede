...
In diesem Tutorial erfahren Sie, wie Sie Cimpl in Azure Active Directory (Azure AD) integrieren können.<br>Die Integration von Cimpl in Azure AD bietet Ihnen folgende Vorteile:
...
6. Geben Sie im Suchfeld das Wort **Cimpl** ein.<br><br> ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-cimpl-tutorial/tutorial_cimpl_01.png)<br>
7. Wählen Sie im Ergebnisbereich **Cimpl** aus, und klicken Sie dann auf **Abschließen**, um die Anwendung hinzuzufügen. <br><br>
...
Damit einmaliges Anmelden funktioniert, muss Azure AD wissen, welcher Benutzer in Cimpl als Gegenbenutzer zu einem Benutzer in Azure AD fungiert. Anders ausgedrückt: Zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Cimpl muss eine Linkbeziehung eingerichtet werden.<br> Diese Linkbeziehung wird hergestellt, indem Sie den **Benutzernamen** in Azure AD als Wert dem **Benutzernamen** in Cimpl zuweisen.
...
1. Klicken Sie im klassischen Azure-Portal auf der Anwendungsintegrationsseite für **Cimpl** auf **Einmaliges Anmelden konfigurieren**, um das Dialogfeld **Einmaliges Anmelden konfigurieren** zu öffnen. <br><br> ![Einmaliges Anmelden konfigurieren][6] <br>

2. Wählen Sie auf der Seite **Wie sollen sich Benutzer bei Cimpl anmelden** die Option **Azure AD – einmaliges Anmelden** aus, und klicken Sie dann auf **Weiter**. <br><br> ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-cimpl-tutorial/tutorial_cimpl_03.png) <br>

3. Führen Sie auf der Dialogfeldseite **App-Einstellungen konfigurieren** folgende Schritte aus: <br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-cimpl-tutorial/tutorial_cimpl_04.png) <br>
...
1. Klicken Sie im **klassischen Azure-Portal** im linken Navigationsbereich auf **Active Directory**. <br><br>![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-cimpl-tutorial/create_aaduser_09.png)<br>

2. Wählen Sie in der Liste **Verzeichnis** das Verzeichnis aus, für das Sie die Verzeichnisintegration aktivieren möchten.

3. Klicken Sie zum Anzeigen der Liste der Benutzer im Menü oben auf **Benutzer**. <br><br> ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-cimpl-tutorial/create_aaduser_03.png) <br>

4. Um das Dialogfeld **Benutzer hinzufügen** zu öffnen, klicken Sie auf der Symbolleiste unten auf **Benutzer hinzufügen**. <br><br> ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-cimpl-tutorial/create_aaduser_04.png) <br>
...
6.  Führen Sie auf der Dialogfeldseite **Benutzerprofil** die folgenden Schritte aus: <br><br>![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-cimpl-tutorial/create_aaduser_06.png) <br>
...
7. Klicken Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** auf **Erstellen**. <br><br> ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-cimpl-tutorial/create_aaduser_07.png) <br>

8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus: <br><br>![Erstellen einen Azure AD-Testbenutzers](./media/active-directory-saas-cimpl-tutorial/create_aaduser_08.png) <br>
...
Das Ziel dieses Abschnitts besteht darin, Britta Simon die Verwendung des einmaligen Anmeldens bei Azure zu ermöglichen, indem sie Zugriff auf Cimpl erhält. <br><br>![Benutzer zuweisen][200] <br>
...
2. Wählen Sie in der Anwendungsliste **Cimpl** aus. <br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-cimpl-tutorial/tutorial_cimpl_50.png) <br>
...
Das Ziel dieses Abschnitts ist das Testen Ihrer Azure AD-Konfiguration für einmaliges Anmelden mithilfe des Zugriffsbereichs.<br> Wenn Sie im Zugriffsbereich auf die Kachel „Cimpl“ klicken, sollten Sie automatisch bei Ihrer Cimpl-Anwendung angemeldet werden.
