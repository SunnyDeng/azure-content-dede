...
Falls Probleme mit der Konnektivität auftreten, sehen Sie unter [Problembehebung bei Konnektivitätsproblemen](active-directory-aadconnect-troubleshoot-connectivity.md) nach.
...
- Windows Server 2008 R2 und Windows Server 2012
  - Die neueste Version von Microsoft PowerShell steht in **Windows Management Framework 4.0** im [Microsoft Download Center](http://www.microsoft.com/downloads) zur Verfügung.
