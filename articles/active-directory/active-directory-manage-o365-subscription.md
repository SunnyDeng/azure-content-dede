...
1.	Melden Sie sich als msmith@hotmail.com beim klassischen Azure-Portal an.
...
Nehmen wir nun an, dass John Doe sich beim klassischen Azure-Portal anmelden und die Webseiten und Datenbankressourcen verwalten muss, die dem Azure-Abonnement von msmith@hotmail.com zugeordnet sind. Zu diesem Zweck muss Michael Smith folgende zusätzliche Schritte ausführen:

1.	Melden Sie sich über das Dienstadministratorkonto des Azure-Abonnements beim klassischen Azure-Portal an (in diesem Beispiel msmith@hotmail.com)).
