...
- **Dienstadministrator**: verwaltet Dienstanforderungen und überwacht die Integrität des Dienstes.
    > [AZURE.NOTE]
    > Damit ein Benutzer die Dienstadministratorrolle zugewiesen bekommt, muss der globale Administrator dem Benutzer zunächst administrative Berechtigungen im Dienst zuweisen, wie z. B. Exchange Online, und anschließend die Dienstadministratorrolle im Azure-Verwaltungsportal. 
