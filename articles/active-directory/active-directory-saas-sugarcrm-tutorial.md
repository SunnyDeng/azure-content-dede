...
6.  Geben Sie in das **Suchfeld** als Suchbegriff **Sugar CRM** ein.
...
3.  Geben Sie auf der Seite **App-URL konfigurieren** im Textfeld für die **Sugar CRM-Anmelde-URL** die URL ein, die die Benutzer zur Anmeldung bei Sugar CRM verwenden (z. B. „**http://company.sugarondemand.com*"“), und klicken Sie dann auf **Weiter**.
...
7.  Klicken Sie unter **Verwaltung** auf **Kennwortverwaltung**.

    ![Verwaltung](./media/active-directory-saas-sugarcrm-tutorial/IC795889.png "Verwaltung")

8.  Wählen Sie die Option **SAML-Authentifizierung aktivieren**.
...
9.  Führen Sie im Abschnitt für die **SAML-Authentifizierung** die folgenden Schritte aus:
    ...
    4.  Öffnen Sie das Base64-codierte Zertifikat im Editor, kopieren Sie den Inhalt des Zertifikats in die Zwischenablage, und fügen Sie anschließend das gesamte Zertifikat in das Textfeld **X.509-Zertifikat** ein.
...
6.  Wählen Sie als **Status** die Option **Aktiv** aus.
