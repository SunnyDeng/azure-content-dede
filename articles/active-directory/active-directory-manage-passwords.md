...
# Verwalten von Kennwörtern in Azure Active Directory
...
Im weiteren Verlauf dieses Themas werden die umfassenden Kennwortverwaltungsfunktionen behandelt, die Azure AD unterstützt, einschließlich:
...
- Mit der vom **Administrator ausgelösten Kennwortzurücksetzung** kann ein Administrator über das klassische Azure-Portal das Kennwort eines Endbenutzers oder eines anderen Administrators zurücksetzen.
