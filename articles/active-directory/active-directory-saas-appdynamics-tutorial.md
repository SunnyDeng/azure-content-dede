...
4.  Klicken Sie zum Herunterladen des Zertifikats auf der Seite **Einmaliges Anmelden konfigurieren für AppDynamics** auf **Zertifikat herunterladen**, und speichern Sie das Zertifikat auf Ihrem Computer.
...
7.  Klicken Sie auf die Registerkarte **Authentifizierungsanbieter**.
...
8.  Führen Sie im Abschnitt **Authentifizierungsanbieter** die folgenden Schritte aus:
    ...
    1.  Wählen Sie für **Authentifizierungsanbieter** die Option **SAML** aus.
    2.  Kopieren Sie im Azure-Portal auf der Dialogfeldseite **Einmaliges Anmelden konfigurieren für AppDynamics** den Wert für **Remoteanmelde-URL**, und fügen Sie ihn ins Textfeld **Anmelde-URL** ein.
    3.  Kopieren Sie im Azure-Portal auf der Dialogfeldseite **Einmaliges Anmelden konfigurieren für AppDynamics** den Wert für **Remoteabmelde-URL**, und fügen Sie ihn ins Textfeld **Abmelde-URL** ein.
    ...
    5.  Öffnen Sie das Base64-codierte Zertifikat im Editor, kopieren Sie den Inhalt des Zertifikats in die Zwischenablage, und fügen Sie ihn anschließend in das Textfeld **Zertifikat** ein.
    6.  Klicken Sie auf **Speichern**. ![Speichern](./media/active-directory-saas-appdynamics-tutorial/IC777673.png "Speichern")
...
2.  Wechseln Sie zu **Benutzer**, und klicken Sie dann auf das Symbol **+**, um das Dialogfeld **Benutzer erstellen** zu öffnen.
...
3.  Führen Sie im Abschnitt **Benutzer erstellen** die folgenden Schritte aus:
    ...
    1.  Geben Sie die Werte **Benutzername**, **Name**, **E-Mail**, **Neues Kennwort** und **Neues Kennwort wiederholen** eines gültigen AAD-Kontos, das Sie bereitstellen möchten, in die entsprechenden Textfelder ein.
