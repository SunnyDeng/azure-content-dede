...
Der Azure AD-Anwendungsproxy ist ein Feature, das nur verfügbar ist, wenn Sie Ihr Azure Active Directory auf die Premium oder Basic Edition aktualisiert haben. Weitere Informationen finden Sie unter [Azure Active Directory-Editionen](active-directory-editions.md).
...
Für erste Schritte mit dem Anwendungsproxy gehen Sie folgendermaßen vor: 1. [Anwendungsproxydienste aktivieren](active-directory-application-proxy-enable.md) 2. [Veröffentlichen von Anwendungen mit dem Anwendungsproxy](active-directory-application-proxy-publish.md)
