...
4. Aktivieren Sie das Kontrollkästchen, um alle globalen Mandantenadministratoren zum Empfangen von E-Mail-Benachrichtigungen zu konfigurieren.
5. Wenn Sie E-Mail-Benachrichtigungen an andere E-Mail-Adressen senden lassen möchten, können Sie diese in den Feldern "Weitere E-Mail-Empfänger" angeben. Um eine E-Mail-Adresse aus dieser Liste zu entfernen, klicken Sie mit der rechten Maustaste auf den Eintrag, und wählen Sie "Löschen".
