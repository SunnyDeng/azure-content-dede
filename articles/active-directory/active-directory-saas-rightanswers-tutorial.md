<properties pageTitle="Tutorial: Azure Active Directory-Integration mit RightAnswers | Microsoft Azure" description="Hier erfahren Sie, wie Sie RightAnswers mit Azure Active Directory verwenden können, um einmaliges Anmelden, automatisierte Bereitstellung und vieles mehr zu ermöglichen." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Tutorial: Azure Active Directory-Integration mit RightAnswers
>[AZURE.TIP]Klicken Sie [hier](http://go.microsoft.com/fwlink/?LinkId=615354), um Feedback abzugeben.
...
Nach Abschluss dieses Tutorials können sich die Azure AD-Benutzer, die Sie RightAnswers zugewiesen haben, wie unter [Einführung in den Zugriffsbereich](https://msdn.microsoft.com/library/dn308586) beschrieben mittels einmaliger Anmeldung bei der Anwendung anmelden.
...
6.  Geben Sie im **Suchfeld** das Wort **RightAnswers** ein.
