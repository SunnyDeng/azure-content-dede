...
Sie können auf alle Notification Hubs-Features von einem Java-/PHP-/Ruby-Back-End aus mithilfe der Notification Hub-REST-Schnittstelle zugreifen, die im MSDN-Thema [REST-APIs für Benachrichtigungshubs][REST-APIs für Benachrichtigungshubs] beschrieben ist.

In diesem Thema wird Folgendes erläutert:

-   Erstellen eines REST-Clients für Notification Hubs-Features in Java
-   Führen Sie die Schritte im [Erste-Schritte-Lernprogramm][Erste-Schritte-Lernprogramm] für die mobile Plattform Ihrer Wahl aus, und implementieren Sie den Back-End-Teil in Java.

## <a name="client-interface"></a>Clientschnittstelle

Die Client-Hauptschnittstelle kann dieselben Methoden bereitstellen, die im [.NET Notification Hubs SDK][.NET Notification Hubs SDK] verfügbar sind. Damit können Sie alle Lernprogramme und Beispiele, die aktuell auf dieser Website erhältlich sind und von der Community im Internet beigetragen werden, direkt umsetzen.

Sie finden den gesamten Code im [Java REST-Wrapper-Beispiel][Java REST-Wrapper-Beispiel].
...
Führen Sie ggf. die Schritte in unserem [Erste-Schritte-Lernprogramm][Erste-Schritte-Lernprogramm] bis zum letzten Abschnitt aus, in dem Sie das Back-End implementieren.
Wenn Sie möchten, können Sie auch den Code aus dem [Java REST-Wrapper-Beispiel][Java REST-Wrapper-Beispiel] verwenden und direkt zum Abschnitt [Abschließen des Lernprogramms][Abschließen des Lernprogramms] springen.

Alle Details für das Implementieren eines vollständigen REST-Wrappers finden sich auf [MSDN][MSDN]. In diesem Abschnitt beschreiben wir die Java-Implementierung der Hauptschritte, die für den Zugriff auf REST-Endpunkte von Notification Hubs erforderlich sind:
...
Dies ist die Hauptklasse, die den Client implementiert, dessen Konstruktor die Verbindungszeichenfolge analysiert:
...
Die Details der Erstellung des Sicherheitstokens sind [hier][hier] verfügbar.
...
Alle verfügbaren Optionen finden Sie in der Dokumentation der [REST-APIs für Benachrichtigungshubs][1] und unter den Formaten der einzelnen Benachrichtigungsplattformen.
...
Initialisieren Sie Ihren Notification Hubs-Client (ersetzen Sie die Verbindungszeichenfolge und den Hubnamen wie im [Erste-Schritte-Lernprogramm][Erste-Schritte-Lernprogramm] beschrieben):
...
-   Laden Sie das vollständige [Java REST Wrapper-Beispiel][Java REST-Wrapper-Beispiel] herunter, das den gesamten vorstehenden Code sowie die Registrierungsverwaltung enthält.
...
-   Lernen Sie im [Benachrichtigen von Benutzern-Lernprogramm], wie Sie Pushbenachrichtigungen an einzelne Benutzer senden.
  ...
  [Java]: /de-de/documentation/articles/notification-hubs-java-backend-how-to/ "Java"
  [PHP]: /de-de/documentation/articles/notification-hubs-php-backend-how-to/ "PHP"
  [REST-APIs für Benachrichtigungshubs]: http://msdn.microsoft.com/de-de/library/dn223264.aspx
  [Erste-Schritte-Lernprogramm]: http://azure.microsoft.com/de-de/documentation/articles/notification-hubs-ios-get-started/
  [.NET Notification Hubs SDK]: http://msdn.microsoft.com/de-de/library/jj933431.aspx
  [Java REST-Wrapper-Beispiel]: https://github.com/Azure/azure-notificationhubs-samples/tree/master/notificationhubs-rest-java
  [Abschließen des Lernprogramms]: #complete-tutorial
  [MSDN]: http://msdn.microsoft.com/de-de/library/dn530746.aspx
  [Apache HttpComponents]: http://hc.apache.org/httpcomponents-client-ga/
  [Apache Commons-Codec]: http://commons.apache.org/proper/commons-codec/
  [Apache Commons-Io]: http://commons.apache.org/proper/commons-io/
  [hier]: http://msdn.microsoft.com/de-de/library/dn495627.aspx
  [1]: http://msdn.microsoft.com/de-de/library/dn495827.aspx
