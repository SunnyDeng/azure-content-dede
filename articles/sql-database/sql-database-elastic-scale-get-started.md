...
Eine Liste aller Themen zu Tools für elastische Datenbanken finden Sie in der [Dokumentationsübersicht](sql-database-elastic-scale-documentation-map.md).

## Die elastische Datenbank – Beispielanwendung

Mit dem Beispiel wird eine einfache Sharding-Anwendung erstellt, und es werden die wichtigsten Funktionen von Tools für elastische Datenbanken erkundet. Um die Anwendung herunterzuladen und auszuführen, führen Sie die unten oder im Video [Elastic Scale - Erste Schritte](http://channel9.msdn.com/Blogs/Windows-Azure/Elastic-Scale-with-Azure-SQL-Database-Getting-Started) angegebenen Schritte aus.
