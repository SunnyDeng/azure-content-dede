...
Mit der **Clientbibliothek für elastische Datenbanken** können Sie Clientanwendungen erstellen, die Sammlungen mit Hunderten – oder sogar Tausenden – in Microsoft Azure gehosteten Azure SQL-Datenbanken verwalten. Solche Sammlungen werden häufig für SaaS \(Software as a Service\)-Anwendungen verwendet, bei denen es sich in der Regel um Einzelinstanzarchitekturen handelt. Dabei wird für jede Instanz eine Datenbank bereitgestellt. Das Ziel der Bibliothek ist die Erstellung und Verwaltung einer solchen Anwendung.

Die Clientbibliothek ist eine .NET Framework-Bibliothek, die mithilfe von Visual Studio und NuGet in jedem Anwendungsprojekt installiert werden kann. Die Clientbibliothek ist Teil einer Reihe von [Tools für elastische Datenbanken](sql-azure-database-elastic-scale-introduction.md).
