...
# Verwenden der Clientbibliothek für elastische Datenbanken mit Entity Framework 
...
Begriffsdefinitionen finden Sie im [Glossar zu Elastic Scale](sql-database-elastic-scale-glossary.md).
