...
- Details zu bestimmten Verbindungsfehlern finden Sie im Abschnitt **Fehler aufgrund eines Verbindungsabbruchs** unter [Fehlermeldungen (Azure SQL-Datenbank)](https://msdn.microsoft.com/library/azure/ff394106.aspx#bkmk_connection_errors).

- Zugriff auf Ereignisdaten von Verbindungen erhalten Sie durch Abfragen von Konnektivitätsereignissen mit der Sicht [**sys.event_log (Azure SQL-Datenbank)**](https://msdn.microsoft.com/library/dn270018.aspx).
