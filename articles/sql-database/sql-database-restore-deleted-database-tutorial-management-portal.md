...
In diesem Lernprogramm wird gezeigt, wie Sie eine gelöschte Azure SQL-Datenbank im [Azure-Portal](http://manage.windowsazure.com) wiederherstellen können. Sie können eine Datenbank, die während ihres Aufbewahrungszeitraums gelöscht wurde, zu dem Zeitpunkt wiederherstellen, an dem sie gelöscht wurde. Die Beibehaltungsdauer wird von der Dienstebene der Datenbank bestimmt.
