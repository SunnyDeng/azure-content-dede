...
Dieser Artikel enthält Anweisungen zum Exportieren einer BACPAC-Datei der Azure SQL-Datenbank mit dem [Azure-Portal](https://portal.azure.com).
...
- Ein [Azure-Speicherkonto](../storage/storage-create-storage-account.md) mit einem BLOB-Container zum Speichern des BACPAC.
