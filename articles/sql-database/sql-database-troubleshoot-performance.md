...
3.	Mithilfe von dynamischen Verwaltungsansichten (DMVs), erweiterten Ereignissen (Xevents) und des Abfragespeichers in SSMS können Sie Leistungsparameter in Echtzeit abrufen. Im Leistungsleitfaden finden Sie detaillierte Tipps zur Überwachung und Optimierung.

## Schritte zur Verbesserung der Datenbankleistung mit mehr Ressourcen
1.	Für Einzeldatenbanken können Sie [Tarife bedarfsgesteuert ändern](sql-database-scale-up.md), um die Datenbankleistung zu steigern.
