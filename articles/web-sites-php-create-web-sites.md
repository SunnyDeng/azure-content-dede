<properties title="How to create a PHP website in Azure Websites" pageTitle="Erstellen einer PHP-Website in Azure-Websites" metaKeywords=" PHP Azure-Websites" description="Learn how to create a PHP website in Azure Websites" documentationCenter="PHP" services="Web Sites" editor="mollybos" manager="wpickett" authors="tomfitz" />
