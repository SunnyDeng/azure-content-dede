<properties urlDisplayName="Service Bus AMQP Overview" pageTitle="Übersicht zu Service Bus AMQP - Azure " metaKeywords="" description="Informationen zur Nutzung des erweiterten Message Queuing Protocol (AMQP) 1.0 in Azure." metaCanonical="" services="service-bus" documentationCenter=".NET" title="" authors="sethm" solutions="" manager="timlt" editor="mattshel" />
