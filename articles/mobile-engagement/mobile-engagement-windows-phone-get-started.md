...
2. Wählen Sie im Popupfenster **Store-Apps** -> **Windows Phone-Apps** -> **Leere App (Windows Phone Silverlight)** aus. Füllen Sie die Apps `Name` und `Solution name` aus, und klicken Sie dann auf **OK**.
...
2. Ersetzen Sie, wie unten dargestellt, die übergeordnete Klasse **MainPage**, also vor **PhoneApplicationPage**, durch **EngagementPage**:
...
3. Richten Sie das erste Feld der Kampagne mit den folgenden Schritten ein: ![][36]
	...
	2. Wählen Sie für **Lieferzeit** die Option *Jederzeit* aus, um eine Benachrichtigung darüber zu erhalten, ob die App gestartet wurde oder nicht.
...
<!-- URLs. -->
[Mobile Engagement Windows Phone SDK]: http://go.microsoft.com/?linkid=9874664[Mobile Dokumentation zum Engagement Windows Phone SDK]: ../mobile-engagement-windows-phone-integrate-engagement/
