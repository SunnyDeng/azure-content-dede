<properties pageTitle="Serviceseitige Autorisierung (Android) | Mobile Dev Center" metaKeywords="" description="Erfahren Sie, wie Sie Benutzer im .NET-Backend von Azure Mobile Services autorisieren." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Dienstweite Autorisierung von Mobile Services-Benutzern" authors="glenga" solutions="" manager="dwrede" editor="" />
...
1.  Öffnen Sie in Eclipse das Projekt, das Sie im Lernprogramm [Erste Schritte mit der Authentifizierung][Erste Schritte mit der Authentifizierung] verändert haben.
...
-   [Mobile Services Android-Anleitungen: Konzeptionelle Referenz][Mobile Services Android-Anleitungen: Konzeptionelle Referenz]
    Erfahren Sie mehr über die Verwendung von Mobile Services mit Android.
