...
- Eingangsereignisse (Ereignisse, die von einem Event Hub genutzt werden) bis zu 2 MB pro Sekunde.
...
Wenn der gesamte eingehende Durchsatz oder die gesamte eingehende Ereignisrate über alle Event Hubs in einem Namespace hinweg das Einheitenkontingent für den aggregierten Durchsatz überschreitet, werden die Absender gedrosselt und erhalten die Fehlermeldung, dass das Eingangskontingent überschritten wurde.

Wenn der gesamte ausgehende Durchsatz oder die gesamte ausgehende Ereignisrate über alle Event Hubs in einem Namespace hinweg das Einheitenkontingent für den aggregierten Durchsatz überschreitet, werden die Empfänger gedrosselt und erhalten die Fehlermeldung, dass das Ausgangskontingent überschritten wurde. Eingangs-und Ausgangskontingente werden separat durchgesetzt, sodass kein Absender die Ereignisnutzung verlangsamen und kein Empfänger verhindern kann, dass Ereignisse an einen Event Hub gesendet werden.
