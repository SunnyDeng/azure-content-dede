...
-   [Define a custom API that supports periodic notifications (Definieren benutzerdefinierter APIs mit Unterstützung für periodische Benachrichtigungen)](/en-us/documentation/articles/mobile-services-windows-store-dotnet-create-pull-notifications)
