...
Dieses Thema enthält Links zu Dokumentationsressourcen zur Verwendung von Azure-Webaufträgen und dem Azure-Webauftrags-SDK. Azure-Webaufträge bieten eine einfache Möglichkeit zum Ausführen von Skripts oder Programmen als Hintergrundprozesse auf Azure-Websites. Sie können eine ausführbare Datei, z. B. eine CMD-, BAT-, EXE (.NET)-, PS1-, SH-, PHP, PY-, JS- und JAR-Datei, hochladen und ausführen. Diese Programme werden als Webaufträge nach einem Zeitplan (Cron) oder permanent ausgeführt.

Das Webauftrags-SDK vereinfacht die Verwendung des Azure-Speichers. Das Webauftrags-SDK verfügt über ein Bindungs- und Auslösersystem, das Microsoft Azure-Speicher-BLOB, Warteschlangen und Tabellen sowie Service Bus-Warteschlangen verwendet.
...
* [Zusätzliche Ressourcen für das Webauftrags-SDK](#additionalsdk)
...
* [Was ist das Webauftrags-SDK?](../websites-dotnet-webjobs-sdk/)
* [Ankündigung der Version 1.0.0 RTM des Microsoft Azure-Webauftrags-SDK](/blog/2014/10/25/announcing-the-1-0-0-rtm-of-microsoft-azure-webjobs-sdk/)
* [Erste Schritte mit dem Azure WebJobs SDK](../websites-dotnet-webjobs-sdk-get-started/)
* [Arbeiten mit Azure-Warteschlangenspeicher unter Verwendung des Webauftrags-SDK](../websites-dotnet-webjobs-sdk-storage-queues-how-to)
* Videos
	* [Webaufträge und das Webauftrags-SDK](http://channel9.msdn.com/Shows/Cloud+Cover/Episode-153-WebJobs-with-Pranav-Rastogi?utm_source=dlvr.it&utm_medium=twitter)
...
Weitere Informationen finden Sie auch in den folgenden Abschnitten [Bereitstellen von Webaufträgen](#deploy) und [Testen und Debuggen von Webaufträgen](#debug).
...
* [So stellen Sie Webaufträge mithilfe des Azure-Verwaltungsportals bereit](../web-sites-create-web-jobs/)
...
* [Abrufen eines Dashboards für die lokale Entwicklung mit dem Webauftrags-SDK](http://blogs.msdn.com/b/jmstall/archive/2014/01/27/getting-a-dashboard-for-local-development-with-the-webjobs-sdk.aspx)
...
* [Azure-Websites: Entwerfen von Ready-For-Business-Web-Apps in großen Umfang](https://channel9.msdn.com/Events/Build/2014/3-626) Behandelt die Skalierung von Azure-Websites mit Webaufträgen, einschließlich des Webauftrags-SDK.
...
* [Skalieren Ihrer Webanwendung mit Azure-Websites](http://msdn.microsoft.com/en-us/magazine/dn786914.aspx)
* Videos
...
##<a name="additionalsdk"></a>Zusätzliche Ressourcen für das Webauftrags-SDK
...
* [Erweiterte Bindungen mit dem Azure-Webauftrags-SDK](http://victorhurdugaci.com/advanced-bindings-with-the-windows-azure-web-jobs-sdk/)
...
* [Beispielanwendungen, bereitgestellt vom Webauftrags-Team von GitHub](https://github.com/azure/azure-webjobs-sdk-samples)
...
* [Stapelüberlauf beim Webauftrags-SDK](http://stackoverflow.com/questions/tagged/azure-webjobssdk)
