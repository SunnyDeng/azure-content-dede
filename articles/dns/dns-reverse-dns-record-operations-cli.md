...
Sie können mit „azure network public-ip set“ einer vorhandenen öffentlichen IP-Adresse einen Reverse-DNS-Eintrag hinzufügen.
...
Mithilfe von „azure network public-ip show“ können Sie den konfigurierten Wert für eine vorhandene öffentliche IP-Adresse betrachten.

	azure network public-ip show -n PublicIp3 -g NRP-DemoRG-PS 

## Entfernen Sie eine Reverse-DNS aus vorhandenen öffentlichen IP-Adressen.
Mithilfe von „azure network public-ip set“ können Sie eine Reverse-DNS-Eigenschaft aus einer öffentlichen IP-Adresse entfernen. Dies erfolgt, indem der Wert für den ReverseFqdn-Eigenschaftswert auf „leer“ gesetzt wird.
