...
- [dbo.server_quotas (Azure SQL-Datenbank)](http://msdn.microsoft.com/library/dn308512.aspx)
- [sys.bandwidth_usage (Azure SQL-Datenbank)](http://msdn.microsoft.com/library/dn269985.aspx)
- [sys.database_connection_stats (Azure SQL-Datenbank)](http://msdn.microsoft.com/library/dn269986.aspx)
- [sys.database_firewall_rules (Azure SQL-Datenbank)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.database_usage (Azure SQL-Datenbank)](http://msdn.microsoft.com/library/azure/ff951626.aspx)
- [sys.event_log (Azure SQL-Datenbank)](http://msdn.microsoft.com/library/dn270018.aspx)
- [sys.database_firewall_rules (Azure SQL-Datenbank)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.firewall_rules (Azure SQL-Datenbank)](http://msdn.microsoft.com/library/azure/ff951627.aspx)
- [sys.resource_stats (Azure SQL-Datenbank)](http://msdn.microsoft.com/library/dn269979.aspx)
- sys.resource_usage (Azure SQL-Datenbank)
...
>[AZURE.NOTE]Fügen Sie zum Verwenden dieser Sicht „pdw_nodes_“ in den Namen ein. Dies ist unten in der Tabelle dargestellt.
...
| sys.dm_pdw_nodes_tran_commit_table | Transact-SQL-Dokumentation ist nicht verfügbar. |
...
Dies sind Links zu den SQL Server-Informationsschemasichten, die in SQL Server PDW verfügbar sind. Alle INFORMATION_SCHEMA-Sichten, die Sie in SQL Server erwarten, sind in SQL Server PDW verfügbar.
