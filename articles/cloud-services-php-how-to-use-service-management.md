...
##<a id="Connect"></a>Gewusst wie: Herstellen einer Verbindung zur Dienstverwaltung

Um eine Verbindung zum Dienstverwaltungs-Endpunkt herzustellen, benötigen Sie Ihre Azure-Abonnement-ID und den Pfad zu einem gültigen Verwaltungszertifikat. Sie können die Abonnement-ID über das [Verwaltungsportal][management-portal] abrufen und verschiedene Methoden zum Erstellen von Verwaltungszertifikaten nutzen. In dieser Anleitung wird [OpenSSL](http://www.openssl.org/) verwendet, das für [Windows heruntergeladen](http://www.openssl.org/related/binaries.html) und in einer Konsole ausgeführt werden kann.
...
Zum Erstellen des .cer-Zertifikats führen Sie diesen Befehl aus:

	`openssl x509 -inform pem -in mycert.pem -outform der -out mycert.cer`

Weitere Informationen zu Azure-Zertifikaten finden Sie unter [Übersicht über Zertifikate in Windows Azure](http://msdn.microsoft.com/de-de/library/azure/gg981929.aspx). Eine vollständige Beschreibung von OpenSSL-Parametern finden Sie in der Dokumentation auf [http://www.openssl.org/docs/apps/openssl.html](http://www.openssl.org/docs/apps/openssl.html).
...
Nachdem Sie diese Dateien erstellt haben, müssen Sie die .cer-Datei über das [Verwaltungsportal][management-portal] nach Azure hochladen und sich den Speicherort der .pem-Datei notieren.
...
##<a id="ListAvailableLocations"></a>Gewusst wie: Auflisten verfügbarer Standorte
...
##<a id="CreateCloudService"></a>Gewusst wie: Erstellen eines Clouddiensts
...
##<a id="DeleteCloudService"></a>Gewusst wie: Löschen eines Clouddiensts
...
Bevor Sie einen Dienst löschen können, müssen zunächst alle Bereitstellungen für den Dienst gelöscht werden. (Details finden Sie unter [Gewusst wie: Löschen einer Bereitstellung](#DeleteDeployment) .)

##<a id="CreateDeployment"></a>Gewusst wie: Erstellen einer Bereitstellung
...
##<a id="UpdateDeployment"></a>Gewusst wie: Aktualisieren einer Bereitstellung
...
Mit der Methode **updateDeploymentStatus** können Sie den Status einer Bereitstellung auf RUNNING oder SUSPENDED festlegen. Im folgenden Beispiel wird der Status einer Bereitstellung im Produktionsslot des gehosteten Diensts "myhostedservice" auf RUNNING festgelegt:
...
##<a id="MoveDeployments"></a>Gewusst wie: Verschieben von Bereitstellungen zwischen Staging und Produktion
...
##<a id="DeleteDeployment"></a>Gewusst wie: Löschen einer Bereitstellung
...
##<a id="CreateStorageService"></a>Gewusst wie: Erstellen eines Speicherdiensts
...
##<a id="DeleteStorageService"></a>Gewusst wie: Löschen eines Speicherdiensts
...
##<a id="CreateAffinityGroup"></a>Gewusst wie: Erstellen einer Affinitätsgruppe
...
##<a id="DeleteAffinityGroup"></a>Gewusst wie: Löschen einer Affinitätsgruppe
...
[Dienstverwaltungs-Rest-API]: http://msdn.microsoft.com/de-de/library/windowsazure/ee460799.aspx
[Win-Azure-Konto]: /de-de/pricing/free-trial/
[Speicherkonto]: ../storage-create-storage-account/

[SDK-PHP-herunterladen]: ../php-download-sdk/
[Befehlszeilentools]: ../command-line-tools/
[Composer]: http://getcomposer.org/
[Dienstverwaltungseinstellungen]: https://github.com/WindowsAzure/azure-sdk-for-php/blob/master/WindowsAzure/ServiceManagement/ServiceManagementSettings.php

[Cloud-Dienst]: ../cloud-services-what-is/
[Dienstoptionen-erstellen]: https://github.com/WindowsAzure/azure-sdk-for-php/blob/master/WindowsAzure/ServiceManagement/Models/CreateServiceOptions.php
...
[Azure-Tabellen]: ../storage-php-how-to-use-table-storage/
[Azure-Warteschlangen]: ../storage-php-how-to-use-queues/
[Affinitätsgruppe]: https://github.com/WindowsAzure/azure-sdk-for-php/blob/master/WindowsAzure/ServiceManagement/Models/AffinityGroup.php


[Azure-Dienstkonfigurationsschema (.cscfg)]: http://msdn.microsoft.com/de-de/library/windowsazure/ee758710.aspx
