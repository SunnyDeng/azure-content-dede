...
Weitere Informationen zum Erstellen eines Application Gateways mit URL-basiertem Inhaltsrouting finden Sie unter [Erstellen eines Application Gateways mit URL-basiertem Routing](application-gateway-create-url-route-arm-ps.md).
