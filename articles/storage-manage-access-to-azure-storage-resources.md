<properties 
	pageTitle="Verwalten des Zugriffs auf Azure-Speicherressourcen" 
	description="Erfahren Sie mehr zu den verschiedenen Möglichkeiten, den Zugriff auf Azure-Speicherressourcen zu verwalten." 
	services="storage" 
	documentationCenter="" 
	authors="micurd" 
	manager="jahogg" 
...
- Vollständiger öffentlicher Lesezugriff: Container- und Blob-Daten können über anonyme Anforderungen gelesen werden. Clients können Blobs innerhalb des Container über eine anonyme Anforderung aufzählen, können aber keine Container innerhalb des Speicherkontos aufzählen.
...
| REST-Vorgang                                         | .NET-Methode                                      | Berechtigung mit vollständigem öffentlichen Lesezugriff | Berechtigung mit öffentlichem Lesezugriff nur für Blobs |
|--------------------------------------------------------|--------------------------------------------------|-----------------------------------------|---------------------------------------------------|
| List Containers                                        | ListContainers                                   | Nur Besitzer                              | Nur Besitzer                                        |
| Create Container                                       | Erstellen                                           | Nur Besitzer                              | Nur Besitzer                                        |
| Get Container Properties                               | Eigenschaften                                       | Alle                                     | Nur Besitzer                                        |
| Get Container Metadata                                 | Metadata                                         | Alle                                     | Nur Besitzer                                        |
| Set Container Metadata                                 | Metadata                                         | Nur Besitzer                              | Nur Besitzer                                        |
| Get Container ACL                                      | BlobContainerPermissions                         | Nur Besitzer                              | Nur Besitzer                                        |
| Set Container ACL                                      | BlobContainerPermissions                         | Nur Besitzer                              | Nur Besitzer                                        |
| Delete Container                                       | Löschen                                           | Nur Besitzer                              | Nur Besitzer                                        |
| List Blobs                                             | ListBlobs                                        | Alle                                     | Nur Besitzer                                        |
| Put Blob                                               | Create-Methode von CloudPageBlob oder CloudBlockBlob | Nur Besitzer                              | Nur Besitzer                                        |
| Get Blob                                               | DownloadByteArray und andere                     | Alle                                     | Alle                                               |
| Get Blob Properties                                    | Eigenschaften                                       | Alle                                     | Alle                                               |
| Set Blob Properties                                    | SetProperties                                    | Nur Besitzer                              | Nur Besitzer                                        |
| Get Blob Metadata                                      | Metadata                                         | Alle                                     | Alle                                               |
| Set Blob Metadata                                      | Metadata                                         | Nur Besitzer                              | Nur Besitzer                                        |
| Put Block                                              | PutBlock                                         | Nur Besitzer                              | Nur Besitzer                                        |
| Get Block List (nur Blöcke mit ausgeführtem Commit)                 | DownloadBlockList                                | Alle                                     | Alle                                               |
| Get Block List (nur Blöcke ohne ausgeführten Commit oder alle Blöcke) | DownloadBlockList                                | Nur Besitzer                              | Nur Besitzer                                        |
| Put Block List                                         | PutBlockList                                     | Nur Besitzer                              | Nur Besitzer                                        |
| Delete Blob                                            | Löschen                                           | Nur Besitzer                              | Nur Besitzer                                        |
| Kopieren von Blobs                                              | CopyFromBlob                                     | Nur Besitzer                              | Nur Besitzer                                        |
| Snapshot Blob                                          | CreateSnapshot                                   | Nur Besitzer                              | Nur Besitzer                                        |
| Lease Blob                                             | Lease                                            | Nur Besitzer                              | Nur Besitzer                                        |
| Put Page                                               | WritePages                                       | Nur Besitzer                              | Nur Besitzer                                        |
| Get Page Ranges                                        | GetPageRanges                                    | Alle                                     |                                                   |
...
>[AZURE.NOTE]Eine ausführliche Konzeptübersicht und ein Lernprogramm zu SAS finden Sie unter [SAS (Shared Access Signatures)](http://azure.microsoft.com/documentation/articles/storage-dotnet-shared-access-signature-part-1/).
