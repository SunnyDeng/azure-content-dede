<properties title="Verwenden von Giraph mit HDInsight" pageTitle="Verwenden von Apache Giraph mit Azure HDInsight" description="Erfahren Sie, wie Sie Apache Giraph f&uuml;r die Graphverarbeitung mit Azure HDInsight verwenden k&ouml;nnen" metaKeywords="Azure HDInsight Apache Giraph, hdinsight giraph, hdinsight graph, hadoop giraph, azure hadoop, hadoop graph" services="hdinsight" solutions="big-data" documentationCenter="" authors="larryfr" videoId="" scriptId="" manager="paulettm" />
...
Nachdem Sie nun wissen, wie Sie Giraph mit HDInsight verwenden, versuchen Sie [Pig][Pig] und [Hive][Hive] mit HDInsight.
  ...
  [tiny\_graph.txt als Kreise dargestellt mit Linien unterschiedlicher Länge dazwischen]: .\media\hdinsight-giraph\giraph-graph.png
