<properties title="Add Azure SQL DB Elastic Scale References to a Visual Studio Project" pageTitle="Hinzufügen von Elastic Scale-Verweisen der Azure SQL DB zu einem Visual Studio-Projekt" description="So fügen Sie .NET-Referenzen für Elastic Scale-APIs über Nuget zu Visual Studio-Projekten hinzu" metaKeywords="Azure SQL Database, elastic scale, Nuget references" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
