<properties pageTitle="Hinzufügen von Paging für Daten (JavaScript) - Azure Mobile Services" description="Erfahren Sie, wie Sie mithilfe des Auslagerns die Menge der von Ihrer Windows Store-JavaScript-App von Mobile Services zurückgegebenen Daten verwalten können." services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
