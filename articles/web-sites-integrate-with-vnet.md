<properties 
	...
	description="Sie erfahren, wie Sie eine Verbindung zwischen einer Web-App in Azure App Service und einem neuen oder vorhandenen Azure Virtual Network herstellen." 
...
Dieses Dokument beschreibt die Vorschaufunktion der Virtual Network-Integration und zeigt, wie Sie diese mit Ihrer Web-App in [Azure App Service](http://go.microsoft.com/fwlink/?LinkId=529714) einrichten.  Mit Azure Virtual Networks und Ihren lokalen Ressourcen können Sie Hybrid-Lösungen entwickeln, auch wenn Sie nicht mit virtuellen Azure-Netzwerken vertraut sind.  
...
Um eine Web-App mit einem virtuellen Netzwerk zu verbinden, klicken Sie auf dem Blatt Ihrer Web-App auf die Kachel des virtuelle Netzwerks im Bereich "Netzwerk" und wählen eines Ihrer bereits vorhandenen Netzwerke aus.
...
##Verwalten der Verbindung zum virtuellen Netzwerk##
Auf dem Blatt zum App Service-Plan können Sie eine Liste aller virtuellen Netzwerken anzeigen, die derzeit Web-Apps in einem App Service-Plan zugeordnet sind.  Sie können einem App Service- 'Standard'-Plan maximal fünf Netzwerke zuordnen.
