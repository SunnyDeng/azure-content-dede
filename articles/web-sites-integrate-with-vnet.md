...
Das System erstellt dann ein Zertifikat, um mit Ihrem VNET zu authentifizieren, ob es sich um die erste Website in Ihrem Abonnement handelt, die eine Verbindung zu diesem Netzwerk herstellt.  Um die Übergabe des Zertifikats an das aktuelle Portal anzuzeigen, navigieren Sie zu "Virtuelle Netzwerke" und wählen das Netzwerk und die Registerkarte "Zertifikate" aus.  
...
Im Webhostingplan-Fenster können Sie eine Liste mit allen virtuellen Netzwerken anzeigen, die aktuell Websites in einem Webhostingplan zugeordnet sind.  Sie können einem Standard-Webhostingplan maximal 5 Netzwerke zuordnen.
