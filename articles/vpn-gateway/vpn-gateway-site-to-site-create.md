...
Sie können Ihren lokalen Standort mit einem virtuellen Netzwerk verbinden, indem Sie eine Site-to-Site-VPN-Verbindung erstellen. Bei diesem Verfahren werden Sie durch die Erstellung eines virtuellen Netzwerks und die Erstellung einer Site-to-Site-VPN-Verbindung zwischen Ihrem neu erstellten VNet und Ihrem lokalen Standort geführt. Sie können dieses Verfahren zum Erstellen von standortübergreifenden und hybriden Konfigurationen für virtuelle Netzwerke nutzen.


## Bevor Sie beginnen

- Überprüfen Sie, ob das ausgewählte VPN-Gerät die Anforderungen zum Herstellen einer standortübergreifenden Virtual Network-Verbindung erfüllt. Weitere Informationen finden Sie unter [Informationen zu VPN-Geräten und Gateways für virtuelle Netzwerkverbindungen](https://msdn.microsoft.com/library/azure/jj156075.aspx).
...
## Seite „Details zum virtuellen Netzwerk“

Geben Sie die unten angegebenen Informationen ein. Weitere Informationen zu den Einstellungen auf der Seite "Details" finden Sie unter [Seite "Details zum virtuellen Netzwerk"](https://msdn.microsoft.com/library/azure/09926218-92ab-4f43-aa99-83ab4d355555#BKMK_VNetDetails).
...
Geben Sie die folgenden Informationen ein, und klicken Sie dann unten rechts auf den Pfeil „Weiter“. Weitere Informationen zu den Einstellungen auf dieser Seite finden Sie auf der [Seite "DNS-Server und VPN-Konnektivität"](https://msdn.microsoft.com/library/azure/09926218-92ab-4f43-aa99-83ab4d355555#BKMK_VNETDNS).
...
Geben Sie die folgenden Informationen ein, und klicken Sie dann auf den Pfeil „Weiter“. Weitere Informationen zu den Einstellungen auf dieser Seite finden Sie auf der [Seite „DNS-Server und VPN-Konnektivität“](https://msdn.microsoft.com/library/azure/09926218-92ab-4f43-aa99-83ab4d355555#BKMK_VNETSITE).
...
Als Nächstes konfigurieren Sie das **Gateway für das virtuelle Netzwerk**, um eine sichere Site-to-Site-Verbindung zu erstellen. Weitere Informationen finden Sie unter [Konfigurieren eines Gateways für ein virtuelles Netzwerk im Verwaltungsportal](https://msdn.microsoft.com/library/azure/jj156210.aspx).
...
Wenn Sie eine Punkt-zu-Site-VPN-Verbindung konfigurieren möchten, helfen Ihnen die Informationen unter [Konfigurieren einer Punkt-zu-Site-VPN-Verbindung](vpn-gateway-point-to-site-create.md) weiter.
