...
- Azure PowerShell-Cmdlets (1.0 oder höher). Sie können diese Version aus dem Windows PowerShell-Abschnitt der [Downloadseite](https://azure.microsoft.com/downloads/) herunterladen und installieren. Diese Dokumentation wurde für PowerShell 1.0 oder höher geschrieben. Für diese Konfiguration erforderliche Cmdlets sind in früheren Versionen nicht vorhanden.
