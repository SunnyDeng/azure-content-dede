<properties
   pageTitle="Konfigurieren einer Punkt-zu-Standort-VPN-Verbindung mit einem virtuellen Netzwerk | Microsoft Azure"
   description="Herstellen einer sicheren Verbindung mit Ihrem virtuellen Azure-Netzwerk durch Erstellen einer Punkt-zu-Standort-VPN-Verbindung"
...
# Konfigurieren einer Punkt-zu-Standort-VPN-Verbindung mit einem virtuellen Netzwerk
...
1. [Erstellen eines virtuelles Netzwerks und eines VPN-Gateways](#create-a-virtual-network-and-a-vpn-gateway)
...
Weitere Informationen zu standortübergreifenden Verbindungen in virtuellen Netzwerken finden Sie in diesem Artikel: [Informationen zu sicheren standortübergreifenden Verbindungen in virtuellen Netzwerken](http://go.microsoft.com/fwlink/p/?LinkID=532884).
