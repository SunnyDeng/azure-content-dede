...
### Hochladen der Stammzertifikatdatei in das Azure-Portal

1. Wenn Sie zuvor ein selbstsigniertes Stammzertifikat generiert haben, wurde auch eine *CER*-Datei erstellt. Sie laden die Datei jetzt in das Azure-Portal hoch. Beachten Sie, dass die CER-Datei nicht den privaten Schlüssel des Stammzertifikats enthält.
