...
Sie können das Azure PowerShell-Modul herunterladen und installieren, indem Sie den [Microsoft-Webplattform-Installer][3] ausführen. Klicken Sie in der Nachfrage auf **Ausführen**. Der Microsoft-Webplattform-Installer wird geladen, und das Modul **Azure PowerShell** ist zur Installation verfügbar. Alle Abhängigkeiten für die Azure PowerShell-Cmdlets werden durch den Webplattform-Installer installiert. Befolgen Sie die Anweisungen, um die Installation abzuschließen.

Weitere Informationen zu den für Azure verfügbaren Befehlszeilentools finden Sie unter [Befehlszeilentools][4].
...
Zur Verwendung von Azure wird ein Abonnement benötigt. Wenn Sie über kein Abonnement verfügen, lesen Sie die Informationen unter [Erste Schritte mit Azure][2].

Für die Cmdlets werden Ihre Abonnementinformationen benötigt, damit Sie Ihre Dienste über das Abonnement verwalten können. Ab Version .0.7 des Moduls gibt es zwei Möglichkeiten, um diese Informationen anzugeben. Sie können ein Verwaltungszertifikat mit den Informationen herunterladen und verwenden oder sich mit Ihrem Microsoft-Konto oder einer Organisations-ID bei Azure anmelden. Bei der Anmeldung werden die Anmeldeinformationen von Azure Active Directory (Azure AD) authentifiziert.
...
Weitere Informationen zur Authentifizierungs- und Abonnemontverwaltung in Azure finden Sie unter [Verwalten von Konten, Abonnements und Administratorrollen][5].
...
Das Azure PowerShell-Modul enthält Cmdlets, mit denen Sie das Zertifikat herunterladen und importieren können.
...
Sie können über mehrere Konten und Abonnements zur Verwendung durch Azure PowerShell verfügen und mehrere Konten hinzufügen, indem Sie
...
Nachdem Sie das Modul installiert und die Verbindung zwischen Ihrem Computer und dem Abonnement konfiguriert haben, können Sie als Beispiel für die Verwendung der Cmdlets eine Website erstellen.
...
PowerShell-Modul auf.</td> </tr> <tr  align="left" valign="top"> <td >help
<b>Sprache</b>-dev</td> <td
>Listet Cmdlets zum Entwickeln und Verwalten von
Anwendungen in einer bestimmten Sprache auf. Beispiel: help node-dev, help php-dev, help python-dev.</td> </tr> <tr
...
Parameterdefinitionen für ein Cmdlet an. Beispiel: help get-azuresubscription -parameter \*</td> </tr> <tr
 align="left" valign="top"> <td
>help <b>Cmdlet</b>
