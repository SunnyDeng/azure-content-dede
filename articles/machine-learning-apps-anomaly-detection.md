...
1. Positive und negative Trends: Beispielsweise weist beim Überwachen der Speicherauslastung in der Computerverarbeitung ein Aufwärtstrend auf einen Speicherverlust hin.

2. Anstieg im dynamischen Wertebereich: Beispielsweise deutet bei der Überwachung der durch einen Dienst ausgelösten Ausnahmen ein Anstieg im dynamischen Wertebereich auf eine Instabilität der Dienstintegrität hin.

3. Spitzen und Abfälle: Beispielsweise können beim Überwachen der Anzahl fehlgeschlagener Anmeldeversuche bei einem Dienst oder der Anzahl der Auscheckvorgänge in einer E-Commerce-Website Spitzen oder Abfälle auf anormales Verhalten hinweisen.
...
Der Dienst stellt eine REST-basierte API über HTTPS bereit, die auf verschiedene Arten genutzt werden können, etwa über Web- oder mobile Anwendungen, R, Python, Excel usw. Wir bieten eine [Azure-Webanwendung](http://anomalydetection-aml.azurewebsites.net/) zum Ausführen des Anomaly Detection-Webdienstes für Ihre Daten und Visualisieren der Ergebnisse. 
