<properties
	pageTitle="Versionshinweise zu Hadoop-Komponenten in Azure HDInsight | Microsoft Azure"
	description="Neueste Versionshinweise und Versionen der Hadoop-Komponenten für Azure HDInsight. Erhalten Sie Tipps für die Entwicklung und Details zu Hadoop, Apache Storm und HBase."
	services="hdinsight"
	documentationCenter=""
	editor="cgronlun"
	manager="paulettm"
...
<tr>
<td>Zusätzliche geöffnete HTTPS-Ports</td>
<td>Der Cloud-Dienst öffnet jetzt die 5 Ports 8001 bis 8005 im Cluster, z. B. https://<clustername>.azurehdinsight.net:8001/. An diese URLs gesendete Anforderungen werden mit dem gleichen grundlegenden Authentifizierungsmechanismus mit Kennwort als Port 443 authentifiziert. Diese Ports werden an denselben Port im aktiven Hauptknoten gebunden. Skriptaktionen können verwendet werden, damit kundenspezifische Dienste diese Ports auf dem Hauptknoten und der Route zu externen Rechnern außerhalb des Clusters überwachen.</td>
<td>Cloud-Dienste</td>
<td>Alle</td>
<td>–</td>
</tr>
...
<tr>
<td>Zeitweiliger MapReduce-Shuffle-Fehler bei HDInsight 3.2</td>
<td>Korrektur für eine seltene, zeitweilig auftretende Racebedingung in MapReduce-Shuffle in großen Clustern, die zu gelegentlichen Aufgabenfehlern führt. Weitere Informationen finden Sie unter <a href="https://issues.apache.org/jira/browse/MAPREDUCE-6361" target="_blank">MAPREDUCE-6361</a>.</td>
<td>Hadoop-Kern</td>
<td>Alle</td>
...
<tr>
<td>Umstieg auf aktuelles Azure Java SDK 2.2 für HDInsight 3.2</td>
<td>Umstieg auf die neueste Version des Azure SDK für Java, das vom WASB-Treiber verwendet wird. Das neueste SDK enthält einige Updates, und die Versionshinweise dazu sind verfügbar unter https://github.com/Azure/azure-storage-java/blob/master/ChangeLog.txt .</td>
<td>Hadoop-Kern</td>
<td>Alle</td>
...
<tr>
<td>Umstieg auf HDP 2.1.15 für HDInsight 3.1-Cluster</td>
...
## Hinweise zur HDInsight-Version vom 04.06.2015 ##
...
<tr>
<td>Update für Fehler 502 "Ungültiges Gateway" für Storm-Cluster</td>
<td>Diese Version behebt einen Fehler, der die Auftragsübermittlungs-API betrifft und bewirkt, dass die Website nach einem Neustart nicht verfügbar ist.</td>
<td>Dienst</td>
<td>Storm</td>
<td>–</td>
</tr>
...
## Hinweise für die HDInsight-Version vom 01.06.2015 ##
...
## Hinweise für die HDInsight-Version vom 27.05.2015 ##

Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:

* HDInsight 3.2.4.570.1554102 (HDP 2.2.6.0-2800)
* Andere Clusterversionen und SDK werden nicht als Teil dieser Version bereitgestellt.
...
<tr>
<td>Update für HDP 2.2</td>
<td>Diese Version von HDInsight 3.2 enthält HDP 2.2.6 und einige wichtige Fehlerbehebungen für HDInsight. Die vollständigen Versionshinweise finden Sie unter <a href="http://dev.hortonworks.com.s3.amazonaws.com/HDPDocuments/HDP2/HDP-2.2.6/HDP_RelNotes_v226/index.html">Versionshinweise für HDP 2.2.6</a>.</td>
<td>HDP</td>
<td>Alle Clustertypen</td>
<td>–</td>
</tr>
...
<tr>
<td>Änderung der Standardspeicherkonfiguration für Yarn-Container</td>
<td>In diesem Update wird der für YARN-Container standardmäßig verfügbare Arbeitsspeicher (yarn.nodemanager.resource.memory-mb und yarn.scheduler.maximum-allocation-mb), die von der Knotenverwaltung initiiert werden, auf 5632&#160;MB erhöht. Zuvor wurde diese Einstellung auf 4608&#160;MB verringert. Basierend auf verschiedenen ausgeführten Aufträgen, muss der neue Wert jedoch höhere Zuverlässigkeit und Leistung für die meisten Aufträge bieten und ist daher eine bessere Standardeinstellung. Wenn eine kritische Abhängigkeit von dieser Arbeitsspeicherkonfiguration vorliegt, dann legen Sie diese wie üblich beim Erstellen des Clusters explizit fest.</td>
<td>HDP</td>
<td>Alle Clustertypen</td>
<td>–</td>
</tr>
...
<tr>
<td>Standardkonfigurationsparität für HBase- und Storm-Cluster</td>
...
## Hinweise für die HDInsight-Version vom 20.05.2015 ##
...
<tr>
<td>Beheben von DLL-Abhängigkeiten</td>
<td>Entfernt die HDInsight-Abhängigkeit vom Komponententest-Framework.</td>
<td>SDK</td>
<td>Hadoop</td>
<td>–</td>
</tr>
...
<tr>
<td>Fehlerbehebung für Racebedingung</td>
<td>Eine Anforderung zum Erstellen eines Clusters wartet jetzt, bis die PUT-Anforderung akzeptiert wurde, bevor der Status abgerufen wird.</td>
<td>SDK</td>
<td>Hadoop</td>
<td>–</td>
</tr>
...
<tr>
<td>Tez-Fehlerbehebungen</td>
<td>Updates für Apache TEZ 2214 und TEZ 1923 sind in dieser Version von HDI 3.2 enthalten. Diese werden speziell für bestimmte Hive-Abfragen in Tez benötigt, für die eine beträchtliche Datenmenge gemischt werden muss.
</td>
<td>HDP</td>
<td>Hadoop</td>
...
<td>Update zum Entfernen einiger interner Klassen für HDInsight unter Linux</td>
<td>SDK</td>
<td>Hadoop</td>
<td>–</td>
</tr>
...
<td><b>KnownTypeAttribute</b> wurde der Methode <b>GetAllKnownTypes</b> hinzugefügt. Korrektur von NullReferenceException, wenn ein Typ für die GetAllKnownTypes-Methode NULL ist.</td>
<td>SDK</td>
<td>Hadoop</td>
<td>–</td>
</tr>
...
<tr>
<td>Möglichkeit zum Aktivieren/Deaktivieren von Remotedesktop-Anmeldeinformationen in Windows-Clustern über .NET SDK.</td>
...
<tr>
<td>Möglichkeit, Remotedesktop-Anmeldeinformationen in Clustern zu aktivieren, während diese bereitgestellt werden.</td>
<td>Programmgesteuerte Unterstützung für die Aktivierung von Remotedesktop-Anmeldeinformationen, während der Cluster erstellt wird. Dadurch wird der zweistufige Prozess entfernt, der aus der Bereitstellung der Cluster und der Aktivierung von Remotedesktop besteht.</td>
<td>SDK</td>
<td>Alle</td>
<td>–</td>
</tr>
...
<td>Änderung der Konfiguration von yarn.resourcemanager.maxmax-completed-applications in 1000 für alle Clustertypen für HDInsight Version 3.1 und 3.2. Dieser Wert steuert nur die Liste der abgeschlossenen Anwendungen in der YARN-Benutzeroberfläche. Zum Abrufen von Informationen zu Anwendungen, die vor der auf der Benutzeroberfläche angezeigten Liste der Anwendungen übermittelt wurden, können Sie direkt zum History Server wechseln.</td>
<td>YARN</td>
<td>Alle</td>
<td>–</td>
</tr>
...
<tr>
<td>Ändern der Größe der Knoten in einem HBase-Cluster</td>
<td>In HBase-Clustern kann nun die Größe von Knoten für die HDInsight-Versionen 3.1 und 3.2 (nach oben und unten) geändert werden.</td>
<td>Dienst</td>
<td>HBase</td>
<td>–</td>
</tr>
...
<tr>
<td>JDBC-Upgrade</td>
<td>SQL JDBC-Treiber wird für HDInsight-Version 3.2 auf die Version sqljdbc_4.0.2206.100 aktualisiert. Diese Version enthält wichtige Verbesserungen bei der Sicherheit.</td>
<td>HDP</td>
<td>Alle</td>
<td>–</td>
</tr>
...
<tr>
<td>Update der JVM-Konfiguration</td>
<td>Für HDInsight-Versionen 3.1 und 3.2 wurde die JVM-Konfiguration networkaddress.cache.ttl vom Standardwert -1 auf 300 Sekunden aktualisiert. Dieser Konfigurationswert steuert die Cachingrichtlinie für erfolgreiche Namenssuchvorgänge vom Namensdienst. Damit wird ein Fehler im Zusammenhang mit dem Vergrößern und Verkleinern von HBase-Clustern behoben.</td>
<td>Dienst</td>
<td>HBase</td>
<td>–</td>
</tr>
...
<tr>
<td>Aktualisiert auf Apache WASB-Quellcode</td>
<td>HDInsight Version 3.2 verwendet jetzt den neuesten Code für die WASB-Dateisystemtreiber von Apache Hadoop. Durch diese Änderung wird der WASB-Treiber jetzt als separate JAR-Datei verpackt. Dies ist nur eine Änderung der Verpackung, die mit keinerlei Änderungen am Verhalten der WASB-Treiber verbunden ist. Der Name der JAR-Datei lautet hadoop-azure-2.6.0.jar.</td>
<td>HDP</td>
<td>Alle</td>
<td>–</td>
</tr>
...
<tr>
<td>JAR-Dateinamen-Updates in HDInsight 3.2</td>
...
<tr>
<td>Verbesserungen der Zuverlässigkeit</td>
...
<td>Cluster können unter Ubuntu Linux bereitgestellt werden. Nähere Informationen finden Sie unter <a href="http://azure.microsoft.com/documentation/articles/hdinsight-hadoop-linux-get-started/" target ="_blank">Erste Schritte mit HDInsight unter Linux</a>.</td>
<td>Dienst</td>
<td>Hadoop</td>
<td>–</td>
</tr>
...
<td>Apache-Storm-Cluster sind allgemein verfügbar. Nähere Informationen finden Sie unter <a href="http://azure.microsoft.com/documentation/articles/hdinsight-storm-getting-started/" target="_blank">Erste Schritte mit Storm in HDInsight</a>.</td>
<td>Dienst</td>
<td>Storm</td>
<td>–</td>
</tr>
...
<tr>
<td>Größen virtueller Computer</td>
...
<tr>
<td>Clusterskalierung</td>
<td>Sie können die Anzahl der Datenknoten für einen ausgeführten HDInsight-Cluster ändern, ohne ihn zu löschen oder neu zu erstellen. Derzeit haben nur Cluster vom Typ Hadoop-Abfrage und Apache Storm diese Fähigkeit, aber Cluster vom Typ Apache HBase werden ebenfalls bald unterstützt werden. Weitere Informationen finden Sie unter <a href="http://azure.microsoft.com/documentation/articles/hdinsight-hadoop-cluster-scaling/" target="_blank">Cluster-Skalierung in HDInsight</a>.</td>
<td>Dienst</td>
<td>Hadoop, Storm</td>
<td>–</td>
</tr>
...
<td>Mit Hadoop-Connector für DocumentDB können Sie komplexe Aggregationen, Analysen und Bearbeitungen mit schemalosen JSON-Dokumenten ausführen, die in verschiedenen DocumentDB-Sammlungen oder Datenbankkonten gespeichert sind. Weitere Informationen und ein Lernprogramm finden Sie unter <a href="http://azure.microsoft.com/documentation/articles/documentdb-run-hadoop-with-hdinsight/" target="_blank">Ausführen von Hadoop-Aufträgen mit DocumentDB und HDInsight</a>.</td>
<td>Dienst</td>
<td>Hadoop</td>
<td>–</td>
</tr>
...
<tr>
<td>Wartungsupdate für HDP 2.1</td>
<td>HDInsight 3.1 wird aktualisiert, um HDP 2.1.10.0 bereitstellen. Weitere Informationen finden Sie unter <a href ="http://docs.hortonworks.com/HDPDocuments/HDP2/HDP-2.1.10/bk_releasenotes_hdp_2.1/content/ch_relnotes-HDP-2.1.10.html" target="_blank">Versionshinweise zu HDP-2.1.10</a>. </td>
<td>Open-Source-Software</td>
<td>Alle</td>
<td>–</td>
</tr>
...
<tr>
<td>Updates der HDP-Binärdateien</td>
<td>Es gibt einige JAR-Dateien in HBase, für die Dateinamen aktualisiert wurden. Da diese JAR-Dateien werden intern von HBase verwendet werden, wird nicht erwartet, dass bei Kunden eine Abhängigkeit von den Namen dieser JAR-Dateien vorhanden ist. Das umfasst:
<ul>
...
Apache Mahout ist eine Apache Hadoop-Bibliothek für maschinelles Lernen. Mahout enthält Algorithmen zur Verarbeitung von Daten (z.&#160;B. Filtern, Klassifizierung und Clustering). In diesem Lernprogramm verwenden Sie ein Empfehlungsmodul, um Filmempfehlung auf Grundlage von Filmen, die Ihre Freunde gesehen haben, zu erstellen.</p></td>
...
<tr>
<td>Änderung des Standardwerts für die Hive-Konfiguration: hive.auto.convert.join.noconditionaltask.size</td>
...
* HDInsight 2.1.10.420.1246783 (unveränderte HDP-Version)
* HDInsight 3.0.6.420.1246783 (unveränderte HDP-Version)
* HDInsight 3.1.1.420.1246783 (unveränderte HDP-Version)
...
Diese Version enthält das folgende Komponentenupdate.
...
<tr>
<td>Fehlerbehebung: Zeitweiliger Fehler beim Hinzufügen sehr vieler Partitionen zu einer Tabelle in einer Hive-DLL. </td>
...
<tr>
<td>Fehlerbehebung: Gelegentlicher Absturz in der HDInsight-Abfragekonsole</td>
...
<tr>
<td>Namensänderungen bei HDP-JAR-Dateien</td>
<td>Bei HDI-Clusterversion 3.0 wurde einige interne JAR-Dateien geändert, die von HDP installiert werden. jetty-6.1.26.jar wurde durch jetty-6.1.26.hwx.jar ersetzt. jetty-util-6.1.26.jar wurde durch jetty-util-6.1.26.hwx.jar ersetzt. Diese Änderungen gelten für Hadoop-, Mahout-, WebHCat- und Oozie-Projekte.</td>
...
<td>Das Azure HDInsight SDK ermöglicht jetzt die Angabe eines Regionsnamens, wenn **DeleteCluster** verwendet wird. Dadurch werden Konflikte bei Kunden beseitigt, die über zwei Ressourcen mit demselben Namen in unterschiedlichen Regionen verfügten und keine davon löschen konnten.</td>
<td>SDK</td>
<td>Alle</td>
<td>–</td>
</tr>
...
<td>Das **ClusterDetails**-Objekt gibt nun das Feld **DeploymentID** zurück, das einen eindeutigen Bezeichner des Clusters darstellt. Dieser ist bei Versuchen der Erstellung von Clustern mit demselben Namen garantiert eindeutig.</td>
<td>SDK</td>
<td>Alle</td>
<td>–</td>
</tr>
...
Diese Version enthält die folgenden neuen Features, Komponentenupdates und Fehlerbehebungen.
...
<td>Vorschau auf das Feature zur Clusteranpassung, das die Änderung von Hadoop-Clustern auf beliebige Weisen mithilfe benutzerdefinierter Skripts ermöglicht. Mithilfe dieses neuen Features können Benutzer mit Projekten experimentieren, die in der Apache Hadoop-Umgebung zur Verfügung stehen, und diese in Azure HDInsight-Clustern bereitstellen. Diese Anpassungsfunktion steht für alle Typen von HDInsight-Clustern einschließlich Hadoop, HBase und Storm zur Verfügung.</td>
<td>Neues Feature</td>
<td>Alle</td>
<td>–</td>
</tr>
...
<td>Die HDInsight-Abfragekonsole bietet einen Katalog für erste Schritte, der Lösungen unterstützt, die für entweder Ihre Daten oder Beispieldaten funktionieren.
<p>**Lösungen, die für Ihre Daten funktionieren**:<br>
Wir haben Aufträge für einige der gängigsten Datenanalyseszenarien entwickelt, um Ihnen einen Ausgangspunkt für das Erstellen eigener Lösungen zu bieten. Sie können Ihre Daten mit dem Auftrag verwenden, um zu sehen, wie er funktioniert. Wenn Sie soweit sind, können Sie das Gelernte nutzen, um eine Lösung zu entwickeln, die dem vordefinierten Auftrag folgt.</p>
<p>**Lösungen, die für Beispieldaten funktionieren**:<br>
Erfahren Sie, wie Sie mit HDInsight arbeiten, indem Sie verschiedene einfache Szenarien durchlaufen, z.&#160;B. das Analysieren von Webprotokollen und Sensordaten. Sie lernen, wie Sie mit HDInsight solche Daten analysieren und wie Sie andere Anwendungen und Dienste mit diesen Daten verbinden. Die Visualisierung von Daten durch Verbinden mit Microsoft Excel ist ein Beispiel der Leistungsfähigkeit dieses Ansatzes.</p></td>
<td>Abfragekonsole</td>
<td>Hadoop</td>
<td>–</td>
</tr>
...
<tr>
<td>HDP 2.1.7</td>
<td>Diese Version basiert auf Hortonworks Data Platform (HDP) 2.1.7. Weitere Informationen finden Sie in den <a href="http://docs.hortonworks.com/HDPDocuments/HDP2/HDP-2.1.7-Win/bk_releasenotes_HDP-Win/content/ch_relnotes-HDP-2.1.7.html" target="_blank">Versionshinweisen für HDP 2.1.7</a>.</td>
<td>HDP</td>
<td>Alle</td>
<td>–</td>
</tr>
...
<td>Ab der SDK-Version 1.3.3.1.5426.29232 können Benutzer auf die von HDInsight ausgestellte eindeutige ID für jeden Cluster zugreifen. Dadurch können Kunden eindeutige Instanzen von Clustern bestimmen, wenn ein DNS-Name in Erstellungs-/Löschszenarien wiederverwendet wird.</td>
<td>SDK</td>
<td>Alle</td>
<td>–</td>
</tr>
...
<table border="1"> <tr><th>Komponente</th><th>Speicherzuweisung</th></tr> <tr><td> yarn.scheduler.minimum-allocation</td><td>768 MB (zuvor 512 MB)</td></tr> <tr><td> yarn.scheduler.maximum-allocation</td><td>6144 MB (unverändert)</td></tr> <tr><td>yarn.nodemanager.resource.memory</td><td>6144 MB (unverändert)</td></tr> <tr><td>mapreduce.map.memory</td><td>768 MB (zuvor 512 MB)</td></tr> <tr><td>mapreduce.map.java.opts</td><td>opts=-Xmx512m (zuvor -Xmx410m)</td></tr> <tr><td>mapreduce.reduce.memory</td><td>1536 MB (zuvor 1024 MB)</td></tr> <tr><td>mapreduce.reduce.java.opts</td><td>opts=-Xmx1024m (zuvor -Xmx819m)</td></tr> <tr><td>yarn.app.mapreduce.am.resource</td><td>768 MB (zuvor 1024 MB)</td></tr> <tr><td>yarn.app.mapreduce.am.command</td><td>opts=-Xmx512m (zuvor -Xmx819m)</td></tr> <tr><td>mapreduce.task.io.sort</td><td>256 MB (zuvor 200 MB)</td></tr> <tr><td>tez.am.resource.memory</td><td>1536 MB (unverändert)</td></tr>
...
* Die Datei "avro-mapred-1.7.4.jar” im pig-Bibliotheksverzeichnis wurde in "avro-mapred-1.7.4-hadoop2.jar" geändert. Diese Datei enthält eine kleine Fehlerbehebung, die keine Funktionen beeinträchtigt. Wir empfehlen unseren Kunden, keine direkten Abhängigkeiten über den Namen der JAR-Datei zu definieren, um Probleme zu vermeiden, wenn Dateien umbenannt werden.


## Hinweise für die Version vom 21.08.2014 ##

* Es wird die folgende WebHCat-Konfiguration (HIVE-7155) hinzugefügt, mit der die Standardspeicherbegrenzung für einen Templeton-Controllerauftrag auf 1 GB festgelegt wird. (Der vorherige Standardwert lautete 512 MB.)
...
* **Verfügbarkeit von HDInsight in drei neuen Regionen**: Mit dieser Version wurde die geografische Präsenz von HDInsight auf drei neue Regionen ausgeweitet. HDInsight-Kunden können in den folgenden Regionen Cluster erstellen:
	* Ostasien
	* USA (Mitte/Norden)
	* USA (Mitte/Süden)
* HDInsight Version 1.6 (HDP 1.1 und Hadoop 1.0.3) und HDInsight Version 2.1 (HDP1.3 und Hadoop 1.2) werden aus dem Azure-Portal entfernt. Sie können weiterhin Hadoop-Cluster für diese Versionen mithilfe der HDInsight PowerShell-Cmdlets ([New-AzureHDInsightCluster](http://msdn.microsoft.com/library/dn593744.aspx)) oder des [HDInsight SDK](http://msdn.microsoft.com/library/azure/dn469975.aspx) erstellen. Weitere Informationen finden Sie auf der Seite [HDInsight-Komponentenversionen](../hdinsight-component-versioning/).
...
### Apache Mahout vorinstalliert in HDInsight 3.1 ###
...
Hive 0.13 ist in HDInsight 3.1 verfügbar und kann Abfragen mit Tez ausführen. Dies kann für erhebliche Leistungsverbesserungen genutzt werden. Tez ist nicht standardmäßig für Hive-Abfragen aktiviert. Um es zu verwenden, müssen Sie die entsprechende Option aktivieren. Sie können Tez aktivieren, indem Sie das folgende Code-Snippet ausführen:
...
Weitere Informationen zum Verwenden von Hive mit Tez finden Sie unter [Hive in Tez](https://cwiki.apache.org/confluence/display/Hive/Hive+on+Tez).

###Globale Verfügbarkeit
Mit der Freigabe von HDInsight auf Hadoop 2.2 hat Microsoft HDInsight in allen größeren geografischen Regionen, in denen Azure verfügbar ist, verfügbar gemacht. Insbesondere wurden die Rechenzentren in Westeuropa und Südostasien online geschaltet. So können die Kunden Cluster in einem Rechenzentrum finden, das sich in Ihrer Nähe befindet und potenziell in einer Zone mit ähnlichen Anforderungen zur Einhaltung von Vorschriften liegt.


###Empfehlungen und Warnungen für unterschiedliche Clusterversionen

**Oozie-Metastores mit einem HDInsight 3.1-Cluster sind nicht abwärtskompatibel mit HDInsight 2.1-Clustern und können nicht mit dieser älteren Version verwendet werden**.

Benutzerdefinierte Oozie-Metastore-Datenbanken mit einem HDInsight 3.1-Cluster können nicht mit einem HDInsight 2.1-Cluster wiederverwendet werden. Dies gilt auch dann, wenn der Metastore ursprünglich mit einem HDInsight 2.1-Cluster erstellt wurde. Dieses Szenario wird nicht unterstützt, weil das Metastore-Schema bei der Verwendung mit einem HDInsight 3.1-Cluster aktualisiert wird und daher nicht mehr mit dem Metastore kompatibel ist, den ein HDInsight 2.1-Cluster benötigt. Durch jeden Versuch der Wiederverwendung eines Oozie-Metastore, der bereits mit einem HDInsight 3.1-Cluster verwendet wurde, wird das HDInsight 2.1-Cluster unbrauchbar.

**Oozie-Metastores können nicht zwischen Clustern freigegeben werden**.

Oozie-Metastores sind an ein bestimmtes Cluster gebunden und können nicht zwischen Clustern freigegeben werden.

###Wichtige Änderungen

**Präfixsyntax**: In HDInsight 3.1- und 3.0-Clustern wird nur die „wasb://“-Syntax unterstützt. Die ältere "asv://"-Syntax wird in HDInsight 2.1- und 1.6-Clustern unterstützt, nicht aber in HDInsight 3.1 oder 3.0-Clustern. Dies bedeutet, dass alle an einen HDInsight-Cluster der Version 3.1 oder 3.0 übermittelten Aufträge, die explizit die "asv://"-Syntax verwenden, misslingen. Stattdessen sollte die "wasb://"-Syntax verwendet werden. An HDInsight-Cluster der Version 3.1 oder 3.0 übermittelte Aufträge, die mithilfe eines vorhandenen Metastores erstellt wurden, der explizite Verweise auf Ressourcen mit der "asv://"-Syntax enthält, schlagen ebenfalls fehl. Diese Metastores müssen mit der "wasb://"-Syntax zur Adressierung von Ressourcen neu erstellt werden.


**Ports**: Die vom HDInsight-Dienst verwendeten Ports wurden geändert. Die Portnummern, die verwendet wurden, befanden sich im kurzlebigen Portbereich des Windows-Betriebssystems. Ports werden automatisch von einem vordefinierten kurzlebigen Bereich für kurzlebige Internetprotokollbasierte Kommunikationen zugewiesen. Die neue Reihe der zulässigen Portnummern des HDP-Dienstes (Hortonworks Data Platform) befinden sich außerhalb dieses Bereichs, um Konflikte zu vermeiden, die mit den Ports auftreten könnten, welche von auf dem Hauptknoten ausgeführten Diensten verwendet werden. Die neuen Portnummern dürften keine fehlerhaften Änderungen verursachen. Es werden folgende Nummern verwendet:
 ...
 **HDInsight 3.1 und 3.0 (HDP 2.1 und 2.0)** <table border="1"> <tr><th>Name</th><th>Wert</th></tr> <tr><td>dfs.namenode.http-Adresse</td><td>Namenodehost:30070</td></tr> <tr><td>dfs.namenode.https-Adresse</td><td>Headnodehost:30470</td></tr> <tr><td>dfs.datanode.address</td><td>0.0.0.0:30010</td></tr> <tr><td>dfs.datanode.http.address</td><td>0.0.0.0:30075</td></tr> <tr><td>dfs.datanode.ipc.address</td><td>0.0.0.0:30020</td></tr> <tr><td>dfs.namenode.secondary.http-Adresse</td><td>0.0.0.0:30090</td></tr> <tr><td>yarn.nodemanager.webapp.address</td><td>0.0.0.0:30060</td></tr> <tr><td>templeton.port</td><td>30111</td></tr> </table><br>
...
Versionshinweise zu den HDPs (Hortonworks Data Platforms), die von den Versionen von HDInsight-Cluster verwendet werden, sind an folgenden Speicherorten verfügbar.

* HDInsight Version 3.1 verwendet eine Hadoop-Distribution, die auf [Hortonworks Data Platform 2.1.7][hdp-2-1-7] basiert. Dies ist der Hadoop-Standardcluster, der bei Verwendung des Azure-Portals nach dem 7.11.2014 erstellt wird. Vor dem 7.11.2014 erstellte HDInsight 3.1-Cluster basierten auf [Hortonworks Data Platform 2.1.1][hdp-2-1-1].
