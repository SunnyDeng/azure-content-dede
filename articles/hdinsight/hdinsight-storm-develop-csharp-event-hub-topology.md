...
1. Klicken Sie im **Projektmappen-Explorer** mit der rechten Maustaste auf das Projekt E**EventHubReader**, und wählen Sie **NuGet-Pakete verwalten** aus. Suchen Sie nach dem **Json.Net**-Paket, und fügen Sie es der Projektmappe hinzu. Auf diese Weise lassen sich die aus dem Spout übermittelten JSON-Daten einfach verarbeiten. Fügen Sie auch ein **WindowsAzure.Storage**-Paket hinzu, das das Schreiben von Daten in den Tabellenspeicher ermöglicht.
