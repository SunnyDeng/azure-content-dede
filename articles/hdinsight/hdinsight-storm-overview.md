...
![Ein Beispiel für das Schnellerfassungsformular für Cluster im Portal](./media/hdinsight-storm-overview/quick-create.png)
...
![Anzahl der Datenknoteninstanzen im Portal](./media/hdinsight-storm-overview/scale.png)
