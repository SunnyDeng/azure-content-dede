...
1. Wenn Sie einen HDInsight-Cluster im Vorschauportal bereitstellen, klicken Sie auf **Optionale Konfiguration** und anschließend auf **Skriptaktionen**.
...
**So erstellen Sie eine .NET-Anwendung in Visual Studio**
