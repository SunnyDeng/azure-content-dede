...
Script Action-Skripts können über das Azure-Portal, Azure PowerShell oder das HDInsight .NET SDK genutzt werden.
...
Siehe [Entwickeln von Script Action-Skripts für HDInsight][hdinsight-write-script].
