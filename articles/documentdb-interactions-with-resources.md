...
Schließlich muss zum Ausführen der gespeicherten Prozedur im obigen Beispiel ein POST mit dem URI der gespeicherten Prozedurressource (/dbs/_rid-db/colls/_rid-coll/sprocs/sproc1) ausgegeben werden. Dies wird im folgenden Code veranschaulicht.  
...
## Referenzen
-   [Azure DocumentDB-REST-API-Referenz](https://msdn.microsoft.com/library/azure/dn781481.aspx)
...
-	[DocumentDB-Programmierung: Gespeicherte Prozeduren, Trigger und benutzerdefinierte Funktionen](../documentdb-programming/)
