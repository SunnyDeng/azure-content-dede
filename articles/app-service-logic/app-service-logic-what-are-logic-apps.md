...
Mit unseren [BizTalk-API-Apps][biztalk] können Sie darüber hinaus ausgereifte Integrationsszenarien erstellen – dank [Regelmodul][rules], [Handelspartnerverwaltung][tpm] und vielem mehr.
...
- **Integrierte Erweiterbarkeit** – Sie finden den benötigten Connector nicht? Logik-Apps sind Teil der App Service-Produktfamilie und für das Arbeiten mit API-Apps ausgelegt. Sie können problemlos eine eigene API-App entwickeln und anschließend als Connector nutzen. Entwickeln Sie eine neue App nur für sich allein, oder veröffentlichen Sie sie im Marketplace, um sie kommerziell zu verwerten.
