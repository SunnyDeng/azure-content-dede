...
Außerdem können Logik-Apps mit integrierten [verwalteten APIs][managedapis] kombiniert werden, um selbst schwierige Integrationsszenarien einfach zu meistern:

![Datenfluss-App-Designer](./media/app-service-logic-what-are-logic-apps/LogicAppCapture2.png)

Sie können z. B. neue Datensätze in Ihrer SQL-Datenbank automatisch replizieren und per E-Mai an die Mitarbeiter mit Kundenkontakt senden. Oder Sie können automatisch negative Tweets suchen und an einen Pufferkanal senden.
...
Mit unseren [verwalteten BizTalk-APIs][biztalk] können Sie darüber hinaus ausgereifte Integrationsszenarien erstellen – dank [Regelmodul][rules], [Handelspartnerverwaltung][tpm] und vielem mehr.
...
- **BizTalk** – Für anspruchsvollere Integrationsszenarien bieten Logik-Apps Funktionen von BizTalk. BizTalk ist die branchenführende Integrationsplattform von Microsoft. Mit BizTalk-API-Apps können Sie z. B. Validierungen, Transformationen und Regeln auf einfache Weise in Ihre Logik-App-Workflows einbinden. Unter [Was sind BizTalk-API-Apps?][biztalk] finden Sie weitere Informationen.
