<properties
   pageTitle="Verwendung des SugarCRM-Connectors in Logik-Apps | Microsoft Azure App Service"
   description="Erstellen und Konfigurieren des SugarCRM-Connectors oder einer API-App und Verwenden in einer Logik-App in Azure App Service"
...
Im Rahmen der Connector-Paketeinstellungen können Sie Entitäten angeben, die der Connector verwalten kann. Aktionen, Eingabeparameter und Ausgabeparameter werden daraufhin dynamisch aufgefüllt.

Logik-Apps können basierend auf einer Vielzahl von Datenquellen ausgelöst werden und Connectors anbieten, um Daten als Teil des Datenflusses abzurufen und zu verarbeiten. Sie können den SugarCRM-Connector dem geschäftlichen Workflow hinzufügen und Daten im Rahmen dieses Workflows in einer Logik-App verarbeiten.
...
*Hinweis*: Weitere Informationen über die unterstützten Argumente in Abfragen finden Sie in der [SugarCRM-REST-API](https://msdn.microsoft.com/library/dn705870)-Dokumentation (in englischer Sprache).
...
4.	Erweitern Sie "API-Apps in dieser Ressourcengruppe" im Katalog, um alle verfügbaren API-Apps anzuzeigen. Wählen Sie "SugarCRM" aus dem Katalog aus, damit der "SugarCRM-Connector" dem Datenfluss hinzugefügt wird: ![][3]

5.	Wählen Sie die Aktion "Konto erstellen" aus, und die Eingabeparameter werden angezeigt: ![][4]

6.	Geben Sie als Namen "Microsoft-Konto" an, und klicken Sie auf ✓: ![][5]

7.	Wählen Sie "SugarCRM-Connector" aus dem Abschnitt "Zuletzt verwendet" im Katalog aus. Eine neue SugarCRM-Aktion wird hinzugefügt.

8.	Wählen Sie "Konto aktualisieren" (unter den erweiterten Aktionen "...") aus der Liste der Aktionen aus, und die Eingabeparameter der Aktion "Konto aktualisieren" werden angezeigt: ![][6]

9.	Klicken Sie neben "Datensatz-ID" auf "...", um den ID-Wert aus der Ausgabe der Aktion "Konto erstellen" auszuwählen: ![][7]

10.	Geben Sie Werte für die Abrechnungsadresse an, und klicken Sie auf ✓: ![][8]

11. Klicken Sie im Bildschirm des Logik-App-Editors auf "OK", und klicken Sie dann auf "Erstellen". Es dauert ungefähr 30 Sekunden, bis die Erstellung abgeschlossen ist.

12. Sehen Sie sich die neu erstellte Logik-App an, und klicken Sie auf "Jetzt ausführen", um eine Ausführung zu initiieren.

13. Überprüfen Sie, ob ein neues Konto mit dem Namen "Microsoft-Konto" im SugarCRM-Konto erstellt wurde. Dieses Konto wird auch mit den Abrechnungsadressinformationen aktualisiert.
