...
Die Box-Katalog-App bietet Ihnen Trigger und Aktionen als Mechanismen für die Interaktion mit Box:
...
</table>*Hinweis: Hierdurch werden keine Dateiinhalte zurückgegeben.*
...
</table>*Hinweis: Bei diesem Vorgang wird die Datei nach dem Lesen nicht gelöscht.*
...
Zur Verwendung des Box-Connectors müssen Sie zunächst eine Instanz der Box-Connector-API-App erstellen. Gehen Sie dazu folgendermaßen vor:
