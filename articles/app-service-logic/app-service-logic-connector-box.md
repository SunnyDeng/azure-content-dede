...
1. **Aktionen**: Über die Aktionen können Sie vordefinierte Aktionen für das Box-Konto durchführen, das mit der Logik-App konfiguriert wurde. Im Folgenden sind die Aktionen aufgeführt, die über ein Box-Konto mit dem Box-Connector durchgeführt werden können:
...
Zur Verwendung des Box-Connectors müssen Sie zunächst eine Instanz der Box-Connector-API-App erstellen. Sie können dies innerhalb des Logik-App-Designers als auch außerhalb tun. Außerhalb des Designers erfolgt das Erstellen wie folgt:
...
Sobald Ihre API-App erstellt wurde, können Sie jetzt den Box-Connector als Aktion für Ihre Logik-App verwenden. Gehen Sie hierzu wie folgt vor:
...
3. Wenn der Box-Connector zu Beginn der Logik-App ausgewählt wird, fungiert er als Trigger. Andernfalls können mit dem Connector Aktionen am Box-Konto durchgeführt werden. Beachten Sie, dass der Box-Connector zum Zeitpunkt dieses Artikels über keine Trigger verfügt.
...
7. Die Liste der Aktionen wird angezeigt, und Sie können die entsprechende Operation auswählen, die Sie ausführen möchten.
