...
Der BizTalk JSON Encoder kann als Aktion verwendet werden. Er besitzt keine Trigger.
...
- Der BizTalk JSON Encoder unterstützt nur eine Aktion. Wählen Sie *XML zu JSON*.
