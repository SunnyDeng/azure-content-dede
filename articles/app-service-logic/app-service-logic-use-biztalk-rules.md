...
1. Suchen Sie die erstellte API-App über "Durchsuchen" -> "API-Apps" -> <Your Rules API App>. Das Dashboard der Regel-API-App wird angezeigt und sieht etwa folgendermaßen aus:
