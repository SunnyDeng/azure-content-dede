...
1. Melden Sie sich beim Microsoft Azure [vorschauportal](https://portal.azure.com).
...
Um diese Schritte durchführen zu können, benötigen Sie eine Web-App, mobile App oder Logik-App. Sobald Ihre Anwendung verfügbar ist, fügen Sie die Connectors hinzu. Das geht so:
