...
--- | ---
<ul><li>X12-API-App</li><li>AS2-Connector</li><li>EDIFACT-API-App</li><li>Handelspartnerverwaltungs-API-App</li> | Diese API-Apps bieten Business-to-Business-Funktionen (B2B). [B2B-Connectors](app-service-logic-b2b-connectors.md) bietet weitere Details zu diesen API-Apps.
...
BizTalk XML Validator | Eine API-App vom Typ **Aktion**. Überprüft XML-Daten im Abgleich mit vordefinierten XML-Schemas. Sie können Schemas basierend auf Flatfile-Instanzen, JSON-Instanzen oder vorhandenen Connectors nutzen. 
...
Wenn Sie in Ihrer App die BizTalk-API-Apps im Katalog auswählen, werden sie automatisch Ihrer App hinzugefügt.

Über die folgenden Schritte werden BizTalk-API-Apps Logik-Apps, mobilen Apps oder Web-Apps hinzugefügt:

1. Wechseln Sie im Azure-Portal im Startmenü (auf der Startseite) zu **Marketplace**, und suchen Sie Ihre Logik-, mobilen oder Web-Apps. 
...
3. Fügen Sie über den **Katalog** die von Ihnen erstellte BizTalk-API-App hinzu, die automatisch Ihrer App hinzugefügt wird.
