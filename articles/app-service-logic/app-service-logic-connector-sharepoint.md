...
7. Wenn der SharePoint-Connector als Trigger konfiguriert ist, werden die Trigger angezeigt. Andernfalls wird eine Liste mit Aktionen angezeigt, und Sie können die entsprechende Operation wählen, die Sie ausführen möchten:
<br/>
![][6]
<br/>
