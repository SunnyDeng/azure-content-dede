<properties urlDisplayName="Get Started with Authentication (iOS)" pageTitle="Erste Schritte mit der Authentifizierung (iOS) | Mobile Dev Center" metaKeywords="Azure registering application, Azure authentication, application authenticate, authenticate mobile services, Mobile Services iOS" description="Erfahren Sie, wie Sie Mobile Services verwenden, um die Benutzer Ihrer iOS-App über verschiedene Identitätsanbieter, einschließlich Google, Facebook, Twitter und Microsoft, zu authentifizieren." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Get started with authentication in Mobile Services" authors="krisragh" solutions="" manager="dwrede" editor="" />
...
In diesem Thema wird die Authentifizierung von Benutzern in Azure Mobile Services über Ihre iOS-App veranschaulicht.  In diesem Lernprogramm fügen Sie Authentifizierung mithilfe eines von Mobile Services unterstützten Identitätsanbieters zum Schnellstartprojekt hinzu. Nach der erfolgreichen Authentifizierung und Autorisierung durch Mobile Services wird der Benutzer-ID-Wert angezeigt.  
