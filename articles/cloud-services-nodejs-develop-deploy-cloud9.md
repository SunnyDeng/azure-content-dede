...
Um Cloud9 zu verwenden, müssen Sie zuerst die Website besuchen und sich [für ein Abonnement registrieren](http://cloud9ide.com/). Sie können sich entweder mit einem vorhandenen GitHub- oder BitBucket anmelden, oder ein Cloud9-Konto erstellen. Sie können zwischen einem kostenlosen Angebot sowie einem Bezahlangebot wählen, das mehr Funktionen bietet. Weitere Informationen finden Sie unter [Cloud9-IDE](http://cloud9ide.com/).
