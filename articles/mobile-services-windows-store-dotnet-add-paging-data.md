<properties pageTitle="Optimieren von Mobile Services-Abfragen mit Paging (Windows Store) | Mobile Dev Center" description="Erfahren Sie, wie Sie mithilfe des Auslagerns die Menge der von Ihrer Windows Store-App von Mobile Services zurückgegebenen Daten verwalten können." services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
