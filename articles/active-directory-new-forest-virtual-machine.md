...
- Optional können Sie ein [Standort-zu-Standort-VPN](https://msdn.microsoft.com/library/azure/dn133795.aspx) konfigurieren und dann entweder eine neue Gesamtstruktur installieren oder eine lokale Gesamtstruktur in einem virtuellen Azure-Netzwerk erweitern. Erläuterungen hierzu finden Sie unter [Installieren eines Active Directory-Replikatdomänencontrollers unter virtuellen Netzwerken in Windows Azure](virtual-network/virtual-networks-install-replica-active-directory-domain-controller.md).
...
-  [Konfigurieren eines Standort-zu-Standort-VPN](https://msdn.microsoft.com/library/dn133795.aspx)
