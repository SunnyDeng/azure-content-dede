...
Befolgen Sie anschließend die Anweisungen unter [Installieren und Konfigurieren von Azure PowerShell zum Installieren von Azure PowerShell auf dem lokalen Computer](install-configure-powershell.md).
