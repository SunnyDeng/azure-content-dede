...
# Erste Schritte mit Hadoop 1.2 in HDInsight

<div class="dev-center-tutorial-selector sublanding">
<a href="../hdinsight-get-started" title="Erste Schritte mit Hadoop 2.2 in HDInsight">Hadoop 2.2</a>
<a href="../hdinsight-get-started-31" title="Erste Schritte mit Hadoop 2.4 in HDInsight">Hadoop 2.4</a>
<a href="../hdinsight-get-started-21" title="Erste Schritte mit Hadoop 1.2 in HDInsight" class="current">Hadoop 1.2</a>
</div>
...
In diesem Lernprogramm werden Sie mithilfe des Azure-Verwaltungsportals ein Hadoop-Cluster in HDInsight bereitstellen, einen Hive-Job zur Abfrage einer Hive-Beispieltabelle mithilfe des Cluster-Dashboards übermitteln und anschließend die ausgegebenen Daten des Hive-Jobs für eine Untersuchung in Excel importieren.

> [WACOM.NOTE] In diesem Lernprogramm wird die Verwendung von Hadoop 1.2-Clustern auf HDInsight behandelt. Klicken Sie das Auswahlfeld oben auf der Seite für andere unterstützte Versionen. Versionshinweise finden Sie unter [Neuheiten in den von HDInsight bereitgestellten Clusterversionen][Neuheiten in den von HDInsight bereitgestellten Clusterversionen]
...
4.  Geben Sie auf der Registerkarte "Clusterdetails" die folgenden Werte ein, oder wählen Sie sie aus:
    ...
    | **HDInsight-Version** | Wählen Sie **2,1**, um einen Hadoop 1,2-Cluster in HDInsight zu erstellen.                                                                                                                                                                                                                          |
...
1.  Klicken Sie oben im Cluster-Dashboard auf **Hive-Editor**.
...
-   [Entwickeln von Java MapReduce-Programmen für HDInsight][Entwickeln von Java MapReduce-Programmen für HDInsight]
  ...
  [Hadoop 2.2]: ../hdinsight-get-started "Erste Schritte mit Hadoop 2.2 in HDInsight"
  [Hadoop 2.4]: ../hdinsight-get-started-31 "Erste Schritte mit Hadoop 2.4 in HDInsight"
  [Hadoop 1.2]: ../hdinsight-get-started-21 "Erste Schritte mit Hadoop 1.2 in HDInsight"
