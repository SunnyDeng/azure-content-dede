...
Nachdem die Wiederherstellung abgeschlossen ist, können Sie die wiederhergestellte Datenbank für die Verwendung konfigurieren. Befolgen Sie hierzu die Anleitung [Abschließen einer wiederhergestellten Datenbank](articles/sql-database-recovered-finalize.md).
###PowerShell 
Verwenden Sie PowerShell für eine programmgesteuerte Durchführung der Datenbankwiederherstellung.
