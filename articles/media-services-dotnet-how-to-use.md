<properties pageTitle="Verwenden von Media Services" description="" services="media-services" documentationCenter="" authors="juliako" manager="dwrede" editor=""/>
...
-	[Smooth Streaming Client for Silverlight](http://www.microsoft.com/de-de/download/details.aspx?id=29940) (Smooth Streaming-Client für Silverlight, in englischer Sprache)
...
-	[Smooth Streaming Client SDK for Windows 8](http://go.microsoft.com/fwlink/?LinkID=246146) (in englischer Sprache). Weitere Informationen zum Erstellen einer Windows Store-Anwendung mit diesem SDK finden Sie unter [Erstellen einer Smooth Streaming Windows Store-Anwendung](http://go.microsoft.com/fwlink/?LinkId=271647). Informationen zum Erstellen eines Smooth Streaming-Players in HTML5 finden Sie unter [Walkthrough: Building Your First HTML5 Smooth Streaming Player](http://msdn.microsoft.com/de-de/library/jj573656(v=vs.90)) (Exemplarische Vorgehensweise: Erstellen Ihres ersten HTML5 Smooth Streaming-Players, in englischer Sprache).
...
-	[Microsoft Media-Plattform: Player Framework für Silverlight](http://smf.codeplex.com/documentation)
...
## Nächste Schritte
Nachdem Sie nun einen Überblick über Media Services haben, rufen Sie das Thema [Einrichten Ihres Computers für Media Services](../media-services-set-up-computer/) auf.
  ...
  [Gewusst wie: Programmgesteuertes Verbinden mit Mediendiensten]: #connect
  ...
  [Gewusst wie: Prüfen des Auftragsfortschritts]: #check-job-progress
  ...
  [Gewusst wie: Bereitstellen von Streaminginhalten]: #stream-asset
  [Gewusst wie: Bereitstellen von Apple HLS-Streaminginhalten]: #stream-HLS
