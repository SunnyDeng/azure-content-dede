...
Um die Programmierung mit der Media Services REST-API oder dem Media Services SDK zu beginnen, aktivieren Sie zuerst Ihr Azure-Konto für Media Services, wie unter [Einrichten eines Azure-Kontos für Media Services][Einrichten eines Azure-Kontos für Media Services] beschrieben.

Die aktuelle Media Services SDK-Dokumentation finden Sie [hier][hier].
...
-   **Codieren**. Codieroperationen umfassen das Codieren, Transformieren und Konvertieren von Medienressourcen. Codieraufgaben können in der Cloud mit dem Azure Media Encoder ausgeführt werden. Die folgenden Codieroptionen stehen zur Verfügung:
	...
	-   Große Anzahl unterstützter Dateitypen, -formate und Codecs (siehe [Unterstützte Codecs und Dateitypen für Windows Azure Media Encoder][Unterstützte Codecs und Dateitypen für Windows Azure Media Encoder])
...
Nachdem Sie nun einen Überblick über Media Services haben, rufen Sie das Thema [Einrichten Ihres Computers für die Media Services-Entwicklung][Einrichten Ihres Computers für die Media Services-Entwicklung] auf.
  ...
  [hier]: http://msdn.microsoft.com/de-de/library/hh973613.aspx
  [Media Services-Architektur]: ./media/media-services-dotnet-how-to-use/wams-01.png
  [Unterstützte Codecs und Dateitypen für Windows Azure Media Encoder]: http://msdn.microsoft.com/de-de/library/hh973634
  ...
  [Smooth Streaming Client for Silverlight (Smooth Streaming-Client für Silverlight, in englischer Sprache)]: http://www.microsoft.com/de-de/download/details.aspx?id=29940
  ...
  [Walkthrough: Building Your First HTML5 Smooth Streaming Player]: http://msdn.microsoft.com/de-de/library/jj573656(v=vs.90).aspx
