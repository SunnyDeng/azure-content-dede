  ...
  <tr>
    ...
    <td><p>Liefert einen Vektor aus Samplewerten zurück. Beispiel:</p>
        <ul>
          ...
          <p>$CPUPercent.GetSample(TimeInterval_Minute*10), sollte 200&#160;Samplewerte zurückliefern, wenn alle Samplewerte der letzten zehn Minuten im CPUPercent-Verlauf vorhanden sind. Wenn der Verlauf der letzten Minute noch nicht vorhanden ist, werden nur 180&#160;Samplewerte zurückgegeben.</p>
					<p>$CPUPercent.GetSample (TimeInterval_Minute\ * 10, 80) wird erfolgreich ausgeführt, $CPUPercent.GetSample(TimeInterval_Minute*10, 95) schlägt fehl.</p></li>
