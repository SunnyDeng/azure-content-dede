...
Azure Backup erstellt eine vollständige VSS-Sicherung auf virtuellen Windows-Computern. Weitere Informationen zur [vollständigen VSS-Sicherung](http://blogs.technet.com/b/filecab/archive/2008/05/21/what-is-the-difference-between-vss-full-backup-and-vss-copy-backup-in-windows-server-2008.aspx) (in englischer Sprache). Um die VSS-Kopiesicherungen zu aktivieren, müssen die folgenden Registrierungsschlüssel auf dem virtuellen Computer festgelegt werden.
