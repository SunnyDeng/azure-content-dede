...
<div class="dev-center-tutorial-selector sublanding"><a href="/de-de/documentation/articles/role-based-access-control-powershell.md" title="Windows PowerShell" class="current">Windows PowerShell</a><a href="/de-de/documentation/articles/role-based-access-control-xplat-cli.md" title="Cross-Platform CLI">Plattformübergreifende Befehlszeilenschnittstelle</a></div>
...
- Azure PowerShell, Version 0.8.8 oder höher. Informationen zum Installieren der aktuellen Version und zum Verknüpfen mit dem Azure-Abonnement finden Sie unter [Installieren und Konfigurieren von Windows Azure PowerShell](http://azure.microsoft.com/documentation/articles/install-configure-powershell/).
...
- [Verwenden von Windows PowerShell mit dem Ressourcen-Manager](http://azure.microsoft.com/documentation/articles/powershell-azure-resource-manager/)
...
Weitere Informationen finden Sie unter [Verwenden von Windows PowerShell mit dem Ressourcen-Manager](http://azure.microsoft.com/documentation/articles/powershell-azure-resource-manager/).
...
Wenn Sie über mehrere Abonnements verfügen und ein anderes Abonnement abrufen möchten, geben Sie Folgendes ein:
    ...
    # Verwenden Sie den Abonnementnamen, um das Abonnement auszuwählen, das Sie bearbeiten möchten.
    PS C:> Select-AzureSubscription -SubscriptionName <subscription name>

Weitere Informationen finden Sie unter [Installieren und Konfigurieren von Azure PowerShell](http://azure.microsoft.com/documentation/articles/install-configure-powershell/).
...
- Welcher Bereich soll zugewiesen werden: Sie können aus den folgenden drei Bereichsebenen auswählen:
    ...
    - Eine Ressourcengruppe. Um eine Liste der Ressourcengruppen zu erhalten, geben Sie Folgendes ein: `PS C:> Get-AzureResourceGroup`
    - Eine Ressource. Um eine Liste der Ressourcen zu erhalten, geben Sie Folgendes ein: `PS C:> Get-AzureResource`

Verwenden Sie `New-AzureRoleAssignment`, um eine Rollenzuweisung zu erstellen. Beispiel:
...
Wenn sie versuchen, andere Cmdlets wie z. B. `New-AzureResourceGroup` auszuführen, wird ein Zugriffsverweigerungsfehler ausgegeben, wenn Sie nicht über die Berechtigung verfügen.
...
- [Konfigurieren der rollenbasierten Zugriffssteuerung mit XPLAT-CLI](http://azure.microsoft.com/documentation/articles/role-based-access-control-xplat-cli/)
