...
[Was ist der Anwendungsblock für die automatische Skalierung?][]
 ...
 [Gewusst wie: Instanziieren und Ausführen der automatischen Skalierung][]
 [Gewusst wie: Definieren des Dienstmodells][]
...
<a id="PerfCounter">Sammeln von Leistungsindikatordaten in der Azure-Zielanwendung
--------------------------------------------------------------
...
Ihr Projekt muss .NET Framework 4 als Ziel haben. So ändern oder überprüfen Sie das Zielframework:
...
-   **[subscriptionid]:** Die eindeutige ID des Azure-Abonnements, das die Anwendung enthält, in der Sie die automatische Skalierung verwenden möchten.
    ...
    2.  Klicken Sie in der Liste der Cloud-Dienste auf den Dienst, der die Anwendung hostet, in der Sie die automatische Skalierung verwenden möchten. Im Bereich "Schnelleinsicht" auf der rechten Seite wird die **Abonnement-ID** angezeigt.
...
Das folgende Codebeispiel enthält ein Beispiel für einen Regelsatz in der Datei **rules.xml**:
    ...
    <rules xmlns="http://schemas.microsoft.com/practices/2011/entlib/autoscaling/rules">
      <constraintRules>
        <rule name="default" enabled="true" rank="1" description="Die Standard-Einschränkungsregel">
          <actions>
      ...
      <reactiveRules>
        <rule name="ScaleUpOnHighUtilization" rank="10" description="Webrolle hochskalieren" enabled="true" >
          <when>
            <any>
        ...
        <rule name="ScaleDownOnLowUtilization" rank="10" description="Webrolle runterskalieren" enabled="true" >
          <when>
            <all>
...
4.  Erweitern Sie den Abschnitt **Autoscaling Settings**, sodass die Abschnitte **Regelspeicher** und **Service Information Store** angezeigt werden. Standardmäßig sind sie für die Verwendung des Azure-Blob-Speichers konfiguriert:
...
6.  Geben Sie in das Feld **Dateiname** den Dateinamen **rules.xml** ein. Dies ist der Name der Datei, welche die Regeln für die automatische Skalierung enthält:
...
8.  Geben Sie in das Feld **Dateiname** den Dateinamen **services.xml** ein. Dies ist der Name der Datei, welche die Regeln für die automatische Skalierung enthält:
...
Jetzt können Sie die Host-Konsolenanwendung für den Anwendungsblock für die automatische Skalierung ausführen und beobachten, wie die Regeln für die automatische Skalierung in der Azure-Zielanwendung arbeiten. Wenn Sie die Host-Konsolenanwendung ausführen, werden in Visual Studio im Ausgabefenster Meldungen ähnlich den folgenden angezeigt. Diese Protokollmeldungen helfen Ihnen, das Verhalten des Blocks zu verstehen. Sie geben z. B. an, welche Regeln dem Block entsprechen und welche Aktionen der Block ausführt.
    ...
    "MatchingRules":[{"RuleName":"default","RuleDescription":"die Standard-Einschränkungsregel",
    "Targets":["AutoscalingApplicationRole"]},{"RuleName":"ScaleUp","RuleDescription":"Webrolle hochskalieren",
    "Targets":[]},{"RuleName":"ScaleDown","RuleDescription":"Webrolle hochskalieren","Targets":[]}]}

    Autoscaling Updates Verbose: 3001 : Die aktuelle Bereitstellungskonfiguration für einen gehosteten Dienst wird geprüft,
    um festzustellen, ob eine Änderung erforderlich ist (für Rollenskalierung oder Änderungen an Einstellungen).
    [BEGIN DATA]{"EvaluationId":"6b27dfa0-b671-44a3-adf1-bb1e0b7c3726",
    ...
    Autoscaling Updates Verbose: 3003 : Rollenskcalierungsanfragen für gehosteten Service, die gesendet werden sollen.
    [BEGIN DATA]{"EvaluationId":"6b27dfa0-b671-44a3-adf1-bb1e0b7c3726",
    "HostedServiceDetails":{"Subscription":"AutoscalingHowTo","HostedService":"autoscalingtarget",
    ...
    Informationen zu Aktualisierungen der automatischen Skalierung: 3002 : Rollenkonfigurationsänderungen für Bereitstellung wurden gesendet.
    [BEGIN DATA]{"EvaluationId":"6b27dfa0-b671-44a3-adf1-bb1e0b7c3726",
    "HostedServiceDetails":{"Subscription":"AutoscalingHowTo","HostedService":"autoscalingtarget",
    "DeploymentSlot":"Staging"},"ScaleRequests":{"AutoscalingApplicationRole":{"Min":2,"Max":6,"AbsoluteDelta":0,
    "RelativeDelta":0,"MatchingRules":"default"}},"SettingChangeRequests":{},
...
[Verwenden von Leistungsindikatoren in Azure]: http://azure.microsoft.com/de-de/documentation/articles/cloud-services-dotnet-use-performance-counters/?fb=de-de 
