<properties title="How to make a phone call from Twilio (PHP) - Azure" pageTitle="Tätigen eines Anrufs mit Twilio (PHP) - Azure" metaKeywords="Azure PHP Twilio, Azure Twilio, Azure-Telefonanrufe, Twilio in Azure, Azure-SMS, SMS in Azure, Azure-Sprachanrufe, Sprachanrufe in Azure, Azure-Textnachrichten, Textnachrichten in Azure, PHP Twilio Azure" description="Erfahren Sie, wie Sie mit dem Twilio API-Dienst in Azure einen Telefonanruf tätigen und eine SMS-Nachricht senden. Die Beispiele beziehen sich auf die PHP-Anwendung." documentationCenter="PHP" services="" solutions="" videoId="" scriptId="" authors="MicrosoftHelp@twilio.com; robmcm" manager="twilio" editor="mollybos" />
