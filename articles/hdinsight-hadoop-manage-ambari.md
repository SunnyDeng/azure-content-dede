...
* **Authentifizierung**: Für die Authentifizierung beim Dienst sollten der Benutzername (Standardeinstellung ist **admin**) und das Kennwort des Clusteradministrators verwendet werden.
