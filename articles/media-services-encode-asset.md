<properties urlDisplayName="How to Encode an Asset" pageTitle="Codieren von Medienobjekten in Media Services &ndash; Azure" metaKeywords="" description="Erfahren Sie, wie Sie Medieninhalte in Media Services mithilfe des Azure Media Encoder codieren k&ouml;nnen. Die Codebeispiele sind in C# geschrieben und verwenden das Media Services SDK f&uuml;r .NET." metaCanonical="" services="media-services" documentationCenter="" title="Gewusst wie: Codieren von Medienobjekten" authors="juliako" solutions="" manager="dwrede" editor="" />

<tags ms.service="media-services" ms.workload="media" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="01/01/1900" ms.author="juliako" />

# Gewusst wie: Codieren von Medienobjekten

Dieser Artikel ist Teil einer Reihe zum Thema Programmierung von Azure-Mediendiensten. Das vorherige Thema war [Vorgehensweise: Abrufen eines Medienprozessors][Vorgehensweise: Abrufen eines Medienprozessors].

Sie können Medieninhalte auf dem Server mit dem Azure Media Encoder in verschiedenen Medien-Codierungen und Formaten codieren. Außerdem können Sie Codierer von Mediendienste-Partnern verwenden. Externe Codierer finden Sie im [Azure Marketplace][Azure Marketplace]. Sie können die Details von Codierungsaufgaben entweder mit [Voreinstellungs][Voreinstellungs]-Zeichenfolgen oder über Konfigurationsdateien angeben.
...
-   [Verarbeiten von Medienobjekten mit dem Mediendienste-SDK für .NET][Verarbeiten von Medienobjekten mit dem Mediendienste-SDK für .NET]
-   [Verarbeiten von Medienobjekten mit der Mediendienste-REST-API][Verarbeiten von Medienobjekten mit der Mediendienste-REST-API]

</p>
## Nächste Schritte

Sie sind nun in der Lage, einen Auftrag zur Codierung von Medienobjekten zu erstellen und können mit dem Thema [Prüfen des Auftragsfortschritts mit Media Services][Prüfen des Auftragsfortschritts mit Media Services] fortfahren.

  [Vorgehensweise: Abrufen eines Medienprozessors]: ../media-services-get-media-processor/
  [Azure Marketplace]: https://datamarket.azure.com/
  [Voreinstellungs]: http://msdn.microsoft.com/de-de/library/hh973610.aspx
  [Zeichenfolgen für vordefinierte Einstellungen für Aufgaben für Azure Media Encoder]: http://msdn.microsoft.com/de-de/library/jj129582.aspx
  [Voreinstellungen für Aufgaben für Azure Media Packager]: http://msdn.microsoft.com/de-de/library/windowsazure/hh973635.aspx
  [Verarbeiten von Medienobjekten mit dem Mediendienste-SDK für .NET]: http://msdn.microsoft.com/de-de/library/jj129580.aspx
  [Verarbeiten von Medienobjekten mit der Mediendienste-REST-API]: http://msdn.microsoft.com/de-de/library/jj129574.aspx
  [Prüfen des Auftragsfortschritts mit Media Services]: ../media-services-check-job-progress/
