...
| :---------------- | :------------------------------------------- | :----------------- |
| Sitzung | Gleichzeitig geöffnete Sitzungen | 1024<br/><br/>Wir unterstützen maximal 1.024 aktive Verbindungen, die gleichzeitig Anforderungen an das Data Warehouse übermitteln können. Beachten Sie, dass die Anzahl der Abfragen, die gleichzeitig ausgeführt werden können, begrenzt ist. Wenn ein Grenzwert überschritten wird, gelangt die Anforderung in eine interne Warteschlange, in der sie auf die Verarbeitung wartet.|
