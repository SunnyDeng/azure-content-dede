...
Verwenden von Rootberechtigungen auf virtuellen Linux-Computern in Azure
========================================================================
...
In diesem Fall wird der Benutzer **nicht** zur Eingabe eines Kennworts aufgefordert. Nachdem `<enter>` gedrückt wurde, führt `sudo` den Befehl mit `root`-Berechtigungen aus.
