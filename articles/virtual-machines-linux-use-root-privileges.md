...
In diesem Fall wird der Benutzer **nicht** zur Eingabe eines Kennworts aufgefordert. Nachdem das `<enter>` gedrückt wurde, führt `sudo` den Befehl mit `root`-Berechtigungen aus.
