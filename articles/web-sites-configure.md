...
Der vollständige Name der FTP-Benutzer "App\username" wo ist *app* ist der Name der Webanwendung. Der Benutzername, finden Sie in der Web-app-Blade unter **Essentials**.  
...
Im Modus "Basic" oder "Standard" können Sie SSL-Zertifikate für benutzerdefinierte Domänen hochladen. Weitere Informationen finden Sie unter [HTTPS für eine Webanwendung aktivieren](web-sites-configure-ssl-certificate.md). 

Klicken Sie zum Anzeigen der hochgeladenen Zertifikate auf **Alle Einstellungen** > **Custom domains and SSL**.
...
Klicken Sie zum Anzeigen des Domänennamens auf **Alle Einstellungen** > **Custom domains and SSL**.
...
- Bereitstellungsslots. Weitere Informationen finden Sie unter [Bereitstellen von Web-Apps in Azure App Service in Stagingslots](web-sites-staged-publishing.md)
