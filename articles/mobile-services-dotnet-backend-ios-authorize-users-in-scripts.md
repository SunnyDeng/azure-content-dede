<properties pageTitle="Dienstseitige Autorisierung (iOS) | Mobile Dev Center" metaKeywords="" description="Erfahren Sie, wie Sie Benutzer im .NET-Backend von Azure Mobile Services autorisieren." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Service-side authorization of Mobile Services users" authors="krisragh" solutions="" manager="dwrede" editor="" />
...
1. Öffnen Sie in Xcode das Projekt, das Sie im Lernprogramm [Erste Schritte mit der Authentifizierung] verändert haben.
