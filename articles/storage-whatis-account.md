...
- Weitere Informationen über Azure Storage finden Sie in der entsprechenden Dokumentation auf [azure.com](http://azure.microsoft.com/de-de/documentation/services/storage/) und auf [MSDN](http://msdn.microsoft.com/de-de/library/gg433040.aspx). 
