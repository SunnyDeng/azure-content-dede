<properties urlDisplayName="Upload a Linux VHD" pageTitle="Erstellen und Hochladen einer Linux-VHD in Azure" metaKeywords="Azure VHD, uploading Linux VHD" description="Erfahren Sie, wie Sie eine virtuelle Azure-Festplatte (Virtual Hard Disk, VHD) erstellen und hochladen, die ein Linux-Betriebssystem enth&auml;lt." metaCanonical="" services="virtual-machines" documentationCenter="" title="Erstellen und Hochladen einer virtuellen Festplatte, die ein Linux-Betriebssystem enth&auml;lt" authors="kathydav" solutions="" manager="timlt" editor="tysonn" />
...
**Wichtig**: Das Azure-Plattform-SLA gilt für virtuelle Computer unter dem Betriebssystem Linux nur dann, wenn eine der [bestätigten Distributionen][bestätigten Distributionen] verwendet wird. Alle Linux-Distributionen, die in der Azure-Image-Galerie bereitgestellt werden, sind bestätigte Distributionen mit der erforderlichen Konfiguration.

-   [Linux auf Azure-unterstützten Distributionen][bestätigten Distributionen]
-   [Unterstützung für Linux-Bilder in Microsoft Azure][Unterstützung für Linux-Bilder in Microsoft Azure]
...
Daher wird empfohlen, dass Sie nach Möglichkeit mit einem unserer [Linux auf Azure-unterstützten Distributionen][Linux auf Azure-unterstützten Distributionen] beginnen. Die folgenden Artikel führen Sie durch die Vorbereitung der verschiedenen bestätigten Linux-Distributionen, die auf Azure unterstützt werden:
...
-   [ata\_piix: defer disks to the Hyper-V drivers by default][ata\_piix: defer disks to the Hyper-V drivers by default] (Standardmäßiges Rückstellen von Datenträgern zu Hyper-V-Treibern) (in englischer Sprache)
-   [storvsc: Account for in-transit packets in the RESET path][storvsc: Account for in-transit packets in the RESET path] (Konto für Pakete auf dem Transportweg im RESET-Pfad) (in englischer Sprache)

## Der Azure Linux-Agent

Der [Azure Linux-Agent][Azure Linux-Agent] (waagent) ist für die entsprechende Bereitstellung eines virtuellen Linux-Computers in Azure erforderlich. Unter [Linux Agent GitHub repo][Linux Agent GitHub repo] können Sie die neueste Version abrufen, Probleme einreichen oder Pull-Anforderungen senden.
...
-   Installieren des Azure Linux-Agents
    ...
    Der Azure Linux-Agent ist für das Bereitstellen eines Linux-Images auf Azure erforderlich. Viele Distributionen stellen den Agent als ein RPM- oder DEB-Paket (das Paket heißt für gewöhnlich „WALinuxAgent“ oder „walinuxagent“) bereit. Der Agent kann zudem manuell installiert werden, indem die folgenden Schritte im [Linux Agent Guide][Azure Linux-Agent] eingehalten werden.
...
-   Sie müssen den virtuellen Computer anschließend herunterfahren und die virtuelle Festplatte in Azure hochladen.
  ...
  [bestätigten Distributionen]: ../virtual-machines-linux-endorsed-distributions
  [Unterstützung für Linux-Bilder in Microsoft Azure]: http://support2.microsoft.com/kb/2941892
  [Linux auf Azure-unterstützten Distributionen]: ../linux-endorsed-distributions
  ...
  [hier]: http://go.microsoft.com/fwlink/p/?LinkID=254263&clcid=0x409
  ...
  [Linux Agent GitHub repo]: https://github.com/Azure/WALinuxAgent
