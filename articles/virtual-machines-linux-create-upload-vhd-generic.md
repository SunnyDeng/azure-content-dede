...
- [Linux auf Azure - unterstützte Verteilungen](virtual-machines-linux-endorsed-distributions.md)
...
Daher wird empfohlen, dass Sie nach Möglichkeit mit einer unserer [unterstützten Linux-Verteilungen auf Azure](linux-endorsed-distributions.md) beginnen. Die folgenden Artikel führen Sie durch die Vorbereitung der verschiedenen unterstützten Linux-Verteilungen, die auf Azure unterstützt werden:
...
Der [Azure Linux Agent](virtual-machines-linux-agent-user-guide.md) (waagent) ist für die entsprechende Bereitstellung eines virtuellen Linux-Computers in Azure erforderlich. Unter [Linux Agent-GitHub-Repository](https://github.com/Azure/WALinuxAgent) können Sie die neueste Version abrufen, Probleme einreichen oder Pull-Anforderungen senden.
