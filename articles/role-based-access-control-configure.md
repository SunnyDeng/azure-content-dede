...
Wir unterstützen nun die rollenbasierte Zugriffssteuerung (RBAC) über das Azure-Vorschauportal, damit Organisationen ihren Zugriffsverwaltungsanforderungen einfach und präzise nachkommen können. Lesen Sie diesen [Blogeintrag][Blogeintrag], um sich mit dieser Funktion vertraut zu machen und eine rasche Einführung zu erhalten. Die Konzepte werden detailliert beschrieben und an zusätzlichen Anwendungsfällen verdeutlicht.

<!--Table of contents for topic, the words in brackets must match the heading wording exactly-->

## Inhaltsverzeichnis

-   [RBAC in Azure][RBAC in Azure]
-   [Koexistenz von RBAC mit Abonnement-Co-Administratoren][Koexistenz von RBAC mit Abonnement-Co-Administratoren]
-   [Autorisierung für Verwaltungsvorgänge vs. Datenvorgänge][Autorisierung für Verwaltungsvorgänge vs. Datenvorgänge]
-   [Hinzufügen und Entfernen von Zugriffsrechten][Hinzufügen und Entfernen von Zugriffsrechten]
-   [Bekannte Probleme bei der Verwendung der rollenbasierten Zugriffssteuerung][Bekannte Probleme bei der Verwendung der rollenbasierten Zugriffssteuerung]
...
-   [Zugriff hinzufügen][Zugriff hinzufügen]
-   [Zugriff entfernen][Zugriff entfernen]
-   [Zugriff für externe Benutzer hinzufügen und entfernen][Zugriff für externe Benutzer hinzufügen und entfernen]
...
Weitere Informationen über das Hinzufügen und Entfernen von Zugriffsrechten mit Windows PowerShell finden Sie unter [Verwalten der rollenbasierten Zugriffssteuerung mit Windows PowerShell][Verwalten der rollenbasierten Zugriffssteuerung mit Windows PowerShell].
...
Wenn Sie während der Testphase bei der Verwendung der rollenbasierten Zugriffssteuerung auf Probleme stoßen, finden Sie unter [Behandlung von Problemen bei der rollenbasierten Zugriffssteuerung][Behandlung von Problemen bei der rollenbasierten Zugriffssteuerung] bekannte Probleme, die mit dem vorliegenden Problem in Zusammenhang stehen können.

## <span id="feedback"></span></a>Feedback geben

Wir bitten Sie, Azure RBAC zu testen und uns [Feedback][Feedback] zu senden.
...
-   [Verwalten der rollenbasierten Zugriffssteuerung mit Windows PowerShell][Verwalten der rollenbasierten Zugriffssteuerung mit Windows PowerShell]
-   [Verwalten der rollenbasierten Zugriffssteuerung mit xplat-cli][Verwalten der rollenbasierten Zugriffssteuerung mit xplat-cli]
...
-   [Azure Active Directory Premium und Basic][Azure Active Directory Premium und Basic]
-   [Verknüpfung von Azure-Abonnements mit Azure AD][Verknüpfung von Azure-Abonnements mit Azure AD]
-   Eine Einführung zur Self-Service-Gruppenverwaltung von Sicherheitsgruppen finden Sie im [Active Directory Team-Blog][Active Directory Team-Blog].

<!--Image references-->

  [Blogeintrag]: http://go.microsoft.com/fwlink/?LinkId=511576
  ...
  [jan@outlook.com]: mailto:joe@outlook.com
  [Verzeichnisintegration]: http://technet.microsoft.com/library/jj573653.aspx
  [Funktion zur delegierten Gruppenverwaltung]: http://msdn.microsoft.com/library/azure/dn641267.aspx
  ...
  [Feedback]: http://aka.ms/azurerbacfeedback
  ...
  [Active Directory Team-Blog]: http://blogs.technet.com/b/ad/archive/2014/02/24/more-preview-enhancements-for-windows-azure-ad-premium.aspx
