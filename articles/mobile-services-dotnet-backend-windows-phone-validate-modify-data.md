<properties pageTitle="Verwenden des .Net-Back-End zum Prüfen und Ändern von Daten (Windows Phone 8) | Mobile Dev Center" description="Erfahren Sie, wie Sie Daten für Ihre Windows Phone-App mit dem .NET-Back-End von Microsoft Azure Mobile Services überprüfen, ändern und vergrößern." services="mobile-services" documentationCenter="windows" authors="wesmc7777" manager="dwrede" editor=""/>
