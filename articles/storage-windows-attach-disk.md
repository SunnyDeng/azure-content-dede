<properties urlDisplayName="Attach a disk" pageTitle="Anf&uuml;gen eines Datentr&auml;gers an einen virtuellen Computer | Azure" metaKeywords="Azure Windows virtual machine, Azure attach disk, Azure initialize disk" description="Erfahren Sie, wie Sie einen Datentr&auml;ger an einen virtuellen Azure-Computer anf&uuml;gen und initialisieren k&ouml;nnen, damit er betriebsbereit ist." metaCanonical="" services="virtual-machines,storage" documentationCenter="" title="Anf&uuml;gen eines Datentr&auml;gers an einen virtuellen Computer" authors="kathydav" solutions="" manager="timlt" editor="tysonn" />
...
-   [Gewusst wie: Initialisieren eines neues Datenträgers unter Windows Server][Gewusst wie: Initialisieren eines neues Datenträgers unter Windows Server]

[WACOM.INCLUDE [howto-attach-disk-windows-linux](../includes/howto-attach-disk-windows-linux.md)]

## <span id="initializeinWS"></span></a>Gewusst wie: Initialisieren eines neues Datenträgers unter Windows Server

1.  Stellen Sie eine Verbindung mit dem virtuellen Computer her. Eine Beschreibung der dafür erforderlichen Schritte finden Sie unter [Anmeldung auf einem virtuellen Windows Server-Computer][Anmeldung auf einem virtuellen Windows Server-Computer].
...
2.  Öffnen Sie nach der Anmeldung im linken Bereich **Server-Manager**, erweitern Sie **Speicherung**, und klicken Sie anschließend auf **Datenträgerverwaltung**.
    ...
    ![Server-Manager öffnen][Server-Manager öffnen]
...
4.  Klicken Sie mit der rechten Maustaste auf den Speicherplatzzuordnungsbereich für Datenträger 2, klicken Sie auf **Neues einfaches Volume**, und beenden Sie anschließend den Assistenten mit den Standardwerten.
    ...
    ![Volume initialisieren][Volume initialisieren]
