...
## Konfigurieren des automatischen Patchens im Azure-Portal

Sie können das [Azure-Portal](http://go.microsoft.com/fwlink/?LinkID=525040&clcid=0x409) zum Konfigurieren des automatisierten Patchens verwenden, wenn Sie einen neuen virtuellen Computer mit SQL Server erstellen.
...
![Automatisches Patchen für SQL im Azure-Portal](./media/virtual-machines-windows-classic-ps-sql-patch/IC778484.jpg)
...
Eine verwandte Funktion für virtuelle SQL Server-Computer in Azure ist die [automatisierte Sicherung für SQL Server auf virtuellen Azure-Computern](virtual-machines-windows-classic-ps-sql-backup.md).

Lesen Sie auch die weiteren [Ressourcen für die Ausführung von SQL Server in Azure Virtual Machines](virtual-machines-windows-classic-sql-overview.md).
