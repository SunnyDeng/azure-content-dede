...
16. Erstellen Sie eine Gruppe von Endpunkten mit Lastenausgleich für die verwalteten virtuellen Computer.
	...
	1. Wählen im [Azure-Portal](https://ms.portal.azure.com/) im Abschnitt **Virtuelle Computer** den ersten verwalteten virtuellen Computer aus (z. B. **MYVM2-MANAGED)**.
