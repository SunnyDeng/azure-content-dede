...
Bearbeiten oder erstellen Sie im "/.ssh"-Verzeichnis die Datei "ssh_config". Geben Sie den IP-Adressbereich des privaten Netzwerks an, das Sie in Azure verwenden:
