...
1. Melden Sie sich nach den Anweisungen der Prozedur [Anmelden bei einem virtuellen Computer über eine Remotedesktopverbindung](virtual-machines-windows-ps-sp-intranet-ph2.md#logon) mit den Anmeldeinformationen des lokalen Administratorkontos an.

2. Gehen Sie jeweils für beide SQL-Server nach den Anweisungen der Prozedur [Initialisieren eines leeren Datenträgers](virtual-machines-windows-ps-sp-intranet-ph2.md#datadisk) vor, um den zusätzlichen Datenträger hinzufügen.
...
Gehen Sie nach den Anweisungen der Prozedur [Anmelden bei einem virtuellen Computer über eine Remotedesktopverbindung](virtual-machines-windows-ps-sp-intranet-ph2.md#logon) vor, um den Mehrheitsknoten des Clusters mit den Anmeldeinformationen eines Domänenkontos anzumelden.

Gehen Sie auf dem Mehrheitsknoten des Clusters nach den Anweisungen der Prozedur [Testen der Konnektivität](virtual-machines-windows-ps-sp-intranet-ph2.md#testconn) vor, um die Konnektivität zu den Standorten in Ihrem Unternehmensnetzwerk zu testen.
