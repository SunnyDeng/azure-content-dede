...
* Automatisieren Sie die VM- und Workloadbereitstellung und die Verwaltung unter Verwendung des [Azure-Ressourcen-Managers](virtual-machines-how-to-automate-azure-resource-manager.md) und der [Azure-Ressourcen-Manager-Vorlagen](http://azure.microsoft.com/en-us/documentation/templates/).
