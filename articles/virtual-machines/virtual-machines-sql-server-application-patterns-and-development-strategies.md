...
|---|---|---|---|
|**Lokale Anwendungsmigration**|Vorhandene Anwendungen bleiben unverändert.|Anwendungen benötigen Web-und Workerrollen.|Vorhandene Anwendungen bleiben unverändert, sind aber geeignet für eigenständige Webanwendungen und Webdienste, die schnelle Skalierbarkeit erfordern.|
