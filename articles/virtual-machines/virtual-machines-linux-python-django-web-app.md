...
1. Standardmäßig hat der neue virtuelle Computer keinen vollständig qualifizierten Domänennamen (FQDN). Sie können einen FQDN erstellen, indem Sie die Anleitung [hier](virtual-machines-linux-portal-create-fqdn.md) befolgen. Dieser Schritt ist optional, um dieses Lernprogramm abzuschließen.
