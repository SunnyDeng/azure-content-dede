...
Der Schwerpunkt dieses Artikels liegt auf dem Erstellen eines Listeners, der den **internen Load Balancer** verwendet. Wenn Sie einen öffentlichen/externen Listener benötigen, finden Sie die entsprechenden Schritte im Artikel zum Einrichten eines [externen Listeners](virtual-machines-windows-classic-ps-sql-ext-listener.md).
