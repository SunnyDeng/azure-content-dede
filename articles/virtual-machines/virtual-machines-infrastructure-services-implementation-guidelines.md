...
> [AZURE.NOTE]Affinitätsgruppen sind veraltet. Ihre Verwendung wird hier nicht beschrieben. Weitere Informationen finden Sie unter [Informationen zu regionalen VNets und Affinitätsgruppen](https://msdn.microsoft.com/library/azure/jj156085.aspx).
