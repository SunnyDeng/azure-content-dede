...
Das Begleitthema für Windows-basierte virtuelle Computer finden Sie unter [Erstellen eines virtuellen Windows-Computers mit Azure PowerShell](virtual-machines-ps-create-preconfigure-windows-vms.md).
