...
Dieser Artikel erläutert, wie Sie eine virtuelle Festplatte (Virtual Hard Disk, VHD) mit einem Betriebssystem hochladen, um sie als Image für die Erstellung von virtuellen Computern zu nutzen. Weitere Informationen zu Datenträgern und Images in Microsoft Azure finden Sie unter [Informationen zu Datenträgern und Images in Azure](http://msdn.microsoft.com/library/azure/jj672979.aspx).
...
5. **OPTIONAL:** Sie können das Add-AzureVMImage-Cmdlet anstelle des Verwaltungsportals verwenden, um die VDH als Image hinzuzufügen. Geben Sie Folgendes in die Azure PowerShell-Konsole ein:
