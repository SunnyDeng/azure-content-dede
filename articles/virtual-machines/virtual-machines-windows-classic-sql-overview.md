...
- [Konfigurieren von AlwaysOn-Verfügbarkeitsgruppen in Azure (GUI)](virtual-machines-windows-classic-portal-sql-availability.md)
...
Weitere Informationen finden Sie unter [Hochverfügbarkeit und Notfallwiederherstellung für SQL Server auf virtuellen Azure-Computern](virtual-machines-windows-classic-sql-dr.md).
...
|AlwaysOn-Verfügbarkeitsgruppen|Verfügbar in SQL Server 2012 und höher. Erfordert [zusätzliche Konfigurationsschritte](virtual-machines-windows-classic-sql-dr.md)
...
- [Migrieren einer Datenbank zu SQL Server auf einer Azure-VM](virtual-machines-windows-classic-migrate-sql.md)
