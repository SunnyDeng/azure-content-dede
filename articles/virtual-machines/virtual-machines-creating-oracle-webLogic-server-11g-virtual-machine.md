<properties 
	pageTitle="Erstellen eines virtuellen Oracle WebLogic Server 12c- und Oracel Database 12c-Computers in Azure" 
	description="Durchlaufen Sie ein Beispiel zum Erstellen eines Oracle WebLogic Server 12c- und Oracle Database 12c-Images unter Windows Server 2012 in Microsoft Azure." 
...
#Erstellen eines virtuellen Oracle WebLogic Server 11g-Computers in Azure
Das folgende Beispiel zeigt, wie Sie einen virtuellen Computer basierend auf einem von Microsoft bereitgestellten Oracle WebLogic Server 11g-Image unter Windows Server 2008 R2 in Azure erstellen.
...
3. Wählen Sie ein Image aus bzw. überprüfen Sie die Informationen zum Image, das Sie auswählen möchten (z. B. empfohlene Mindestgröße), und klicken Sie dann auf "Weiter".
...
7. Beachten Sie, dass die empfohlenen Preiskategorien standardmäßig angezeigt werden. Um alle Konfigurationsoptionen anzuzeigen, klicken Sie oben rechts auf **Alle anzeigen**.
...
6. Klicken Sie auf die **Windows-Schaltfläche Start** und dann auf **Alle Programme**, **Oracle WebLogic**, **WebLogic Server 11g R1**, **Tools** und anschließend auf **Configuration Wizard**.
...
10. Führen Sie im Dialogfeld **Benutzername und Kennwort für Administrator konfigurieren** Folgendes durch:
...
11. Wählen Sie im Dialogfeld **Server-Startmodus und JDK konfigurieren** die Option **Produktionsmodus** aus, wählen Sie das verfügbare JDK aus (oder navigieren Sie ggf. zum gewünschten JDK), und klicken Sie auf **Weiter**.
...
15.	Eine Eingabeaufforderung für **startWebLogic.cmd** wird gestartet. Geben Sie bei Aufforderung Ihren WebLogic-Benutzernamen und ein Kennwort ein.

## Installieren einer Anwendung auf einem virtuellen Oracle WebLogic Server 11g-Computer in Azure

1. Bleiben Sie auf dem virtuellen Computer angemeldet, und speichern Sie das shoppingcart.war-Beispiel unter [http://www.oracle.com/webfolder/technetwork/tutorials/obe/fmw/wls/12c/12-ManageSessions--4478/files/shoppingcart.war](http://www.oracle.com/webfolder/technetwork/tutorials/obe/fmw/wls/12c/12-ManageSessions--4478/files/shoppingcart.war) lokal. Erstellen Sie z. B. einen Ordner mit dem Namen **c:\mywar** und speichern Sie die unter [http://www.oracle.com/webfolder/technetwork/tutorials/obe/fmw/wls/12c/12-ManageSessions--4478/files/shoppingcart.war](http://www.oracle.com/webfolder/technetwork/tutorials/obe/fmw/wls/12c/12-ManageSessions--4478/files/shoppingcart.war) verfügbare WAR-Datei in **c:\mywar**.

2. Öffnen Sie die **WebLogic Server-Verwaltungskonsole**, [http://localhost:7001/console](http://localhost:7001/console). Geben Sie bei Aufforderung Ihren WebLogic-Benutzernamen und ein Kennwort ein.
...
4. Geben Sie unter **Pfad** den Wert `c:\mywar\shoppingcart.war` ein.
...
7. Klicken Sie in der **WebLogic Server-Verwaltungskonsole** auf **Änderungen aktivieren**.
...
9. Um die lokal ausgeführte Warenkorbanwendung zu sehen, öffnen Sie einen Browser mit der URL [http://localhost:7001/shoppingcart](http://localhost:7001/shoppingcart)

10.  Lassen Sie eine eingehende Verbindung über die Firewall für Port 7001 zu.

	1. Bleiben Sie am **virtuellen Computer** angemeldet, klicken Sie auf die **Windows-Schatlfläche Start** und dann auf **Systemsteuerung**, **System und Sicherheit**, **Windows-Firewall** und anschließend auf **Erweiterte Einstellungen**. Die Verwaltungskonsole für **Windows-Firewall mit erweiterter Sicherheit** wird geöffnet.
...
11. Erstellen Sie eines Endpunkts für den virtuellen Computer
