...
![Konfigurieren der automatischen SQL-Sicherung im Azure-Portal](./media/virtual-machines-windows-classic-ps-sql-backup/IC778483.jpg)
...
![Konfigurieren der automatisierten Sicherung im Azure-Portal](./media/virtual-machines-windows-classic-ps-sql-backup/IC792133.jpg)
...
Weitere Informationen zur Sicherung und Wiederherstellung für SQL Server auf Azure-VMs finden Sie im folgenden Thema: [Sicherung und Wiederherstellung für SQL Server auf virtuellen Azure-Computern](virtual-machines-windows-classic-sql-br.md).

Eine verwandte Funktion für SQL Server-VMs in Azure ist die [automatisierte Anwendung von Patches für SQL Server auf virtuellen Azure-Computern](virtual-machines-windows-classic-ps-sql-patch.md).
