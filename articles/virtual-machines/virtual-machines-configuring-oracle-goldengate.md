...
- Sie haben bereits den Überlegungen zu hoher Verfügbarkeit und Notfallwiederherstellung im Thema [Abbilder des virtuellen Oracle-Computers – verschiedene Überlegungen](virtual-machines-miscellaneous-considerations-oracle-virtual-machine-images.md) . Beachten Sie, dass Azure derzeit eigenständige Oracle-Datenbankinstanzen, aber keine Oracle Real Application Clusters (Oracle RAC) unterstützt.
...
- Sie haben zwei virtuelle Computer (VMs) in Azure mit dem von der Plattform bereitgestellten Abbild von Oracle Enterprise Edition auf Windows Server erstellt. Weitere Informationen finden Sie unter [Erstellen eines Oracle-Datenbank 12c virtuellen Computers in Azure](#z3dc8d3c097cf414e9048f7a89c026f80) und [Azure virtuelle Computer](http://azure.microsoft.com/documentation/services/virtual-machines/). Stellen Sie sicher, dass sich die virtuellen Computer im [gleichen Clouddienst](virtual-machines-load-balance.md) und im gleichen [virtuellen Netzwerk](http://azure.microsoft.com/documentation/services/virtual-network/) befinden, um sicherzustellen, dass sie über die permanente private IP-Adresse aufeinander zugreifen können.
...
Öffnen Sie das SQL* Plus-Eingabeaufforderungsfenster mit Administratorrechten für die Datenbank, wie z. B. **SYSDBA** an Standort A und Standort B:
