...
Ein virtueller Computer in Azure führt das Betriebssystem basierend auf dem Image aus, das Sie beim Erstellen auswählen. Diese Images werden im VHD-Format unter einem Speicherkonto in .vhd-Dateien gespeichert. Weitere Informationen finden Sie unter [Datenträger in Azure](virtual-machines-linux-about-disks-vhds.md) und [Images in Azure](virtual-machines-linux-classic-about-images.md).


Wenn Sie den virtuellen Computer erstellen, können Sie einige Betriebssystemeinstellungen anpassen, damit sie für die Anwendung geeignet sind, die Sie ausführen möchten. Anweisungen hierzu finden Sie unter [Erstellen eines benutzerdefinierten virtuellen Computers](virtual-machines-windows-classic-createportal.md).
...
Beachten Sie auch die **[Installationshinweise für Linux](virtual-machines-linux-create-upload-generic.md#linuxinstall)**. Dort erhalten Sie weitere Tipps zur Vorbereitung der Linux-Images für Azure.
