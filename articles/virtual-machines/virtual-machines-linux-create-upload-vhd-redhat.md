...
12.	Installieren Sie den Azure Linux Agent, indem Sie den folgenden Befehl ausführen:
    ...
    **Hinweis:** Durch eine Installation des WALinuxAgent-Pakets werden die NetworkManager- und NetworkManager-gnome-Pakete entfernt, sofern sie nicht bereits wie in Schritt 2 beschrieben entfernt wurden.
...
18.	Konvertieren Sie das qcow2-Image in das vhd-Format: Konvertieren Sie das Bild zuerst in das raw-Format:
...
## Automatisches Vorbereiten aus einer ISO-Datei mit einer Kickstart-Datei
