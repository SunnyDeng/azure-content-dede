...
Die schnellste Möglichkeit für die ersten Schritte mit [Docker] besteht darin, Azure Marketplace aufzurufen und einen virtuellen Computer mit der Imagevorlage **Docker on Ubuntu Server** zu erstellen, die von [Canonical] in Verbindung mit [MSOpenTech] erstellt wurde. Damit wird eine Ubuntu Server-VM erstellt und automatisch die [Docker-VM-Erweiterung](virtual-machines-linux-dockerextension.md) zusammen mit dem **neuesten** Docker-Modul, das bereits auf Azure installiert und aktiv ist, installiert.
...
> [AZURE.NOTE]Der mit der Azure Marketplace-Vorlage erstellte virtuelle Computer ist kein Host für die Remote-API von Docker zur Verwaltung eines Remote-Docker-Clients. Informationen zur Remotesteuerung des Docker-Hosts auf diesem virtuellen Computer finden Sie unter [Running Docker with HTTPS](https://docs.docker.com/articles/https/) (Ausführen von Docker mit https) (in englischer Sprache). Sie können auch die Schritte unter [Verwenden der Docker-VM-Erweiterung mithilfe des klassischen Azure-Portals ](virtual-machines-linux-classic-portal-use-docker.md) oder [Verwenden der Docker-VM-Erweiterung über die Azure-CLI](virtual-machines-linux-classic-cli-use-docker.md) ausführen.
<!-- -->
Wenn Sie den virtuellen Azure-Docker-Computer aus Windows automatisieren möchten, können Sie [die Docker-Toolbox installieren](https://docs.docker.com/installation/windows/) oder „Docker.exe“ von [Chocolatey](https://chocolatey.org/packages/docker) abrufen.
...
> ![Wählen Sie das Docker Ubuntu-Image im Banner](./media/virtual-machines-linux-classic-docker-quickstart/CreateNewDockerBanner.png)

2. Ist dies jedoch nicht der Fall, suchen Sie im Imagekatalog danach:

> ![Suchen Sie das Image in der Bildergalerie](./media/virtual-machines-linux-classic-docker-quickstart/DockerOnUbuntuServerMSOpenTech.png)
...
> ![Konfigurieren Sie die VM-Instanz](./media/virtual-machines-linux-classic-docker-quickstart/CreateVMDockerUbuntuPwd.png)

4. Warten Sie die Ausführung ab. Es sollte nicht all zu lange dauern.

> ![Im Verwaltungsportal ausgeführtes Docker-Image](./media/virtual-machines-linux-classic-docker-quickstart/DockerUbuntuRunning.png)
...
> ![Herstellen einer Verbindung mit SSH](./media/virtual-machines-linux-classic-docker-quickstart/SSHToDockerUbuntu.png)
...
> ![Abrufen von Images](./media/virtual-machines-linux-classic-docker-quickstart/DockerPullSmallImages.png)
