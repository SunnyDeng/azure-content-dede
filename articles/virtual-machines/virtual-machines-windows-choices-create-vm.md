...
Informationen zur Azure-Befehlszeilenschnittstelle finden Sie unter [Befehlsentsprechungen für den Ressourcen-Manager und die Dienstverwaltung für Aufgaben für virtuelle Computer mit der Azure-Befehlszeilenschnittstelle für Mac, Linux und Windows][]. Informationen zum Verwenden einer Vorlage finden Sie unter [Bereitstellen und Verwalten von virtuellen Computern mit Azure-Ressourcen-Manager-Vorlagen und der Azure-CLI][].

Informationen zu Azure PowerShell finden Sie unter [Verwenden von Azure PowerShell zum Erstellen und Vorabkonfigurieren Windows-basierter virtueller Computer][]. Informationen zum Verwenden einer Vorlage finden Sie unter [Bereitstellungen und Verwalten von virtuellen Computern mit Azure-Ressourcen-Manager und PowerShell][]. Informationen zum Erstellen virtueller Computer im Dienstverwaltungsstapel finden Sie unter [Verwenden von Azure PowerShell zum Erstellen und Vorabkonfigurieren Windows-basierter virtueller Computer][].
...
[Bereitstellungen und Verwalten von virtuellen Computern mit Azure-Ressourcen-Manager und PowerShell]: virtual-machines-deploy-rmtemplates-powershell.md
