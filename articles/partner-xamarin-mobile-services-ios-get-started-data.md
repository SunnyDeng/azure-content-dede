<properties urlDisplayName="Get Started with Data" pageTitle="Erste Schritte mit Daten (Xamarin.iOS) - Azure Mobile Services" metaKeywords="Azure Xamarin.iOS Daten, Azure mobile services Daten, " description="Learn how to store and access data from your Azure Mobile Services Xamarin.iOS app." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Get started with data in Mobile Services" authors="donnam" manager="dwrede" services="mobile-services"/>
