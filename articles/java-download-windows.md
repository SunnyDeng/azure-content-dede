<properties urlDisplayName="Download for Windows" pageTitle="Herunterladen des Azure SDK für Java (Windows)" metaKeywords="Azure SDK Java, Azure Java Maven, Azure Maven, Azure plugin for Eclipse, Azure Eclipse Java" description="Laden Sie das Azure SDK für Java herunter. Der Code wird für Maven bereitgestellt. Die Installationsschritte werden für das Azure-Plug-In für Eclipse mit Java bereitgestellt." metaCanonical="" disqusComments="1" umbracoNaviHide="1" services="" documentationCenter="Java" title="Download the Azure SDK for Java" authors="robmcm" solutions="" manager="wpickett" editor="mollybos" scriptId="" videoId="" />
