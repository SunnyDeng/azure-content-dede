<properties
	pageTitle="Exemplarische Vorgehensweisen für Cloud Data Science Process | Azure" 
	description="Exemplarische Vorgehensweisen für Cloud Data Science Process" 
	metaKeywords="" 
...
In diesem Artikel werden die Cloud Data Science Process-Zuordnung sowie einige Quell- und Zielszenarien mit Beispieldaten erläutert. Das Beispiel veranschaulicht einige der Optionen und Verarbeitungssequenzen auf Grundlage von Datenmerkmalen, Quellspeicherort und Zielrepositorys in Azure. Der Cloud Data Science Process-Ablauf für die Beispielszenarien wird im letzten Abschnitt zusammengefasst.

[AZURE.INCLUDE [machine-learning-free-trial](../includes/machine-learning-free-trial.md)]

**Für alle Szenarien ist Folgendes erforderlich:**
...
- [Szenario 1: Kleines bis mittelgroßes tabellarisches Dataset in lokalen Dateien](#smalllocal)
- [Szenario 2: Kleines bis mittelgroßes Dataset in lokalen Dateien, das verarbeitet werden muss](#smalllocalprocess)
- [Szenario 3: Großes Dataset in lokalen Dateien, Ziel-Azure-Blobs](#largelocal)
- [Szenario 4: Kleines bis mittelgroßes Dataset in lokalen Dateien, Ziel-SQL Server in Azure VM](#smalllocaltodb)
- [Szenario 5: Großes Dataset in lokalen Dateien, Ziel-SQL Server in Azure VM](#largelocaltodb)
- [Szenario 6: Großes Dataset in einer lokalen SQL Server-Datenbank, Ziel-SQL Server in Azure VM](#largedbtodb)
- [Szenario 7: Big Data in lokalen Dateien, Zielstrukturdatenbank in Azure HDInsight Hadoop-Clustern](#largedbtohive)
...
## <a name="smalllocaltodb"></a>Szenario 4: Kleines bis mittelgroßes Dataset lokaler Dateien, das auf SQL Server in Azure Virtual Machine ausgerichtet ist
...
4.  Laden Sie Daten in einer SQL Server-Datenbank, die auf einem virtuellen Azure-Computer ausgeführt wird.
    ...
    a. Melden Sie sich beim virtuellen SQLServer-Computer an.
...
Zusammenfassung der Beispielszenarien
------------------------

Im folgenden Diagramm werden die oben beschriebenen Szenarien und die in den einzelnen Szenarien getroffenen Cloud Data Science Process-Auswahlen zusammengefasst. Beachten Sie, dass die Datenverarbeitung, Erkundung, Featureentwicklung und Entnahme von Probedaten in einer oder mehreren Methoden/Umgebungen – in der Quell-, Zwischen- und/oder Zielumgebung – erfolgen und nach Bedarf wiederholt durchgeführt werden kann. Das Diagramm soll nur einige der möglichen Abläufe veranschaulichen.
