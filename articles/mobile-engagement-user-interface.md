...
Sobald Sie das Azure Mobile Engagement [SDK][Link 5] in Ihre Anwendung integriert haben und sich mit den grundlegenden [Konzepten][Link 6] von Azure Mobile Engagement vertraut gemacht haben,gibt es für Ihre App zwei Möglichkeiten der Interaktion mit Azure Mobile Engagement: Standardbenutzer können die [Benutzeroberfläche][Link 1] und Entwickler die HTTP-REST-basierten [APIs][Link 4] nutzen. Eine exemplarische Vorgehensweise für allgemeine Aktivitäten finden Sie in den [Anleitungen][Link 3]. Falls Sie Probleme haben sollten, konsultieren Sie die [Handbücher zur Problembehandlung][Link 2] zu Azure Mobile Engagement.
