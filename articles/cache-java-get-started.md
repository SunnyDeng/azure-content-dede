...
Dieser Leitfaden beschreibt die ersten Schritte mit dem Azure-Redis-Cache und Java.
...
Klicken Sie auf den Link unter **Ports**, und klicken Sie für "Zugriff nur über SSL zulassen" auf **Nein**. Dadurch wird der Nicht-SSL-Port für den Cache aktiviert. Der Jedis-Client unterstützt SSL derzeit nicht.
