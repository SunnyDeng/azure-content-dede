<properties 
	pageTitle="Verwenden des Blob-Speichers (Java) | Microsoft Azure" 
	description="Erfahren Sie, wie Sie den Azure-Blobdienst zum Hochladen, Herunterladen, Auflisten und Löschen von Blob-Inhalten verwenden. Die Beispiele wurden in Java geschrieben." 
	services="storage" 
...
Zum Löschen eines Blobcontainers rufen Sie einen Blobcontainerverweis ab und rufen **deleteIfExists** auf.
