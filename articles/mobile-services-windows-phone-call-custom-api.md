...
Sie fügen diese Funktionen zu der App hinzu, welche Sie beim Abschluss entweder des Lernprogramms [Erste Schritte mit Mobile Services](/de-de/documentation/articles/mobile-services-windows-phone-get-started/) oder [Erste Schritte mit Daten](/de-de/documentation/articles/mobile-services-windows-phone-get-started-data/) erstellen. Dafür führen Sie die folgenden Schritte aus:
...
Dieses Lernprogramm baut auf dem Mobile Services-Schnellstart auf. Sie müssen zuerst [Erste Schritte mit Mobile Services](/de-de/documentation/articles/mobile-services-windows-phone-get-started/) oder [Erste Schritte mit Daten](/de-de/documentation/articles/mobile-services-windows-phone-get-started-data/) abschließen, bevor Sie mit diesem Lernprogramm beginnen. Dieses Lernprogramm verwendet Visual Studio 2012 Express für Windows Phone.
