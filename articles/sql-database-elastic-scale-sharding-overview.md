<properties title="Sharding Overview" pageTitle="Sharding - Übersicht" description="Gründe für das Sharding: Skalieren von Datenbankressourcen für eine bessere Verfügbarkeit oder Leistung" metaKeywords="sharding, scaling, elastic scale, Azure SQL Database" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
