...
1.  Klicken Sie im [Azure-Vorschauportal][Azure-Vorschauportal] auf **Durchsuchen** und dann auf **Virtuelle Computer**. Wählen Sie den zu überwachenden virtuellen Computer aus.
...
4.  Um weitergehende Diagnosen zu erhalten, klicken Sie auf die Schaltfläche **Einstellungen**, woraufhin der Bereich **Diagnose** angezeigt wird. Wählen Sie **EIN**:
    ![Diagnose-Fenster][Diagnose-Fenster]
    ...
    -   **Windows-Systemereignisprotokolle**: Windows-Ereignisse, die zum Systemkanal gesendet werden. Dazu gehören auch alle Ereignisse von [Microsoft Antimalware][Microsoft Antimalware].
...
3.  Wählen Sie aus, welche Daten Sie vom Speicherkonto erheben möchten:
    ![Speicherdiagnose][Speicherdiagnose]
...
Derzeit besteht nicht die Möglichkeit, Metriken mit mehreren Instanzen grafisch darzustellen, wie Metriken nach Prozess oder nach Festplatte. Weitere Informationen zur Anpassung Ihrer Überwachungsdiagramme finden Sie unter [Anpassen der Überwachung][Anpassen der Überwachung].
...
Beachten Sie, dass Metriken, die nur im Vorschauportal angezeigt werden, nicht im vollständigen Portal mit Warnungen versehen werden können. Daher werden bestimmte Warnregeln aus dem Vorschauportal nicht im vollständigen Portal angezeigt.
  ...
  [Anpassen der Überwachung]: http://go.microsoft.com/fwlink/?LinkID=394523&clcid=0x409
