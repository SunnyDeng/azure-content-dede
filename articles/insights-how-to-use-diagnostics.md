<properties title="How to use diagnostics" pageTitle="Gewusst wie: Diagnose" description="Learn how to set up diagnostics for your resources in Azure." authors="stepsic" manager="kamrani" />
