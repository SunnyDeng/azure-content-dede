...
Folgende Funktionen stehen in ACS zur Verfügung:
...
Weitere Informationen zu ACS finden Sie unter [Access Control Service 2.0](http://go.microsoft.com/fwlink/?LinkID=212360).
...
2.  Da die Anforderung noch nicht authentifiziert ist, verweist die RP den Benutzer an die Stelle, der sie vertraut, also an ACS. ACS übermittelt dem Benutzer verschiedene IPs, die für diese RP definiert wurden. Der Benutzer wählt einen passenden IP aus.
...
Damit Sie die in dieser Anleitung gestellten Aufgaben durchführen können, brauchen Sie Folgendes:

-   Azure-Abonnement
-   Microsoft Visual Studio 2012
-   Identitäts- und Zugriffstool für Visual Studio 2012 (Download siehe [Identitäts- und Zugriffstool](http://go.microsoft.com/fwlink/?LinkID=245849))
...
1.  Melden Sie sich beim [Azure-Verwaltungsportal](http://manage.WindowsAzure.com) (https://manage.WindowsAzure.com) an.
...
1.  Klicken Sie im Projektmappen-Explorer mit der rechten Maustaste auf das Projekt "MvcACS", und wählen Sie dann **Identität und Zugriff** aus.
    ...
    Wenn die Option **Identität und Zugriff** im Kontextmenü nicht angezeigt wird, installieren Sie das Identitäts- und Zugriffstool. Informationen hierzu finden Sie unter [Identitäts- und Zugriffstool](http://go.microsoft.com/fwlink/?LinkID=245849).
...
2.  Klicken Sie mit der rechten Maustaste auf die Methode *Claims*, und wählen Sie dann **Ansicht hinzufügen** aus.
...
Wenn Sie die ACS-Funktionalität genauer erforschen und mit anderen Szenarien experimentieren möchten, finden Sie weitere Informationen unter [Access Control Service 2.0](http://go.microsoft.com/fwlink/?LinkID=212360).
