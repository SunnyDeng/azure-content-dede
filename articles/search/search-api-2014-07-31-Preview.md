...
Dieses Dokument beschreibt die ältere Version **2014-07-31-Preview** der Azure Search-Dienst-REST-API, die für die öffentliche Vorschau von Azure Search im August 2014 veröffentlicht wurde. Eine Dokumentation der aktuellen, allgemein verfügbaren Version der Azure Search-Dienst-REST-API finden Sie auf MSDN. Weitere Informationen finden Sie unter [Azure Search-Dienst-REST-API](http://msdn.microsoft.com/library/azure/dn798935.aspx).

Wenn Sie eine Vorschauversion der API in Ihrem Anwendungscode verwenden, wird dringend empfohlen, eine Migration zur allgemein verfügbaren Version durchzuführen. Eine Anleitung zur Vorgehensweise finden Sie unter [Umstellung von der Vorschau-API-Version auf die allgemein verfügbare API-Version](search-transition-from-preview.md).
...
Es gibt verschiedene API-Versionen für Azure Search. Wenn Sie Azure Search für den Einsatz in einer Anwendung für die Produktion bewerten, wird empfohlen, die Versionsinformationen zu jedem API-Satz zu prüfen. Hilfestellung bei der Auswahl einer spezifischen Version finden Sie unter [Versionsverwaltung für den Suchdienst](http://msdn.microsoft.com/library/azure/dn864560.aspx).
...
Die Azure Search-Dienst-API unterstützt zwei Syntaxtypen für die Entitätssuche. Die folgende Liste zeigt sowohl die einfache als auch die alternative OData-Syntax.
