<properties
    ...
    description="Erstellen Sie eine Suchabfrage in Azure Search, und verwenden Sie Suchparameter zum Filtern, Sortieren und Facettieren von Suchergebnissen."
    services="search"
    documentationCenter=""
	authors="ashmaka"
/>
...
Azure Search bietet viele Optionen, um äußerst leistungsfähige Abfragen zu erstellen. Weitere Informationen über die verschiedenen Parameter einer Abfrage finden Sie auf [dieser Seite](https://msdn.microsoft.com/library/azure/dn798927.aspx). Im Folgenden finden Sie auch einige Beispielabfragen.
...
Durchsuchen des gesamten Indexes nach dem Wort „budget“, zurückgegeben wird nur das Feld `hotelName`:
...
Durchsuchen des gesamten Indexes, Sortieren nach einem bestimmten Feld (`lastRenovationDate`) in absteigender Reihenfolge, Auswählen der oberen beiden Ergebnisse, nur Anzeigen von `hotelName` und `lastRenovationDate`:
...
Weitere Informationen finden Sie im Abschnitt „Antwort“ [dieser Seite](https://msdn.microsoft.com/library/azure/dn798927.aspx). Weitere Informationen zu anderen HTTP-Statuscodes, die bei Fehlern ausgegeben werden, finden Sie in [diesem Artikel](https://msdn.microsoft.com/library/azure/dn798925.aspx).
