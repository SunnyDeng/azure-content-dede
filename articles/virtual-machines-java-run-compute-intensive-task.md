<properties urlDisplayName="TSP on Virtual Machine" pageTitle="Rechenintensive Java-Anwendung auf einem virtuellen Computer &ndash; Azure" metaKeywords="Azure virtual machine Java, Azure Java app, Azure Java application" description="Erfahren Sie, wie Sie einen virtuellen Azure-Computer erstellen k&ouml;nnen, der eine rechenintensive Java-Anwendung ausf&uuml;hrt, die durch eine andere Java-Anwendung &uuml;berwacht werden kann." metaCanonical="" services="virtual-machines" documentationCenter="Java" title="Ausf&uuml;hren einer rechenintensiven Aufgabe in Java auf einem virtuellen Computer" authors="robmcm" videoId="" scriptId="" solutions="" manager="wpickett" editor="mollybos" />
...
3.  Wählen Sie im Dialogfeld **Image des virtuellen Computers auswählen** die Option **JDK 7 Windows Server 2012** aus.
    Beachten Sie, dass **JDK 6 Windows Server 2012** verfügbar ist, wenn Sie über Legacyanwendungen verfügen, die noch nicht in JDK 7 ausgeführt werden können.
...
3.  Klicken Sie im Verwaltungsportal links oben auf den Knoten **Service
    Bus** und dann auf die Schaltfläche **Neu**.
    ![Screenshot des Service Bus-Knotens][Screenshot des Service Bus-Knotens]
4.  Geben Sie im Dialogfeld **Neuen Dienstnamespace erstellen** einen
    **Namespace** ein, und klicken Sie dann auf die Schaltfläche
    **Verfügbarkeit prüfen**, um sicherzustellen, dass er eindeutig ist.
    ![Screenshot "Neuen Namespace erstellen"][Screenshot "Neuen Namespace erstellen"]
5.  Nachdem Sie sichergestellt haben, dass der Namespacename verfügbar
    ist, wählen Sie das Land oder die Region aus, in dem bzw. der Ihr Namespace gehostet werden soll, und klicken Sie dann auf die Schaltfläche **Namespace erstellen**.

    Der neue Namespace wird anschließend im Verwaltungsportal angezeigt
...
3.  Im Bereich **Eigenschaften** auf der rechten Seite werden die
    Eigenschaften des neuen Namespace aufgelistet:
    ![Screenshot des Eigenschaftenbereichs][Screenshot des Eigenschaftenbereichs]
4.  Der **Standardschlüssel** ist ausgeblendet. Klicken Sie auf die Schaltfläche **Anzeigen**, um die
    Sicherheitsanmeldeinformationen anzuzeigen:
    ![Screenshot des Standardschlüssels][Screenshot des Standardschlüssels]
5.  Notieren Sie sich den **Standardaussteller** und den **Standardschlüssel**, da
    Sie diese Informationen weiter unten zum Durchführen von Vorgängen mit dem Namespace
    verwenden.

## Erstellen einer Java-Anwendung für die Ausführung einer rechenintensiven Aufgabe

1.  Laden Sie auf dem Entwicklungscomputer (der nicht mit dem erstellten virtuellen Computer identisch sein muss) das [Azure-SDK für Java][Azure-SDK für Java] herunter.
...
Für Solver- und Clientanwendungen können Sie **Strg+C** drücken, um die Anwendung vor dem normalen Abschluss zu beenden.
  ...
  [Hinzufügen eines Zertifikats zum Java CA-Zertifikatspeicher]: ../java-add-certificate-ca-store
  [Screenshot des Service Bus-Knotens]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_02_SvcBusNode.jpg
  [Screenshot "Neuen Namespace erstellen"]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_03_CreateNewSvcNamespace.jpg
