<properties pageTitle="Verwenden von VMAccess für virtuelle Linux-Computer" description="So verwenden Sie die VMAccess-Erweiterung für Linux zum Zurücksetzen von Kennwörtern, SSH-Schlüsseln und SSH-Konfigurationen" services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
...
[Azure-VM-Erweiterungen und Features]: http://msdn.microsoft.com/de-de/library/azure/dn606311.aspx
[Herstellen einer Verbindung mit einem virtuellen Azure-Computer über RDP oder SSH]: http://msdn.microsoft.com/de-de/library/azure/dn535788.aspx
