<properties urlDisplayName="Get Started with Mobile Analytics" pageTitle="Erste Schritte mit Mobile Analytics | Mobile Dev Center" metaKeywords="" description="Get Started with Mobile Analytics." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Get Started with Mobile Analytics" authors="mahender" manager="dwrede"/>
