...
**Media Encoder Premium Workflow** unterstützt Untertitel, wie in [diesem](#closed_captioning) Abschnitt beschrieben. 
...
Aktuell unterstützt der **Media Encoder Premium Workflow**-Medienprozessor Untertitel bei Verschachtelung in Quelle oder Eingabemediendatei: CEA-608/CEA-708 bei Übertragung als Benutzerdaten (SEI-Nachrichten übertragen als H.264-Basisstreams, ATSC/53, SCTE20) oder Übertragung als Zusatzdaten in MXF/GXF-Dateien.

In der Ausgabe stehen folgende Optionen für die Neupaketierung von CEA 608/708 in der Eingabe zur Verfügung:

- Übersetzung von CEA-608 nach CEA-708
- CEA-608/CEA-708-Passthrough (eingebettet in SEI-Nachrichten von H.264-Basisstreams oder Übertragung als Zusatzdaten in MXF-Dateien)
- SCC
- SMPTE Timed Text (aus Quelle CEA-608 pro SMPTE RP2052; DFXP-Dateierstellung eingeschlossen)
- SRT-Untertiteldatei
- DVB-Untertitelstreams
