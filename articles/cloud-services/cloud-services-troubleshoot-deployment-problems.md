...
1. Klicken Sie im Azure-Portal auf die Bereitstellung Ihres Clouddiensts.
2. Überprüfen Sie die Informationen im Bereich **Eigenschaften** des Azure-Portals, und stellen Sie fest, ob während der Zeitraums, in dem Sie den Neustart der Rollen beobachtet haben, eine Dienstreparatur durchgeführt wurde.
