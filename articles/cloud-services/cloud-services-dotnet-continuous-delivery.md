<properties 
	pageTitle="Kontinuierliche Zustellung für Clouddienste mit TFS in Azure" 
...
Write-Output "$(Get-Date -f $timeStampFormat) - Azure Cloud Services-Bereitstellungsskript beendet."
</pre>
