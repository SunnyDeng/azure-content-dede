...
2. Da die Remotedebugging-Laufzeit \(msvsmon.exe\) für das Paket erforderlich ist, müssen Sie [Remote Tools für Visual Studio 2015](http://www.microsoft.com/download/details.aspx?id=46874) \(oder [Remote Tools für Visual Studio 2013 Update 5 RC](https://www.microsoft.com/en-us/download/details.aspx?id=46870) bei Verwendung von Visual Studio 2013\) installieren. Alternativ können Sie auch die Remotedebugging-Binärdateien aus einem System kopieren, auf dem Visual Studio installiert ist.
