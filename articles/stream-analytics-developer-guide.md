<properties title="Azure Stream Analytics developer guide" pageTitle="Stream Analytics-Entwicklerhandbuch | Azure" description="Erfahren Sie mehr über die Entwicklung von Azure Stream Analytics-Anwendungen." metaKeywords="" services="stream analytics" solutions="" documentationCenter="" authors="jgao" videoId="" scriptId="" manager="paulettm" editor="cgronlun"/>
