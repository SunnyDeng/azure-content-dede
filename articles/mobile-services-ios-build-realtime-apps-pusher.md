<properties urlDisplayName="Build Realtime Apps with Pusher" pageTitle="Erstellen von Echtzeit-Apps mit Pusher (iOS) - Mobile Services" metaKeywords="" description="Erfahren Sie, wie Sie mithilfe von Pusher Benachrichtigungen an Ihre Azure Media Services-App für iOS senden." metaCanonical="" services="" documentationCenter="Mobile" title="Build Real-time Apps with Mobile Services and Pusher" authors="donnam" solutions="" manager="dwrede" editor="" />
...
[WACOM.INCLUDE [Pusher-Anmeldung](../includes/pusher-sign-up.md)]
...
12. Ersetzen Sie die Methode **onAdd** durch den folgenden Code:
...
5. Ersetzen Sie die Platzhalter im oben angegebenen Skript durch jene Werte, die Sie zuvor aus dem Verbindungsinformationsdialog kopiert haben:
	...
	- **`**your_app_key**`**: der App&#95;Schlüsselwert
	- **`**your_app_key_secret**`**: der geheime Schlüssel der App
