...
Bei einem virtuellen Computer, auf dem das Linux-Betriebssystem ausgeführt wird, verwenden Sie zur Anmeldung einen Secure Shell (SSH)-Client.
...
- Auf einem Computer, auf dem ein Windows-Betriebssystem ausgeführt wird, sollten Sie einen SSH-Client wie PuTTY verwenden. Weitere Informationen finden Sie auf der [PuTTY-Downloadseite](http://www.chiark.greenend.org.uk/~sgtatham/putty/download.html).
...
4. Melden Sie sich mit dem Konto an, das Sie beim Erstellen des virtuellen Computers angegeben haben. Nähere Informationen zum Erstellen eines virtuellen Computers mit Benutzername und Kennwort finden Sie unter [Erstellen eines virtuellen Linux-Computers](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-tutorial/). 
