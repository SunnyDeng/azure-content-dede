<properties title="virtual-machines-how-to-inject-custom-data" pageTitle="Einfügen von benutzerdefinierten Daten in einem virtuellen Azure-Computer="Dieses Thema beschreibt das Einfügen von benutzerdefinierten Daten in einem virtuellen Azure-Computer, wenn die Instanz erstellt wird, und das Suchen der benutzerdefinierten Daten auf Windows oder Linux." metaKeywords="Azure linux vm, linux vm, userdata vm, user data vm, custom data vm, windows custom data" services="virtual-machines" solutions="" documentationCenter="" authors="rasquill" manager="timlt" editor="tysonn" videoId="" scriptId="" />
...
> [WACOM.NOTE] Dieses Thema führt [diesen Beitrag im Azure-Blog](http://azure.microsoft.com/blog/2014/04/21/custom-data-and-cloud-init-on-windows-azure/) weiter aus und wird mit der Einführung weiterer Funktionen aktualisiert werden.
...
Dieses Feature wird zurzeit nur in der [Microsoft Azure-Befehlszeilenschnittstelle] unterstützt(https://github.com/Azure/azure-sdk-tools-xplat). Auch wenn Sie jede der Optionen für den Befehl `azure vm create` verwenden können, ist der folgende Ansatz sehr allgemein gehalten. 
...
Wenn es sich bei Ihrem virtuellen Azure-Computer um ein Ubuntu-Image handelt, können Sie cloud-init zum Starten eines Skripts für die automatische Verwendung (oder Ausführung, wenn Ihre benutzerdefinierte Datei ein Skript ist) Ihrer benutzerdefinierten Daten verwenden. FWeitere Informationen finden Sie unter [cloud-init-Dokumentation für Ubuntu] (in englischer Sprache)(https://help.ubuntu.com/community/CloudInit).

<!--Link references-->
[Add Role Service Management REST API-Verweis](http://msdn.microsoft.com/library/azure/jj157186.aspx)

[Microsoft Azure Cross-Platform Command-line Interface](Plattformübergreifende Microsoft Azure-Befehlszeilenschnittstelle) (in englischer Sprache)(https://github.com/Azure/azure-sdk-tools-xplat)
