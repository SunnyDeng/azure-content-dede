...
## <span id="RetrieveEntity"></span></a>Gewusst wie: Abrufen einer einzelnen Entität

Mit der **TableRestProxy-\>getEntity**-Methode können Sie eine einzelne Entität durch Abfragen ihres `PartitionKey` und `RowKey` abrufen: Im Beispiel unten werden der Partitionsschlüssel `tasksSeattle` und der Zeilenschlüssel `1` an die **getEntity**-Methode übergeben.
...
## <span id="RetPropertiesSubset"></span></a>Gewusst wie: Abrufen einer Teilmenge von Entitätseigenschaften
...
## <span id="UpdateEntity"></span></a>Gewusst wie: Aktualisieren einer Entität
...
## <span id="DeleteEntity"></span></a>Gewusst wie: Löschen einer Entität
...
## <span id="BatchOperations"></span></a>Gewusst wie: Batch-Tabellenvorgänge
