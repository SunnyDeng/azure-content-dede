...
Das [Azure SDK für PHP] besteht aus verschiedenen Komponenten. In diesem Artikel werden zwei Komponenten verwendet: Azure PowerShell und Azure-Emulatoren. Diese beiden Komponenten können über den Microsoft-Webplattform-Installer installiert werden: [Installieren von Azure PowerShell und Azure-Emulatoren][PS und Emulatoren installieren].

## <a name="CreateProject"></a>Vorgehensweise: Erstellen eines Cloud Services-Projekts
...
## <a name="AddRole"></a>Vorgehensweise: Hinzufügen von PHP-Web- und Workerrollen
...
## <a name="SpecifyPHPVersion"></a>Vorgehensweise: Angeben der integrierten PHP-Version
...
Die Ausgabe dieses Befehls wird ähnlich wie die unten angezeigte Ausgabe aussehen. In diesem Beispiel ist das Kennzeichen  `IsDefault` auf  `true` für PHP 5.3.17 festgelegt, das heißt, dass dies die installierte PHP-Standardversion ist. 
...
## <a name="CustomizePHP"></a>Vorgehensweise: Anpassen der integrierten PHP-Laufzeit
...
## <a name="OwnPHP"></a>Vorgehensweise: Verwenden Ihrer eigenen PHP-Laufzeit
...
1. Erstellen Sie ein Azure-Dienstprojekt, und fügen Sie eine PHP-Webrolle hinzu, wie unter [Gewusst wie: Erstellen eines Cloud Services-Projekts](#CreateProject) und [Gewusst wie: Hinzufügen von PHP-Web- und Workerrollen](#AddRole) oben beschrieben.
...
> [AZURE.NOTE] Das  `download.ps1` script (in the `bin` des Stammverzeichnisses der Webrolle) kann gelöscht werden, wenn Sie die hier beschriebenen Schritte für die Verwendung Ihrer eigenen PHP-Laufzeit befolgt haben.
...
1. Erstellen Sie ein Azure-Dienstprojekt, und fügen Sie eine PHP-Workerrolle hinzu, wie unter [Gewusst wie: Erstellen eines Cloud Services-Projekts](#CreateProject) und [Gewusst wie: Hinzufügen von PHP-Web- und Workerrollen](#AddRole) oben beschrieben.
...
## <a name="Emulators"></a>Vorgehensweise: Ausführen der Anwendung in den Server- und Speicheremulatoren
...
## <a name="Publish"></a>Vorgehensweise: Veröffentlichen der Anwendung
