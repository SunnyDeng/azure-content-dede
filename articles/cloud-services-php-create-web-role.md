...
##<a name="CreateProject"></a>Erstellen eines Cloud Services-Projekts
...
##<a name="AddRole"></a>Hinzufügen von PHP-Web- und -Workerrollen
...
##<a name="SpecifyPHPVersion"></a>Angeben der integrierten PHP-Version
...
##<a name="CustomizePHP"></a>Anpassen der integrierten PHP-Laufzeit
...
##<a name="OwnPHP"></a>Verwenden Ihrer eigenen PHP-Laufzeit
...
1. Erstellen Sie ein Azure-Dienstprojekt, und fügen Sie, wie in den obigen Abschnitten [Erstellen eines Cloud Services-Projekts](#CreateProject) und [Hinzufügen von PHP-Web- oder -Workerrollen](#AddRole) beschrieben, eine PHP-Webrolle hinzu.
...
6. Veröffentlichen Sie die Anwendung, wie im Abschnitt [Veröffentlichen der Anwendung](#Publish) weiter unten beschrieben.
...
1. Erstellen Sie ein Azure-Dienstprojekt, und fügen Sie, wie in den obigen Abschnitten [Erstellen eines Cloud Services-Projekts](#CreateProject) und [Hinzufügen von PHP-Web- oder -Workerrollen](#AddRole) beschrieben, eine PHP-Workerrolle hinzu.
...
##<a name="Emulators"></a>Ausführen der Anwendung in den Server- und Speicheremulatoren
...
##<a name="Publish"></a>Veröffentlichen der Anwendung
