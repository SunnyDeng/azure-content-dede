...
Weitere Informationen finden Sie unter [Verwenden des Warteschlangenspeichers aus .NET](storage-dotnet-how-to-use-queues.md/ "Verwenden des Warteschlangenspeichers mit .NET").
...
Um die Azure-Warteschlange in Code statt mit Visual Studio **Server-Explorer** zu erstellen, fügen Sie einfach einen Aufruf von `CreateIfNotExistsAsync()` hinzu.
