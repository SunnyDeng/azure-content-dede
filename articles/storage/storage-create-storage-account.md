<properties
	...
	description="Erfahren Sie, wie Sie ein Speicherkonto im Azure-Portal erstellen, verwalten oder löschen können."
	services="storage"
	documentationCenter=""
	authors="tamram"
	manager="adinah"
...
Sie sehen die Endpunkte für Ihr Speicherkonto auf dem Speicher-Dashboard im Anschluss an die Erstellung im Azure-Portal.
...
Verwenden Sie im [Azure-Portal](http://manage.windowsazure.com) die Option **Schlüssel verwalten** auf dem Dashboard oder die Seite **Storage**, um die Speicherzugriffsschlüssel, dir für den Zugriff auf Blob-, Tabellen- und Warteschlangendienste verwendet werden, anzuzeigen, zu kopieren und erneut zu generieren.
...
1. Klicken Sie im [Azure-Portal](http://manage.windowsazure.com) auf **Storage** und dann auf den Namen des Speicherkontos, um das Dashboard zu öffnen.
...
1. Klicken Sie im [Azure-Portal](http://manage.windowsazure.com) auf **Storage**.
