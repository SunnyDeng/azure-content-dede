<properties pageTitle="Was ist Azure Multi-Factor Authentication?" description="Erfahren Sie mehr über die Azure Multi-Factor Authentication. Hierbei handelt es sich um eine Authentifizierungsmethode, welche die Verwendung von mehr als einer Verifizierungsmethode erfordert und eine wichtige zweite Sicherheitsebene für Benutzeranmeldungen und Transaktionen darstellt." services="active-directory, multi-factor-authentication" documentationCenter="" authors="blackmist" manager="wpickett" editor=""/>
