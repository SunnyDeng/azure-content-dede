...
<p>Wenn Sie lieber ein Video zu diesem Thema ansehen m&ouml;chten, k&ouml;nnen Sie den Clip auf der rechten Seite ausw&auml;hlen. In diesem werden dieselben Schritte behandelt wie in diesem Lernprogramm. Im Video zeigt Ihnen Mat Velloso, wie man eine Windows Store-App so &auml;ndert, dass sie mit SharePoint Online interagiert.</p>
</div>
...
Um auf SharePoint zugreifen zu können, benötigen Sie einen speziellen Zugriffstoken mit SharePoint als Zielgruppe. Diesen Token erhalten Sie, wenn Sie einen Abruf bei AAD mit der Identität des mobilen Diensts und dem Token machen, der für den Benutzer ausgestellt worden ist.
...
2.  Erstellen Sie jetzt eine Methode, mit der die Datei zur Dokumentenbibliothek des Benutzers hinzugefügt wird:
