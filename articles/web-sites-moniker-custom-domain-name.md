<properties title="Learn how to configure an Azure website to use a domain name registered with Moniker" pageTitle="Konfigurieren eines Moniker-Domänennamens für eine Azure-Website" metaKeywords="Azure, Azure-Websites, Domänennamen" description="Erfahren Sie mehr über die Konfiguration einer Azure-Website für die Verwendung eines bei Moniker registrierten Domänennamens." services="web-sites" documentationCenter="" authors="larryfr,jroth" manager="wpickett" />
