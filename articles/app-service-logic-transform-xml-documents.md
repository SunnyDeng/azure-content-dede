...
2.	Wählen Sie **Neu** > **Web + Mobil** > **Azure Marketplace** > **API-Apps**:
...
4.	Das Blatt "Konfiguration" für die API-App wird geöffnet. Im Abschnitt "Komponenten" wird **Zuordnungen** angezeigt:
...
1. Innerhalb der Logik-App ist "BizTalk-Transformation" in der Galerie rechts verfügbar. Wählen Sie in der Galerie **BizTalk Transform Service** aus. Die Transformation wird dem Datenfluss hinzugefügt:
