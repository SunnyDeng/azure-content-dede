...
6. Öffnen Sie in Visual Studio die Datei "Package.appxmanifest" und vergewissern Sie sich, dass **Toastfähig** in der Registerkarte **Anwendungsbenutzeroberfläche** auf **Ja** gesetzt ist.
...
3. Klicken Sie auf die Registerkarte **Push**, aktivieren Sie **Aktivieren Sie nicht authentifizierte Pushbenachrichtigungen**, und klicken Sie dann auf **Speichern**.
...
[Hinzufügen von Mobile Services zu einer vorhandenen Anwendung]: /de-de/documentation/articles/mobile-services-dotnet-backend-windows-phone-get-started-data
