...
Dieser Artikel beschreibt die allgemeinen Betriebssystem Grundfunktionen, die für alle Anwendungen auf [Azure Anwendungsdiensts](http://go.microsoft.com/fwlink/?LinkId=529714) Webanwendungen. Diese Funktionen umfassen Zugriff auf Dateien, Netzwerke und Registrierung sowie Diagnoseprotokolle und Ereignisse.

<a id="tiers"></a>
## App Service-Planstufen
Web-Apps führen Kunden-Apps in einer Hostingumgebung mit mehreren Mandanten aus. Web-apps bereitgestellt, die der **frei** und **Shared** Ebenen in Arbeitsprozessen auf freigegebenen virtuellen Maschinen ausführen, während der Bereitstellung von Webanwendungen in der **Standard** und **Premium** Ebenen auf virtuellen Maschinen, die speziell für einen einzelnen Kunden zugeordneten Web-apps dediziert ausgeführt.
