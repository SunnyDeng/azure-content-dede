...
Microsoft Azure informiert jeweils aktuell über Dienstunterbrechungen oder Leistungsbeeinträchtigungen. Sie können die Integrität des Diensts im [Azure-Vorschauportal](https://portal.azure.com/) nachverfolgen. Weitere Informationen finden Sie unter [Nachverfolgen der Dienstintegrität](insights-service-health.md).
...
Weitere Informationen zu den verfügbaren Funktionen in Kudu finden Sie unter [Team Services-Tools für Azure-Websites, die Sie kennen sollten](/blog/windows-azure-websites-online-tools-you-should-know-about/).
...
Dies ist oft die einfachste Methode zum Beheben einmaliger Probleme. Im [Azure-Vorschauportal](https://portal.azure.com) stehen auf dem Blatt Ihrer Web-App Optionen zum Beenden oder Neustarten der App zur Verfügung.
