...
Mit DocumentDB können Sie weitere Auflistungen oder Datenbanken (oder beides) erstellen, wenn die Skalierungsanforderungen Ihrer Anwendung wachsen. Tatsächlich wird DocumentDB von vielen Erstanbieteranwendungen innerhalb von Microsoft in großem Maße genutzt, indem sehr große DocumentDB-Datenbanken erstellt werden, die jeweils Tausende von Auflistungen mit mehreren Terabytes Dokumentspeicher enthalten. Sie können eine Datenbank erweitern oder reduzieren, indem Sie je nach den Skalierungsanforderungen Ihrer Anwendung Auflistungen hinzufügen oder entfernen. Sie können in Abhängigkeit von der Angebotsverfügbarkeit und der erworbenenen Menge an Kapazitätseinheiten eine beliebige Anzahl von Auflistungen innerhalb einer Datenbank erstellen. Der SSD-gestützte Speicher und für Sie bereitgestellte Durchsatz kann über die Auflistungen unter den Datenbanken in Ihrem Datenbankkonto aufgeteilt werden.
...
Die folgende Tabelle enthält eine Liste verschiedener Datenbankvorgänge sowie die pro CU verfügbaren Anforderungseinheiten. Mithilfe der Tabelle können Sie planen, wie ein bestimmter Datenbankvorgang den bereitgestellten Durchsatz, der mit einer CU verbunden ist, verbraucht. Es wird davon ausgegangen, dass die Dokumentgröße 1 KB ist und aus 10 eindeutigen Eigenschaftenwerten besteht, wobei die standardmäßige Konsistenzebene auf "Session" festgelegt ist und alle Dokumente automatisch von DocumentDB indiziert werden.

| Datenbankvorgänge                                                                                | Anzahl von Vorgängen pro Sekunde pro CU |
|--------------------------------------------------------------------------------------------------|-----------------------------------------|
