<properties 
   pageTitle="Hinzufügen von Mobile Services mithilfe von verbundenen Diensten in Visual Studio"
...
1. Öffnen Sie das Dialogfeld **Verbundene Dienste hinzufügen**.
 ...
 - Öffnen Sie für Apache Cordova-App-Projekte das Projekt in Visual Studio, öffnen Sie das Kontextmenü für den Projektnoten im Projektmappen-Explorer, und wählen Sie dann **Verbundenen Dienst hinzufügen** aus.
...
1. Wählen Sie im Dialogfeld "Azure Mobile Services" einen vorhandenen mobilen Dienst aus, falls einer verfügbar ist. Wenn Sie einen neuen mobilen Dienst in Azure erstellen müssen, führen Sie dazu das folgende Verfahren aus. Gehen Sie andernfalls zum nächsten Schritt.
    ...
    2. Im Dialogfeld **Mobilen Service erstellen** können Sie einen mobilen JavaScript-Back-End-Dienst oder einen mobilen .NET-Back-End-Dienst aus der Dropdownliste **Laufzeit** auswählen. 
  
        ![Erstellen eines mobilen Diensts](./media/vs-azure-tools-connected-services-add-mobile-services/IC797638.png)

        Ein JavaScript-Back-End-Dienst ist einfach und leistungsstark. Wenn Sie einen mobilen JavaScript-Back-End-Dienst erstellen, wird der serverseitige JavaScript-Code in der Cloud gespeichert, aber Sie können mit dem Server-Explorer oder dem Azure-Verwaltungsportal Serverskripts bearbeiten.
    ...
    1. Nachdem Sie alle erforderlichen Informationen eingegeben haben, wählen Sie die Schaltfläche **Erstellen** aus, um den mobilen Dienst zu erstellen.
    2. Der neue mobile Dienst sollte in der Liste der Dienste im Dialogfeld **Azure Mobile Services** angezeigt werden. Wählen Sie den neuen mobilen Dienst in der Liste aus, und wählen Sie dann die Schaltfläche **Hinzufügen** aus, um den Dienst zu Ihrem Projekt hinzuzufügen.
