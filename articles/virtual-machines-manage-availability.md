<properties urlDisplayName="Manage Availability of VMs" pageTitle="Verwalten der Verfügbarkeit virtueller Computer - Azure" metaKeywords="" description="Learn how to use multiple virtual machines to ensure high availability for your Azure application. " metaCanonical="" services="virtual-machines" documentationCenter="" title="" authors="kenazk" solutions="" manager="timlt" editor="tysonn" />
