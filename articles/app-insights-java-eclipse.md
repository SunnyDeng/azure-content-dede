...
![Serverantwort, Anforderungsanzahl und Fehler](./media/app-insights-java-track-http-requests/5-results.png)
 

Klicken Sie sich durch ein beliebiges Diagramm, um ausführlichere Metriken anzuzeigen.

![Anzahlen nach Name anfordern](./media/app-insights-java-track-http-requests/6-barchart.png)
...
![Alle Ablaufverfolgungen für diese Anforderung](./media/app-insights-java-track-http-requests/7-instance.png)
...
![Sitzungen, Benutzer und Seitenaufrufe](./media/appinsights/appinsights-47usage-2.png)
...
![Beispiel für Webtest](./media/appinsights/appinsights-10webtestresult.png)
