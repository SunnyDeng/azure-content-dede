...
Im folgenden Beispiel werden die obigen Konzepte veranschaulicht. Nehmen Sie einen Actor-Typ, der zwei asynchrone Methoden implementiert (z. B. *Method1* und *Method2*), einen Timer und eine Erinnerung. Das folgende Diagramm zeigt ein Beispiel einer Zeitachse für die Ausführung dieser Methoden und Rückrufe für zwei Actors (*ActorId1* und *ActorId2*), die zu diesem Actor-Typ gehören.
