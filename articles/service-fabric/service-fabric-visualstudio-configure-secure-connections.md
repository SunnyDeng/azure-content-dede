...
Zwei Arten von Verbindungen werden vom Azure Service Fabric-Cluster unterstützt: **nicht sichere** Verbindungen und sichere Verbindungen auf **x509-Zertifikatbasis**. (Bei lokal gehosteten Service Fabric-Cluster werden auch **Windows**- und **DST**-Authentifizierung unterstützt.) Sie müssen den Verbindungstyp für den Cluster bei dessen Erstellung konfigurieren. Der Verbindungstyp kann nach der Erstellung nicht mehr geändert werden.
