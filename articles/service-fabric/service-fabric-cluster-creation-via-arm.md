...
1. ARM-Beispielvorlagen stehen im [Azure-Schnellstart-Vorlagenkatalog auf Github](https://github.com/Azure/azure-quickstart-templates) zur Verfügung. Die Namen aller Service Fabric-Vorlagen beginnen mit „service-fabric-cluster-...“. Sie können im Repository entweder nach „fabric“ suchen oder einfach zu den Beispielvorlagen scrollen.
2. Um die Vorlagen schneller finden zu können, wurden sie wie folgt benannt:
	1. [service-fabric-cluster-5-node-1-nodetype](https://github.com/Azure/azure-quickstart-templates/tree/master/service-fabric-cluster-5-node-1-nodetype) stellt eine Vorlage für einen unsicheren Einzelknotencluster mit 5 Knoten dar.
	2. [service-fabric-cluster-5-node-1-nodetype-wad](https://github.com/Azure/azure-quickstart-templates/tree/master/service-fabric-cluster-5-node-1-nodetype-wad) stellt eine Vorlage für einen unsicheren Einzelknotencluster mit 5 Knoten und WAD-Unterstützung dar.
	3. [service-fabric-cluster-5-node-secure-1-nodetype-wad](https://github.com/Azure/azure-quickstart-templates/tree/master/service-fabric-cluster-5-node-secure-1-nodetype-wad) stellt eine Vorlage für einen sicheren Einzelknotencluster mit 5 Knoten und WAD-Unterstützung dar.
	4. [service-fabric-cluster-10-node-secure-2-nodetype-wad](https://github.com/Azure/azure-quickstart-templates/tree/master/service-fabric-cluster-5-node-secure-1-nodetype-wad) stellt eine Vorlage für einen sicheren Zweifachknotencluster mit 10 Knoten und WAD-Unterstützung dar.
...
2. Führen Sie das Verfahren zum Erstellen des Clusters aus, wie in [Erstellen des Service Fabric-Cluster über das Portal](service-fabric-cluster-creation-via-portal.md). Klicken Sie jedoch nicht auf ****create**, sondern wechseln Sie stattdessen zur Übersicht, und laden Sie die Vorlage herunter. ![DownloadTemplate][DownloadTemplate]
