<properties
   pageTitle="Clusterressourcen-Manager von Service Fabric – Integration der Verwaltung"
...
4.	Den Zeitpunkt des Auftretens des Verstoßes (10.08.2015 19:13:02 Uhr).Dies sind aussagekräftige Daten für eine Warnung, die in der Produktion ausgelöst wird, um Sie zu informieren, dass etwas falsch gelaufen ist und Sie einen Blick darauf werfen sollten. In diesem Fall möchten wir herausfinden, warum der Ressourcen-Manager keine andere Wahl hatte, als die Replikate in der Fehlerdomäne abzulegen. Eine Möglichkeit ist, dass alle Knoten in den anderen Fehlerdomänen ausgefallen waren und es nicht genügend Ersatzfehlerdomänen gab. Oder wenn es genügend aktive Domänen gab, ist etwas anderes vorgefallen, das bewirkt hat, dass die Knoten in diesen anderen Fehlerdomänen ungültig waren (wie z. B. eine „InvalidDomain“-Richtlinie für den Dienst).
...
## Nächste Schritte
- [Einführende Informationen zum Clusterressourcen-Manager von Service Fabric](service-fabric-cluster-resource-manager-introduction.md)
