<properties
   pageTitle="Knotenpufferprozentsatz | Microsoft Azure"
...
# Übersicht über den Knotenpufferprozentsatz

Derzeit können Kunden den Grenzwert für die Knotenkapazität als Einschränkung angeben, die vom Resource Balancer gemäß der Einschränkungspriorität berücksichtigt wird. Wenn die Kapazitätseinschränkung eine hohe Priorität hat (Knotenkapazität darf nicht verletzt werden) und die Clusterknoten eine hohe Auslastung aufweisen, erfolgt das Failover möglicherweise nicht sofort oder die Knotenkapazität wird verletzt.
...
Wenn der Wert in diesem Abschnitt nicht angegeben ist, wird 0 als Standardwert verwendet.
