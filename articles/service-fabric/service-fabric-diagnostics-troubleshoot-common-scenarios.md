...
| Fehler | Beschreibung |
| --- | --- |
| System.IO.FileNotFoundException | Dieser Fehler tritt oft aufgrund fehlender Assemblyabhängigkeiten auf. Überprüfen Sie die CopyLocal-Eigenschaft in Visual Studio oder im globalen Assemblycache für den Knoten.
...
[Azure-Diagnose](service-fabric-diagnostics-how-to-setup-wad-operational-insights.md) kann so konfiguriert werden, dass das Ereignisprotokoll der Anwendung für alle Ihre Knoten automatisch hochgeladen wird.
