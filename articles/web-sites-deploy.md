...
* [Erstellen einer Node.js-Website und Bereitstellen auf Azure mit WebMatrix](http://www.windowsazure.com/de-de/documentation/articles/web-sites-nodejs-use-webmatrix/).
* [Erstellen und Bereitstellen einer PHP-MySQL-Azure-Website mithilfe von WebMatrix](http://www.windowsazure.com/de-de/documentation/articles/web-sites-php-mysql-use-webmatrix/).
...
Sie können MSBuild- oder FTP-Bereitstellungsfunktionen mithilfe von [Windows PowerShell](http://msdn.microsoft.com/de-de/library/dd835506.aspx) ausführen. Wenn dies der Fall ist, können Sie auch eine Sammlung von Windows PowerShell-Cmdlets nutzen, mit denen die Azure-REST-Verwaltungs-API leicht aufgerufen werden kann.
...
* [Veröffentlichung in Entwicklungs- und Testumgebungen mithilfe von Windows PowerShell-Skripts](http://msdn.microsoft.com/de-de/library/dn642480.aspx). Hier erfahren Sie, wie Sie Windows PowerShell-Bereitstellungsskripts verwenden, die von Visual Studio generiert werden.
...
* [Webbereitstellungstool](http://technet.microsoft.com/de-de/library/dd568996). Offizielle Dokumentation auf der Microsoft TechNet-Website. Der Inhalt ist nicht mehr auf dem neuesten Stand, aber für den Anfang gut geeignet.
