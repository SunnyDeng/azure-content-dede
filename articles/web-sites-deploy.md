...
* [Repositorywebsites mit Mercurial](#mercurial)
* [Dropbox](#dropbox)

###<a name="ide"></a>Bereitstellen über eine IDE

[Visual Studio](http://www.visualstudio.com/) und [WebMatrix](http://www.microsoft.com/web/webmatrix/) sind Microsoft-IDEs (Integrated Development Environments, integrierte Entwicklungsumgebungen), die Sie für die Webentwicklung verwenden können. Beide stellen integrierte Funktionen für die einfache Bereitstellung von Web-Apps zur Verfügung.  [Web Deploy](http://www.iis.net/downloads/microsoft/web-deploy) kann in beiden Entwicklungsumgebungen für zusätzliche Aufgaben in Bezug auf die Bereitstellung verwendet werden, beispielsweise für die Datenbankbereitstellung oder die Änderung von Verbindungszeichenfolgen. Beide ermöglichen eine Bereitstellung über [FTP oder FTPS](http://en.wikipedia.org/wiki/File_Transfer_Protocol)).
...
* [Plattformübergreifende Befehlszeile (xplat-cli)](#cli)
...
* [Bereitstellen in Web-Apps mit GitHub unter Verwendung von Kudu](/documentation/videos/deploying-to-azure-from-github/). Das Video von Scott Hanselman und David Ebbo zeigt, wie Sie eine Web-App direkt von GitHub in Web-Apps bereitstellen.
...
* [Erstellen einer Node.js-Website und Bereitstellen auf Azure mit WebMatrix](web-sites-nodejs-use-webmatrix.md).
...
* [Kontinuierliche Bereitstellung für Cloud-Dienste in Azure](cloud-services-dotnet-continuous-delivery.md). Dieses Dokument ist in erster Linie für einen Azure-Cloud-Dienst bestimmt. Einige Inhalte gelten allerdings auch für Web-Apps.
...
* [Inside the Microsoft Build Engine: Using MSBuild and Team Foundation Build (in englischer Sprache)](http://msbuildbook.com/). Buch, in dem Kapitel zur Verwendung von MSBuild für die Bereitstellung enthalten sind.
...
Informationen zur Verwendung der rollenbasierten Zugriffssteuerung von Azure zum Verwalten des Zugriffs auf die Web-App-Bereitstellung finden Sie unter [RBAC and Web App Publishing (in englischer Sprache)](http://azure.microsoft.com/blog/2015/01/05/rbac-and-azure-websites-publishing).
