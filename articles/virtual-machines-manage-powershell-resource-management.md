<properties
   pageTitle="Häufige Aufgaben für virtuelle Computer mit dem Ressourcen-Manager in Azure PowerShell"
   description="Beschreibt Befehle für häufige Aufgaben für virtuelle Computer mit dem Ressourcen-Manager-Modus in Azure PowerShell"
...
# Häufige Aufgaben für virtuelle Computer mit Azure PowerShell im Ressourcen-Manager-Modus
...
Viele Aufgaben, die Sie jeden Tag zur Verwaltung der virtuellen Computer ausführen, können mithilfe von Azure PowerShell-Cmdlets im Azure-Ressourcen-Manager-Modus automatisiert werden. In diesem Artikel finden Sie Beispiele für Befehle für einfachere Aufgaben und Links zu Artikeln, die die Befehle für komplexere Aufgaben behandeln.
...
Wenn Sie den Befehl mit einer Ressourcengruppe namens "MyRG" und einem virtuellen Computer mit dem Namen "MyVM" ausführen, sollte etwa Folgendes angezeigt werden:
