...
-   [][4]<http://www.cs.toronto.edu/~hinton/absps/imagenet.pdf></a> (Abschnitt 3.4)
...
-   In der ersten Zeile wird die Eingabeschicht namens „Mydata“ definiert. Sie hat 100 Knoten, von denen jeder ein Feature in den Eingabebeispielen darstellt.
...
-   Die Anzahl der Gewichtungen pro Kernel beträgt 1 + **KernelShape**[0] * **KernelShape**[1][1] * **KernelShape**[2] = 1 + 1 * 5 * 5 = 26. Oder 26 * 50 = 1300.
-   Sie können die Knoten in jeder verdeckten Schicht wie folgt berechnen:
    -   **NodeCount**[0] = (5 - 1) / 1 + 1 = 5.
    -   **NodeCount**[1][1] = (13 - 5) / 2 + 1 = 5.
    -   **NodeCount**[2] = (13 - 5) / 2 + 1 = 5.
-   Die Gesamtanzahl Knoten kann anhand der deklarierten Dimensionalität der Schicht ([50, 5, 5]) wie folgt berechnet werden: **MapCount** * **NodeCount**[0] * **NodeCount**[1][1] * **NodeCount**[1][1] = 10 * 5 * 5 * 5
