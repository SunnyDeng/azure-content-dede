<properties title="How to use end user analytics in Azure" pageTitle="Endnutzeranalysen verwenden" description="End user analytics for Microsoft Azure websites." authors="awills" manager="kamrani" />
