...
# Schnellstart: Übermitteln von Video-on-Demand mit dem Media Services SDK für .NET 
...
Die Funktion **Main** ruft Methoden auf, die weiter unten in diesem Abschnitt definiert werden.
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                // Erstellen und Zwischenspeichern der Media Services-Anmeldeinformationen in einer statischen Klassenvariablen.
                _cachedCredentials = new MediaServicesCredentials(
                                _mediaServicesAccountName,
                                _mediaServicesAccountKey);
                // Für das Zwischenspeichern der zu erstellenden Anmeldeinformationen. CloudMediaContext.
                _context = new CloudMediaContext(_cachedCredentials);

                // Fügen Sie Aufrufe von Methoden hinzu, die in diesem Abschnitt definiert sind.
            ...
            {
                // Analysieren Sie die XML-Fehlermeldung in der Media Services-Antwort, und erstellen Sie eine neue 
                // Ausnahme mit deren Inhalt.
...
Fügen Sie die folgende Methode zur Program-Klasse hinzu.
	...
	{
		// Vorbereiten eines Auftrags mit einer Aufgabe zum Transcodieren des angegebenen Medienobjekts
	    ...
	    // Übermitteln des Auftrags und Warten auf den Abschluss.
	    job.Submit();
...
Die folgende **ConfigureClearAssetDeliveryPolicy**-Methode gibt an, dass dynamische Verschlüsselung nicht verwendet und der Stream in einem der folgenden Protokolle übermittelt werden soll:  MPEG DASH, HLS und Smooth Streaming-Protokoll. 
...
Fügen Sie die folgende Methode zur Program-Klasse hinzu.
    ...
    static public void PublishAssetGetURLs(IAsset asset)
    {
        ...
        // Abrufen der URLs für das progressive Herunterladen für jede MP4-Datei, die als Ergebnis
		// der Codierung generiert wurde.
		List<Uri> mp4ProgressiveDownloadUris = mp4AssetFiles.Select(af => af.GetSasUri()).ToList();


        // Anzeigen der Streaming-URLs.
		...
		// Anzeigen der URLs für das progressive Herunterladen.
        Console.WriteLine("Use the following URLs for progressive download.");
        mp4ProgressiveDownloadUris.ForEach(uri => Console.WriteLine(uri + "\n"));
        Console.WriteLine();

        // Herunterladen des Ausgabemedienobjekts in einen lokalen Ordner.
