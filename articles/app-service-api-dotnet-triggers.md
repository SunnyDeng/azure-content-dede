...
Wenn Sie neu in der Welt der API-Apps sind, finden Sie hier einige Artikel für den Einstieg.

1. [Erstellen einer API-App](app-service-dotnet-create-api-app.md) – Erstellen Sie eine API-App von Grund auf neu oder konvertieren Sie ein vorhandenes Web-API-Projekt in eine API-App. 
2. [Bereitstellen einer API-App](app-service-dotnet-deploy-api-app.md) – Stellen Sie eine API-App für Ihr Azure-Abonnement bereit.
3. [Debuggen einer API-App](app-service-dotnet-remotely-debug-api-app.md) – Verwenden Sie Visual Studio, um eine in Azure ausgeführte API-App zu debuggen.
...
Ein Beispiel: Ihr Clientcode verwendet die [Twitter Connector-API-App](app-service-logic-connector-twitter.md) und der Code muss auf eine Aktion basierend auf neuen Tweets ausführen, die bestimmte Wörter enthalten. In diesem Fall können Sie einen Push- oder einen Abfragetrigger einrichten, um diese Anforderung zu erleichtern.
