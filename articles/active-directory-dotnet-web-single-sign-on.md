<properties urlDisplayName="" pageTitle="Einmalige Webanmeldung mit .NET und Azure Active Directory" metaKeywords="" description="" metaCanonical="" services="" documentationCenter="" title="Web Single Sign-On with .NET and Azure Active Directory" authors="" solutions="" manager="terrylan" editor="" />
...
<h2><a name="introduction"></a>Einführung</h2>
...
<h2><a name="createapp"></a>Schritt 1: Erstellen einer ASP.NET MVC-Anwendung</h2>
...
4. Wählen Sie im Dialogfeld **Neues ASP.NET MVC 3-Projekt** die Vorlage **Leer** aus, und klicken Sie dann auf **OK**.
...
6. Geben Sie dem neuen Controller im Dialogfeld **Controller hinzufügen** den Namen *HomeController.cs*, und klicken Sie dann auf **Hinzufügen**.
...
8. Klicken Sie im Dialogfeld **Ansicht hinzufügen** auf **OK**. Eine Datei **Index.cshtml** wird in einem neuen Ordner namens **Home** erstellt. 
9. Klicken Sie mit der rechten Maustaste im **Projektmappen-Explorer** auf **OrgIdFederationSample**, und klicken Sie dann auf **Eigenschaften**.
...
<h2><a name="provisionapp"></a>Schritt 2: Bereitstellen der Anwendung in einem Directory-Mandanten eines Unternehmens</h2>
...
Die in diesem Schritt ausgegebenen Informationen sehen in etwa folgendermaßen aus:
		...
		Usage                 : Verify 
	<div class="dev-callout"><strong>Hinweis</strong><p>Sie sollten diese Ausgabe, besonders den generierten symmetrischen Schlüssel, speichern. Dieser Schlüssel wird Ihnen nur während der Erstellung des Dienstprinzipals angezeigt, und Sie können ihn in Zukunft nicht mehr abrufen. Die anderen Werte werden zur Verwendung der Graph-API benötigt, um Informationen im Verzeichnis zu lesen und zu schreiben.</p></div>
...
<h2><a name="protectapp"></a>Schritt 3: Schutz der Anwendung mit WS-Federation zur Mitarbeiteranmeldung</h2>
...
5. Wählen Sie auf der nächsten Seite der Federation Utility die Option **Überprüfung der Zertifikatskette deaktivieren** aus, und klicken Sie dann auf **Weiter**.
...
9. Erweitern Sie im linken Menü des IIS-Managers den Ordner **Sites**, klicken Sie dann auf **Standardwebsite-Home**. Klicken Sie rechts im Menü **Aktionen** auf **Bindungen...**.

10. Klicken Sie im Dialogfeld **Sitebindungen** auf **Hinzufügen**. Ändern Sie im Dialogfeld **Sitebindung hinzufügen** im Dropdownmenü **Typ** den Wert auf ***https***, und wählen Sie dann unter **SSL-Zertifikat** die Option **IIS Express-Entwicklungszertifikat** aus. Klicken Sie auf **OK**.
...
15. Fügen Sie im Abschnitt **system.web** einen Knoten **httpRuntime** mit dem Attribut **requestValidationMode** und dem Wert **2.0** hinzu. Beispiel:
...
<h2><a name="summary"></a>Zusammenfassung</h2>
In diesem Lernprogramm haben Sie erfahren, wie Sie eine Anwendung für einen einzelnen Mandanten erstellen und konfigurieren können, die die Möglichkeiten einer einmaligen Anwendung mit Azure Active Directory nutzt. Sie können auch Anwendungen für mehrere Mandanten in Azure Active Directory erstellen. Lesen Sie dafür das Lernprogramm [Entwickeln von Cloud-Anwendungen für mehrere Mandanten mit Azure Active Directory].
