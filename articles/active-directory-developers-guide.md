...
1. **[Integration in Azure AD](active-directory-how-to-integrate.md)**: Hier erfahren Sie, warum die Integration in Azure Active Directory die beste Lösung für eine sichere Anmeldung und Autorisierung ist.
...
#### Videos
Falls Sie das Lernen per Video vorziehen, können Sie sich diese Übersichtspräsentationen zum Entwickeln von Apps mit Azure Active Directory ansehen. Darin sehen Sie meist Referenten, die direkt im Engineering Team arbeiten und für Sie wichtige Themen durchgehen, z. B. IDMaaS, Authentifizierung, Identitätsverbund und einmaliges Anmelden (Single Sign-On, SSO).
...
- [Auflisten Ihrer Anwendung in der Azure AD-Anwendungsgalerie](active-directory-app-gallery-listing.md)
