...
-   Blob: Eine Datei von beliebiger Art und Größe. Es gibt zwei Arten von Blobs, die im Azure-Blob-Speicherdienst gespeichert werden können: Block- und Seiten-Blobs. Für die SQL Server-Sicherung werden Seiten-Blobs verwendet. Blobs sind über das folgende URL-Format adressierbar: `https://<storage account>.blob.core.windows.net/<container>/<blob>` Weitere Information zu Seiten-Blobs finden Sie unter [Grundlegendes zu Block-BLOBs und Seiten-BLOBs](http://msdn.microsoft.com/de-de/library/windowsazure/ee691964.aspx).
