...
[WACOM.INCLUDE [Haftungsausschluss][]]
...
4.  Klicken Sie auf die Schaltfläche "Speichern", um die Änderungen zu speichern.
    ...
    **Hinweis:** Die höchste für den 24-Stunden-Zeitraum angegebene Anzahl an Einheiten wird zum Berechnen der Kosten verwendet. Informationen zu den Preisen finden Sie unter [Media Services Pricing Details][].
...
1.  Melden Sie sich im [Verwaltungsportal][] an Ihrem Azure-Konto an.
2.  Wechseln Sie zu [Support][].
