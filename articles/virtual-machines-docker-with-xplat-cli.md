...
Damit Docker mit einem virtuellen Azure-Computer verwendet werden kann, muss das für den virtuellen Computer verwendete Linux-Abbild über den installierten [Azure Linux VM Agent](http://azure.microsoft.com/de-de/documentation/articles/virtual-machines-linux-agent-user-guide/) verfügen. Zurzeit stehen nur zwei Imagetypen zur Verfügung, die diesen bereitstellen:

+ Ein Ubuntu-Image aus dem Azure-Image-Katalog oder 

+ Ein benutzerdefiniertes Linux-Image, das Sie mit dem installierten und konfigurierten Azure Linux VM Agent erstellt haben. Unter [Azure Linux VM Agent](http://azure.microsoft.com/de-de/documentation/articles/virtual-machines-linux-agent-user-guide/) finden Sie weitere Informationen über das Erstellen eines benutzerdefinierten virtuellen Linux-Computers mit dem Azure VM Agent.
