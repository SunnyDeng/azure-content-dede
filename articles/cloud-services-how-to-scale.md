<properties urlDisplayName="How to scale" pageTitle="Skalieren eines Cloud-Diensts &ndash; Azure" metaKeywords="Azure link resource, scaling cloud service" description="Hier erfahren Sie, wie Sie einen Cloud-Dienst und verkn&uuml;pfte Ressourcen in Azure skalieren." metaCanonical="" services="cloud-services" documentationCenter="" title="Skalieren einer Anwendung" authors="davidmu" solutions="" manager="timlt" editor="" />
