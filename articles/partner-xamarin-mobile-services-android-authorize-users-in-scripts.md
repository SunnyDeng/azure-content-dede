<properties urlDisplayName="Authorize Users in Scripts (Xamarin.Android)" pageTitle="Autorisieren von Benutzern in Skripts (Xamarin.Android) - Azure Mobile Services" metaKeywords="Azure Autorisieren von Benutzern, Xamarin.Android Skripts Autorisierung, mobile services autorisieren" description="Erfahren Sie, wie Sie Benutzer mithilfe von Skripts in Ihrer Azure Mobile Services-App für Xamarin.Android autorisieren." metaCanonical="" disqusComments="1" umbracoNaviHide="1" title="Use scripts to authorize users in Mobile Services" authors="donnam" manager="dwrede" />
...
In diesem Thema erfahren Sie, wie Sie Serverskripts verwenden, um authentifizierte Benutzer für den Zugriff auf Daten in Azure Mobile Services von einer Xamarin.Android-App zu autorisieren.  In diesem Lernprogramm registrieren Sie Skripts mit Mobile Services, um Abfragen basierend auf der userID eines authentifizierten Benutzers zu filtern, sodass jeder Benutzer nur seine eigenen Daten sehen kann.
