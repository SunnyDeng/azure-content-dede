...
Um den **Kontonamen** und Informationen zum **Kontoschlüssel** zu erhalten, öffnen Sie das klassische **Azure-Portal**, wählen Ihr Media Services-Konto aus und klicken auf die Schaltfläche **SCHLÜSSEL VERWALTEN**.
