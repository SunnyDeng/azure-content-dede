...
1. Erstellen eines Ausgabemedienobjekts für den Codierungsauftrag im angegebenen Speicherkonto.
	...
	namespace MultipleStorageAccounts { class Program { // Location of the media file that you want to encode. private static readonly string singleInputFilePath = Path.GetFullPath(@"../..\\supportFiles\\multifile\\interview2.wmv");
