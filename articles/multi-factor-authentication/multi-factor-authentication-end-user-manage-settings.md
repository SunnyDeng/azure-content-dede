...
![Einrichtung](./media/multi-factor-authentication-end-user-manage-myapps/proofup.png)
...
3. Wählen Sie in der Dropdownliste "Zusätzliche Sicherheitsüberprüfung" aus. ![Einrichtung](./media/multi-factor-authentication-end-user-manage/azure1.png)
4. Dadurch gelangen Sie zu der Seite, auf der Sie Ihre Einstellungen ändern können. ![Einrichtung](./media/multi-factor-authentication-end-user-manage-azure/proofup.png)
