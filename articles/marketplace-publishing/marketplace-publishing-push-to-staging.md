<properties
   pageTitle="Vorbereiten und Testen Ihres Angebot für die Bereitstellung im Azure Marketplace | Microsoft Azure"
...
In diesem Schritt des Veröffentlichungsprozesses müssen Sie bestimmte Marketinginhalte sowie Details zu Ihrem Angebot und/oder SKUs im Azure Marketplace bereitstellen, wie beispielsweise eine Beschreibung Ihres Produkts, Firmenlogos, Preispläne, Informationen zu Werken sowie weitere Informationen, die zum Überführen Ihres Angebots und/oder Ihrer SKU in der Stagingumgebung erforderlich sind. Diese Informationen werden in unserem Azure Portal als Marketinginhalte verwendet. Sie starten diesen Prozess im [Veröffentlichungsportal][link-pubportal].
...
2.	Laden Sie Abbildungen gemäß den erforderlichen Spezifikationen (wie im Veröffentlichungsportal erläutert) im PNG-Format hoch. Laden Sie ein Bild für jede gewünschte Größe hoch.
...
|Kostenlose Version | Dieser Plan ist immer kostenlos. |
...
4.	Wenn Ihre SKU auf Stundenbasis abgerechnet wird, geben Sie die Preise für Ihre Software ein. SKUs ohne Preis stehen nicht zum Kauf oder zur Verwendung zur Verfügung.
  ...
  >[AZURE.NOTE]Wenn Sie sowohl über BYOL-SKUs als auch auf Stundenbasis abgerechnete SKUs verfügen, stellen Sie sicher, dass beide Optionen angegeben sind.
...
Einige dieser Informationen haben Sie bereits im Schritt für die Zertifizierung eingegeben. In den nächsten Schritten können Sie Informationen hinzufügen oder bearbeiten. Die Kontaktinformationen werden nur für die interne Kommunikation zwischen dem Partner und Microsoft verwendet. Für die Endkunden steht eine Support-URL zur Verfügung.
...
4.	Geben Sie eine Support-URL ein.

## Schritt 4: Auswählen von Azure Marketplace-Kategorien
Auf der Registerkarte **Kategorien** stehen Ihnen verschiedene Möglichkeiten zur Auswahl. Wenn Ihr Angebot sich hier einordnen lässt, können Sie bis zu fünf (5) Kategorien auswählen.

## Verwendung Ihrer Marketinginhalte
Im Folgenden finden Sie eine detaillierte Übersicht darüber, wie die Marketinginhalte des Angebots im Veröffentlichungsportal auf der [Azure Marketplace-Website](http://azure.microsoft.com/marketplace) und im [Marketplace-Katalog des Azure-Vorschauportals](https://ms.portal.azure.com) verwendet werden.

### Auf der Website des Azure.com-Marketplace
...
*Auflisten der Angebote auf der Website des Azure.com-Marketplace*

![Abbildung](media/marketplace-publishing-push-to-staging/acom-listing-details-01.png)

*Beschreibung der Angebote auf der Website des Azure.com-Marketplace*

![Abbildung](media/marketplace-publishing-push-to-staging/acom-listing-details-02.png)

*Preisinformationen zu den Angeboten auf der Website des Azure.com-Marketplace*

### Im Marketplace-Katalog des Azure-Vorschauportals
![Abbildung](media/marketplace-publishing-push-to-staging/portal-catalog-01.png)

*Auflisten der Angebote im Marketplace-Katalog des Azure-Vorschauportals*

![Abbildung](media/marketplace-publishing-push-to-staging/portal-listing-details-01.png)

![Abbildung](media/marketplace-publishing-push-to-staging/portal-listing-details-01.png)

*Beschreibung der Angebote im Marketplace-Katalog des Azure-Vorschauportals*
