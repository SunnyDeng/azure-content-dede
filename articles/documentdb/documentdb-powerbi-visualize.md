<properties 
	pageTitle="Tutorial zu DocumentDB und Power BI-Visualisierungen | Microsoft Azure" 
	description="Erfahren Sie, wie Power BI Desktop verwendet wird, um aussagekräftige Berichte mit JSON-Daten aus DocumentDB, einer vollständig verwalteten NoSQL-Dokumentdatenbank, zu erstellen." 
	services="documentdb" 
	authors="h0n" 
	manager="jhubbard" 
	editor="mimig" 
...
# Visualisieren von DocumentDB-Daten mit Power BI
...
In diesem Tutorial gehen wir die Schritte zum Herstellen einer Verbindung mit einem DocumentDB-Konto in Power BI Desktop durch, navigieren zu einer Sammlung, aus der die Daten mithilfe des Navigators extrahiert werden sollen, transformieren JSON-Daten mit dem Abfrage-Editor von Power BI Desktop in das Tabellenformat und erstellen und veröffentlichen einen Bericht in PowerBI.com.
...
Bevor Sie diesen Artikel durcharbeiten, sollten Sie sicherstellen, dass Sie über Folgendes verfügen:
...
Sie möchten die Daten zu Vulkanen aus dem DocumentDB-Konto abrufen und einen interaktiven Power BI-Bericht wie den folgenden erzeugen.

![Power BI Desktop – Bericht zu Vulkanen](./media/documentdb-powerbi-visualize/pbireportfinal.png)

Sind Sie bereit, es zu versuchen? Lassen Sie uns anfangen.

## Herstellen einer Verbindung mit einem DocumentDB-Konto
...
2. Nach dem Start von Power BI Desktop wird eine *Willkommensseite* angezeigt.
	...
	![Power BI Desktop – Willkommensseite](./media/documentdb-powerbi-visualize/welcomescreen.png)
...
3. Direkt über die *Willkommensseite* können Sie **Daten abrufen**, **aktuelle Quellen** anzeigen oder **andere Berichte öffnen**. Klicken Sie oben rechts auf das X, um das Dialogfeld zu schließen. Die Ansicht **Bericht** von Power BI Desktop wird angezeigt.
	...
	![Power BI Desktop – Berichtsansicht](./media/documentdb-powerbi-visualize/pbireportview.png)
...
5. Klicken Sie auf **Azure**, wählen Sie **Microsoft Azure DocumentDB (Beta)** aus, und klicken Sie dann auf **Verbinden**. Das Fenster **Verbindung mit Microsoft Azure DocumentDB** wird angezeigt.
	...
	![Power BI Desktop – Daten abrufen](./media/documentdb-powerbi-visualize/pbigetdata.png)
...
6. Geben Sie die Endpunkt-URL des DocumentDB-Kontos an, von dem Sie die Daten abrufen möchten, wie unten dargestellt, und klicken Sie dann auf **OK**. Sie können die URL aus dem URI-Feld auf dem Blatt **Schlüssel** des Azure-Vorschauportals nutzen, oder Sie können die oben angegebenen Informationen für das Demokonto verwenden. Weitere Informationen finden Sie unter [Schlüssel](documentdb-manage-account.md#keys).
	...
	*Hinweis: In diesem Tutorial geben wir keinen Datenbanknamen, Sammlungsnamen bzw. keine SQL-Anweisung an, da diese Felder optional sind. Stattdessen verwenden wir den Navigator zum Auswählen der Datenbank und der Sammlung, um zu bestimmen, woher die Daten stammen.*
    ...
    ![Power BI Desktop – Fenster „Verbinden“](./media/documentdb-powerbi-visualize/pbiconnectwindow.png)
...
7. Wenn Sie zum ersten Mal eine Verbindung mit diesem Endpunkt herstellen, werden Sie aufgefordert, den Kontoschlüssel anzugeben. Geben Sie den Kontoschlüssel an, und klicken Sie auf **Verbinden**.
	...
	*Hinweis: Es wird empfohlen, den Schlüssel mit Leseberechtigung beim Erstellen von Berichten zu verwenden. Dadurch wird verhindert, dass der Hauptschlüssel unnötig potenziellen Sicherheitsrisiken ausgesetzt wird. Der Schlüssel mit Lesezugriff ist auf dem Blatt „Schlüssel mit Leseberechtigung“ des Azure-Vorschauportals verfügbar, oder Sie können die oben angegebenen Informationen für das Demokonto verwenden.*

    ![Power BI Desktop – Kontoschlüssel](./media/documentdb-powerbi-visualize/pbidocumentdbkey.png)
...
1. Im Abfrage-Editor von Power BI sollte eine Spalte **Dokument** im mittleren Bereich angezeigt werden. ![Power BI Desktop – Abfrage-Editor](./media/documentdb-powerbi-visualize/pbiqueryeditor.png)
...
2. Klicken Sie auf das Erweiterungssteuerelement rechts in der Spaltenüberschrift **Dokument**. Das Kontextmenü mit einer Liste von Feldern wird angezeigt. Wählen Sie die Felder aus, die Sie für Ihren Bericht benötigen, z. B. „Volcano Name“, „Country“, „Region“, „Location“, „Elevation“, „Type“, „Status“ und „Last Know Eruption“. Klicken Sie dann auf **OK**.
	...
	![Power BI Desktop – Dokumente erweitern](./media/documentdb-powerbi-visualize/pbiqueryeditorexpander.png)

3. Im mittleren Bereich wird eine Vorschau des Ergebnisses mit den ausgewählten Feldern angezeigt.

	![Power BI Desktop – Ergebnis vereinfachen](./media/documentdb-powerbi-visualize/pbiresultflatten.png)
...
5. Klicken Sie auf das Erweiterungssteuerelement rechts in der Spaltenüberschrift „Location“. Das Kontextmenü mit Typ- und Koordinatenfeldern wird angezeigt. Wir wählen das Koordinatenfeld aus und klicken auf **OK**.

    ![Power BI Desktop – Standortdatensatz](./media/documentdb-powerbi-visualize/pbilocationrecord.png)
...
6. Im mittleren Bereich wird nun eine Spalte „coordinates“ mit dem Typ **Liste** angezeigt. Wie am Anfang des Tutorials dargestellt, weisen die GeoJSON-Daten in diesem Tutorial den Typ „Punkt“ auf. Die Werte für den Breiten- und Längengrad wurden im Koordinatenarray aufgezeichnet.
	...
	*Hinweis: Das Element „ coordinates[0]“ stellt den Längengrad und „coordinates[1]“ den Breitengrad dar.* ![Power BI Desktop – Koordinatenliste](./media/documentdb-powerbi-visualize/pbiresultflattenlist.png)
...
9. Geben Sie dann die benutzerdefinierte Formel für die neue Spalte ein. In unserem Beispiel verketten wir die Werte für Breiten- und Längengrad, getrennt durch ein Komma, wie unten dargestellt, mit der folgenden Formel: Text.From([coordinates]{1})&","&Text.From([coordinates]{0}). Klicken Sie auf **OK**.
    ...
    *Hinweis: Weitere Informationen zu DAX (Data Analysis Expressions), einschließlich der DAX-Funktionen, finden Sie unter [DAX Basic in Power BI Desktop](https://support.powerbi.com/knowledgebase/articles/554619-dax-basics-in-power-bi-desktop) (in englischer Sprache).*
    ...
    ![Power BI Desktop – Benutzerdefinierte Spalte](./media/documentdb-powerbi-visualize/pbicustomlatlong.png)
...
10. Jetzt wird im mittleren Bereich die neue LatLong-Spalte mit den Werten für Breiten- und Längengrade, die durch ein Komma getrennt sind, angezeigt.
	...
	![Power BI Desktop – Benutzerdefinierte Spalte „LatLong“](./media/documentdb-powerbi-visualize/pbicolumnlatlong.png)
...
11. Jetzt ist das Vereinfachen der Daten in ein Tabellenformat abgeschlossen. Sie können sämtliche im Abfrage-Editor verfügbare Funktionen zum Formen und Transformieren von Daten in DocumentDB nutzen. Sie können z. B. den Datentyp für „Elevation“ in **Dezimalzahl** ändern, indem Sie den **Datentyp** im Menüband **Start** ändern.
    ...
    ![Power BI Desktop – Typ ändern](./media/documentdb-powerbi-visualize/pbichangetype.png)

12. Klicken Sie auf **Schließen und übernehmen**, um das Datenmodell zu speichern.
    
    ![Power BI Desktop – Schließen und übernehmen](./media/documentdb-powerbi-visualize/pbicloseapply.png)

## Erstellen der Berichte
In der Berichtsansicht von Power BI Desktop können Sie Berichte erstellen. Sie können Berichte erstellen, indem Sie Felder in den Zeichenbereich **Bericht** ziehen.

![Power BI Desktop – Berichtsansicht](./media/documentdb-powerbi-visualize/pbireportview2.png)
...
6. Sie haben jetzt einen einfachen Bericht erstellt. Sie können den Bericht weiter anpassen, indem Sie weitere Visualisierungen hinzufügen. In unserem Fall haben wir einen Datenschnitt für den Vulkantyp hinzugefügt, um den Bericht interaktiv zu gestalten.
    ...
    ![Power BI Desktop – Fertiger Bericht](./media/documentdb-powerbi-visualize/pbireportfinal.png)
...
## Nächste Schritte
- Um weitere Informationen zu Power BI zu erhalten, klicken Sie [hier](https://support.powerbi.com/knowledgebase).
