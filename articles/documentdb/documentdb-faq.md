...
Jede Sammlung ist mit einer Zuweisung an Datenbankspeicher und bereitgestelltem Durchsatz auf einer der unterstützten Leistungsstufen ausgestattet. Weitere Informationen zu Leistungsstufen finden Sie unter [Leistungsstufen](documentdb-performance-levels.md). Außerdem sind für jede vom Dienst verwaltete Ressource Kontingente angegeben. Weitere Informationen finden Sie unter [DocumentDB-Grenzen](documentdb-limits.md).
