...
Dieser Artikel bietet eine Einführung in die Funktionsweise der automatischen Indizierung in DocumentDB und ist ein Auszug aus dem Artikel „Schemaagnostische Indizierung mit Azure DocumentDB“, der bei der [VLDB-Konferenz 2015](http://www.vldb.org/2015/) vorgestellt wird. Nach dem Lesen dieses Artikels können Sie die folgenden Fragen beantworten:
...
- Nachdem Sie die Funktionsweise der Indizierung kennen gelernt haben, können Sie sich nun mit [Abfragen mit DocumentDB-SQL](documentdb-sql-query.md) befassen.
