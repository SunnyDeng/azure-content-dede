...
Beachten Sie, dass Azure Möglichkeiten bietet, Java-Websites mithilfe der Konfigurationsbenutzeroberfläche des Azure-Portals und der Azure-Anwendungsgalerie zu erstellen. Informationen hierzu finden Sie unter [Erste Schritte mit Azure-Websites und Java][Erste Schritte mit Azure-Websites und Java]. Dieses Lernprogramm eignet sich für Szenarien, in denen Sie nicht die Azure-Konfigurationsbenutzeroberfläche oder die Azure-Anwendungsgalerie verwenden möchten.
...
1.  Erstellen Sie im Stammverzeichnis Ihrer Azure-Website, also **d:\\home\\site\\wwwroot**, ein Verzeichnis namens **webapps** (falls nicht bereits vorhanden), und speichern Sie die Hudson.war-Datei unter **d:\\home\\site\\wwwroot\\webapps**.
...
3.  Erstellen Sie unter **d:\\home\\site\\wwwroot** eine web.conifg-Datei, und kopieren Sie die folgenden Inhalte hinein:
    ...
    Nun kann die Website neu gestartet werden, um die Änderungen zu übernehmen. Stellen Sie eine Verbindung mit <http://yoursite/hudson> her, um Hudson zu starten.
...
6.  Konfigurieren Sie das JDK wie unten gezeigt:
    ...
    ![Hudson configuration][Hudson configuration]
...
Weitere Informationen zu Hudson finden Sie unter [][]<http://hudson-ci.org></a>.
...
-   Legen Sie für den HTTP-Konnektor
     `<Connector port="${port.http}" protocol="HTTP/1.1" connectionTimeout="600000" address="127.0.0.1" URIEncoding="UTF-8" />` fest.
...
Sobald Sie diese Änderungen vorgenommen haben, starten Sie Ihre Website neu mit Liferay und öffnen dann <http://yoursite>. Das Liferay-Portal ist über das Website-Root-Verzeichnis verfügbar.

Weitere Informationen über Liferay finden Sie unter [][1]<http://www.liferay.com></a>.

  [Erste Schritte mit Azure-Websites und Java]: ../web-sites-java-get-started
