...
3. Die PHP-Version ist jetzt festgelegt.
	...
	![Festlegen der PHP-Version mit der Azure-Befehlszeilenschnittstelle][SETPHPVERXPLAT]
4. Sie können diese Einstellungen bestätigen, indem Sie `azure site show [site-name]` eingeben und dann die EINGABETASTE drücken.
	...
	![Überprüfen der PHP-Version mit der Azure-Befehlszeilenschnittstelle][GETPHPVERXPLAT]
