<properties urlDisplayName="Install software on VM" pageTitle="Installieren von Software auf dem virtuellen Linux-Computer &ndash; Azure" metaKeywords="" description="Erfahren Sie, wie Sie mithilfe von CentOS/Red Hat oder Ubuntu Software auf Ihrem virtuellen Linux-Computer in Azure installieren." metaCanonical="" services="virtual-machines" documentationCenter="" title="Installieren von Software auf dem virtuellen Linux-Computer in Azure" authors="timlt" solutions="" manager="timlt" editor="" />
