<properties urlDisplayName="How to configure" pageTitle="Konfigurieren eines Cloud-Diensts &ndash; Azure" metaKeywords="Configuring cloud services" description="Hier erfahren Sie, wie Sie Cloud-Dienste in Azure konfigurieren. Hier erfahren Sie, wie Sie die Konfiguration f&uuml;r Cloud-Dienste aktualisieren und Remotezugriff auf Rolleninstanzen konfigurieren." metaCanonical="" services="cloud-services" documentationCenter="" title="Konfigurieren von Cloud-Diensten" authors="davidmu" solutions="" manager="timlt" editor="" />
...
1.  Klicken Sie im [Azure-Verwaltungsportal][Azure-Verwaltungsportal] auf **Cloud-Dienste** und dann auf den Namen des Cloud-Diensts, und klicken Sie dann auf **Konfigurieren**.
...
2.  Legen Sie in **Überwachung** die Überwachungsstufe auf "Ausführlich" oder "Minimal" fest, und konfigurieren Sie die Diagnoseverbindungszeichenfolgen, die für eine ausführliche Überwachung benötigt werden. Anweisungen hierzu finden Sie unter [Überwachen von Cloud-Diensten][Überwachen von Cloud-Diensten].
...
1.  Klicken Sie auf **Cloud-Dienste** und dann auf den Namen des Cloud-Diensts, und klicken Sie dann auf **Konfigurieren**.
...
5.  Klicken Sie auf **OK** (Häkchen).
  ...
  [Verwenden von Remotedesktop mit Azure-Rollen]: http://msdn.microsoft.com/de-de/library/windowsazure/gg443832.aspx
