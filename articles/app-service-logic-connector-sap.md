...
Connectors können in Logik-Apps als Teil eines Datenflusses verwendet werden, um Daten im Rahmen eines Datenflusses abzurufen, zu verarbeiten oder per Pushvorgang zu übermitteln. 
In manchen Szenarien müssen Sie möglicherweise mit einem SAP-System arbeiten, das lokal und hinter der Firewall installiert ist. Mithilfe des SAP-Connectors im Datenfluss können Sie eine Vielzahl von Szenarien erzielen. Einige Beispiele:  
...
2. Klicken Sie auf den Link 'Download and Configure'.
