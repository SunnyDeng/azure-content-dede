<properties 
	pageTitle="Suchdienst: Workflow für Entwickler" 
	description="Suchdienst: Workflow für Entwickler"
	services="search" 
	documentationCenter="" 
	authors="HeidiSteen" 
	manager="mblythe" 
...
[OData-Ausdruckssyntax für Azure Search](http://msdn.microsoft.com/library/dn798921.aspx)
[Syntax für einfache Abfragen in Azure Search](http://msdn.microsoft.com/library/dn798920.aspx)
...
Weitere Informationen zur Erstellung von Indizes und Dokumenten finden Sie unter [Azure Search REST-API](http://msdn.microsoft.com/library/dn798935.aspx).
