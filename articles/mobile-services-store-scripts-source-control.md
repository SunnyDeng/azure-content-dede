...
1. Installieren von Git auf Ihrem lokalen Computer 
...
[Aufrufen einer benutzerdefinierten API aus dem Client]: /de-de/documentation/articles/mobile-services-ios-call-custom-api/
