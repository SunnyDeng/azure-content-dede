<properties urlDisplayName="Upload a SUSE Linux VHD" pageTitle="Erstellen und Hochladen einer SUSE Linux-VHD in Azure" metaKeywords="Azure VHD, uploading Linux VHD, SUSE, SLES, openSUSE" description="Learn to create and upload an Azure virtual hard disk (VHD) that contains a SUSE Linux operating system." metaCanonical="" services="virtual-machines" documentationCenter="" title="Creating and Uploading a Virtual Hard Disk that Contains a SUSE Linux Operating System" authors="szarkos" solutions="" manager="timlt" editor="tysonn" />
...
## <a id="sles11"> </a>Vorbereiten von SUSE Linux Enterprise Server 11 SP3 ##
...
## <a id="osuse"> </a>Vorbereiten von openSUSE 13.1+ ##
