<properties 
   ...
   description="Beschreibung von StorSimple-Features, -Architektur und -Komponenten." 
   services="storsimple" 
...
- **StorSimple-Momentaufnahmen-Manager** - Ein MMC-Snap-In, das Volumegruppen und den Volumeschattenkopie-Dienst von Windows verwendet, um anwendungskonsistente Sicherungen zu generieren. Darüber hinaus können Sie den StorSimple-Momentaufnahmen-Manager zum Erstellen von Sicherungszeitplänen und Klonen oder Wiederherstellen von Volumes einsetzen. 
...
Erfahren Sie mehr über die [StorSimple-Komponenten](https://technet.microsoft.com/library/cc754482.aspx), und überprüfen Sie die [StorSimple-Versionsanmerkungen](https://msdn.microsoft.com/library/azure/dn772367.aspx).
