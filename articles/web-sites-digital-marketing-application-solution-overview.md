<properties urlDisplayName="Resources" pageTitle="Erstellen einer digitalen Marketingkampagne mithilfe von Azure-Websites" metaKeywords="" description="Dieser Leitfaden bietet einen technischen Überblick über das Erstellen von digitalen Marketingkampagnen mithilfe von Azure-Websites. Dazu gehören die Bereitstellung, die Integration von sozialen Medien, Skalierungsstrategien und die Überwachung." metaCanonical="" services="" documentationCenter="" title="Create a Digital Marketing Campaign on Azure Websites" authors="jroth" solutions="" manager="wpickett" editor="mollybos" />
