...
Die Active Directory Premium Edition ist ein kostenpflichtiges Angebot von Azure Active Directory mit dem vollen Funktionsumfang der Basic Edition plus den folgenden Funktionen:
...
- **Mehrstufige Authentifizierung** – Die nun in der Premium Edition enthaltene mehrstufige Authentifizierung hilft Ihnen beim Schutz des Zugriffs auf lokale Anwendungen (VPN, RADIUS usw.), Azure, Microsoft-Onlinedienste wie Office 365 und Dynamics CRM Online sowie Tausende von Clouddiensten von Drittanbietern, die bereits mit Azure Active Directory integriert sind. Aktivieren Sie einfach die mehrstufige Authentifizierung für Azure Active Directory-Identitäten, und Benutzer werden bei der nächsten Anmeldung aufgefordert, sich durch eine zusätzliche Verifizierung auszuweisen.

    Weitere Informationen finden Sie unter [Hinzufügen der mehrstufigen Authentifizierung zu Azure Active Directory](https://msdn.microsoft.com/library/azure/dn249466.aspx).
...
- **Microsoft Identity Manager (MIM)** – Die Premium Edition beinhaltet die Möglichkeit, in Ihrem lokalen Netzwerk die Rechte zur Nutzung eines MIM-Servers (und zur Nutzung von CALs) zu erteilen, um beliebige Kombinationen von Hybrid-Identity-Lösungen zu unterstützen. Dies ist ein großartiges Feature, wenn Sie verschiedene lokale Verzeichnisse und Datenbanken verwenden, die Sie direkt mit Azure Active Directory synchronisieren möchten. Die Anzahl der FIM-Server, die Sie verwenden können, ist unbeschränkt, die Erteilung von MIM CALs basiert jedoch auf der Zuweisung einer Azure Active Directory Premium-Benutzerlizenz.
    ...
    Weitere Informationen finden Sie unter [Bereitstellen von MIM 2010 R2](https://www.microsoft.com/de-de/server-cloud/products/forefront-identity-manager/features.aspx).
...
- Bidirektionale Synchronisierung über [Azure Active Directory Connect](https://msdn.microsoft.com/library/azure/dn832695.aspx)
- Verwaltungseinheiten: ein neuer Azure Active Directory-Container mit Ressourcen, die zum Delegieren administrativer Berechtigungen und Anwenden von Richtlinien für bestimmte Benutzergruppen verwendet werden können
- Cloud-Anwendungserkennung: Ermitteln Sie schnell und einfach, welche Cloud-Anwendungen in Ihrem Unternehmen genutzt werden
- Hinzufügen eigener SaaS-Anwendungen zu Azure Active Directory
- Hinzufügen von Sicherheitsfragen für die Self-Service-Kennwortrücksetzung
- Zustandsüberwachung für Azure Active Directory Connect: Überwachen Sie den Zustand Ihrer lokalen Active Directory-Infrastruktur und rufen Sie Nutzungsanalysen ab
...
- Dynamische Gruppen; [hier finden Sie weitere Informationen](https://msdn.microsoft.com/library/azure/dn913807.aspx)
- Bedingter Zugriff: mehrstufige Authentifizierung pro Anwendung 
- HR-Anwendungsintegration: Arbeitstag

## Vergleich der Free, Basic und Premium Edition

Azure Active Directory Basic und Azure Active Directory Premium bieten im Vergleich zur Free Edition ein reichhaltigeres Angebot an erweiterten Funktionen zur Optimierung der Verwaltungsaufgaben auf Unternehmensebene und Vereinfachung der Aufgaben eines Administrators. In den folgenden Abschnitten sind die allen drei Editions gemeinsamen Verwaltungsvorteile aufgeführt. Entnehmen Sie diesen Listen zudem, wie diese Features durch die Registrierung der Azure Active Directory Basic oder Azure Active Directory Premium Edition aufgewertet werden.

### Gemeinsame Features

- Das Angebot „Verzeichnis als Dienst“ ist für die Free Edition auf Objekte bis zu einem Volumen von 500K begrenzt. Diese Einschränkung gilt jedoch nicht für Office 365, Windows Intune oder einen anderen Microsoft-Onlinedienst, der von Azure Active Directory als Verzeichnisdienst abhängig ist. Für die Basic und Premium Edition gilt keine Einschränkung des Objektvolumens.
- Benutzer- und Gruppenverwaltung mithilfe der Benutzeroberfläche oder der Windows PowerShell-Cmdlets
- Zugriffsbereichsportal für SSO-basierten Benutzerzugriff auf SaaS- und benutzerdefinierte Anwendungen in Azure Active Directory Free und Basic Edition: Endbenutzer, denen Zugriff auf SaaS-Anwendungen zugewiesen wurde, können in ihrem Zugriffsbereich bis zu 10 dieser Anwendungen anzeigen und mittels SSO darauf zugreifen (sofern sie vom Administrator für SSO konfiguriert wurden). Mit der Free Edition können Administratoren SSO konfigurieren und Benutzerzugriff auf beliebig viele SaaS-Anwendungen zuweisen; die Endbenutzer können in ihrem Zugriffsbereich jedoch jeweils nur 10 Anwendungen anzeigen. Für Azure Active Directory Premium gilt keine Anwendungseinschränkung.
...
- Anwendungsproxy: sicherer Remotezugriff und SSO für lokale Webanwendungen

### Nur in der Premium Edition enthaltene Features
...
- Mehrstufiger Authentifizierungsdienst für Cloudbenutzer
- Mehrstufiger Authentifizierungsserver für lokale Benutzer
