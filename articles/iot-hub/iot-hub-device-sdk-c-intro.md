...
* Die **IoTHubClient**-Bibliothek hängt von anderen Open-Source-Bibliotheken ab:
   ...
   * Der [Azure uMQTT](https://github.com/Azure/azure-umqtt-c)-Bibliothek, einer allgemeinen Bibliothek, die das Protokoll MQTT implementiert und für Geräte mit eingeschränkten Ressourcen optimiert ist.
...
Zunächst müssen Sie eine Kopie des SDK von GitHub abrufen und dann die Quelle erstellen. Sie müssen eine Kopie des Quellcodes aus dem Verzeichnis **master** des [GitHub-Repositorys](https://github.com/Azure/azure-iot-sdks) abrufen.

Nachdem Sie eine Kopie des Quellcodes heruntergeladen haben, müssen Sie die Schritte ausführen, die im SDK-Artikel [Vorbereiten Ihrer Entwicklungsumgebung](https://github.com/Azure/azure-iot-sdks/blob/master/c/doc/devbox_setup.md) beschrieben sind.
...
Wenn Sie alle auf der Seite [Vorbereiten der Entwicklungsumgebung](https://github.com/Azure/azure-iot-sdks/blob/master/c/doc/devbox_setup.md) beschriebenen Schritte abgeschlossen haben, sind Sie bereit, die Beispielanwendungen zu kompilieren.
...
Das Tool [Device Explorer](https://github.com/Azure/azure-iot-sdks/tree/master/tools/DeviceExplorer) verwendet die Azure IoT-Dienstbibliotheken, um verschiedene Aufgaben in IoT Hub auszuführen – z. B. das Hinzufügen von Geräten. Wenn Sie den Geräte-Explorer zum Hinzufügen eines Geräts verwenden, erhalten Sie eine entsprechende Verbindungszeichenfolge. Sie benötigen diese Verbindungszeichenfolge, um die Beispielanwendungen auszuführen.
...
Einen Windows Installer für Device Explorer finden Sie auf der [GitHub-Seite „releases“](https://github.com/Azure/azure-iot-sdks/releases). Sie können das Tool jedoch auch direkt aus seinem Code starten, indem Sie **[DeviceExplorer.sln](https://github.com/Azure/azure-iot-sdks/blob/master/tools/DeviceExplorer/DeviceExplorer.sln)** in **Visual Studio 2015** öffnen und die Projektmappe erstellen.
...
Innerhalb des Ordners **iothub\_client** im Repository „azure-iot-sdks“ gibt es den Ordner **samples** mit einer Anwendung namens **iothub\_client\_sample\_amqp**.
