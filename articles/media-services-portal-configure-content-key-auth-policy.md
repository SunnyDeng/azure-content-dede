...
##Nächste Schritte
Nachdem Sie die Autorisierungsrichtlinie für Inhaltsschlüssel jetzt konfiguriert haben, fahren Sie mit dem Thema [Gewusst wie: Aktivieren der Verschlüsselung im Azure-Verwaltungsportal](media-services-manage-content#encrypt.md) fort.
