...
* [Anleitung](#howto) - Erstellen, Bereitstellen und Konfigurieren Ihrer Website
...
* **MySQL-Datenbank** - Verfügbar über [ClearDB im Azure Shop][cdbnstore]. Sie können auch Ihre eigene MySQL-Installation auf virtuellen Azure-Computern entweder mithilfe von [Windows][mysqlwindows] oder [Linux][mysqllinux] verwalten.
    ...
    > [WACOM.NOTE] ClearDB bietet mehrere MySQL-Konfigurationen mit unterschiedlichen Leistungsmerkmalen für jede Konfiguration. Weitere Informationen zu den Angeboten im [Azure Store][cdbnstore] finden Sie dort sowie zu [ClearDB-Preisen](http://www.cleardb.com/pricing.view) für Angebote, die direkt von ClearDB stammen.
...
**E-Mail senden** | [SendGrid][storesendgrid] und das [WordPress-Plug-In für das Verwenden von SendGrid][sendgridplugin]
...
**Validierung vor der Live-Schaltung** | [Unterstützung für stufenweise Veröffentlichung in Azure Websites][staging] <p>Beachten Sie, dass beim Wechsel einer Website von der Staging- zur Produktionsumgebung auch die WordPress-Konfiguration verschoben wird. Sie müssen sicherstellen, dass alle Einstellungen an die Anforderungen Ihrer Produktionswebsite angepasst werden, bevor Sie die Stagingwebsite zur Produktionswebsite machen.</p> 
...
Maßnahme | Option ...
------------------------|-----------
**Informationen zu Website-Instanzmöglichkeiten** |  [Preisdetails einschließlich Möglichkeiten von Websitegrößen und -modi][websitepricing]
...
* **[WordPress-Export][export]** - Dient zum Exportieren des Inhalts Ihres Blogs, der anschließend in eine neue WordPress-Website in Azure mithilfe des [WordPress-Import-Plug-Ins][import] importiert werden kann.
...
6. Klicken Sie auf **Absenden**. Sie werden informiert, wenn der Import erfolgreich war.
...
------------------ | ----------
**Permalinks** | Im WordPress-Dashboard der neuen Website klicken Sie auf Einstellungen **Einstellungen** -> **Permalinks** und aktualisieren anschließend die Permalinks-Struktur
...
**Konfigurieren benutzerdefinierter Domänennamen** | [Verwenden benutzerdefinierter Domänennamen mit einer Azure Website][customdomain]
**HTTPS für einen benutzerdefinierten Domänennamen aktivieren** | [HTTPS mit einer Azure Website verwenden][httpscustomdomain]
**Lastenausgleich oder geografisch verteilte Bereitstellung Ihrer Website** | [Traffic steuern mit Azure Traffic Manager][trafficmanager]. Wenn Sie eine benutzerdefinierte Domäne verwenden, finden Sie unter [Verwenden eines benutzerdefinierten Domänennamens für eine Azure-Website][customdomain] Informationen zum Verwenden von Traffic Manager mit benutzerdefinierten Domänennamen
...
[phpwebsite]: http://azure.microsoft.com/de-de/documentation/articles/web-sites-php-configure/
[customdomain]: http://azure.microsoft.com/de-de/documentation/articles/web-sites-custom-domain-name/
[trafficmanager]: http://azure.microsoft.com/blog/2014/03/27/azure-traffic-manager-can-now-integrate-with-azure-web-sites/
[backup]: http://azure.microsoft.com/de-de/documentation/articles/web-sites-backup/
[restore]: http://azure.microsoft.com/de-de/documentation/articles/web-sites-restore/
[rediscache]: http://msdn.microsoft.com/de-de/library/azure/dn690470.aspx
[managedcache]: http://msdn.microsoft.com/de-de/library/azure/dn386122.aspx
[websitescale]: http://azure.microsoft.com/de-de/documentation/articles/web-sites-scale/
[managedcachescale]: http://msdn.microsoft.com/de-de/library/azure/dn386113.aspx
[cleardbscale]: http://www.cleardb.com/developers/cdbr/introduction
[staging]: http://azure.microsoft.com/de-de/documentation/articles/web-sites-staged-publishing/
[monitor]: http://azure.microsoft.com/de-de/documentation/articles/web-sites-monitor/
[log]: http://azure.microsoft.com/de-de/documentation/articles/web-sites-enable-diagnostic-log/
[httpscustomdomain]: http://azure.microsoft.com/de-de/documentation/articles/web-sites-configure-ssl-certificate/
[mysqlwindows]: http://azure.microsoft.com/de-de/documentation/articles/virtual-machines-mysql-windows-server-2008r2/
[mysqllinux]: http://azure.microsoft.com/de-de/documentation/articles/virtual-machines-linux-mysql-use-opensuse/
...
[createwordpress]: http://azure.microsoft.com/de-de/documentation/articles/web-sites-php-web-site-gallery/
...
[deploy]: http://azure.microsoft.com/de-de/documentation/articles/web-sites-deploy/
[posh]: http://azure.microsoft.com/de-de/documentation/articles/install-configure-powershell/
