...
> [AZURE.NOTE]– Sie müssen einen CNAME-Eintrag bei der Domänenregistrierungsstelle registrieren, um die Domäne dem CDN-Endpunkt zuzuordnen. CNAME-Einträge werden bestimmten Unterdomänen wie "www.mydomain.com" oder "myblog.mydomain.com" zugeordnet. Es ist nicht möglich, einen CNAME-Eintrag einer Stammdomäne wie "mydomain.com" zuzuordnen. – Eine Unterdomäne kann nur einem CDN-Endpunkt zugeordnet werden. Der erstellte CNAME-Eintrag leitet sämtlichen Datenverkehr für die Unterdomäne an den angegebenen Endpunkt weiter. Wenn Sie dem CDN-Endpunkt beispielsweise die Unterdomäne **www.mydomain.com** zuordnen, können Sie diese Unterdomäne keinem anderen Microsoft Azure-Endpunkt, z. B. einem Speicherkonto-Endpunkt oder einem Clouddienst-Endpunkt, zuordnen. Innerhalb einer Domäne können Sie jedoch verschiedene Unterdomänen für unterschiedliche Dienstendpunkte verwenden. Außerdem haben Sie die Möglichkeit, demselben CDN-Endpunkt verschiedene Unterdomänen zuzuordnen. – Beachten Sie, dass es bis zu **90 Minuten** dauern kann, bis Änderungen für die benutzerdefinierte Domäne an die CDN-Edgeknoten weitergegeben wurden.
...
- Navigieren Sie in Ihrem Browser mithilfe der benutzerdefinierten Domäne zur Adresse des Blobs. Wenn die benutzerdefinierte Domäne beispielsweise **cdn.mydomain.com** lautet, ähnelt die URL eines zwischengespeicherten Blobs der folgenden URL:  
