...
- **Cache für eindeutige URL**: In diesem Modus wird jede Anforderung mit einer Abfragezeichenfolge als eindeutiges Objekt mit eigenem Cache behandelt. So wird z. B. die Antwort vom Ursprung für eine Anforderung für *foo.ashx?q=bar* auf dem Edgeknoten zwischengespeichert und für nachfolgende Caches mit der gleichen Abfragezeichenfolge zurückgegeben. Eine Anforderung für *foo.ashx?q=somethingelse* wird als separates Objekt mit eigener Lebensdauer zwischengespeichert.
	
	>[AZURE.WARNING]Dieser Modus sollte nicht verwendet werden, wenn die Abfragezeichenfolge Parameter enthält, die mit jeder Anforderung geändert werden, wie z. B. eine Sitzungs-ID oder ein Benutzername, da dies zu einer sehr niedrigen Cache-Trefferquote führt.
