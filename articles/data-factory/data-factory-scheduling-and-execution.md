...
------------- | ----------- | ------------ | ------------------------
WindowStart | Anfang des Zeitfensters der aktuellen Aktivitätsausführung | Aktivität | <ol><li>Geben Sie Abfragen zur Datenauswahl an. Siehe die Artikel zu Connectors, auf die im Artikel [Datenverschiebungsaktivitäten](data-factory-data-movement-activities.md) verwiesen wird.</li><li>Übergeben Sie Parameter an das Hive-Skript (siehe das zuvor gezeigte Beispiel).</li>
WindowEnd | Ende des Zeitfensters der aktuellen Aktivitätsausführung | Aktivität | Wie oben
SliceStart | Anfang des Zeitfensters für den zu erstellenden Datenslice | Aktivität<br/>
Dataset | <ol><li>Geben Sie bei der Arbeit mit [Azure-Blob-](data-factory-azure-blob-connector.md) und [Dateisystem-Datasets](data-factory-onprem-file-system-connector.md) dynamische Pfade und Dateinamen an.</li><li>Geben Sie Eingabeabhängigkeiten mit Data Factory-Funktionen in der Auflistung der Aktivitätseingaben an.</li></ol>
SliceEnd | Ende des Zeitfensters für den zu erstellenden Datenslice | Aktivität<br/>
Dataset | Wie oben. 
...
Date | DayOfYear(X) | X: DateTime | Ruft den Tag des Jahres ab, der von der Komponente "Jahr" von X dargestellt wird.<p>Beispiele:<br/>
01.12.2015: Tag 335 von 2015<br/>
31.12.2015: Tag 365 von 2015<br/>
31.12.2016: Tag 366 von 2016 (Schaltjahr)</p>
