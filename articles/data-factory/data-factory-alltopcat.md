<properties
	...
	description="Tabelle mit allen Themen für den Azure-Dienst mit dem Namen „Data Factory“ auf http://azure.microsoft.com/documentation/articles/, Titel und Beschreibung."
...
Dieses Thema listet alle Themen mit direktem Bezug zum Azure Data-Factory-Dienst auf. Sie können auf dieser Webseite mit **STRG+F** nach Schlüsselwörtern suchen, um aktuell interessante Themen zu finden.
...
| [Datasets](data-factory-create-datasets.md) | Lernen Sie Azure Data Factory-Datasets kennen, und erfahren Sie, wie Sie sie erstellen können. |
| [Grundlegendes zu Pipelines und Aktivitäten](data-factory-create-pipelines.md) | Informieren Sie sich über Azure Data Factory-Pipelines. Erfahren Sie, wie Sie sie erstellen, um Daten zu verschieben und zu transformieren und somit Informationen generieren, die Ihnen Einblicke verschaffen. |
...
| Titel | Beschreibung |
| :-- | :-- |
| [Erste Schritte mit Azure Data Factory – Übersicht](data-factory-build-your-first-pipeline.md) | Dieses Tutorial zeigt, wie Sie eine Beispieldatenpipeline erstellen, die Daten mithilfe von Azure HDInsight transformiert. |
| [Erste Schritte mit Azure Data Factory (Data Factory Edition)](data-factory-build-your-first-pipeline-using-editor.md) | In diesem Tutorial erstellen Sie eine Azure Data Factory-Beispielpipeline mit dem Data Factory-Editor im klassischen Azure-Portal. |
| [Erste Schritte mit Azure Data Factory (Azure PowerShell)](data-factory-build-your-first-pipeline-using-powershell.md) | In diesem Tutorial erstellen Sie eine Azure Data Factory-Beispielpipeline mithilfe von Azure PowerShell. |
| [Erste Schritte mit Azure Data Factory (Visual Studio)](data-factory-build-your-first-pipeline-using-vs.md) | In diesem Tutorial erstellen Sie eine Azure Data Factory-Beispielpipeline mithilfe von Visual Studio. |
| [Erste Schritte mit Azure Data Factory (Azure-Ressourcen-Manager)](data-factory-build-your-first-pipeline-using-arm.md) | In diesem Tutorial erstellen Sie eine Azure Data Factory-Beispielpipeline mithilfe einer Azure-Ressourcen-Manager-Pipeline (ARM). |
| [Tutorial: Kopieren von Daten aus einem Azure-Blob in Azure SQL](data-factory-get-started.md) | Dieses Tutorial veranschaulicht das Verwenden der Kopieraktivität in einer Azure Data Factory-Pipeline, um Daten aus einem Azure-Blob in eine Azure SQL-Datenbank zu kopieren. |
| [Tutorial: Kopieren von Daten aus einem Azure-Blob in Azure SQL (Data Factory Editor)](data-factory-get-started-using-editor.md) | In diesem Tutorial erstellen Sie eine Azure Data Factory-Pipeline mit Kopieraktivität mithilfe des Data Factory-Editors im klassischen Azure-Portal. |
| [Tutorial: Kopieren von Daten aus einem Azure-Blob in Azure SQL (Visual Studio)](data-factory-get-started-using-vs.md) | In diesem Tutorial erstellen Sie eine Azure Data Factory-Pipeline mit Kopieraktivität mithilfe von Visual Studio. |
| [Tutorial: Kopieren von Daten aus einem Azure-Blob in Azure SQL (Azure PowerShell)](data-factory-monitor-manage-using-powershell.md) | In diesem Tutorial erstellen Sie eine Azure Data Factory-Pipeline mit Kopieraktivität mithilfe der Azure PowerShell. |
| [Tutorial: Verschieben und Verarbeiten von Protokolldateien mit Data Factory (Data Factory Editor)](data-factory-tutorial.md) | In diesem fortgeschrittenen Lernprogramm wird ein sehr praxisnahes Szenario beschrieben und mithilfe des Azure Data Factory-Diensts und des Data Factory-Editors im klassischen Azure-Portal implementiert. |
| [Exemplarische Vorgehensweise: Kopieren von Daten zur Kampagneneffektivität in eine lokale SQL Server-Datenbank (Data Factory Editor)](data-factory-tutorial-extend-onpremises.md) | Diese exemplarische Vorgehensweise baut auf dem Lernprogramm mit dem Data Factory-Editor im klassischen Azure-Portal auf, indem die Pipeline Ausgabedaten in eine SQL Server-Datenbank kopiert. |
| [Tutorial: Verschieben und Verarbeiten von Protokolldateien mit Data Factory (Azure PowerShell)](data-factory-tutorial-using-powershell.md) | In diesem fortgeschrittenen Tutorial wird ein sehr praxisnahes Szenario beschrieben und mithilfe des Azure Data Factory-Diensts und Azure PowerShell implementiert. |
| [Exemplarische Vorgehensweise: Kopieren von Daten zur Kampagneneffektivität in eine lokale SQL Server-Datenbank (Azure PowerShell)](data-factory-tutorial-extend-onpremises-using-powershell.md) | Diese exemplarische Vorgehensweise baut auf dem Tutorial mit Verwendung der Azure PowerShell auf, indem die Pipeline Ausgabedaten in eine SQL Server-Datenbank kopiert. |
...
| [Verschieben von Daten in und aus Azure SQL mithilfe von Azure Data Factory](data-factory-azure-sql-connector.md) | Erfahren Sie, wie Daten mithilfe von Azure Data Factory in und aus Azure SQL-Datenbank verschoben werden. |
...
| [Verschieben von Daten in das und aus dem lokalen Dateisystem mithilfe von Azure Data Factory](data-factory-onprem-file-system-connector.md) | Erfahren Sie, wie Daten mithilfe von Azure Data Factory in das und aus dem lokalen Dateisystem verschoben werden. |
...
| Titel | Beschreibung |
| :-- | :-- |
| [Azure Data Factory – Änderungsprotokoll für das .NET SDK](data-factory-api-change-log.md) | Beschreibt Änderungen, hinzugefügte Features und Fehlerbehebungen usw. in einer bestimmten Version der .NET-API für Azure Data Factory. |
...
| [Azure Data Factory SDKs](data-factory-sdks.md) | Lernen Sie die verschiedenen Möglichkeiten zum Erstellen, Überwachen und Verwalten von Azure Data Factorys kennen. |
