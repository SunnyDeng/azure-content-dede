...
| -------- | ----------- | -------------- | -------- | 
| treatEmptyAsNull | Gibt an, ob Null oder eine leere Zeichenfolge als NULL-Wert behandelt wird. <p>Hinweis: Wenn die **quoteChar**-Eigenschaft angegeben ist, kann eine leere Zeichenfolge in Anführungszeichen mit dieser Eigenschaft auch als NULL behandelt werden.</p> | TRUE (Standardwert) <br/>FALSE | Nein |
