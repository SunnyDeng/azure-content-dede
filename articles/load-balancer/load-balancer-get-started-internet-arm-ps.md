...
Erstellen Sie eine öffentliche IP-Adresse mit dem Namen *PublicIP* zur Verwendung durch einen Front-End-IP-Pool mit dem DNS-Namen *loadbalancernrp.westus.cloudapp.azure.com*. Der folgende Befehl verwendet den statischen Zuordnungstyp.
...
- eine NAT-Regel, um sämtlichen, bei Port 3441 eingehenden Datenverkehr für Port 3389<sup>1</sup> zu übersetzen.
...
Erstellen Sie eine Netzwerkkarte mit dem Namen *lb-nic2-be*, und ordnen Sie sie der zweiten NAT-Regel und dem ersten (und einzigen) Back-End-Adresspool zu.
...
Weisen Sie die Netzwerkkarten mithilfe des Cmdlets `Add-AzureVMNetworkInterface` unterschiedlichen virtuellen Computern zu.
