...
Im Bereich **Cloud-Dienste** des Azure-Verwaltungsportals können Sie eine Dienstrolle oder eine Bereitstellung aktualisieren, eine Bereitstellung zur Produktion höher stufen, Ressourcen mit Ihrem Cloud-Dienst verknüpfen, sodass Sie die Ressourcenabhängigkeiten sehen und die Ressourcen zusammen skalieren können, und einen Cloud-Dienst oder eine Bereitstellung löschen.

## Inhaltsverzeichnis##

* [Vorgehensweise: Aktualisieren einer Cloud-Dienstrolle oder -bereitstellung](#updaterole)
* [Vorgehensweise: Austauschen von Bereitstellungen, um eine Bereitstellung zur Produktion höher zu stufen](#swap)
* [Vorgehensweise: Verknüpfen einer Ressource mit einem Cloud-Dienst](#linkresources)
* [Vorgehensweise: Löschen von Bereitstellungen und eines Cloud-Diensts](#deletecloudservice)


<h2><a id="updaterole"></a>Vorgehensweise: Aktualisieren einer Cloud-Dienstrolle oder -bereitstellung</h2>
...
<h2><a id="swap"></a>Vorgehensweise: Austauschen von Bereitstellungen, um eine Bereitstellung zur Produktion heraufzustufen</h2>

Verwenden Sie **Austauschen**, um eine Stagingbereitstellung eines Cloud-Diensts zur Produktion höher zu stufen. Wenn Sie beschließen, eine neue Version eines Cloud-Diensts bereitzustellen, können Sie die neue Version in der Cloud-Dienst-Stagingumgebung bereitstellen und testen, während Ihre Kunden die aktuelle Version in der Produktion einsetzen. Wenn Sie bereit sind, die neue Version zur Produktion höher zu stufen, können Sie mit **Austauschen** die URLs austauschen, mit denen die beiden Bereitstellungen adressiert werden. 
...
<h2><a id="linkresources"></a>Vorgehensweise: Verknüpfen einer Ressource mit einem Cloud-Dienst</h2>
...
3. Klicken Sie entweder auf **Eine Ressource verknüpfen** oder auf **Verknüpfen**.

	Der Assistent **Ressource verknüpfen** wird gestartet.
...
2. Klicken Sie auf **Verknüpfte Ressourcen**, und wählen Sie die Ressource anschließend aus.

3. Klicken Sie auf **Verknüpfung aufheben**. Klicken Sie dann an der Bestätigungsaufforderung auf **Ja**.
...
<h2><a id="deletecloudservice"></a>Vorgehensweise: Löschen von Bereitstellungen und eines Cloud-Diensts</h2>
...
3. Klicken Sie zum Löschen einer Bereitstellung auf **Delete production deployment** oder **Delete staging deployment**. Klicken Sie dann an der Bestätigungsaufforderung auf **Ja**. 
