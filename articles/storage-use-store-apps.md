...
-   [Visual Studio 2012][] vereinfacht das Erstellen, Debuggen, Lokalisieren, Packen und Bereitstellen von Windows Store-Apps.
-   [Windows Azure Storage Client Library for Windows Runtime][] enthält Typen, die für die Kommunikation mit Azure Storage verwendet werden, gepackt in eine Windows Runtime-Komponente.
-   [WCF Data Services Tools for Windows Store Apps][] erwartet die Add Service Reference-Nutzung durch clientseitige OData-Unterstützung für Windows Store-Apps in Visual Studio 2012.
...
Fügen der Seite dann eine Schaltfläche hinzu. Fügen Sie dem **Click**-Ereignis den folgenden Code hinzu, und ändern Sie die Ereignishandlermethode mit dem [async-Schlüsselwort][]:
...
Dieser Befehl fügt dem Projekt automatisch alle erforderlichen Verweise hinzu. Falls Sie die Package Manager-Konsole nicht verwenden möchten, können Sie auch den NuGet-Ordner von WCF Data Services auf dem lokalen Computer hinzufügen, um die Paketquellen aufzulisten. Fügen Sie dann den Verweis über die im Thema zum [Verwalten von NuGet-Paketen mithilfe des Dialogs][] beschriebene Oberfläche hinzu.
