...
Handelspartner sind die Entitäten, die an einer B2B-Kommunikation (Business-to-Business) beteiligt sind. Wenn zwei Partner eine Beziehung einrichten, wird dies als  *Agreement* bezeichnet. Diese Vereinbarung basiert auf der Kommunikation, die beide Partner wünschen, und ist protokoll- oder transportspezifisch. Die verschiedenen  von Azure App Service unterstützten B2B-Protokolle und -Transporte sind u. a.:
...
1. Erstellen Sie eine Instanz des **BizTalk Trading Partner Management**-Connectors. Hierfür ist eine leere SQL-Datenbank erforderlich. Vergewissern Sie sich, bevor Sie beginnen, dass eine leere Datenbank verfügbar und einsatzbereit ist.
