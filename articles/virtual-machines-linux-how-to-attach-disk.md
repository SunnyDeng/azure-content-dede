<properties urlDisplayName="Attach a disk" pageTitle="Anf&uuml;gen eines Datentr&auml;gers an einen virtuellen Computer unter Linux in Azure" metaKeywords="disk VM Azure, initialize new disk Azure, initialize disk Azure Linux, attaching empty disk Azure" description="Erfahren Sie, wie Sie einen Datentr&auml;ger an einen virtuellen Azure-Computer anf&uuml;gen und initialisieren k&ouml;nnen, damit er betriebsbereit ist." metaCanonical="http://www.windowsazure.com/de-de/manage/windows/how-to-guides/attach-a-disk/" services="virtual-machines" documentationCenter="" title="" authors="kathydav" solutions="" manager="timlt" editor="tysonn" />
