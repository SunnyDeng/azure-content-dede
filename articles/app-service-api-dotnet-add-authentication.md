...
Im Lernprogramm [Bereitstellen einer API-App](app-service-dotnet-deploy-api-app.md) haben Sie eine API-App mit der Zugriffsebene **Für jeden verfügbar** bereitgestellt. Dieses Lernprogramm zeigt, wie Sie eine API-App schützen, indem nur authentifizierte Benutzer darauf zugreifen können.
...
2. Wechseln Sie im Browser zur Anmelde-URL. Die URL folgt diesem Muster:
	...
	Der Wert für [providername] lautet "microsoftaccount", "facebook", "twitter", "google" oder "aad".
