...
1.  Laden Sie die JavaScript-Version der GetStartedWithData-Beispiel-App von der Website mit den [Codebeispielen für Entwickler][GetStartedWithData] herunter.
...
2.  Wählen Sie im linken Bereich die Kategorie **Online**, suchen Sie nach `WindowsAzure.MobileServices.WinJS`, klicken Sie auf **Installieren** für das Paket **Azure Mobile Services für WinJS**, und akzeptieren Sie die Lizenzbedingungen.

    ![][2]

    Dadurch wird die Mobile Services-Clientbibliothek zum Projekt hinzugefügt.

3.  Fügen Sie in der Projektdatei "default.html" folgenden Skriptverweis im Seitenkopf hinzu:
...
6.  Öffnen Sie die Datei "default.js" in Visual Studio und fügen Sie den folgenden Code hinzu, um die **client**-Variable zu definieren und übergeben Sie Anwendungs-URL und -Schlüssel in dieser Reihenfolge an den **MobileServiceClient**-Konstruktor.
...
7.  Entfernen Sie die Kommentare in den folgenden Codezeilen:

        var todoTable = client.getTable('TodoItem');

    Dieser Code erstellt ein Proxyobjekt (**todoTable**) für die neue Datenbanktabelle.

8.  Ersetzen Sie die Funktion **InsertTodoItem** durch den folgenden Code:
...
9.  Ersetzen Sie die Funktion **RefreshTodoItems** durch den folgenden Code:
...
10. Ersetzen Sie die Funktion **UpdateCheckedTodoItem** durch den folgenden Code:
...
<!-- Anchors. --> <!-- Images. --> <!-- URLs. -->
  ...
  [Erste Schritte mit Daten in Mobile Services]: /de-de/develop/mobile/tutorials/get-started-with-data-js/
  ...
  [Kostenlose Azure-Testversion]: http://www.windowsazure.com/de-de/pricing/free-trial/?WT.mc_id=A756A2826&returnurl=http%3A%2F%2Fwww.windowsazure.com%2Fde-de%2Fdevelop%2Fmobile%2Ftutorials%2Fget-started-with-data-js%2F
