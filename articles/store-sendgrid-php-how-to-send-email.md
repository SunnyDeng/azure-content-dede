<properties title="How to use the SendGrid email service (PHP) - Azure" pageTitle="Verwenden des SendGrid-E-Mail-Dienstes (PHP) - Azure"," metaKeywords="Azure SendGrid, Azure-E-Mail-Dienst, Azure SendGrid PHP, Azure E-Mail PHP" description="Erfahren Sie, wie Sie E-Mails mit dem SendGrid-E-Mail-Dienst in Azure senden. Die Codebeispiele wurden in PHP geschrieben." documentationCenter="PHP" services="" manager="wpickett" editor="mollybos" authors="robmcm" scriptId="" videoId="" />
