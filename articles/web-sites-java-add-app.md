...
Nachdem Sie Ihre Java-Website wie unter [Erste Schritte mit Microsoft Azure-Websites und Java](../web-sites-java-get-started) beschriebben initialisiert haben, können Sie die Anwendung hochladen, indem Sie Ihre WAR-Datei im Ordner **webapps** ablegen.
...
Beachten Sie, dass Sie die Quellcodeverwaltung zum Hochladen Ihrer Anwendung oder Webseiten verwenden können, auch in Szenarien mit fortlaufender Integration. Anweisungen zur Verwendung der Quellcodeverwaltung mit Ihrer Website finden Sie unter [Veröffentlichen aus der Quellcodeverwaltung auf Azure-Websites](../web-sites-publish-source-control). FTP stellt ebenfalls eine Möglichkeit zum Hochladen Ihrer Anwendung oder Webseiten dar.
