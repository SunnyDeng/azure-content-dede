...
Nachdem Sie Ihre Java-Website wie unter [Erste Schritte mit Microsoft Azure-Websites und Java](../web-sites-java-get-started) beschreiben initialisiert haben, können Sie die Anwendung hochladen, indem Sie Ihre WAR-Datei im Ordner **webapps** ablegen.
