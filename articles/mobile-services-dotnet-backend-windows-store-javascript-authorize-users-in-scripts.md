...
1.  Öffnen Sie in Visual Studio das Projekt, das Sie im Lernprogramm [Erste Schritte mit der Authentifizierung](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-get-started-users) verändert haben.
...
-   [Verwenden eines HTML-/JavaScript-Clients für Azure Mobile Services](/en-us/documentation/articles/mobile-services-html-how-to-use-client-library)
