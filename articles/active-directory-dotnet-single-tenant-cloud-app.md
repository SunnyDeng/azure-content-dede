...
In diesem Lernprogramm erfahren Sie, wie Sie das Azure Active Directory nutzen, um Verzeichnisbenutzer zu authentifizieren und deren Daten aus dem Verzeichnis zu lesen. Sie erhalten Informationen zu folgenden Themen:
...
-   [WCF Data Services für OData V3][WCF Data Services für OData V3]
...
-   [Schritt 4: Lesen der Verzeichnisdaten mit der Graph-API][Schritt 4: Lesen der Verzeichnisdaten mit der Graph-API]
...
3.  Sie erteilen dem Dienstprinzipal Leseberechtigungen, indem Sie ihn zur Service Support Administrator-Rolle hinzufügen. Weitere Informationen über das Zuweisen von Rollen zum Dienstprinzipal finden Sie unter [Rollenbasierte Zugriffssteuerung für Graph-API][Rollenbasierte Zugriffssteuerung für Graph-API]. Geben Sie den folgenden Befehl ein, und drücken Sie die Eingabetaste:
...
4.  Die **$appPrincipal.ObjectId**-Variable stellt die objectId Ihres Dienstprinzipals dar. Sie erhalten diese, indem Sie den folgenden Befehl eingeben und die Eingabetaste drücken:
    ...
    <div class="dev-callout"><strong>Hinweis</strong><p>Der oben angegebene Wert **AppPrincipalId wurde zur&uuml;ckgegeben, als Sie den Dienstprinzipal im Schritt 2 erstellt haben.</p></div>
...
Weitere Informationen zur Graph-API erhalten Sie, wenn [Sie die betreffenden Themen unter MSDN lesen][Sie die betreffenden Themen unter MSDN lesen]. Sie können auch Anwendungen für mehrere Mandanten in Azure Active Directory erstellen. Lesen Sie dafür das Lernprogramm [Entwickeln von Cloud-Anwendungen für mehrere Mandanten mit Azure Active Directory][Entwickeln von Cloud-Anwendungen für mehrere Mandanten mit Azure Active Directory].
  ...
  [Beispielanwendung mit Schreibunterstützung für die Graph-API]: http://code.msdn.microsoft.com/Write-Sample-App-for-79e55502
  [Rollenbasierte Zugriffssteuerung für Graph-API]: http://msdn.microsoft.com/de-de/library/hh974466.aspx
  [Sie die betreffenden Themen unter MSDN lesen]: http://msdn.microsoft.com/de-de/library/hh974476.aspx
