...
# Erstellen einer neuen Salesforce-API in der App Service-Umgebung Ihrer Organisation
...
4. Auf der Seite **New Connected App**:
	...
	a) Geben Sie unter **Connected App Name** einen Namen ein. b) Geben Sie unter **API Name** einen Namen ein. c) Geben Sie unter **Contact Email** eine E-Mail-Adresse ein. d) Aktivieren Sie unter _API (Enable OAuth Settings)_ die Option **Enable OAuth Settings**, und legen sie unter **Callback URL** die Umleitungs-URL fest, die Sie beim Hinzufügen der neuen Google Drive-API im Azure-Portal erhalten haben (weiter oben in diesem Thema).
