<properties 
   pageTitle="Sicherheit für Ihr StorSimple-Gerät"
   description="Lesen Sie die Sicherheitsrichtlinien für die Bereitstellung und den Betrieb des StorSimple-Geräts"
   services="storsimple"
   documentationCenter=""
   authors="alkohli"
   manager="carolz"
