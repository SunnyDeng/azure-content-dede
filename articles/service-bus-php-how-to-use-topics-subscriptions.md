<properties urlDisplayName="Service Bus Topics" pageTitle="Verwenden von Service Bus-Themen (PHP) - Azure" metaKeywords="" description="Erfahren Sie mehr über die Verwendung von Service Bus-Themen mit PHP in Azure." metaCanonical="" services="service-bus" documentationCenter="PHP" title="How to Use Service Bus Topics/Subscriptions" authors="sethm" solutions="" manager="timlt" editor="" />
