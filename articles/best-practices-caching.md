...
Weitere Informationen finden Sie auf der Seite [Redis Security](http://redis.io/topics/security) auf der Redis-Website.
...
Auf der Seite [Partitioning: how to split data among multiple Redis instances](http://redis.io/topics/partitioning) der Redis-Website finden Sie weitere Informationen zur Implementierung der Partitionierung mit Redis.
...
Weitere Informationen zum Schreiben von Clientanwendungen, die den Redis-Cache von Azure verwenden können, finden Sie auf der Seite [Azure Redis Cache-Dokumentation](https://azure.microsoft.com/documentation/services/cache/) auf der Microsoft-Website. Zusätzliche Informationen finden Sie auf der Seite [Basic Usage](https://github.com/StackExchange/StackExchange.Redis/blob/master/Docs/Basics.md) der StackExchange.Redis-Website, und die Seite [Pipelines und Multiplexers](https://github.com/StackExchange/StackExchange.Redis/blob/master/Docs/PipelinesMultiplexers.md) auf derselben Website bietet darüber hinaus Informationen zu asynchronen Vorgängen und Pipelining mit Redis und der StackExchange-Bibliothek. Im Abschnitt „Anwendungsfälle für das Caching mit Redis“ weiter unten in diesem Dokument finden Sie Beispiele für erweiterte Techniken, die Sie für die Daten in einem Redis-Cache verwenden können.
...
- Seite [Azure Redis Cache-Dokumentation](https://azure.microsoft.com/documentation/services/cache/) auf der Microsoft-Website.
...
- Seite [Pipelines and Multiplexers](https://github.com/StackExchange/StackExchange.Redis/blob/master/Docs/PipelinesMultiplexers.md) im GitHub-Repository StackExchange.Redis.
- Seite [Redis Persistence](http://redis.io/topics/persistence) auf der Redis-Website.
- Seite [Replication](http://redis.io/topics/replication) auf der Redis-Website.
- Seite [Redis Cluster Tutorial](http://redis.io/topics/cluster-tutorial) auf der Redis-Website.
- Seite [Partitioning: how to split data among multiple Redis instances](http://redis.io/topics/partitioning) auf der Redis-Website.
- Seite [Using Redis as an LRU Cache](http://redis.io/topics/lru-cache) auf der Redis-Website.
- Seite [Transactions](http://redis.io/topics/transactions) auf der Redis-Website.
- Seite [Redis Security](http://redis.io/topics/security) auf der Redis-Website.
- Seite [Lap around Azure Redis Cache](https://azure.microsoft.com/blog/2014/06/04/lap-around-azure-redis-cache-preview/) (in englischer Sprache) im Azure-Blog.
- Seite [Running Redis on a CentOS Linux VM in Azure](http://blogs.msdn.com/b/tconte/archive/2012/06/08/running-redis-on-a-centos-linux-vm-in-windows-azure.aspx) auf der Microsoft-Website.
...
- Die Seite [An Introduction to Redis data types and abstractions](http://redis.io/topics/data-types-intro) auf der Redis-Website.
- Seite [Basic Usage](https://github.com/StackExchange/StackExchange.Redis/blob/master/Docs/Basics.md) auf der StackExchange.Redis-Website.
- Seite [Transactions in Redis](https://github.com/StackExchange/StackExchange.Redis/blob/master/Docs/Transactions.md) im GitHub-Repository StackExchange.Redis.
- Seite [Data Partitioning Guidance](http://msdn.microsoft.com/library/dn589795.aspx) auf der Microsoft-Website.
