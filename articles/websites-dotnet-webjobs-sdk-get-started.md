<properties pageTitle="Erste Schritte mit dem Azure WebJobs-SDK" metaKeywords="Azure Lernprogramm, Azure WebJobs Lernprogramm, Azure mehrschichtig Lernprogramm, MVC Lernprogramm, Lernprogramm für Azure-Blobs, Azure-Warteschlangen-Lernprogramm, Azure-Speicher-Lernprogramm" description="Learn how to create a multi-tier app using ASP.NET MVC and Azure. The frontend runs in a website, and the backend runs as a WebJob. The app uses Entity Framework, SQL Database, and Azure storage queues and blobs." metaCanonical="" services="web-sites,storage" documentationCenter=".NET" title="Get Started with the Azure WebJobs SDK" authors="tdykstra" solutions="" manager="wpickett" editor="mollybos" />
