...
<tbody>
<tr class="odd">
<td align="left"><p><strong>Ressource</strong></p></td>
<td align="left"><p><strong>Beschreibung</strong></p></td>
</tr>
<tr class="even">
<td align="left"><p><strong>Datenbank</strong></p>
<p><strong>Konto</strong></p></td>
<td align="left"><p>Ein Datenbankkonto ist mindestens einer Kapazitätseinheit zugeordnet, die den bereitgestellten Dokumentspeicher und -durchsatz, eine Reihe von Datenbanken und den BLOB-Speicher angibt. Sie können mithilfe Ihres Azure-Abonnements mindestens ein Datenbankkonto erstellen. Jedes Datenbankkonto verfügt über einen eindeutigen DNS-Namen.</p></td>
</tr>
<tr class="odd">
<td align="left"><p><strong>Datenbank</strong></p></td>
<td align="left"><p>Eine Datenbank ist ein logischer Container für Dokumentspeicher, der auf Sammlungen aufgeteilt ist. Sie ist auch ein Container für Benutzer.</p></td>
</tr>
<tr class="even">
<td align="left"><p><strong>Benutzer</strong></p></td>
<td align="left"><p>Der logische Namespace für Gültigkeitsbereichsberechtigungen.</p></td>
</tr>
<tr class="odd">
<td align="left"><p><strong>Berechtigung</strong></p></td>
<td align="left"><p>Ein Autorisierungstoken, das einem Benutzer für den autorisierten Zugriff auf eine bestimmte Ressource zugeordnet ist.</p></td>
</tr>
<tr class="even">
<td align="left"><p><strong>Sammlung</strong></p></td>
<td align="left"><p>Eine Sammlung ist ein Container für JSON-Dokumente und die zugehörige JavaScript-Anwendungslogik. Abfragen und Transaktionen sind folgenden Bereichen zugeordnet: Sammlungen.</p></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td align="left"><p><strong>Eigenschaftenname</strong></p></td>
<td align="left"><p><strong>Beschreibung</strong></p></td>
</tr>
<tr class="even">
<td align="left"><p>Konsistenzrichtlinie</p></td>
<td align="left"><p>Legen Sie diese Eigenschaft fest, um die Standardkonsistenzebene für alle Sammlungen unter Ihrem Datenbankkonto zu konfigurieren. Sie können die Konsistenzebene mithilfe des Anforderungsheaders &quot;[x-ms-consistency-level]&quot; anforderungsweise außer Kraft setzen. Zukünftig wird möglicherweise die Außerkraftsetzung der Konsistenzebene auf Sammlungsbasis unterstützt.</p>
<p>Beachten Sie, dass diese Eigenschaft nur für <em>benutzerdefinierte Ressourcen</em> gilt. Alle systemdefinierten Ressourcen werden konfiguriert, um Lese-/Abfragevorgänge mit hoher Konsistenz zu unterstützen.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>Primärer und sekundärer Hauptschlüssel</p></td>
<td align="left"><p>Dies sind die primären und sekundären Hauptschlüssel, die den Administratorzugriff auf alle Ressourcen unter dem Datenbankkonto bereitstellen.</p></td>
</tr>
<tr class="even">
<td align="left"><p>MaxMediaStorageUsageInMB (READ)</p></td>
<td align="left"><p>Maximale Medienspeichermenge, die für das Datenbankkonto zur Verfügung steht.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>CurrentMediaStorageUsageInMB (READ)</p></td>
<td align="left"><p>Aktuelle Medienspeichernutzung für das Datenbankkonto.</p></td>
</tr>
<tr class="even">
<td align="left"><p>CapacityUnitsProvisioned</p></td>
<td align="left"><p>Die Gesamtanzahl der unter dem Datenbankkonto bereitgestellten Kapazitätseinheiten.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>CapacityUnitsConsumed (READ)</p></td>
<td align="left"><p>Die Gesamtanzahl der aktuell unter dem Datenbankkonto verbrauchten Kapazitätseinheiten.</p></td>
</tr>
<tr class="even">
<td align="left"><p>ProvisionedDocumentStorageInMB (READ)</p></td>
<td align="left"><p>Die Gesamtmenge des Dokumentspeichers (in MB), der unter dem Datenbankkonto über alle Kapazitätseinheiten hinweg bereitgestellt wird.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>ReservedDocumentStorageInMB (READ)</p></td>
<td align="left"><p>Die Gesamtmenge des Dokumentspeichers (in MB), der unter dem Datenbankkonto über alle Kapazitätseinheiten hinweg reserviert wird. Der Dokumentspeicher gilt als reserviert, wenn eine Sammlung Dokumente enthält.</p></td>
</tr>
<tr class="even">
<td align="left"><p>ConsumedDocumentStorageInMB (READ)</p></td>
<td align="left"><p>Die Gesamtmenge des Dokumentspeichers (in MB), der unter dem Datenbankkonto über alle Kapazitätseinheiten hinweg tatsächlich verbraucht wurde. Dies ist die Größe der tatsächlichen Dokumente und des Index, die unter einem Datenbankkonto über verschiedene Sammlungen hinweg kombiniert wird.</p></td>
</tr>
</tbody>
</table>
...
Eine Datenbank ist in DocumentDB ein logischer Container für mindestens eine Sammlung und einen Benutzer. Sie können in Abhängigkeit von Angebotseinschränkungen eine beliebige Anzahl von Datenbanken unter einem DocumentDB-Datenbankkonto erstellen.

![][2]

**Eine Datenbank ist ein logischer Container, der Benutzer und Sammlungen enthält**.
...
-   Wählen Sie zwischen synchronen (konsistenten) und asynchronen (flexiblen) Indexaktualisierungen. Der Index wird bei jedem Einfügen, Ersetzen oder Löschen eines Dokuments der Sammlung standardmäßig synchron aktualisiert. Auf diese Weise können die Abfragen denselben Konsistenzgrad wie bei Dokumentlesevorgängen akzeptieren. Obwohl DocumentDB für Schreibvorgänge optimiert ist und beständige Mengen an Dokumentschreibvorgängen zusammen mit der synchronen Indexwartung und der Bereitstellung konsistenter Abfragen unterstützt, können Sie bestimmte Sammlungen so konfigurieren, dass ihr Index flexibel aktualisiert wird. Die flexible Indizierung steigert die Schreibleistung noch weiter und ist ideal für Massenaufnahmeszenarien für Sammlungen mit hauptsächlich übermäßigen Lesevorgängen geeignet.
...
## Registrieren eines vorangestellten Auslösers

Die Registrierung eines Auslösers umfasst das Erstellen einer neuen Auslöserressource für eine Sammlung über HTTP POST. Sie können angeben, ob es sich um einen vorangestellten oder nachgestellten Auslöser handelt. Zudem können Sie die Art des Vorgangs angeben, der dem Auslöser zugeordnet ist (z. B. Erstellen, Ersetzen, Löschen oder Alle).
...
## Ausführen eines vorangestellten Auslösers

Die Ausführung eines Auslösers erfolgt durch die Angabe des Namens (über den Anforderungsheader) eines vorhandenen Auslösers während der Auslösung der POST-/PUT-/DELETE-Anforderung einer Dokumentressource.
...
## Aufheben der Registrierung eines vorangestellten Auslösers

Das Aufheben der Registrierung für einen Auslöser umfasst einfach das Auslösen einer HTTP DELETE-Methode für eine vorhandene Auslöserressource.
