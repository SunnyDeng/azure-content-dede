...
Dies ist der vierte Teil der exemplarischen Vorgehensweise [Entwickeln einer Vorhersagelösung mit Azure ML][Entwickeln einer Vorhersagelösung mit Azure ML]:
...
4. Suchen Sie das Modul **Daten durch Skalierung transformieren**, und ziehen Sie es in den Bereich.
...
8. Klicken Sie auf **Spaltenauswahl starten**. Wählen Sie in der ersten Dropdown-Liste „Spaltentypen“ und in der zweiten Dropdown-Liste „Numerisch“ aus (belassen Sie in der dritten Dropdown-Liste die Auswahl „Alle“). Damit wird festgelegt, dass alle numerischen Spalten (und nur die numerischen Spalten) transformiert werden.
9. Klicken Sie auf das Pluszeichen (+). Dadurch wird eine neue Dropdown-Zeile erstellt. Wählen Sie in der ersten Dropdown-Liste „Spaltenindizes ausschließen“ aus, und geben Sie „21“ in das Textfeld ein. Dadurch wird angegeben, dass Spalte 21 (die Spalte „Kreditrisiko“) ignoriert wird.
10. Klicken Sie auf **OK**.


Das Modul **Daten durch Skalierung transformieren** ist jetzt für eine tanh-Transformation aller numerischen Spalten mit Ausnahme der Spalte „Kreditrisiko“ eingerichtet.

Dieser Teil des Experiments sieht jetzt in etwa wie folgt aus:

![Trainieren des zweiten Modells][Trainieren des zweiten Modells]
...
6. Für das SVM-Modell muss die gleiche Transformation an den Testdaten durchgeführt werden wie bei den Trainingsdaten. Kopieren Sie also das Modul **Daten durch Skalierung transformieren** und fügen Sie es ein, um eine zweite Kopie zu erstellen, und verbinden Sie sie mit der Ausgabe des rechten Moduls **R-Skript ausführen**.
7. Verbinden Sie den rechten Eingabeport des Moduls **Modell bewerten** mit der Ausgabe des Moduls **Daten durch Skalierung transformieren**.
...
![Evaluieren beider Modelle][Evaluieren beider Modelle]
...
![ROC-Kurven für Modelle][ROC-Kurven für Modelle]
...
**Nächster Schritt: [Veröffentlichen des Webdiensts][Veröffentlichen des Webdiensts]**
...
[Trainieren eines Modells]: ./media/machine-learning-walkthrough-4-train-and-evaluate-models/train1.png
[Trainieren des zweiten Modells]: ./media/machine-learning-walkthrough-4-train-and-evaluate-models/train2.png
[Evaluieren beider Modelle]: ./media/machine-learning-walkthrough-4-train-and-evaluate-models/train3.png
[ROC-Kurven für Modelle]: ./media/machine-learning-walkthrough-4-train-and-evaluate-models/train4.png
