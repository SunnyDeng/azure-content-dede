...
**create_queue** unterstützt zudem weitere Optionen, mit denen Sie Standardeinstellungen für die Warteschlange überschreiben können, wie zum Beispiel die Gültigkeitsdauer von Nachrichten oder die maximale Warteschlangengröße. Das folgende Beispiel legt die maximale Warteschlangengröße auf 5 GB bei einer Gültigkeitsdauer von 1 Minute fest:
...
Das folgende Beispiel zeigt, wie eine Testnachricht an die Warteschlange *taskqueue* mithilfe von **send_queue_message** gesendet wird:
...
Nachrichten werden von einer Warteschlange über **receive_queue_message**-Methode des **ServiceBusService**-Objekts empfangen:
