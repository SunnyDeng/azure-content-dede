...
Das folgende Beispiel zeigt, wie fünf Testnachrichten an das [`QueueClient`](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.queueclient.aspx)-Objekt "TestQueue" gesendet werden, das im vorherigen Codebeispiel abgerufen wurde.
