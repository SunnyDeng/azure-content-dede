...
> [AZURE.NOTE] Beim Erstellen der Verbindung muss der **SASL-Authentifizierungsmechanismus auf EXTERNAL** festgelegt werden. (Es darf nicht der Standardmechanismus PLAIN mit Benutzername und Kennwort genutzt werden. Dieser wird verwendet, wenn Sie das SAS-Token nicht senden müssen).
