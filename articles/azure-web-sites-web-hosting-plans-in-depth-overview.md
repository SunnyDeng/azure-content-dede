<properties title="Azure Websites Web Hosting Plans In-Depth Overview" pageTitle="Webhosting-Pläne für Azure-Websites: ausführliche Übersicht - Windows Azure-Featurehandbuch" description="Learn how Web Hosting Plans for Azure Websites work, and how they benefit your management experience." metaKeywords="Azure Web Sites, Azure Websites, WHP, Web Hosting Plan, Web Hosting Plans, Resource Groups" services="web-sites" solutions="web" documentationCenter="Infrastructure" authors="Byron Tardif and Yochay Kiryaty" videoId="" scriptId="" manager="wpickett" />
