...
Öffnen Sie eine neue Instanz des Texteditors Ihrer Wahl, und kopieren Sie Folgendes in die neue Textdatei. Ersetzen Sie dabei den ImageFamily-Wert.
...
Sie können die Liste der Azure-Speicherorte abrufen mit:
