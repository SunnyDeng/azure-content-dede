...
Die Fähigkeit von App Service-Web-Apps, eine [Skalierung nach oben und unten] zu bieten, ist optimal für Ihre Branchenanwendung geeignet, unabhängig von der Arbeitsauslastung. Skalieren Sie Ihre Web-App manuell über das [Azure-Verwaltungsportal], programmgesteuert über die [Dienstverwaltungs-API] oder [PowerShell-Skripts] oder automatisch über die Funktion "Autoskalierung". Im Modus **Standard** können Sie eine Web-App mithilfe von "Autoskalierung" basierend auf der CPU-Auslastung automatisch horizontal hochskalieren. Bewährte Methoden finden Sie auf der Website von [Troy Hunt]: [10 Dinge, die ich über eine schnelle Skalierung von Websites mit Azure gelernt habe].
...
Im Modus **Standard** erhalten die für die Web-App-Überwachung verantwortlichen Benutzer E-Mail-Benachrichtigungen, wenn die Anwendung nicht mehr reagiert. Weitere Informationen finden Sie unter [Vorgehensweise: Empfangen von Warnbenachrichtigungen und Verwalten von Warnungsregeln in Azure].
...
[Autorisieren von Benutzern]:web-sites-authentication-authorization.md
...
[Skalierung nach oben und unten]:web-sites-scale.md
