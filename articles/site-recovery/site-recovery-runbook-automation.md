...
<table border="1"> <tr><th>Name der Variablen</th><th>Beschreibung der Variablen</th></tr> <tr><td>RecoveryPlanName</td><td>Der Name des ausgeführten Wiederherstellungsplans. <p> Mit dieser Variablen können Sie verschiedene, Wiederherstellungsplan-spezifische Aktionen mit dem gleichen Skript durchführen.</td></tr> <tr><td>FailoverType</td><td>Gibt an, ob es sich um ein Test-Failover, um ein geplantes Failover oder um ein nicht geplantes Failover handelt. <p> Diese Variable ermöglicht die Durchführung verschiedener Aktionen auf der Grundlage des Failovertyps. </td></tr> <tr><td>FailoverDirection</td><td>Gibt an, ob es sich um eine Wiederherstellung vom primären Standort zum Wiederherstellungsstandort oder um eine Wiederherstellung in umgekehrter Richtung handelt. <p>Mögliche Werte: **PrimaryToSecondary** und **SecondaryToPrimary**. </td></tr> <tr><td>GroupId</td><td> Gibt die Gruppennummer innerhalb des Wiederherstellungsplans an, in dessen Rahmen das Runbook ausgeführt wird. <p> Gehört das Runbook also beispielsweise der zweiten Gruppe an, ist unter „GroupId“ der Wert „2“ angegeben. </td></tr> <tr><td>VmMap</td><td> Ein Array mit allen virtuellen Computern in der Gruppe. </td></tr> <tr><td>VmMap-Schlüssel</td><td>Jeder virtuelle Computer besitzt einen eindeutigen Schlüssel (GUID). Diese GUID entspricht der VMM-ID des virtuellen Computers. <p> Mit dieser GUID können Sie deterministisch angeben, auf welchem virtuellen Computer Sie arbeiten möchten. </td></tr> <tr><td>RoleName</td><td>Gibt den Namen des wiederherzustellenden virtuellen Azure-Computers an.</td></tr> <tr><td>CloudServiceName</td><td> Gibt den Azure-Clouddienstnamen an, unter dem der virtuelle Computer erstellt wird. </td></tr> </table><br />
