<properties
	pageTitle="Vorbereiten der Azure Site Recovery-Bereitstellung"
...
**Virtuelle Computer** | Mindestens eine VM auf dem Hyper-V-Quellhostserver | Mindestens ein VM auf dem Hyper-V-Hostserver in der VMM-Quellcloud | Mindestens ein VM auf dem Hyper-V-Hostserver in der VMM-Quellcloud | VMs, für die eine Replikation zu Azure ausgeführt wird, müssen die [Voraussetzungen für virtuelle Azure-Maschinen](site-recovery-best-practices/#virtual-machines) erfüllen.
**Azure-Konto** | Sie benötigen ein [Azure](http://azure.microsoft.com/)-Konto und ein Abonnement für den Site Recovery-Dienst. | Sie benötigen ein [Azure](http://azure.microsoft.com/)-Konto und ein Abonnement für den Site Recovery-Dienst. | – | Beginnen Sie mit einer [kostenlosen Testversion](pricing/free-trial/), falls Sie kein Konto haben. Erfahren Sie mehr über die [Preise](pricing/details/site-recovery/) für den Dienst.
...
Betriebssystem des VMware-Hypervisors | Unterstütztes Betriebssystem | [Details](site-recovery-vmware-to-azure/#before-you-start) 
Gastbetriebssystem | Bei der Replikation von Hyper-V zu Azure unterstützt Site Recovery alle Betriebssysteme, die [von Azure unterstützt werden](https://technet.microsoft.com/library/cc794868%28v=ws.10%29.aspx). <br/><br/> Lesen Sie bei der Replikation von VMware und physischen Servern die [Voraussetzungen](site-recovery-vmware-to-azure/#before-you-start) für Windows und Linux. | Für die Überprüfung der Voraussetzungen tritt ein Fehler auf, wenn keine Unterstützung vorhanden ist. 
...
- **Kapazitätsplanung**: Lesen Sie im [Kapazitätsplaner](http://www.microsoft.com/en-in/download/details.aspx?id=39057) nach, wenn Sie virtuelle Hyper-V-Maschinen replizieren.
