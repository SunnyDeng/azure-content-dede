...
Sortiert die Ergebnisse nach bestimmten Feldern. Das Präfix "Asc/Desc" ist optional. Wenn sie ausgelassen werden, wird von der "Asc"-Sortierreihenfolge ausgegangen. Wenn eine Abfrage den Befehl **Sortieren** nicht explizit verwendet, ist "**TimeGenerated** abst. sortieren" das Standardverhalten. Dabei werden die neuesten Ergebnisse immer zuerst zurückgegeben.
