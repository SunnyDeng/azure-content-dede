...
Wenn Ihre Anwendung einen Anruf an die Twilio-API initiiert – z. B. über die client.InitiateOutboundCall-Methode – sendet Twilio Ihre Anforderung an eine URL, von der die Rückgabe einer TwiML-Antwort erwartet wird. Das Beispiel unter "Gewusst wie: Tätigen von ausgehenden Anrufen" verwendet die von Twilio bereitgestellte URL <http://twimlets.com/message> für die Rückgabe der Antwort.

<div class="dev-callout">
<b>Hinweis</b>
<p>TwiML wurde f&uuml;r die Verwendung durch Webdienste konzipiert, kann jedoch im Browser angezeigt werden. Klicken Sie z.&nbsp;B. auf <a href="http://twimlets.com/message">twimlet_message_url</a>, um ein leeres &lt;Response&gt;-Element anzuzeigen, oder klicken Sie auf <a href="http://twimlets.com/message?Message%5B0%5D=Hello%20World">twimlet_message_url_hello_world</a>, um ein &lt;Response&gt;-Element mit einem &lt;Say&gt;-Element anzuzeigen.</p>
</div>
...
[WACOM.INCLUDE [twilio\_additional\_services\_and\_next\_steps][]]
  ...
  [.NET]: /de-de/develop/net/how-to-guides/twilio-voice-and-sms-service/
  [node.js]: /de-de/develop/nodejs/how-to-guides/twilio-voice-and-sms-service/
  [Java]: /de-de/develop/java/how-to-guides/twilio-voice-and-sms-service/
  [PHP]: /de-de/develop/php/how-to-guides/twilio-voice-and-sms-service/
  [Python]: /de-de/develop/python/how-to-guides/twilio-voice-and-sms-service/
  [Ruby]: /de-de/develop/ruby/how-to-guides/twilio-voice-and-sms-service/
