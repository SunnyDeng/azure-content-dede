<properties pageTitle="Verwenden von Twilio für Telefonie- und SMS-Funktionen | Mobile Dev Center" metaKeywords="" description="Erfahren Sie, wie Sie häufige Aufgaben über die Twilio-API mit Azure Mobile Services durchführen." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="How to use Twilio for voice and SMS capabilities from Mobile Services" authors="MicrosoftHelp@twilio.com" solutions="" manager="twilio" editor="" />
