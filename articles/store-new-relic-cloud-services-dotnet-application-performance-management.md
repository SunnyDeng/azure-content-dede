<properties 
	pageTitle="Verwenden von New Relic mit Azure - Azure-Funktionshandbücher" 
...
10. Prüfen Sie im Dialogfeld **Kauf überprüfen** den Plan, die Preisinformationen sowie die rechtlichen Bedingungen. Wenn Sie den Bedingungen zustimmen, klicken Sie auf **Kaufen**.
...
2. Wenn Ihre Projektmappe noch kein Azure-Clouddienstprojekt enthält, fügen Sie eins hinzu, indem Sie im Projektmappen-Explorer mit der rechten Maustaste auf Ihre App klicken und **Azure-Clouddienstprojekt hinzufügen** wählen.
...
3. Wählen Sie **Extras > Bibliothekspaket-Manager > Paket-Manager-Konsole**, um die Paket-Manager-Konsole zu öffnen. Wählen Sie Ihr Projekt oben im Fenster der Paket-Manager-Konsole als Standardprojekt aus.
...
**Hinweis:** Wenn Sie diese App zum ersten Mal in Azure bereitstellen, werden Sie zur Eingabe Ihrer
Azure-Anmeldeinformationen aufgefordert. Weitere Informationen finden Sie unter <a href="/de-de/develop/net/tutorials/get-started/">Bereitstellen einer ASP.NET-Webanwendung auf einer Azure-Website</a>.
...
€<td>Anzeigen von Schwellenwerten für das <a href="https://newrelic.com/docs/site/apdex" target="_blank">Apdex</a>-Ergebnis Ihrer App</td>
    ...
    <tr>
       ...
       <td>Zeigen Sie in der <b>Browser</b>-Ansicht der Übersicht auf eine beliebige Stelle der globalen Apdex-Karte.<br /><b>Tipp:</b> Wenn Sie direkt zum Dashboard <a href="https://docs.newrelic.com/docs/new-relic-browser/geography-dashboard" target="_blank">Geography</a> der ausgewählte App wechseln möchten, klicken Sie auf den Titel <b>Global Apdex</b>, oder klicken Sie auf eine beliebige Stelle der globalen Apdex-Karte.</td>
    </tr>
    <tr>
 ...
 * [RUM (Real User Monitoring)](https://newrelic.com/docs/features/real-user-monitoring): Überblick darüber, wie mit RUM (Real User Monitoring) die Zeit gemessen wird, die das Laden Ihrer Webseiten in den Browsern von Benutzern dauert, woher diese Benutzer stammen und welche Browser sie verwenden (in englischer Sprache)
