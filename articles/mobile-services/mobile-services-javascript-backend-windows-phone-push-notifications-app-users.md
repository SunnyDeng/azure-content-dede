...
>[AZURE.NOTE]Dieses Lernprogramm unterstützt Apps für Windows Phone 8.0 und Windows Phone 8.1 Silverlight. Informationen für Windows Phone 8.1 Store-Apps finden Sie in der [Windows Store-Version dieses Themas](mobile-services-javascript-backend-windows-store-dotnet-push-notifications-app-users.md).
