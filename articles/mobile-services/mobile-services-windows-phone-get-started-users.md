...
&nbsp;&nbsp;3. Öffnen Sie in Visual Studio das Projekt, das Sie im Tutorial [Hinzufügen von Mobile Services zu einer vorhandenen App](mobile-services-windows-phone-get-started-data.md) erstellt haben.
