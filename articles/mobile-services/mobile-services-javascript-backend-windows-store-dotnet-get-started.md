...
> Informationen für die entsprechende Mobile Apps-Version dieses Themas finden Sie unter [Erstellen einer Windows-App](../app-service-mobile/app-service-mobile-windows-store-dotnet-get-started.md).
...
* [Verwenden der .NET Clientbibliothek](mobile-services-dotnet-how-to-use-client-library.md) Erfahren Sie, wie Sie den mobilen Dienst abfragen, mit Daten arbeiten und auf benutzerdefinierte APIs zugreifen.
