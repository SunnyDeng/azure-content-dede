<properties title="Azure Machine Learning Sample: Credit risk prediction" pageTitle="Machine Learning-Beispiel: Kreditrisiko-Vorhersage | Azure" description="Azure Machine Learning-Beispielexperiment für die Entwicklung eines binären Klassifizierungsmodells, das prognostiziert, ob ein Bewerber ein niedriges oder hohes Kreditrisiko darstellt" metaKeywords="" services="machine-learning" solutions="" documentationCenter="" authors="garye" manager="paulettm" editor="cgronlun"  videoId="" scriptId="" />
