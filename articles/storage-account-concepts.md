<properties 
	pageTitle="Konzepte für Speicherkonten | Azure" 
	description="Erfahren Sie mehr über Konzepte für Speicherkonten." 
	headerExpose="" 
	footerExpose="" 
	services="storage" 
	authors="tamram" 
...
2. Klicken Sie auf **Neu erstellen**, klicken Sie auf **Speicher**, und klicken Sie dann auf **Schnellerfassung**.

	![NewStorageAccount](./media/storage-create-storage-account/storage_NewStorageAccount.png)

3. Geben Sie in **URL** einen Namen für das Speicherkonto ein. Unter [Speicherkontoendpunkte](#account-endpoints) (siehe unten) finden Sie Details dazu, wie dieser Name zum Adressieren von Objekten verwendet wird, die Sie im Azure-Speicher speichern.

4. Wählen Sie in **Standort/Affinitätsgruppe** einen Standort für das Speicherkonto aus, der sich nahe bei Ihnen oder Ihren Kunden befindet. Wird von einem anderen Azure-Dienst aus auf die Daten zugegriffen, wie etwa einem virtuellen Azure-Computer oder Cloud-Dienst, empfiehlt es sich, eine Affinitätsgruppe aus der Liste auszuwählen. Damit gruppieren Sie das Speicherkonto im selben Rechenzentrum wie andere von Ihnen verwendete Azure-Dienste und senken die Kosten. 
	...
	Details zu Affinitätsgruppen finden Sie unter [Dienst am selben Standort wie Affinitätsgruppe](#affinity-group) (siehe unten).
...
6. Wählen Sie unter **Replikation** die gewünschte Replikationsstufe für Ihr Speicherkonto aus. Die empfohlene Replikationsoption ist die georedundante Replikation. Sie sorgt für maximalen Bestand Ihrer Daten. Weitere Details zu Azure-Speicherreplikationsoptionen finden Sie unter [Replikationsoptionen für das Speicherkonto](#replication-options) (siehe unten).
...
Jedes in Azure-Speicher abgelegte Objekt hat eine eindeutige URL-Adresse; der Speicherkontoname bildet die Unterdomäne dieser Adresse. Die Unterdomäne bildet zusammen mit dem Domänennamen, der für jeden Dienst spezifisch ist, einen *Endpunkt* für Ihr Speicherkonto. 
...
Sie können auch einen benutzerdefinierten Domänennamen konfigurieren, den Sie mit Ihrem Speicherkonto verwenden. Weitere Informationen finden Sie unter [Konfigurieren eines benutzerdefinierten Domänennamens für Blob-Daten in einem Speicherkonto](http://azure.microsoft.com/de-de/documentation/articles/storage-custom-domain-name/).
...
> [AZURE.WARNING] Es gibt keine Möglichkeit zur Wiederherstellung des Inhalts aus einem gelöschten Speicherkonto. Stellen Sie sicher, dass Sie alle zu speichernden Inhalte sichern, bevor Sie das Konto löschen.<br />
