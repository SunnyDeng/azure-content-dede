<properties title="Shard Map Management" pageTitle="Shard Map-Verwaltung" description="So verwenden Sie ShardMapManager und die Elastic Scale-API für .NET" metaKeywords="sharding scaling, Azure SQL Database sharding, elastic scale, shardmapmanager" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
