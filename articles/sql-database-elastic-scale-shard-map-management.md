<properties 
	pageTitle="Shard Map-Verwaltung" 
	description="So verwenden Sie ShardMapManager und die Elastic Scale-API für .NET" 
...
In einer **Bereichs-Shard Map** wird der Schlüsselbereich durch ein Paar bestehend aus **[Niedriger Wert, hoher Wert)** beschrieben, wobei *Low Value* der minimale Schlüssel und *High Value* der erste Wert außerhalb des Bereichs ist. 

**[0, 100)** enthält z. B. alle ganzen Zahlen größer als oder gleich 0 und kleiner als 100. Mehrere Bereiche können auf dieselbe Datenbank verweisen, und unzusammenhängende Bereiche werden unterstützt (z. B. [100,200) und [400,600), die im folgenden Beispiel beide auf Datenbank_C verweisen.)
<table>
   <tr>
...
* Erstellen oder Entfernen von Punkten oder Bereichen, die den Shards zugeordnet sind: Verwenden Sie **CreateRangeMapping**, **DeleteMapping**, **CreatePointMapping**. 
...
* Unterteilen vorhandener Bereiche in zwei Hälften oder Zusammenführen benachbarter Bereiche: Verwenden Sie **SplitMapping** und **MergeMappings**.  
...
* Neuzuordnen (oder Verschieben) einzelner Punkte oder Bereiche zu unterschiedlichen Shards: Verwenden Sie **UpdateMapping**.  
...
* Online- und Offlineschalten von Zuordnungen: Verwenden Sie **MarkMappingOffline** und **MarkMappingOnline**, um den Onlinestatus einer Zuordnung zu steuern. 
