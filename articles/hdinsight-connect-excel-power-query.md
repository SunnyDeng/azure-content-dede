<properties urlDisplayName="HDInsight and Excel" pageTitle="Verbinden von Excel &uuml;ber Power Query mit Hadoop | Azure" metaKeywords="hdinsight, excel, data explorer, hive excel, hdinsight excel, power query" description="Erfahren Sie, wie Sie Business Intelligence-Komponenten und Excel f&uuml;r den Zugriff auf Daten in Azure HDInsight mithilfe von Power Query verwenden k&ouml;nnen." metaCanonical="" services="hdinsight" documentationCenter="" title="Verbinden von Excel &uuml;ber Power Query mit Hadoop" authors="bradsev" solutions="" manager="paulettm" editor="cgronlun" />
