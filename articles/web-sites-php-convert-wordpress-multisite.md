<properties 
	pageTitle="Konvertieren einer WordPress-Website in eine Multisite" 
	description="Erfahren Sie, wie Sie eine vorhandene WordPress-Website, die über die Galerie in Azure erstellt wurde, in eine WordPress Multisite konvertieren." 
	services="web-sites" 
...
Das Konvertieren einer vorhandenen WordPress-Einzelsite in eine Multisite ist im Allgemeinen sehr einfach. Viele der hier aufgeführten Schritte stammen direkt von der Seite [Create A Network][wordpress-codex-create-a-network] auf [WordPress Codex](http://codex.wordpress.org).
...
Melden Sie sich am Bereich  *wp-admin* Ihrer Website an. Im Menü **Tools** sollte ein neues Element mit dem Namen **Network Setup** angezeigt werden. Klicken Sie auf **Network Setup**, und geben Sie die Details zu Ihrem Netzwerk ein.
...
Weitere Informationen zu Unterdomäneneinrichtungen im Vergleich zu Unterverzeichniseinrichtungen finden Sie im Artikel [Types of multisite network][wordpress-codex-types-of-networks] im WordPress Codex.
...
* Melden Sie sich am Azure-Portal an, und suchen Sie Ihre Website. 
...
Nachdem Sie die Domäne in das Textfeld eingegeben haben, überprüft Azure den CNAME-Eintrag  *awverify*, den Sie zuvor erstellt haben. Wenn der DNS nicht vollständig ausgefüllt wurde, wird eine rote Markierung angezeigt. Wenn der Vorgang erfolgreich abgeschlossen wurde, wird ein grünes Häkchen angezeigt. 
...
Nachdem Sie das Plug-In installiert und aktiviert haben, rufen Sie **Settings** > **Domain Mapping** auf, um das Plug-In zu konfigurieren. Geben Sie im ersten Textfeld,  *Server IP Address*, die IP-Adresse ein, die Sie zum Einrichten das A-Datensatzes für die Domäne verwendet haben. Legen Sie unter  *Domain Options* die gewünschten Optionen fest (die Standardwerte sind in der Regel ausreichend), und klicken Sie auf **Save**.
...
[website-from-gallery]: https://www.windowsazure.com/de-de/develop/php/tutorials/website-from-gallery/
[wordpress-codex-create-a-network]: http://codex.wordpress.org/Create_A_Network
[website-w-mysql-and-ftp-ftp-setup]: https://www.windowsazure.com/de-de/develop/php/tutorials/website-w-mysql-and-ftp/#header-0
[website-w-mysql-and-git-git-setup]: https://www.windowsazure.com/de-de/develop/php/tutorials/website-w-mysql-and-git/#header-1
