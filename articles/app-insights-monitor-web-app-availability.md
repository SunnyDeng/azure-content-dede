<properties title="Monitor any web site's availability and responsiveness" pageTitle="Überwachen der Verfügbarkeit und Reaktionszeit von Websites" description="Richten Sie Webtests in Application Insights ein. Erhalten Sie Benachrichtigungen, wenn eine Website nicht mehr zur Verfügung steht oder langsam reagiert." metaKeywords="analytics web test availability" authors="awills"  manager="kamrani" />
