<properties urlDisplayName="Twilio Voice/SMS Service" pageTitle="Verwenden von Twilio für Telefonie und SMS (Ruby) - Azure" metaKeywords="Azure Ruby Twilio, Azure-Anrufe, Azure-Telefonanrufe, Azure Twilio, Azure-SMS, Azure SMS, Azure-Telefonate, Azure-Sprachanrufe, Azure-Textnachrichten, Azure Textnachrichten" description="Learn how to make a phone call and send a SMS message with the Twilio API service on Azure. Code samples written in Ruby." metaCanonical="" services="" documentationCenter="Ruby" title="How to Use Twilio for Voice and SMS Capabilities in PHP" authors="MicrosoftHelp@twilio.com" solutions="" manager="twilio" editor="" />
