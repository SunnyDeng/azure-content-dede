...
![Neue eingehende Regel][Neue eingehende Regel]

1.  Wählen Sie für die neue Regel unter **Regeltyp** die Option **Port** aus, und klicken Sie dann auf **Weiter**.

![Neue eingehende Regel – Port][Neue eingehende Regel – Port]

1.  Wählen Sie als Protokoll **TCP** aus, und geben Sie als Port **8080** an. Klicken Sie dann auf **Weiter**.

![Neue eingehende Regel][1]

1.  Wählen Sie die Option **Verbindung zulassen** aus, und klicken Sie anschließend auf **Weiter**.

![Neue eingehende Regel – Aktion][Neue eingehende Regel – Aktion]

1.  Stellen Sie sicher, dass die Kontrollkästchen **Domäne**, **Privat** und **Öffentlich** für das Profil aktiviert sind, und klicken Sie dann auf **Weiter**.

![Neue eingehende Regel – Profil][Neue eingehende Regel – Profil]

1.  Geben Sie einen Namen für die Regel an, wie beispielsweise **HttpIn** (der Name der Regel muss jedoch nicht mit dem Namen des Endpunkts übereinstimmen). Klicken Sie anschließend auf **Fertig stellen**.

![Neue eingehende Regel – Name][Neue eingehende Regel – Name]

An dieser Stelle sollte es nun möglich sein, die Tomcat-Website über einen externen Browser anzuzeigen. Dabei wird eine URL in der Form **[http://\*your\\_DNS\\_name][http://\*your\\_DNS\\_name]*.cloudapp.net **verwendet, wobei*** your\_DNS\_name**\* der DNS-Name ist, den Sie beim Erstellen des virtuellen Computers angegeben haben.
...
-   Wenn der Tomcat-Dienst installiert ist, wird standardmäßig der manuelle Start festgelegt. Über das Snap-In **Dienste** können Sie zum automatischen Start wechseln. Starten Sie das Snap-In **Dienste**, indem Sie unter Windows auf **Start**, auf **Verwaltung** und dann auf **Dienste** klicken. Um festzulegen, dass Tomcat automatisch gestartet wird, doppelklicken Sie auf den Dienst **Apache Tomcat** im Snap-In **Dienste**, und wählen Sie unter **Starttyp** die Option **Automatisch** aus, wie in der folgenden Abbildung gezeigt.
    ...
    ![Festlegen, dass ein Dienst automatisch gestartet wird][Festlegen, dass ein Dienst automatisch gestartet wird]
