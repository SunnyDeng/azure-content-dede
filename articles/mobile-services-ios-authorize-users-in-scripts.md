<properties pageTitle="Dienstseitige Autorisierung (iOS) | Mobile Dev Center" metaKeywords="" description="Erfahren Sie, wie Sie Benutzern im JavaScript-Back-End von Azure Mobile Services Berechtigungen erteilen." metaCanonical="" services="" documentationCenter="Mobile" title="Service-side authorization of Mobile Services users" authors="krisragh" solutions="" manager="dwrede" editor="" />
