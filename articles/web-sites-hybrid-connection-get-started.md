...
6. Sobald der Prozess abgeschlossen ist, werden Sie im Benachrichtigungsbereich des Portals informiert, dass die Verbindung erfolgreich erstellt wurde.
    ...
    Dieser Schritt schlägt fehl. Es ist nicht möglich, einen BizTalk Service im Azure-Portal zu erstellen. Ich wechselte zum alten Portal (vollständiges Portal) und habe den BizTalk-Dienst erstellt, aber es scheint keine Verbindung zwischen den beiden möglich. – Wenn Sie den Schritt "Hybridverbindung erstellen" abgeschlossen haben, erhalten Sie eine Fehlermeldung, dass die Hybridverbindung RelecIoudHC nicht erstellt werden konnte. Der Ressourcentyp konnte nicht im Namespace 'Microsoft.BizTaIkServices for api version 2014-06-01' gefunden werden.
	
	Der Fehler zeigt an, dass der Typ und nicht die Instanz nicht gefunden werden konnte. ![Erfolgsmeldung][CreateHCSuccessNotification] -->
