...
2.  [Aktualisierung des Einfügeskripts zur Erzeugung einer SAS](#update-scripts)
...
2.  Wählen Sie im linken Bereich die Kategorie **Online** aus, suchen Sie nach `WindowsAzure.Storage`, klicken Sie auf dem Paket **Azure Storage** auf **Installieren**, und stimmen Sie dem Lizenzvertrag zu.
