...
## Öffentliche IP
Eine öffentliche IP-Adresse bietet entweder eine reservierte oder dynamische öffentliche IP-Adresse.  
Eine öffentliche IP-Adresse kann einem Lastausgleichsmodul, NAT, zugewiesen oder einer privaten IP-Adresse auf einer NIC eines virtuellen Computers zugeordnet sein.  
