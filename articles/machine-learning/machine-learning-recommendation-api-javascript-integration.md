...
- itemName (Zeichenfolge, optional) – der Name des Elements - itemDescription (Zeichenfolge, optional) – die Beschreibung des Elements
...
* function – eine Funktion, welche die zurückgegebenen Empfehlungen verarbeitet. Die Daten werden als Array mit folgenden Elementen zurückgegeben:
	* Item – eindeutige ID des Element
