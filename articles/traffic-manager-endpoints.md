...
>[AZURE.NOTE] Stellen Sie bei Verwendung der Lastenausgleichsmethode  *Failover* nach dem Hinzufügen oder Entfernen eines Endpunkts sicher, dass Sie die Failoverprioritätsliste auf der Seite Konfiguration entsprechend der für Ihre Konfiguration gewünschten Failoverreihenfolge anpassen. Weitere Informationen finden Sie unter [Konfigurieren der Lastenausgleichsmethode "Failover"](traffic-manager-configure-failover-load-balancing.md)..
...
[Informationen zu Traffic Manager-Überwachung](traffic-manager-monitoring.md)
