...
2. Melden Sie sich mit IHren Anmeldeinformationen bei Ihrem Azure-Konto an, wählen Sie Ihren Dienst in **Vorhandene Mobile Services** aus, und klicken Sie auf **OK**. Visual Studio lädt die Veröffentlichungseinstellungen direkt von Azure herunter.
