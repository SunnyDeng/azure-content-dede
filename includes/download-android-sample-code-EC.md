...
1. Laden Sie das  `mobile-services-samples`-Repository von gitHub herunter, indem Sie <a href="https://github.com/RickSaling/mobile-services-samples/tree/futures" target="blank">hier</a> klicken und anschließend auf **ZIP herunterladen** klicken.
