<h2><a name="add-select-images"></a>Aktualisierung der Schnellstart-Client-App zum Aufnehmen und Hochladen von Bildern</h2>
...
1.  Ersetzen Sie die vorhandene `InsertTodoItem`-Methode durch den folgenden Code:
...
1.  Klicken Sie auf das Bild, um eine Aufnahme zu machen, und klicken Sie dann auf **OK**.

	![](./media/mobile-services-windows-store-dotnet-upload-to-blob-storage/mobile-quickstart-blob-camera.png)

2.  Klicken Sie auf **Hochladen**, um das neue Element einzufügen und das Bild hochzuladen.

    ![](./media/mobile-services-windows-store-dotnet-upload-to-blob-storage/mobile-quickstart-blob-appbar2.png)

3.  Das neue Element wird zusammen mit dem hochgeladenen Bild in der Listenansicht angezeigt.

    ![](./media/mobile-services-windows-store-dotnet-upload-to-blob-storage/mobile-quickstart-blob-ie.png)

	>[WACOM.NOTE]Das Bild wird automatisch vom Blob-Speicherdienst heruntergeladen, wenn die <code>imageUri</code>-Eigenschaft des neuen Elements an die <strong>Image</strong>-Steuerung gebunden ist.
