...
3. Installieren Sie das Google Play Services SDK in Ihrem Projekt. Klicken Sie in Eclipse auf **File**, dann auf **Import**. Wählen Sie **Android**, dann **Existing Android Code into Workspace**, und klicken Sie auf **Next**. Klicken Sie auf **Browse**, navigieren Sie zum Android-SDK-Pfad (normalerweise in einem Ordner namens "adt-bundle-windows-x86_64" in dem Order, der Eclipse enthält), gehen Sie dann zum Unterordner "\extras\google\google_play_services\libproject", wählen Sie dort den Ordner "google-play-services-lib", und klicken Sie auf **OK**. Aktivieren Sie das Kontrollkästchen **Copy projects into workspace**, und klicken Sie dann auf **Finish**.
...
7. Stellen Sie sicher, dass für **Project Build Target** "Google APIs x86" (bzw. je nach Ihrer Entwicklungsplattform "Google APIs") für die geeignete SDK-Version ausgewählt ist.

 
8. Im **Library**-Abschnitt wählen Sie **Add** wählen Sie dann das Google Play Services-Projekt (*google-play-services-lib*), und klicken Sie auf **OK**.

9. Klicken Sie auf **Apply** und dann auf **OK**.
