...
7.  Stellen Sie sicher, dass für **Project Build Target** `Google APIs x86` (oder `Google APIs`, je nach Ihrer Entwicklungsplattform) für die geeignete SDK-Version ausgewählt ist.
