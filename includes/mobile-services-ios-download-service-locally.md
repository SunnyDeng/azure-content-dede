1. Klicken Sie im [Azure-Verwaltungsportal] auf den neuen mobilen Dienst oder dessen Cloud-Registerkartensymbol, um auf die Übersichtsseite zu gelangen.

    ![](./media/mobile-services-ios-download-service-locally/mobile-portal-quickstart-ios.png)

2. Klicken Sie auf die **iOS**-Plattform. Unter dem Abschnitt **Erste Schritte**, und erweitern Sie **Eine neue iOS-App erstellen**. 
