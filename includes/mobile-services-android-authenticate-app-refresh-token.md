Unser Tokencache sollte normalerweise funktionieren, doch was tun, wenn das Token abläuft oder widerrufen wird? Wir müssen daher in der Lage sein, abgelaufene Token zu erkennen. Das Token kann beispielsweise abgelaufen sein, wenn die App nicht ausgeführt wurde. Dann ist der Tokencache ungültig. Das Token kann auch abgelaufen sein, wenn die App ausgeführt wird und einen direkten Aufruf ausführt oder ein Aufruf von der Mobile Services-Bibliothek ausgeführt wird. Ergebnis ist der HTTP-Statuscode 401 "Nicht autorisiert". Solche Fälle müssen wir erkennen und das Token aktualisieren. Dazu verwenden wir einen [ServiceFilter][ServiceFilter] aus der [Android-Clientbibliothek][Android-Clientbibliothek].
