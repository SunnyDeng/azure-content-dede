...
Wenn Sie [Azure PowerShell 1.0][lnk-powershell-install] nicht installiert haben, können Sie dazu die folgenden PowerShell-Befehle verwenden. Sie müssen PowerShell als Administrator ausführen.
