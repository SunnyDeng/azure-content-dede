...
1. Melden Sie sich mit Ihrem Azure-Konto am [Azure-Verwaltungsportal][AzurePreviewPortal] an.
...
3. Wählen Sie unter der Gruppe **SUSE** das Image eines virtuellen OpenSUSE-Computers aus, und klicken Sie dann unten rechts auf der Seite auf den Pfeil "Weiter".


4. Nehmen Sie auf der ersten Seite **Konfiguration des virtuellen Computers** die erforderlichen Einstellungen vor, oder überprüfen Sie diese:

	- Weisen Sie unter **Name des virtuellen Computers** einen Namen zu, z. B. "testlinuxvm".
	- Überprüfen Sie den **Tarif**, und wählen Sie eine **Größe** aus. Die Ebene bestimmt, zwischen welchen Größen Sie wählen können.
...
5. Nehmen Sie auf der nächsten Seite **Konfiguration des virtuellen Computers** die erforderlichen Einstellungen vor, oder überprüfen Sie diese:
