...
4. Anschließend erhalten Sie aus dem Azure-Portal der mobilen App:
    ...
    - Klicken Sie unter **Verbindungszeichenfolgen** auf **Show Connection Strings**. Kopieren Sie den Wert für die Einstellung **MS_TableConnectionString**. Dies ist die Verbindungszeichenfolge, die von der mobilen App verwendet wird, um eine Verbindung mit der SQL-Datenbank herzustellen.

5. Klicken Sie in Visual Studio mit der rechten Maustaste auf das Web-API-Projekt, und wählen Sie **veröffentlichen** aus. Wählen Sie als Veröffentlichungsziel **Azure-Web-Apps** aus, und wählen Sie die Web-App, die Sie erstellt haben. Klicken Sie auf **Weiter** bis Sie der Bereich **Einstellungen** im Assistenten "Web veröffentlichen" angezeigt wird.
