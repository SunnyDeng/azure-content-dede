...
1. Melden Sie sich mit Ihren Microsoft-Kontoanmeldeinformationen unter dieser URL beim klassischen Azure-Portal an: [http://azure.microsoft.com/](http://azure.microsoft.com/).
