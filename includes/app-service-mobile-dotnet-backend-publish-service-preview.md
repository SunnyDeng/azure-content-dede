...
2. Wählen Sie im Dialogfeld **Web veröffentlichen** als Veröffentlichungsziel **Azure Mobile App** aus. Wählen Sie im angezeigten Dialogfeld Ihre vorhandene mobile App aus. Dies ist Ihre mobile A, an deren Namen "Code" angefügt ist.
