...
6. Wenn Sie die PHP-Verbindungsbibliothek verwenden möchten, kopieren Sie die Zeichenfolge mit der Bezeichnung **PHP**.

	![PHP-Verbindungszeichenfolge für die Datenbank kopieren][3-get-connection-string]
