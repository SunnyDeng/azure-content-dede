...
1.  Melden Sie sich mit Ihrem Azure-Konto am [Azure-Verwaltungsportal][2] an.

2.  Klicken Sie im Verwaltungsportal unten links auf der Webseite auf **+Neu**, klicken Sie auf **Virtueller Computer** und dann auf **From Gallery**. ![Neuen virtuellen Computer erstellen](./media/create-and-configure-windows-server-2008-vm-in-portal/CreateWinVM.png)
...
* Geben Sie in das Feld **Neues Kennwort** ein [sicheres Kennwort][3] ein.
