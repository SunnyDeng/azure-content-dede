...
>[WACOM.NOTE]Für die nachfolgenden Methoden sollte das **AuthorizeLevel**-Attribut auf der **Autorisierungsebene** **Benutzer** angewendet werden. Dadurch wird nur authentifizierten Benutzer Tabellenzugang gewährt.
