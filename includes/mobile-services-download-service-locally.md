...
2. Klicken Sie im [klassischen Azure-Portal](https://manage.windowsazure.com/) auf den neuen Mobile Service. Klicken Sie auf der Schnellstart-Seite auf **Android**-Plattform, und erweitern Sie **Erstellen einer neuen Android-App** unter **Erste Schritte**.
