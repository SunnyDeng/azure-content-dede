Sie können BLOB-Container erstellen, indem Sie den **Server-Explorer** von Visual Studio verwenden.
...
3. Wählen Sie den Knoten **Blobs** aus, und wählen Sie dann **BLOB-Container erstellen** aus dem Kontextmenü aus.
