## WordPress und Azure App Service

* [Was ist WordPress?](https://wordpress.org/)
* [Gewusst wie: Einrichten der leistungsstarken WordPress-Web-App](web-sites-php-enterprise-wordpress.md)
...
* [Gewusst wie: Sichern Ihrer Web-App](web-sites-backup.md) und [Gewusst wie: Wiederherstellen Ihrer Web-App](web-sites-restore.md)
...
* [Gewusst wie: Aktivieren von Redis Cache](../redis-cache/cache-dotnet-how-to-use-azure-redis-cache.md) mit dem [Redis Cache-Plug-In](https://wordpress.org/plugins/wp-redis/)
* [Gewusst wie: Aktivieren von Memcached Object Cache für WordPress](web-sites-connect-to-redis-using-memcache-protocol.md) mit dem [memcached-Plug-In](https://wordpress.org/plugins/memcached/)
