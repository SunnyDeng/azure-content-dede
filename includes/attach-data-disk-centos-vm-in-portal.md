1.  Klicken Sie im [Azure-Verwaltungsportal][Azure-Verwaltungsportal] auf **Virtuelle Computer**, und wählen anschließend den gerade von Ihnen erstellten virtuellen Computer aus (**testlinuxvm**).
...
3.  Der **Name des virtuellen Computers**, der **Speicherort** und der **Dateiname** sind bereits ausgefüllt. Sie müssen lediglich die für den Datenträger gewünschte Größe eingeben. Geben Sie **5** in das Feld **Größe** ein.
    ...
    **Hinweis:** Alle Datenträger werden aus einer VHD-Datei in Azure Storage erstellt. Sie können einen Namen für die VHD-Datei angeben, die dem Speicher hinzugefügt wird. Der Name des Datenträgers wird jedoch von Azure automatisch erzeugt.
