...
12. Klicken Sie am unteren Seitenrand auf **Endpunkt hinzufügen**.
    ![Endpunkte](./media/install-and-run-mysql-on-opensuse-vm/LinuxVmAddEndpoint2.png)

13. Fügen Sie einen Endpunkt mit dem Namen "MySQL" hinzu, und wählen Sie als Protokoll **TCP** aus. Setzen Sie die beiden Ports **Öffentlich** und **Privat** auf "3306". Dadurch ist ein Remotezugriff auf MySQL möglich.
    ![Endpunkte](./media/install-and-run-mysql-on-opensuse-vm/LinuxVmAddEndpointMySQL.png)
...
15. Sie haben MySQL erfolgreich konfiguriert und dazu eine Datenbank sowie einen neuen Benutzer erstellt. Weitere Informationen zu MySQL finden Sie in der [MySQL-Dokumentation][2].
