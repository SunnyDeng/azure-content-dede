...
> [AZURE.NOTE]Wenn Sie sich dafür entscheiden, einen anderen <strong>Bundle Identifier</strong>-Wert als <i>MobileServices.Quickstart</i> anzugeben, müssen Sie auch den Bundle Identifier-Wert in Ihrem Xcode-Projekt aktualisieren. Es wird empfohlen, den genauen Bundle-ID-Wert zu verwenden, den Sie bereits in Ihrem Schnellstartprojekt verwendet haben.
...
1. Wählen Sie wieder im <a href="http://go.microsoft.com/fwlink/p/?LinkId=272456" target="_blank">iOS Provisioning Portal</a> die Option **Provisioning Profiles** und dann **All** aus, und klicken Sie schließlich auf die Schaltfläche **+**, um ein neues Profil zu erstellen. Hierdurch wird der Assistent **Add iOS Provisiong Profile** gestartet
