<properties 
   pageTitle="Abrufen des IQN eines Windows-Hosts"
   description="Beschreibt, wie Sie den qualifizierten iSCSI-Namen (IQN) eines Computers mit Windows Server 2012 abrufen."
   services="storsimple"
