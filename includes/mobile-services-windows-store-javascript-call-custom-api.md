...
1.  Öffnen Sie in Visual Studio die Datei "default.html" in Ihrem Schnellstartprojekt, suchen Sie das **button**-Element namens `buttonRefresh`, und fügen Sie das folgende neue Element direkt dahinter ein:
