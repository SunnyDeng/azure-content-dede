...
1.  Windows 7, Windows 8, Windows Server 2008 oder Windows Server 2012.
    (Nicht verfügbar für Mac oder Linux.)
2.  Eclipse Indigo oder höher.

Installationsschritte:

1.  Wählen Sie im Menü von Eclipse **Help**, und wählen Sie **Install
    New Software** aus.
2.  Geben Sie den Websitespeicherort <http://dl.msopentech.com/eclipse> ein, und
    drücken Sie die **Eingabetaste**.
3.  Wählen Sie die zu installierenden Elemente aus, und klicken Sie auf
    **Finish**.
