* [Was ist Azure App Service?](../articles/app-service/app-service-value-prop-what-is.md)
  ...
  * [Logik-App](../articles/app-service-logic/app-service-logic-what-are-logic-apps.md)
* [Azure App Service-Architektur (Präsentation)](http://www.slideshare.net/maartenba/windows-azure-web-sites-things-they-dont-teach-kids-in-school-comunity-day-2013)
* [Azure App Service, Cloud Services und Virtual Machines im Vergleich](../articles/app-service-web/choose-web-site-cloud-service-vm.md)
* [Grundlegendes zu App Service-Plänen](../articles/app-service/azure-web-sites-web-hosting-plans-in-depth-overview.md)
* [Einführung in die App Service-Umgebung](../articles/app-service-web/app-service-app-service-environment-intro.md)
