...
2. Wählen Sie unter **Create a table API** als **Backend language** entweder **C#** oder **Node.js** aus:
	...
	Akzeptieren Sie die Bestätigung, und klicken Sie auf **TodoItem-Tabelle erstellen**. Dadurch wird eine neue *TodoItem*-Tabelle in Ihrer Datenbank erstellt.
