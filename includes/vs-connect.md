...
* Installieren Sie ein Verwaltungszertifikat, dass den Zugriff auf Ihr Konto ermöglicht.
	...
	Klicken Sie in **Server-Explorer** mit der rechten Maustaste auf den Knoten **Azure**, und wählen Sie im Kontextmenü **Abonnements verwalten** aus. Klicken Sie im Dialogfeld **Azure-Abonnements verwalten** auf die Registerkarte **Zertifikate**, und klicken Sie dann auf **Importieren**. Befolgen Sie die Anweisungen zum Herunterladen und Importieren einer Abonnementdatei (auch *.publishsettings*-Datei genannt) für Ihr Azure-Konto.

	<div class="dev-callout"> <b>Sicherheitshinweis:</b>
	<p>Laden Sie die Abonnementdatei in einen Ordner außerhalb Ihrer
	Quellcodeverzeichnisse herunter (beispielsweise in den Ordner
	"Downloads"), und löschen Sie sie nach Abschluss des Importvorgangs.
	Böswillige Benutzer, die Zugriff auf die Abonnementdatei erlangen,
	können Ihre Azure-Dienste bearbeiten, erstellen und löschen.</p></div>
