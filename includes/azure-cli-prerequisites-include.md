...
Um die Schritte in diesem Artikel ausführen zu können, müssen Sie [die Azure-Befehlszeilenschnittstelle für Mac, Linux und Windows (Azure CLI installieren)](xplat-install.md) und sich [bei Azure anmelden](xplat-connect.md).
