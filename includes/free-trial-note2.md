> [AZURE.NOTE]<a name="note"></a>Zum Abschließen dieses Lernprogramms benötigen Sie ein Azure-Konto:
  >
  ...
  >
  > + Sie können die [MSDN-Abonnentenvorteile aktivieren](/pricing/member-offers/msdn-benefits-details/?WT.mc_id=A261C142F): Sie erhalten jeden Monat über Ihr MSDN-Abonnement Guthaben, das Sie für kostenpflichtige Azure-Dienste nutzen können.
  >
