...
-   [Servicebus - Grundlagen][Servicebus - Grundlagen]
...
-   *Warteschlangen* für eine unidirektionale Kommunikation. Jede Warteschlange agiert als Zwischenstufe (manchmal auch *Broker* genannt), die gesendete Nachrichten speichert, bis diese empfangen werden.
-   *Themen*, die eine unidirektionale Kommunikation über *Abonnements* anbieten. Wie bei einer Warteschlange agiert ein Thema als Broker, aber erlaubt jedem Abonnenten, nur Nachrichten zu sehen, die bestimmte Kriterien erfüllen.
...
Angenommen, Sie entscheiden sich dafür, zwei Anwendungen über eine Servicebus-Warteschlange miteinander zu verbinden. [Abbildung 2][Abbildung 2] illustriert diese Situation.

<a name="Fig2"></a>![Diagramm mit Servicebus-Warteschlangen][Diagramm mit Servicebus-Warteschlangen]

**Abbildung 2: Servicebus-Warteschlangen für eine asynchrone unidirektionale Kommunikation.**

Der Prozess ist ganz einfach: Ein Sender sendet eine Nachricht an eine Servicebus-Warteschlange, und ein Empfänger greift diese Nachricht zu einem späteren Zeitpunkt auf. Eine Warteschlange kann wie in [Abbildung 2][Abbildung 2] gezeigt einen einzelnen Empfänger aufweisen, oder mehrere Anwendungen können dieselbe Warteschlange auslesen. In der zweiten Situation wird jede Nachricht normalerweise von nur einem Empfänger gelesen: Warteschlangen bieten keine Multicast-Dienste.
...
So hilfreich sie generell auch sind - Warteschlangen sind nicht immer die beste Lösung. Manchmal sind Servicebus-Themen besser. [Abbildung 3][Abbildung 3] illustriert diesen Gedanken.

<a name="Fig3"></a>![Diagramm mit Servicebus-Themen und -Abonnements][Diagramm mit Servicebus-Themen und -Abonnements]
...
Die Verbindung von Anwendungen war immer ein Teil des Aufbaus kompletter Lösungen, und es ist kaum abzusehen, dass die damit zusammenhängenden Probleme jemals verschwinden. Service Bus stellt cloudbasierte Technologien bereitstellt, um diese Aufgabe über Warteschlangen, Themen und Relais zu bewältigen und damit diese wesentliche Funktion leichter und breiter verfügbar zu machen.
  ...
  [Relais]: #relays
  [Abbildung 1]: #Fig1
  [Diagramm von Azure-Servicebus]: ./media/hybrid-solutions/SvcBus_01_architecture.png
  [Abbildung 2]: #Fig2
  [Diagramm mit Servicebus-Warteschlangen]: ./media/hybrid-solutions/SvcBus_02_queues.png
  [Abbildung 3]: #Fig3
  [Diagramm mit Servicebus-Themen und -Abonnements]: ./media/hybrid-solutions/SvcBus_03_topicsandsubscriptions.png
  [Abbildung 4]: #Fig4
  [Diagramm eines Servicebus-Relais]: ./media/hybrid-solutions/SvcBus_04_relay.png
