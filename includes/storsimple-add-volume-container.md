...
2. Klicken Sie unten auf der Seite auf **Hinzufügen**. Führen Sie im Dialogfeld **Volumecontainer erstellen** die folgenden Schritte aus:
  ...
  4. Es wird empfohlen, dass Sie immer **Cloud-Speicherverschlüsselung aktivieren** zum Verschlüsseln der in der Cloud gespeicherten Daten verwenden. Deaktivieren Sie die Verschlüsselung nur dann, wenn Sie andere Verfahren zum Verschlüsseln Ihrer Daten anwenden. Die Verschlüsselungseinstellung kann nach dem Erstellen des Volumecontainers nicht mehr geändert werden.
