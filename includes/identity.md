...
Es gibt mehrere Optionen für die Verbindung der in der Cloud und der lokal ausgeführten Domänencontroller:
...
- Erstellen separater AD-Gesamtstrukturen lokal und in der Cloud und anschließende Verbindung dieser Gesamtstrukturen mittels gesamtstrukturübergreifender Vertrauensstellungen oder Windows Server Active Directory-Verbunddiensten (AD FS), die auch auf virtuellen Computern in Azure ausgeführt werden können.
