...
2. Erweitern Sie **Erweitert**, überprüfen Sie, ob die Tabellen-Aktionsberechtigungen standardmäßig auf **Jeder mit dem Anwendungsschlüssel** gesetzt sind, und klicken Sie dann auf **Erstellen**. 
