...
-   [Konfigurieren Ihrer Websites für den Freigabe- oder Standardmodus](#bkmk_configsharedmode)
...
-   [Hinzufügen eines A-Datensatzes zu Ihrer benutzerdefinierten Domäne](#bkmk_configurearecord)
...
1. Öffnen Sie das [Verwaltungsportal][portal] in Ihrem Browser.
...
1. Falls Sie nicht bereits ein Traffic Manager-Profil besitzen, erstellen Sie eines mithilfe der Angaben unter [Erstellen eines Traffic Manager-Profils mithilfe der Schnellerfassung][createprofile]. Bitte beachten Sie, dass mit Ihrem Traffic Manager-Profil der Domänenname **.trafficmgr.com** verknüpft ist. Dieser wird in einem späteren Schritt verwendet.
...
1. Verwenden Sie eine dieser Methoden, um den **.azurewebsite.net**-Domänennamen zu ermitteln, der Ihrer Website zugewiesen ist.
	...
	* Installieren und konfigurieren Sie [Azure PowerShell](/manage/install-and-configure-windows-powershell/), und verwenden Sie dann den folgenden Befehl:
...
1. Öffnen Sie das [Azure-Verwaltungsportal][portal] in Ihrem Browser.
...
</table>Dieses Beispiel zeigt das Erstellen eines A-Datensatzes für die Stammdomäne. Wenn Sie einen Platzhaltereintrag erstellen möchten, der alle Unterdomänen abdeckt, würden Sie "\_\_*\_\_" als Unterdomäne eingeben.
...
7. Erstellen Sie dann einen CNAME-Datensatz, der einen Alias von **awverify** besitzt und eine kanonische Domäne von **awverify.mysite.azurewebsites.net**, die Sie zuvor erhalten haben.
	...
	> [AZURE.NOTE]Während awverify zwar für manche Registrierungen funktioniert, benötigen andere hingegen möglicherweise den vollständigen Alias-Domänenname von awverify.www.customdomainname.com oder awverify.customdomainname.com.
