...
1. Melden Sie sich beim [klassischen Azure-Portal](https://manage.windowsazure.com/) an, klicken Sie auf **Mobile Services**, dann auf Ihren mobilen Dienst und auf die Registerkarte **Dashboard**.
