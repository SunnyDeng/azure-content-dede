...
5. Wählen Sie im Dialogfeld **Add-On personalisieren** den **SendGrid**-Plan, für den Sie sich registrieren möchten.
...
10. Nach der Bestätigung Ihres Kaufs werden Sie zum Add-Ons-Dashboard umgeleitet, und die Meldung **Purchasing SendGrid** wird angezeigt.
	...
	Wenn Sie Ihren Abonnementplan ändern oder die SendGrid-Kontakteinstellungen anzeigen möchten, klicken Sie auf den Namen des SendGrid-Diensts, um das SendGrid-Add-Ons-Dashboard zu öffnen. 
...
2. Kopieren Sie im Dialogfeld *Verbindungsinformationen* das **Kennwort** und den Benutzernamen, die Sie später in diesem Lernprogramm verwenden werden.
