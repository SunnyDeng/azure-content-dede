...
1.  Melden Sie sich beim [Azure-Verwaltungsportal][2] an.
...
2.  Kopieren Sie im Feld *Verbindungsinformationen* das **Kennwort** und den Benutzernamen, um beides später in diesem Lernprogramm zu verwenden.
    ...
    Weitere Informationen über die ersten Schritte mit SendGrid finden Sie unter [SendGrid Getting Started][3] (in englischer Sprache).
