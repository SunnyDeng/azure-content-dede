...
1. Wenn Sie dies nicht bereits getan haben, führen Sie die Schritte im Thema <a href="/de-de/documentation/articles/mobile-services-how-to-register-twitter-authentication/" target="_blank">Registrieren Ihrer App für die Twitter-Anmeldung mit Mobile Services</a> aus. 
...
2. Navigieren Sie zur Website für <a href="http://go.microsoft.com/fwlink/p/?LinkId=268300" target="_blank">Twitter-Entwickler</a>, melden Sie sich mit den Anmeldeinformationen für Ihr Twitter-Konto an, navigieren Sie zu **Meine Anwendungen**, und wählen Sie Ihre Twitter-App aus.

    ![](./media/mobile-services-register-twitter-access/mobile-twitter-my-apps.png)

3. Notieren Sie sich in der Registerkarte **Details** der App die folgenden Werte:
...
[App-Einstellungen]: http://msdn.microsoft.com/library/windowsazure/b6bb7d2d-35ae-47eb-a03f-6ee393e170f7<!--HONumber=42-->
