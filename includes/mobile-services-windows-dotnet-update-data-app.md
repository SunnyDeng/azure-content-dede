...
2.  Ersetzen Sie die TodoItem-Klassendefinition durch den folgenden Code:
    ...
    > [WACOM.NOTE] In einem universellen Windows-App-Projekt wird die TodoItem-Klasse in der separaten Codedatei im gemeinsam genutzten Ordner "DataModel" definiert.
