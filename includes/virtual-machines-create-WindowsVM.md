1. Melden Sie sich auf dem [Azure-Verwaltungsportal](http://manage.windowsazure.com) an. Sehen Sie sich das Angebot [kostenlose Testversion](http://www.windowsazure.com/pricing/free-trial/) an, wenn Sie noch kein Abonnent sind.
...
6. Auf dem dritten Bildschirm können Sie die Ressourcen für Netzwerk, Speicher und Verfügbarkeit konfigurieren. Im Folgenden finden Sie einige Details, die Ihnen beim Ausfüllen helfen: 
	...
	- Unter [Gewusst wie: Einrichten von Endpunkten für einen virtuellen Computer](http://www.windowsazure.com/documentation/articles/virtual-machines-set-up-endpoints/) finden Sie Einzelheiten über das Konfigurieren von Endpunkten.
