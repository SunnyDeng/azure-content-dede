1. Melden Sie sich am [Azure-Verwaltungsportal](http://manage.windowsazure.com) an. Testen Sie die [kostenlose Testversion](http://www.windowsazure.com/de-de/pricing/free-trial/), wenn Sie noch nicht über ein Abonnement verfügen.
...
6. Auf dem dritten Bildschirm können Sie die Ressourcen für Netzwerk, Speicher und Verfügbarkeit konfigurieren. Im Folgenden finden Sie einige Details, die Ihnen beim Ausfüllen helfen: 
	...
	- Unter [Gewusst wie: Einrichten von Endpunkten für einen virtuellen Computer](http://www.windowsazure.com/de-de/documentation/articles/virtual-machines-set-up-endpoints/) finden Sie Einzelheiten über das Konfigurieren von Endpunkten.
