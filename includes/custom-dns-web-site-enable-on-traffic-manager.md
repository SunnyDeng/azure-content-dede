...
Wenn Sie Ihre Website noch nicht als Traffic Manager-Endpunkt hinzugefügt haben, müssen Sie dies durchführen, bevor die Namensauflösung funktionieren kann, da der benutzerdefinierte Domänenname an Traffic Manager geleitet wird. Traffic Manager führt Sie dann zu Ihrer Website. Verwenden Sie die Informationen unter [Hinzufügen und Löschen von Endpunkten][Hinzufügen und Löschen von Endpunkten], um dem Traffic Manager-Profil die Website als Endpunkt hinzuzufügen.
