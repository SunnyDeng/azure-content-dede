...
1. Navigieren Sie im [klassischen Azure-Portal](https://manage.windowsazure.com) zu dem Verzeichnis, das Sie zuvor zur Authentifizierung konfiguriert haben, als Sie das Tutorial zum Hinzufügen der Authentifizierung zu Ihrer App bearbeitet haben.
