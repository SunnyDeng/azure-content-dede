...
-   [Die Komponenten von Azure][Die Komponenten von Azure]
-   [Verwaltungsportal][Verwaltungsportal]
-   [Compute][Compute]
-   [Datenverwaltung][Datenverwaltung]
-   [Netzwerk][Netzwerk]
-   [Entwicklerdienste][Entwicklerdienste]

**Zusätzliche Dienste**

-   [Identität und Zugriff][Identität und Zugriff]
-   [Mobile][Mobile]
-   [Sicherung][Sicherung]
-   [Messaging und Integration][Messaging und Integration]
-   [Compute-Unterstützung][Compute-Unterstützung]
-   [Leistung][Leistung]
-   [Big Compute und Big Data][Big Compute und Big Data]
-   [Medien][Medien]
-   [Commerce][Commerce]
...
Azure gruppiert Dienste im Verwaltungsportal unter verschiedenen Kategorien und auf verschiedenen visuellen Hilfsmitteln wie der [Was ist Windows Azure-Infografik][Was ist Windows Azure-Infografik]. Im Verwaltungsportal verwalten Sie die meisten (aber nicht alle) Dienste in Azure.
...
![Azure-Komponenten][Azure-Komponenten]
 **Abbildung: Azure bietet über das Internet zugängige Anwendungsdienste, die in Azure-Datencentern ausgeführt werden.**

## <span id="portal"></span></a>Verwaltungsportal

Azure verfügt über eine Webschnittstelle, das so genannte [Verwaltungsportal][1], über das Administratoren auf die meisten Azure-Features zugreifen und die meisten Azure-Features verwalten können. Microsoft gibt das Portal mit der neueren Benutzeroberfläche in der Regel als Beta-Version heraus, bevor eine ältere Version zurückgezogen wird. Die neuere Version heißt [Azure-Vorschauportal][Azure-Vorschauportal].
...
**Abbildung: Azure Virtual Machines bietet Ihnen volle Kontrolle über Instanzen virtueller Computer in der Cloud.**
...
![Azure Storage SQL-Datenbank][Azure Storage SQL-Datenbank]
...
![Azure Storage-Tabellen][Azure Storage-Tabellen]
**Abbildung: Azure-Tabellen bieten eine flache NoSQL-Möglichkeit zum Speichern von Daten.**
...
Weitere Informationen über das Planen und Erstellen eines auf Ihren Bedarf zugeschnittenen virtuellen Netzwerks finden Sie unter [Virtuelles Netzwerk][Virtuelles Netzwerk].
...
Weitere Informationen über ExpressRoute finden Sie unter [ExpressRoute – Technische Übersicht][ExpressRoute – Technische Übersicht].
...
**Abbildung: Azure Backup sichert Daten von lokalen Servern unter Windows in der Cloud.**
...
Wenn Sie bereits Windows Server oder System Center verwenden, ist Azure Backup die sich anbietende Lösung zum Sichern des Dateisystems Ihrer Server, Ihrer virtuellen Computer und SQL Server-Datenbanken. Es arbeitet mit verschlüsselten, wenigen und komprimierten Dateien. Da bestimmte Beschränkungen gelten, sollten Sie zunächst die [Voraussetzungen für Azure Backup prüfen][Voraussetzungen für Azure Backup prüfen].
...
![Azure Service Bus Relay][2]
**Abbildung: Service Bus Relay ermöglicht die Kommunikation zwischen Anwendungen auf unterschiedlichen Seiten einer Firewall.**
...
**Abbildung: Azure Scheduler ermöglicht die Planung von Aufträgen zu bestimmten Zeiten für eine bestimmte Dauer.**
...
Nachdem Sie nun einen Überblick erhalten haben, besteht der nächste Schritt darin, Ihre erste Azure-Anwendung zu schreiben. Wählen Sie die gewünschte Sprache, [holen Sie sich das entsprechende SDK][holen Sie sich das entsprechende SDK], und los geht's. Cloud-Computing ist der neue Standard – machen Sie jetzt den ersten Schritt.
  ...
  [Azure-Komponenten]: ./media/intro-to-azure/AzureComponentsIntroNew780.png
  ...
  [Azure Cloud Services]: ./media/intro-to-azure/CloudServicesIntroNew.png
  [Azure Storage SQL-Datenbank]: ./media/intro-to-azure/StorageAzureSQLDatabaseIntroNew.png
  [Azure Storage-Tabellen]: ./media/intro-to-azure/StorageTablesIntroNew.png
  ...
  [ExpressRoute – Technische Übersicht]: http://msdn.microsoft.com/de-de/library/azure/dn606309.aspx
  [TrafficManager]: ./media/intro-to-azure/TrafficManagerIntroNew.png
  [www.microsoftazure.com]: http://azure.microsoft.com/de-de/downloads/
  ...
  [Voraussetzungen für Azure Backup prüfen]: http://technet.microsoft.com/de-de/library/dn296608.aspx
  ...
  [2]: ./media/intro-to-azure/ServiceBusRelayIntroNew.png
  ...
  [holen Sie sich das entsprechende SDK]: /de-de/downloads/
