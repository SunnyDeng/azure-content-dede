## <a name="setupdevenv"></a><span class="short-header">Einrichten der Umgebung</span>Einrichten der Entwicklungsumgebung
...
Nach Abschluss der Installation haben Sie alles zur Hand, was Sie benötigen, um mit der Entwicklung zu beginnen.
  ...
  [Webplattform-Installer - Azure SDK für .NET]: ./media/install-sdk-2012-only/WebPI46-2012.png
